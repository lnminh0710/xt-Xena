...
namespace XenaUI.Business
{
    ...
    public interface IUniqueBusiness
    {
        ...
        /// <returns></returns>
        Task<object> GetColumnSetting(string moduleId);
        ...
        /// <returns></returns>
        Task<object> GetSettingModule(string objectParam, int? idSettingsModule, string objectNr, string moduleType, string idLogin);
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        Task<WSContactEditReturn> UpdateContact(ContactEditModel model);

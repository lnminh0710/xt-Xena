...
namespace XenaUI.Business
{
    public interface ICampaignBusiness
    {
        ...
        /// <param name="customMethodName"></param>
        /// <returns></returns>
        Task<object> GetCampaignMediaCodeArticleSalesPrice(int idCountrylanguage, int idSalesCampaignWizard, int idSalesCampaignArticle, string customMethodName);
        ...
        /// <param name="idSalesCampaignWizardItems"></param>
        /// <returns></returns>
        Task<object> GetPaymentTypeSalesPrice(int idSalesCampaignWizardItems);
        ...
        /// <param name="customMethodName"></param>
        /// <returns></returns>
        Task<object> SaveCampaignMediaCodeArticleSalesPrice(CampaignMediaCodeArticleSalesPriceModel model, string customMethodName);
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        Task<object> SavePaymentTypeSalesPrice(CampaignPaymentTypeSalesPriceModel model);

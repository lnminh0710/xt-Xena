...
namespace XenaUI.Business
{
    public interface IGlobalBusiness : IBaseBusiness
    {
        ...
        /// <returns></returns>
        object GetAllWidgetTemplateByModuleId(string moduleId, string objectValue);
        ...
        /// </summary>
        /// <returns></returns>
        Task<object> GetCommonTranslateLabelText();

        /// <summary>
        /// GetMultiTranslateLabelText
        /// </summary>
        /// <param name="originalText"></param>
        /// <param name="widgetMainID"></param>
        /// <param name="widgetCloneID"></param>
        /// <param name="idRepTranslateModuleType"></param>
        /// <param name="idTable"></param>
        /// <param name="fieldName"></param>
        /// <param name="tableName"></param>
        /// <returns></returns>
        Task<object> GetMultiTranslateLabelText(string originalText, string widgetMainID, string widgetCloneID, string idRepTranslateModuleType, string idTable, string fieldName, string tableName);
        ...
        /// </summary>
        /// <returns></returns>
        Task<object> GetSystemTranslateText();
        #endregion

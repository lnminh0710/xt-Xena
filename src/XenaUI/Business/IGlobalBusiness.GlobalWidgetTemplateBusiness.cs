...
namespace XenaUI.Business
{
    ...
    {
        public object GetAllWidgetTemplateByModuleId(string moduleId, string objectValue)
        {
            ...
            var result = _globalService.GetAllWidgetTemplateByModuleId(ServiceDataRequest);
        ...
        public async Task<WSDataReturnValue> UpdateWidgetInfo(DataUpdateModel dataUpdate)
        {
            ...
            string updateKey = dataUpdate.UpdateKey;
            string updateKeyName = "";
            if (dataUpdate.Request.Contains(ConstWidgetReplaceToken.ListenKey) && !string.IsNullOrEmpty(dataUpdate.UpdateKey))
            {
                IDictionary<string, string> obj = JsonConvert.DeserializeObject<IDictionary<string, string>>(dataUpdate.UpdateKey.Replace("\\", ""));
                if (obj != null)
                {
                    ...
                    string tmp = $"\\\"{updateKeyName}\\\":\\\"{updateKey}\\\"";
                    request = request.Replace(ConstWidgetReplaceToken.ListenKey, tmp);
                }
            }
            ...
            {
                //_elasticSearchSyncBusiness.SyncToElasticSearch(dataUpdate.Module);

function GradientCanvas(t, e, n) {
    ...
    for (var r = 0; t.length > r; r++)
        this.addColorStop(t[r].offset, t[r].color);
    e = e || [];
    for (var r = 0; e.length > r; r++)
        this.addAlphaStop(e[r].offset, e[r].alpha);
}
...
!(function (t, e) {
    ...
    (t.namedColors = {}),
        (t.installColorSpace = function (r, o, i) {
            ...
            ["valueOf", "hex", "hexa", "css", "cssa"].forEach(function (t) {
                ...
                (s.equals = function (t, e) {
                    ...
                    for (var i = 0; i < o.length; i += 1)
                        if (Math.abs(this["_" + o[i]] - t["_" + o[i]]) > e)
                            return !1;
                    return !0;
                }),
                (s.toJSON = function () {
            ...
            for (var c in i)
                if (i.hasOwnProperty(c)) {
                    var l = c.match(/^from(.*)$/);
                    l
                        ? (t[l[1].toUpperCase()].prototype[r.toLowerCase()] =
                              i[c])
                        : (s[c] = i[c]);
                }
            return (
        ...
        (t.use = function (e) {
            return (
                -1 === t.pluginList.indexOf(e) &&
                    (this.pluginList.push(e), e(t)),
                t
            );
        }),
    ...
    (function (t, e) {
        ...
        function p(t, e, n) {
            ...
            return {
                change: function (t) {
                    f.forEach(function (e, n) {
                        s instanceof Array
                            ? (e.e.input.value = (t[e.name]() * s[n]).toFixed(
                                  c
                              ))
        ...
        function m(t) {
            function e(t) {
                (f = c.xy(
                    f,
                    { x: P.clamp(t.x, 0, 1), y: P.clamp(t.y, 0, 1) },
                    l,
                    d
                )),
                    r();
            ...
            function o() {
                if (!i.equals(f)) {
                    for (var t = 0, e = a.done.length; t < e; t++)
                        a.done[t].fn(f);
                    i = f;
                }
            }
...
https://bebraw.github.com/colorjoe - 2016-08-12 */
    ...
    https://bebraw.github.com/dragjs - 2016-08-12 */
        ...
        (D.rgb = D({
            ...
            (D.registerExtra = function (t, e) {
                t in D._extras &&
                    console.warn(
                        'Extra "' + t + '"has been registered already!'
                    ),
                    (D._extras[t] = e);
            });
        ...
        })(
            {
                    ...
                    function (t, e) {
                            ...
                            s = (function () {
                                function t(e, s, c, l, u, p) {
                                    ...
                                    a.fire("set-xy", S),
                                        ...
                                        (this.clientX0 =
                                            e.startCoords.client.x - g.x),
                                        (this.clientY0 =
                                            e.startCoords.client.y - g.y),
                                        a.fire("set-delta", S),
                                ...
                                return (
                                    ...
                                    (t.prototype.preventDefault =
                                        function () {}),
                                    (t.prototype.stopImmediatePropagation =
                                        function () {
                        ...
                        a.on("set-delta", function (t) {
                            ...
                            "client" === o
                                ...
                                : ((e.dx = e.pageX - i.pageX),
                                  (e.dy = e.pageY - i.pageY));
                        }),
                            (s.signals = a),
                            (e.exports = s);
                    },
                    ...
                    function (t, e) {
                        ...
                        var S = (function () {
                            ...
                            return (
                                ...
                                (t.prototype._backCompatOption = function (
                                    t,
                                    e
                                ) {
                                    if (h(e) || r.object(e)) {
                                ...
                                (t.prototype._onOffMultiple = function (
                                    t,
                                    e,
                                    n,
                                    o
                                ...
                                (t.prototype.set = function (e) {
                                    ...
                                    for (
                                        var c = 0;
                                        c < t.settingsMethods.length;
                                        c++
                                    ) {
                                        var p;
                                        p = t.settingsMethods[c];
                                        var d = p;
                                        (this.options[d] = l.base[d]),
                                            d in e && this[d](e[d]);
                                    }
                                    return (
                                        u.fire("set", {
                                ...
                                (t.prototype.unset = function () {
                                    ...
                                    u.fire("unset", { interactable: this }),
                                        s.interactables.splice(
                                            s.interactables.indexOf(this),
                                            1
                                        );
                                    for (
                                        var n = 0;
                                        n < (s.interactions || []).length;
                                        n++
                                    ) {
                                        var i;
                                        i = (s.interactions || [])[n];
                        ...
                        (s.interactables.indexOfElement = function (t, e) {
                            ...
                            (s.interactables.get = function (t, e, n) {
                                var o =
                                    this[
                                        this.indexOfElement(t, e && e.context)
                                    ];
                                return o && (r.string(t) || n || o.inContext(t))
                                    ? o
                                    : null;
                            }),
                    ...
                    function (t, e) {
                        ...
                        function i(t, e) {
                            ...
                            for (var o in a.delegatedEvents)
                                r(n, o, c.delegateListener),
                                    r(n, o, c.delegateUseCapture, !0);
                        ...
                        for (
                            var v = (function () {
                                    ...
                                    return (
                                        (t.prototype.pointerDown = function (
                                            t,
                                            e,
                                            n
                                        ) {
                                            var r = this.updatePointer(
                                                t,
                                                e,
                                                !0
                                            );
                                        ...
                                        (t.prototype.pointerMove = function (
                                            e,
                                            n,
                                            r
                                        ) {
                                        ...
                                        (t.prototype.removePointer = function (
                                            t,
                                            e
                                        ) {
                                        ...
                                        (t.prototype._updateEventTargets =
                                            function (t, e) {
                                                (this._eventTarget = t),
                            ...
                            d.on("update-pointer-down", function (t) {
                                ...
                                (e.pointerIds[o] = r),
                                    ...
                                    e.interacting() ||
                                        ...
                                        (e.downEvent = i),
                                        (e.downTimes[o] =
                                            e.curCoords.timeStamp),
                                        (e.downTargets[o] =
                                            a ||
                                            (i && s.getEventTargets(i)[0])),
                                        (e.pointerWasMoved = !1),
                    ...
                    function (t, e) {
                        ...
                        a.signals.on("before-action-move", function (t) {
                            ...
                            if ("drag" === e.prepared.name) {
                                ...
                                "x" === n
                                    ? ((e.curCoords.page.y =
                                          e.startCoords.page.y),
                                      (e.curCoords.client.y =
                                          e.startCoords.client.y),
                                    ...
                                    : "y" === n &&
                                      ((e.curCoords.page.x =
                                          e.startCoords.page.x),
                                      (e.curCoords.client.x =
                                          e.startCoords.client.x),
                                      (e.pointerDelta.page.speed = Math.abs(
                ...
                8: [
                    function (t, e) {
                                ...
                                if (a.options.drop.enabled) {
                                    ...
                                    if (
                                        !(
                                            (l.is.element(s) && s !== e) ||
                                            (l.is.string(s) &&
                                                !l.matchesSelector(e, s))
                                        )
                                    )
                                        for (
                                            var c = l.is.string(a.target)
                                                    ? a._context.querySelectorAll(
                                                          a.target
                                                      )
                                                    : [a.target],
                                                p = 0;
                        ...
                        function o(t, e) {
                            ...
                            for (
                                var o = 0;
                                o < t.activeDrops.dropzones.length;
                                o++
                            )
                                t.activeDrops.rects[o] =
                                    t.activeDrops.dropzones[o].getRect(
                        ...
                        function i(t, e, n) {
                            ...
                            for (
                                var a = 0;
                                a < r.activeDrops.dropzones.length;
                                a++
                            ) {
                                ...
                                i.push(
                                    s.dropCheck(t, e, r.target, n, c, u)
                                        ? c
                                        : null
                                );
                            }
                            ...
                            return (
                                t.dropElement !== t.prevDropElement &&
                                    (t.prevDropTarget &&
                                        ...
                                        (n.dragLeave = r.leave.target =
                                            t.prevDropElement),
                                        (n.prevDropzone = r.leave.dropzone =
                                            t.prevDropTarget)),
                                    t.dropTarget &&
                                        ((r.enter = {
                                            dragEvent: n,
                        ...
                        h.signals.on("action-start", function (t) {
                                ...
                                return l.is.object(t)
                                    ? ((this.options.drop.enabled =
                                      ...
                                      l.is["function"](t.ondropactivate) &&
                                          (this.events.ondropactivate =
                                              t.ondropactivate),
                                      l.is["function"](t.ondropdeactivate) &&
                                          (this.events.ondropdeactivate =
                                              t.ondropdeactivate),
                                      ...
                                      l.is["function"](t.ondropmove) &&
                                          (this.events.ondropmove =
                                              t.ondropmove),
                                      /^(pointer|center)$/.test(t.overlap)
                                          ? (this.options.drop.overlap =
                                                t.overlap)
                            ...
                            (f.prototype.dropCheck = function (
                                t,
                                e,
                                n,
                                r,
                                ...
                                if (f && l.is.number(s)) {
                                    a =
                                        (Math.max(
                                            0,
                                            Math.min(i.right, f.right) -
                                                Math.max(i.left, f.left)
                                        ) *
                                            Math.max(
                                                0,
                                                Math.min(i.bottom, f.bottom) -
                                                    Math.max(i.top, f.top)
                                            )) /
                                            (f.width * f.height) >=
                                        s;
                                }
                ...
                9: [
                    function (t, e) {
                        ...
                        o.signals.on("new", function (t) {
                            ...
                            "gesturestart" === e.type &&
                                ((e.ds = 0),
                                (n.gesture.startDistance =
                                    n.gesture.prevDistance =
                                        e.distance),
                                (n.gesture.startAngle = n.gesture.prevAngle =
                                    e.angle),
                                (n.gesture.scale = 1));
                        }),
                            o.signals.on("new", function (t) {
                ...
                10: [
                    function (t, e) {
                        ...
                        function n(t, e, n, r, i, a, s) {
                            if (!e) return !1;
                            if (!0 === e) {
                                var c = o.is.number(a.width)
                                        ? a.width
                                        : a.right - a.left,
                                    l = o.is.number(a.height)
                                        ? a.height
                                        : a.bottom - a.top;
                                if (
                                    (c < 0 &&
                                    ...
                                    return (
                                        n.x < (c >= 0 ? a.left : a.right) + s
                                    );
                                if ("top" === t)
                                    return (
                                        n.y < (l >= 0 ? a.top : a.bottom) + s
                                    );
                                if ("right" === t)
                                    return (
                                        n.x > (c >= 0 ? a.right : a.left) - s
                                    );
                                if ("bottom" === t)
                                    return (
                                        n.y > (l >= 0 ? a.bottom : a.top) - s
                                    );
                            }
                            return (
                                !!o.is.element(r) &&
                        ...
                        var r = t("./base"),
                            ...
                            l = t("../defaultOptions"),
                            u =
                                i.supportsTouch || i.supportsPointerEvent
                                    ? 20
                                    : 10,
                            p = {
                                defaults: {
                            ...
                            if ("resizestart" === e.type && n.prepared.edges) {
                                ...
                                if (i.square || i.preserveAspectRatio) {
                                    ...
                                    (a.top = a.top || (a.left && !a.bottom)),
                                        (a.left =
                                            a.left || (a.top && !a.right)),
                                        (a.bottom =
                                            a.bottom || (a.right && !a.top)),
                                        (a.right =
                                            a.right || (a.bottom && !a.left)),
                                        (n.prepared._linkedEdges = a);
                                } else n.prepared._linkedEdges = null;
                                i.preserveAspectRatio &&
                                    (n.resizeStartAspectRatio =
                                        r.width / r.height),
                                    (n.resizeRects = {
                                        start: r,
                                        current: o.extend({}, r),
                                    ...
                                    if (
                                        ...
                                        if (o.window(d))
                                            (u = n.clientX < c.margin),
                                                ...
                                                (s =
                                                    n.clientX >
                                                    d.innerWidth - c.margin),
                                                (l =
                                                    n.clientY >
                                                    d.innerHeight - c.margin);
                                        else {
                ...
                12: [
                    function (t) {
                        ...
                        (e.prototype.getAction = function (t, e, n, r) {
                            ...
                            (e.prototype.defaultActionChecker = function (
                                t,
                                e,
                                r,
                                o
                    ...
                    function (t, e) {
                        ...
                        function r(t, e, r, o, i, a) {
                            for (var s = 0, c = o.length; s < c; s++) {
                                ...
                                if (p)
                                    return { action: p, target: l, element: u };
                            }
                            return {};
                        }
                        function o(t, e, n, o) {
                            ...
                            for (var a = [], s = [], c = o; f.is.element(c); ) {
                                (a = []),
                                    (s = []),
                                    d.interactables.forEachMatch(c, i);
                                var l = r(t, e, n, a, s, o);
                                if (
                                    l.action &&
                                    !l.target.options[l.action.name].manualStart
                                )
                                    return l;
                                c = f.parentNode(c);
                            }
                        ...
                        (r.defaults.perAction.hold = 0),
                            ...
                            r.signals.on("prepared", function (t) {
                                var e = t.interaction,
                                    r = n(e);
                                r > 0 &&
                                    (e.autoStartHoldTimer = setTimeout(
                                        function () {
                                            e.start(
                                                e.prepared,
                                                e.target,
                    ...
                    function (t) {
                        ...
                        function n() {
                            ...
                            if (r < t.te) {
                                ...
                                this.doMove(),
                                    (t.i = l.request(this.boundInertiaFrame));
                            } else
                                (t.sx = t.modifiedXe),
                                    (t.sy = t.modifiedYe),
                                    this.doMove(),
                                ...
                                if (n.interacting() && !o.active) {
                                    ...
                                    y &&
                                        ...
                                        (x || v) &&
                                            ...
                                            x
                                                ? ((o.vx0 =
                                                      n.pointerDelta.client.vx),
                                                  (o.vy0 =
                                                      n.pointerDelta.client.vy),
                                                  (o.v0 = g),
                                                  e(n, o),
                ...
                21: [
                    function (t, e) {
                        ...
                        function n(t, e) {
                            ...
                            return (
                                n || ((n = new s(t, e)), (n.events.global = l)),
                                n
                            );
                        }
                        ...
                        (n.isSet = function (t, e) {
                            return (
                                -1 !==
                                a.interactables.indexOfElement(
                                    t,
                                    e && e.context
                                )
                            );
                        ...
                        r.docEvents.dragstart = function (t) {
                            for (var e = 0; e < o.interactions.length; e++) {
                                ...
                                if (
                                    r.element &&
                                    (r.element === t.target ||
                                        c(r.element, t.target))
                                )
                                    return void r.target.checkAndPreventDefault(
                                        t
                                    );
                            }
                        };
                            ...
                            a = {
                                ...
                                setOffset: function (t) {
                                    ...
                                    return (
                                        e && o
                                            ? ((i.left =
                                                  n.left - e.width * o.left),
                                              (i.top =
                                                  n.top - e.height * o.top),
                                              (i.right =
                                                  n.right -
                                                  e.width * (1 - o.right)),
                                              (i.bottom =
                            ...
                            u = {
                                ...
                                set: function (t) {
                                    var e = t.interaction,
                                        n = t.options,
                                        a =
                                            e.prepared.linkedEdges ||
                                            e.prepared.edges;
                                    if (e.interacting() && a) {
                                        var s = i.xywhToTlbr(
                                                e.resizeRects.inverted
                                            ),
                                            u =
                                                i.tlbrToXywh(
                                                    r.getRestrictionRect(
                                                        n.min,
                                                        e
                                                    )
                                                ) || c,
                                            ...
                                            a.top
                                                ? ((t.options.inner.top =
                                                  ...
                                                  (t.options.outer.top =
                                                      s.bottom - p.height))
                                                : a.bottom &&
                                                  ((t.options.inner.bottom =
                                                      s.top + u.height),
                                                  (t.options.outer.bottom =
                                                      s.top + p.height)),
                                            a.left
                                                ? ((t.options.inner.left =
                                                      s.right - u.width),
                                                  (t.options.outer.left =
                                                      s.right - p.width))
                                                : a.right &&
                                                  ((t.options.inner.right =
                                                      s.left + u.width),
                                                  (t.options.outer.right =
                                                      s.left + p.width)),
                                            r.set(t);
                                    }
                                },
                        ...
                        var n = t("./base"),
                            ...
                            a = {
                                ...
                                setOffset: function (t) {
                                    ...
                                    s =
                                        s ||
                                        n.options[e.prepared.name].snap ||
                                        {};
                                    var p = void 0;
                                    ...
                                    if (
                                        i &&
                                        s.relativePoints &&
                                        s.relativePoints.length
                                    )
                                        for (
                                            var f = 0;
                                            f < s.relativePoints.length;
                                            f++
                                        ) {
                                            var h;
                        ...
                        (r.createSnapGrid = function (t) {
                            return function (e, n) {
                                ...
                                return {
                                    x: Math.max(
                                        r.left,
                                        Math.min(r.right, s * t.x + i)
                                    ),
                                    y: Math.max(
                                        r.top,
                                        Math.min(r.bottom, c * t.y + a)
                                    ),
                                    range: t.range,
                                };
                            };
                        ...
                        a.signals.on("update-pointer-down", function (t) {
                            ...
                            a.signals.on("move", function (t) {
                                ...
                                a ||
                                    ...
                                    (e.pointerIsDown &&
                                        clearTimeout(e.holdTimers[s].timeout),
                                    n({
                                        interaction: e,
                                        pointer: r,
                                        event: o,
                        ...
                        for (
                            ...
                            a.signals.on(g, function (t) {
                                var e = t.interaction,
                                    n = t.pointerIndex;
                                e.holdTimers[n] &&
                                    clearTimeout(e.holdTimers[n].timeout);
                            });
                        }
                        for (var v = 0; v < u.length; v++)
                            a.signals.on(u[v], o(p[v]));
                        a.signals.on("new", function (t) {
                            (t.prevTap = null),
                                (t.tapTime = 0),
                                (t.holdTimers = []);
                    ...
                    function (t, e) {
                        ...
                        function r(t) {
                            ...
                            if ("hold" === n.type && o.length) {
                                var a =
                                    o[0].eventable.options.holdRepeatInterval;
                                a <= 0 ||
                                    (e.holdIntervalHandle = setTimeout(
                                        function () {
                                            i.fire({
                                                interaction: e,
                                                eventTarget: r,
                    ...
                    function (t) {
                        ...
                        e.signals.on("collect-targets", function (t) {
                            ...
                            n.signals.on("set", function (t) {
                                var n = t.interactable,
                                    r = t.options;
                                i(n.events.options, e.defaults),
                                    i(n.events.options, r);
                            }),
                        ...
                        (n.prototype._backCompatOption = function (t, e) {
                            ...
                            return (
                                n === this && (this.events.options[t] = e), n
                            );
                        }),
                ...
                37: [
                    function (t, e) {
                        ...
                        (r.document = o.document),
                            ...
                            (r.Touch = o.Touch || n),
                            (r.PointerEvent =
                                o.PointerEvent || o.MSPointerEvent),
                            (e.exports = r);
                    },
                    { "./window": 51 },
                ],
                    ...
                    function (t, e) {
                        ...
                        function r(t, e, n, o) {
                            ...
                            if (s && s.events)
                                if ("all" !== e) {
                                    ...
                                    s.typeCount ||
                                        (x.splice(a, 1), y.splice(a, 1));
                                } else
                                    for (e in s.events)
                                        s.events.hasOwnProperty(e) &&
                                            r(t, e, "all");
                        }
                        function o(t, e, r, o, i) {
                            ...
                            for (
                                ...
                                f >= 0 &&
                                (d.selectors[f] !== t || d.contexts[f] !== e);
                                f--
                            );
                            -1 === f &&
                    ...
                    function (t, e) {
                        ...
                        var n = t("./extend"),
                            ...
                            o = {
                                ...
                                getQuadraticCurvePoint: function (
                                    t,
                                    e,
                                    n,
                                    r,
                                ...
                                idle: function (t) {
                                    for (
                                        ...
                                        if (1 === i.pointerIds.length) {
                                            var a = i.target;
                                            if (a && !a.options.gesture.enabled)
                                                continue;
                                        } else if (i.pointerIds.length >= 2)
                                            continue;
                                        if (
                                            !i.interacting() &&
                                            e === i.pointerType
                ...
                51: [
                    function (t, e) {
                        ...
                        "undefined" == typeof window
                            ? ((r.window = undefined),
                              (r.realWindow = undefined))
                            : n(window),
                            (r.getWindow = function (t) {
                                if (o(t)) return t;
                                var e = t.ownerDocument || t;
                                return (
                                    e.defaultView || e.parentWindow || r.window
                                );
                            }),
                            (r.init = n);
                    },
    ...
    (function (t) {
        function e(t, e) {
            return (
                (e = e || 0), Math.round(t * Math.pow(10, e)) / Math.pow(10, e)
            );
        }
        function n(t, e) {
        ...
        (b.getAvg = function (t, e) {
            ...
            (i.prototype.toCss = function () {
                if (1 === this.stops.length)
                    return (
                        "background-color: " + this.stops[0].color.toString()
                    );
    ...
    (GradientCanvas.prototype.stopsToCSS = function (t, e) {
        ...
        var n = e.map(function (t) {
            return (
                t.color +
                " " +
                Math.max(0, Math.min(parseInt(100 * t.offset))) +
                "%"
            );
        });
        return (
            "linear-gradient(" +
            this.angleToCSSValue(t) +
            ", " +
            n.join(", ") +
            ")"
        );
    ...
    (GradientCanvas.prototype.cloneStop = function (t, e) {
        ...
        return r
            ? this.addAlphaStop(n, t.alpha)
            : this.addColorStop(n, t.color);
    }),
    (GradientCanvas.prototype.addColorStop = function (t, e) {
        ...
        var r = {
            ...
            getOffset: function () {
                return Math.min(
                    1,
                    Math.max(0, Math.round(100 * this.offset) / 100)
                );
            },
...
var isMobile = window.matchMedia("(max-width: 640px)").matches,
    ...
    Drag = function (t, e, n) {
        ...
        var o = function () {},
            i = function (t) {
                ...
                if (
                    "undefined" != typeof t.restrict &&
                    Math.abs(t.restrict.dy) > 120
                )
        ...
        var i = function () {
            ...
            h = function () {
                ...
                var i =
                    ...
                    ");<br>";
                return (
                    (i += '<span class="blue">background</span>: '),
                    (i += t + d() + ";")
                );
            },
            g = function () {
    ...
    App = function () {
        ...
        (t.swatches = $(".js-swatch")),
            ...
            (t.gradient = null),
            (window.isCompat =
                JSON.parse(localStorage.getItem("isCompat")) || !1);
        var e = function () {
                n(),
            ...
            n = function () {
                new ClipboardJS(".js-copy").on("success", function (t) {
                    ...
                    (e.style.transition = "all 250ms ease-in-out"),
                        (e.style.transform =
                            "translateY(0) scaleX(0.02) scaleY(0.5)"),
                        setTimeout(function () {
                            e.style.opacity = 0;
                        }, 200),
                        setTimeout(function () {
            ...
            s = function (e) {
                (window.isCompat = e.target.checked),
                    ...
                    localStorage.setItem(
                        "isCompat",
                        JSON.stringify(window.isCompat)
                    ),

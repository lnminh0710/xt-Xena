    ...
    function waldoPassbackInit(e) {
        for (var a = 0, t = adUnits.length; a < t; a++)
            if (
                ...
                if (e.isEmpty) {
                    if (
                        (r = document.getElementById(e.slot.getSlotElementId()))
                    ) {
            ...
            if (
                ...
                if (browserWidth >= breakpoints.desktop && !e.isEmpty) {
                    ...
                    s.setAttribute("id", "waldo-counter"),
                        (s.innerHTML =
                            'Ad will close in <span class="count">' +
                            i +
                            "</span> seconds"),
                        d.appendChild(s),
                    ...
                    (o.style.left = "50%"),
                        ...
                        (o.style.marginLeft =
                            "-" + parseInt(r.clientWidth) / 2 + "px"),
                        (o.style.marginTop =
                            "-" + parseInt(r.clientHeight) / 2 + "px");
                    var n = setInterval(function () {
                        var e = i--;
                        (s.getElementsByTagName("span")[0].innerHTML = e),
                            0 == e &&
                                (clearInterval(n), d.parentNode.removeChild(d));
                    }, 1e3);
                }
            }
    }
                ...
                if (
                    ...
                    d.customParams.sticky_footer
                        ...
                        : d.customParams.sticky_left ||
                          d.customParams.sticky_right
                        ? browserWidth >= breakpoints.desktop
                            ? d.customParams.sticky_left
                                ? (s.className = "waldo-bfleft")
                                : (s.className = "waldo-bfright")
                            : (s.style.display = "none")
                        : d.customParams.interstitial &&
                          (s.style.display = "none"),
                ...
                bidsBackHandler: function (d) {
                    !(function (d) {
                        "a9" === d
                            ...
                            : "prebid" === d &&
                              (t[e.customParams.slotNo].prebid = !0);
                        a
                            .map(function (a) {
                            ...
                            googletag.cmd.push(function () {
                                pbjs.setTargetingForGPTAsync([e.code]),
                                    googletag
                                        .pubads()
                                        .refresh([
                                            gptAdSlots[e.customParams.slotNo],
                                        ]);
                            });
                    })("prebid");
                },
    ...
    waldoInitScripts(),
                    ...
                    return (
                        ...
                        (function () {
                            try {
                                ...
                                g.open(
                                    "POST",
                                    "https://protected-by.clarium.io/werror",
                                    !0
                                ),
                ...
                pbjs.setConfig({
                    schain: {
                        ...
                        config: {
                            ...
                            complete: 1,
                            nodes: [
                                { asi: "newormedia.com", sid: "4645", hp: 1 },
                            ],
                        },
                    },
                });
        ...
        0 == bidDivAvailable &&
            (document.addEventListener(
                ...
                function () {
                    adTagsInitFlag ||
                        (waldoInitTags(adUnits), (adTagsInitFlag = 1));
                },
                !1
            ),
            window.addEventListener(
    ...
    for (var e = 0; e < adUnits.length; e++) {
        ...
        if (t) {
            ...
            i.setAttribute("id", d.code),
                a.customParams.sticky_footer &&
                    (i.className = "waldo-sticky-footer"),
            ...
            (s.type = "text/javascript"),
                ...
                googletag.cmd.push(function () {
                    googletag
                        .pubads()
                        .refresh([gptAdSlots[a.customParams.passback]]);
                }),
                console.log("ref");
        }
    }
...
function waldoLoadPassback(e) {
    for (i = 0; i < passbackAdUnits.length; i++)
        if (passbackAdUnits[i].customParams.slotNo == e)
            return passbackAdUnits[i];
}

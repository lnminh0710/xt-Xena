                    ...
                    return (
                        ...
                        s(t, [
                            ...
                            },
                            {
                                key: "addHandler",
                                value: function (e, t) {
                                    if (t.includes("rgba(0, 0, 0, 0)")) return;
                                    var n =
                                            arguments.length > 2 &&
                                            void 0 !== arguments[2]
                                                ? arguments[2]
                    ...
                    return (
                        r(e, [
                            ...
                            },
                            {
                                key: "remove",
                                value: function () {
                                    if (this.gp.getHandlers().length === 2)
                                        return;
                                    var e =
                                            arguments.length > 0 &&
                                            void 0 !== arguments[0]
                                    ...
                                    if (n) {
                                        ...
                                        return (
                                            ...
                                            (l.innerHTML =
                                                ...
                                                '-close-c">\n        <div class="' +
                                                c +
                                                '-close" data-toggle="handler-close"><i class="fa fa-times-circle"></i></div>\n      </div>\n      <div class="' +
                                                c +

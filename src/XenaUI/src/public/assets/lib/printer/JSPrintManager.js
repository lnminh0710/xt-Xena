...
(function (JSPM) {
  var ClientPrintJob = (function () {
    ...
    Object.defineProperty(ClientPrintJob.prototype, 'printerCommandsCopies', {
      ...
      set: function (value) {
        if (value < 1) throw 'Copies must be greater than or equal to 1.';
    ...
    ClientPrintJob.prototype._genPrinterArrayAsync = function (clientPrinter) {
      ...
      return new Promise(function (resolve, reject) {
        try {
          if (!clientPrinter) clientPrinter = new JSPM.UserSelectedPrinter();
...
(function (JSPM) {
  ...
  var InstalledPrinter = (function () {
    function InstalledPrinter(
      ...
      this._tray = '';
      this._paper = '';
      if (!printerName) throw 'The specified printer name is null or empty.';
  ...
  var ParallelPortPrinter = (function () {
    function ParallelPortPrinter(portName) {
      ...
      if (!portName) throw 'The specified parallel port name is null or empty.';
  ...
  var SerialPortPrinter = (function () {
    function SerialPortPrinter(
      ...
      if (!portName) throw 'The specified serial port name is null or empty.';
  ...
  var NetworkPrinter = (function () {
    ...
    Object.defineProperty(NetworkPrinter.prototype, 'port', {
      ...
      set: function (value) {
        if (!(value >= 0 && value <= 65535)) throw 'Invalid Port Number';
...
(function (JSPM) {
  var PrintFilePDF = (function (_super) {
    ...
    PrintFilePDF.prototype.serialize = function () {
      ...
      return new Promise(function (ok, err) {
        var SEP = ';';
        if (!_this.isValidRange(_this.printRange)) err('Invalid Print Range');
        _this
          .getBLOBContent()

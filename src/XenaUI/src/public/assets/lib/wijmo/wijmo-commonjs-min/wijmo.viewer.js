...
function _disableImageButton(e, t) {
    t
        ? wjcCore.addClass(e, _disabledCss)
        : wjcCore.removeClass(e, _disabledCss);
}
            ...
            t || n
                ? t &&
                  (i
                      ...
                      : (n && wjcCore.removeClass(o, exports._hiddenCss),
                        (r = o)),
                  (i = !0))
                : (i = !1);
...
function _transformSvg(e, t, o, n, r) {
    ...
    if (i) {
        ...
        i.setAttribute("transform", a),
            wjcCore.isIE &&
                ((e = i.parentNode).removeChild(i), e.appendChild(i));
    }
    return e;
}
...
var _DocumentSource = (function () {
    ...
    return (
        ...
        (e.prototype._updateIsDisposed = function (e) {
            this._isDisposed !== e &&
                ((this._isDisposed = e), this.onDisposed());
        }),
        ...
        (e.prototype.load = function () {
            ...
            this.onLoading();
            var t = {};
            null != this._paginated &&
                (t["pageSettings.paginated"] = this.paginated);
                ...
                for (
                    ...
                    if (r) {
                        ...
                        (u.style.width = c.width.valueInPixel + "px"),
                            ...
                            i.setAttribute(
                                "width",
                                c.width.valueInPixel.toString() + "px"
                            ),
                            i.setAttribute(
                                "height",
                                c.height.valueInPixel.toString() + "px"
                            ),
                            _transformSvg(
                                o[n],
...
var _Promise = (function () {
    ...
    return (
        (e.prototype.then = function (e, t) {
            return (
                this._callbacks.push({ onFulfilled: e, onRejected: t }), this
            );
        }),
...
!(function (e) {
    (e[(e.Custom = 0)] = "Custom"),
        ...
        (e[(e.A6 = 70)] = "A6"),
        (e[(e.JapaneseEnvelopeKakuNumber2 = 71)] =
            "JapaneseEnvelopeKakuNumber2"),
        (e[(e.JapaneseEnvelopeKakuNumber3 = 72)] =
            "JapaneseEnvelopeKakuNumber3"),
        (e[(e.JapaneseEnvelopeChouNumber3 = 73)] =
            "JapaneseEnvelopeChouNumber3"),
        (e[(e.JapaneseEnvelopeChouNumber4 = 74)] =
        ...
        (e[(e.PrcEnvelopeNumber10Rotated = 118)] =
...
var _Report = (function (e) {
    ...
    return (
        ...
        Object.defineProperty(t.prototype, "reportName", {
            get: function () {
                return this._innerService
                    ? this._innerService.reportName
                    : null;
            },
            enumerable: !0,
            configurable: !0,
        ...
        (t.prototype._getIsDisposed = function () {
            return (
                e.prototype._getIsDisposed.call(this) ||
                this._innerService.isCleared
            );
        }),
    ...
    return (
        ...
        (t.prototype.getBookmark = function (e) {
            ...
            return this._checkReportInstanceController(o)
                ? (_httpRequest(
                      this._getReportInstancesUrl(t._bookmarkAction, e),
                      {
                          success: function (e) {
        ...
        (t.prototype.getStatus = function () {
            ...
            return (
                _httpRequest(this._statusLocation, {
                    success: function (t) {
                        e.resolve(
                            JSON.parse(t.responseText, _statusJsonReviver)
                        );
                    },
                }),
                e
        ...
        (t.prototype.getParameters = function () {
            ...
            return this._checkReportInstanceController(e)
                ? (_httpRequest(
                      this._getReportInstancesUrl(t._parametersAction),
                      {
                          success: function (t) {
                ...
                ? (_httpRequest(this._getReportInstancesUrl(t._renderAction), {
                      ...
                      success: function (e) {
                          202 === e.status
                              ...
                              : n.resolve(
                                    _parseReportExecutionInfo(e.responseText)
                                );
                      },
                      error: function (e) {
            ...
            return this._checkReportInstanceController(o)
                ? this._status !== _ExecutionStatus.rendering
                    ? (o.reject(
                      ...
                      o)
                    : (_httpRequest(
                          this._getReportInstancesUrl(t._cancelAction),
                          {
                              method: "POST",
                              success: function (e) {
                                  o.resolve(
        ...
        (t.prototype.getOutlines = function () {
            ...
            return this._checkReportInstanceController(e)
                ? (_httpRequest(
                      this._getReportInstancesUrl(t._outlinesAction),
                      {
                          success: function (t) {
                              e.resolve(JSON.parse(t.responseText));
                          },
        ...
        (t.prototype.setPageSettings = function (e) {
            ...
            return this._checkReportInstanceController(n)
                ? (_httpRequest(
                      this._getReportInstancesUrl(t._pageSettingsAction),
                      {
                          method: "PUT",
                          data: e,
                          success: function (e) {
...
var _PdfDocumentSource = (function (e) {
    ...
    return (
        ...
        (t.prototype.renderToFilter = function (e) {
            ...
            return (
                this.onQueryLoadingData(t),
                this._innerService.renderToFilter(e, t.data)
            );
        }),
        (t.prototype._updateDocumentStatus = function (t) {
            null != t &&
            ...
            this._needUpdate && this._clearResults(),
                this._getSearchResults().then(function (o) {
                    ...
                    e
                        ...
                        (t._currentIndex = Math.max(
                            Math.min(t._currentIndex, n - 1),
                            0
                        )),
                        t._onCurrentChanged();
                });
...
!(function (e) {
    ...
    (_TouchDirection =
        exports._TouchDirection || (exports._TouchDirection = {}))
);
...
!(function (e) {
    ...
    (_TouchEventType =
        exports._TouchEventType || (exports._TouchEventType = {}))
);
...
var _TouchTrigger = (function () {
    ...
    return (
        ...
        (e.prototype._createTouchEventArgs = function (e) {
            return _TouchManager._isTouchEvent(e)
                ? new _TouchEventArgs(e)
                : null;
        }),
        (e.prototype.dispose = function () {
...
var _PanEventArgs = (function (e) {
    function t(t, o, n) {
        ...
        return (
            ...
            (r._client = new wjcCore.Point(
                r.touchInfo.clientX,
                r.touchInfo.clientY
            )),
            (r._screen = new wjcCore.Point(
                r.touchInfo.screenX,
                r.touchInfo.screenY
            )),
            o &&
        ...
        (t.prototype._prepareStart = function (e) {
            ...
            (this._prePanEventArgs = e),
                ...
                (this._panStartTimer = setTimeout(function () {
                    o._panEvents && o._panEvents.start(),
                        o._clearPanStartTimer();
                }, t._threhold));
        }),
...
var _SwipeEventArgs = (function (e) {
    function t(t, o, n, r) {
        ...
        var a = _pointMove(
            ...
            new wjcCore.Point(
                i.startTouchInfo.clientX,
                i.startTouchInfo.clientY
            )
        );
        return (
...
var _SwipeTrigger = (function (e) {
    ...
    return (
        ...
        (t.prototype.onPanMove = function (t) {
            e.prototype.onPanMove.call(this, t),
                (this._prePanMoveEventArgs = t);
        }),
            ...
            if (e._isTouchEvent(t))
                if (t instanceof TouchEvent) {
                    ...
                    for (var o = 0, n = t.touches.length; o < n; o++)
                        e._allTouchInfos.push(
                            new _TouchInfo(t.touches.item(o))
                        );
                } else if (t instanceof PointerEvent) {
                    if (
                        ((e._allTouchInfos = e._allTouchInfos || []),
                        e._isTouchEnd(t.type))
                    ) {
                    ...
                    for (var r = 0, n = e._allTouchInfos.length; r < n; r++)
                        if (e._allTouchInfos[r].id == t.pointerId)
                            return void (e._allTouchInfos[r] = new _TouchInfo(
                                t
                            ));
...
var _PageSetupEditor = (function (e) {
    function t(t) {
        ...
        return (
            ...
            (o._numMarginsBottom = new wjcInput.InputNumber(
                o._divMarginsBottom
            )),
            ...
            o._cmbOrientation.selectedIndexChanged.addHandler(
                o._updateValue,
                o
            ),
            o._globalize(),
        ...
        (t.prototype._updateValue = function () {
            if (!this._uiUpdating) {
                ...
                e &&
                    ...
                    (e.topMargin = new _Unit(
                        this._numMarginsTop.value,
                        _UnitType.Inch
                    )),
                    (e.paperSize = this._cmbPaperKind.selectedValue),
                    _setLandscape(
                        e,
                        this._cmbOrientation.text ===
                            wjcCore.culture.Viewer.landscape
                    ),
                    this._updateUI());
            }
...
var _ExportOptionEditor = (function (e) {
    ...
    return (
        ...
        (t.prototype._generateEditor = function (e) {
            var o;
            if (wjcCore.isArray(e.allowedValues))
                o = this._generateComboEditor(e);
            else
                switch (e.type) {
                    case "bool":
            ...
            if (e.nullable) {
                ...
                (t.checked = i),
                    _addEvent(t, "click", function () {
                        o._setOptionValue(e.name, t.checked),
                            o._updateEditors(e.name);
                    });
            }
            return t;
        ...
        (t.prototype._generateGroup = function (e) {
            ...
            wjcCore.addClass(o, "wj-exportformats-group"),
                ...
                o.appendChild(n);
            for (
                var i = document.createElement("table"), a = 0;
                a < e.length;
                a++
            ) {
                var s = e[a],
                ...
                return (
                    this._optionLabels ||
                        (this._optionLabels = {
                            ...
                            creationTime:
                                wjcCore.culture.Viewer.docInfoCreationTime,
                            revisionTime:
                                wjcCore.culture.Viewer.docInfoRevisionTime,
                            keywords: wjcCore.culture.Viewer.docInfoKeywords,
                            embedFonts: wjcCore.culture.Viewer.embedFonts,
                            pdfACompatible:
                                wjcCore.culture.Viewer.pdfACompatible,
                            useCompression:
                                wjcCore.culture.Viewer.useCompression,
                            useOutlines: wjcCore.culture.Viewer.useOutlines,
                            allowCopyContent:
                                wjcCore.culture.Viewer.allowCopyContent,
                            allowEditAnnotations:
                                wjcCore.culture.Viewer.allowEditAnnotations,
                            allowEditContent:
                                wjcCore.culture.Viewer.allowEditContent,
                            ...
                            outputRangeInverted:
                                wjcCore.culture.Viewer.outputRangeInverted,
                        }),
                    this._optionLabels
                );
            },
                    ...
                    this._groupTitleField ||
                        (this._groupTitleField = {
                            documentRestrictions:
                                wjcCore.culture.Viewer
                                    .documentRestrictionsGroup,
                            passwordSecurity:
                                wjcCore.culture.Viewer.passwordSecurityGroup,
                            outputRange:
                                wjcCore.culture.Viewer.outputRangeGroup,
                            documentInfo:
                                wjcCore.culture.Viewer.documentInfoGroup,
        ...
        (t.prototype._globalize = function () {
            for (
                ...
                n instanceof HTMLLegendElement
                    ? (n.innerHTML =
                          this._groupTitle[n.getAttribute(t._optionNameAttr)])
    ...
    return (
        ...
        (t.prototype._checkMoveButtonEnabled = function () {
            ...
            var i = this._toolbarRight.getBoundingClientRect().width,
                a =
                    ...
                    this._toolbarWrapper.getBoundingClientRect().width,
                s =
                    (o = this._toolbarWrapper.offsetLeft - i - t._moveStep) >=
                    a,
        ...
        (t.prototype.addCustomItem = function (e, t) {
            wjcCore.isString(e) && (e = _toDOM(e)),
                null != t &&
                    e.setAttribute(exports._commandTagAttr, t.toString()),
                this._toolbarWrapper.appendChild(e);
        }),
            ...
            (s.className = "wj-input-zoom"),
                ...
                _addEvent(s, "keypress", function (e) {
                    ...
                    r.keyCode === wjcCore.Key.Enter &&
                        ...
                        (n = parseFloat(i)),
                        isNaN(n)
                            ? (o.text = wjcCore.Globalize.format(
                                  t.zoomFactor,
                                  "p0"
                              ))
                            : (t.zoomFactor = 0.01 * n));
                ...
                _addEvent(
                    s.querySelector(".wj-form-control"),
                    "blur",
                    function (e) {
    ...
    return (
        ...
        (t.prototype._initToolbarItems = function () {
            (this._gPaginated = this.addSvgButton(
                ...
                _ViewerToolbarBase._initToolbarZoomValue(
                    this.hostElement,
                    this.viewer
                ),
                    ...
                    : (o
                          ...
                          .then(function (n) {
                              if (e._documentSource === o) {
                                  ...
                                  a.innerHTML = e._addGlobalUniqueId(
                                      n.responseText
                                  );
                                  var s,
                        ...
                        (s[1] && s[1].length > 0
                            ? ((i.href.baseVal = e._invalidHref),
                              ...
                              _addEvent(i, "click", function () {
                                  o._onLinkClicked(
                                      new _LinkClickedEventArgs(this)
                                  );
                              }))
    ...
    return (
        ...
        (t.prototype._addPageViewHandlers = function (e) {
            ...
            this._activePageView.pageIndexChanged.addHandler(function () {
                ...
                this._activePageView.zoomFactorChanged.addHandler(function (
                    e,
                    o
                ) {
                    t.onZoomFactorChanged(o.oldValue, o.newValue);
                }),
                this._activePageView.zoomModeChanged.addHandler(function (
                    e,
                    o
                ) {
        ...
        (t.prototype._removePageViewHandlers = function (e) {
            e.pageIndexChanged.removeHandler(this.onPageIndexChanged, this),
                e.zoomFactorChanged.removeHandler(
                ...
                e.rotateAngleChanged.removeHandler(
...
var _PageViewBase = (function (e) {
    function t(t) {
        ...
        return (
            ...
            (o._fBorderBoxMode =
                "border-box" === getComputedStyle(t).boxSizing),
            o._init(),
            o
        );
    }
    return (
        ...
        Object.defineProperty(t.prototype, "zoomFactor", {
            ...
            set: function (e) {
                if (
                    ((e = Math.max(0.05, Math.min(10, e))),
                    this._zoomFactor != e)
                ) {
                    var t = this._zoomFactor;
                    (this._zoomFactor = e),
                        this._updatePageViewTransform(),
                        this._zoomModeUpdating ||
        ...
        (t.prototype._renderViewPage = function (e, t) {
            ...
            if (((t = t < 0 ? 0 : t), !e))
                return (
                    r.reject(wjcCore.culture.Viewer.cannotRenderPageNoViewPage),
                    r
                );
        ...
        (t.prototype._getTransformedPoint = function (e, t, o) {
            ...
            switch (n.rotateAngle) {
                case _RotateAngle.Rotation90:
                    ...
                    break;
                case _RotateAngle.Rotation180:
                    (t = r.height.valueInPixel - t),
                        (o = r.width.valueInPixel - o);
                    break;
                case _RotateAngle.Rotation270:
                    var i = t;
...
var _VScroller = (function (e) {
    function t(t) {
        ...
        return (
            ...
            (o.hostElement.style.width =
                _Scroller.getScrollbarWidth() + 1 + "px"),
...
var _SinglePageView = (function (e) {
    ...
    return (
        ...
        (t.prototype._initScroller = function () {
            var e = this;
            new _VScroller(this._vscroller).valueChanged.addHandler(
                function () {
                    setTimeout(function () {
            ...
            if (this._hasPageVScrollBar) {
                var t =
                    (this._pagesContainer.scrollHeight -
                        this._pagesContainer.clientHeight) *
                    e;
                (this._pagesContainer.scrollTop = t),
        ...
        (t.prototype._onZoomFactorChanged = function (t, o) {
            e.prototype._onZoomFactorChanged.call(this, t, o),
    ...
    return (
        ...
        (t.prototype._bindTouchEvents = function (t) {
            ...
            e.prototype._bindTouchEvents.call(this, t),
                ...
                t.swipe.addHandler(function (e, n) {
                    o._swipeSpeedReducer ||
                        (o._swipeSpeedReducer = new _SpeedReducer()),
                        o._swipeSpeedReducer.start(
                            n.speed.x,
                            n.speed.y,
                            function (e, n) {
        ...
        (t.prototype._hitTestPageIndex = function (e) {
            ...
            for (var t = 0, o = 0; t < this.pages.length; t++)
                if (
                    ((o +=
                        this._getPageSize(t).height.valueInPixel *
                            this.zoomFactor +
                        _PageViewBase._pageMargin),
                    e < o)
                ) {
        ...
        (t.prototype._moveToPagePosition = function (e) {
            ...
            for (
                ...
                (t +=
                    ...
                    _PageViewBase._pageMargin),
                    this._borderBoxMode ||
                        (t += 2 * _PageViewBase._pageBorderWidth);
        ...
        (t.prototype._panelViewPntToPageView = function (e, t) {
            ...
            if (this.hostElement.scrollLeft > 0)
                n = this.hostElement.scrollLeft + e;
            else {
            ...
            for (var a = 0; a < i; a++)
                (o -=
                    ...
                    _PageViewBase._pageMargin),
                    this._borderBoxMode ||
                        (o -= 2 * _PageViewBase._pageBorderWidth);
        ...
        (t.prototype._reserveViewPage = function () {
            ...
            for (var e = 0; e < (this.pages || []).length; e++) {
                ...
                (t.style.height =
                    o.height.valueInPixel * this.zoomFactor + "px"),
                    (t.style.width =
                        o.width.valueInPixel * this.zoomFactor + "px");
            }
        }),
        (t.prototype._updatePageViewTransform = function () {
            var e;
            ...
            for (var t = 0; t < e.length; t++)
                this._setPageTransform(e.item(t), t);
        }),
        (t.prototype._zoomToViewWidth = function () {
        ...
        (t.prototype.addPage = function (e, t, o) {
            ...
            i.appendChild(s),
                ...
                this._tabPages.length
                    ...
                    : (this._headersContainer.insertBefore(
                          i,
                          this._tabPages[o].header
                      ),
    ...
    return (
        ...
        (t.prototype._internalFormatItem = function (e, t) {
            if (e && void 0 !== e.commandTag) {
                if ((_removeChildren(t), e.icon)) {
                    ...
                    o.appendChild(_createSvgBtn(e.icon)),
                        t.insertBefore(o, t.firstChild);
                }
                t.setAttribute(
                    exports._commandTagAttr,
                    e.commandTag.toString()
                ),
        ...
        (t.prototype.showMenu = function (e) {
            (this.selectedIndex = -1),
                ...
                (this.dropDown.style.color =
                    this._viewer.hostElement.style.color),
    ...
    return (
        ...
        (t.prototype._updateActionStatus = function (t, o) {
            e.prototype._updateActionStatus.call(this, t, o),
                this.viewer._actionIsChecked(o) &&
                    wjcCore.addClass(t, "checked");
        }),
        t
    );
})(_ViewerMenuBase);
    ...
    return (
        ...
        Object.defineProperty(t.prototype, "_innerPaginated", {
            ...
            set: function (e) {
                this._documentSource && !this._needBind
                    ...
                    : (this._paginated =
                          null == e ? null : wjcCore.asBoolean(e)),
                    this._setViewerAction(
                        _ViewerActionType.TogglePaginated,
                        !0
                    );
            },
            ...
            (this._rubberband = new _Rubberband(
                ...
                this._rubberband.applied.addHandler(function (t, o) {
                    ...
                    n.width > n.height
                        ...
                        e._pageView.moveToPosition(
                            _getPositionByHitTestInfo(r)
                        );
                }),
        ...
        (t.prototype._globalize = function () {
            ...
            (this._gSearchTitle.textContent = e.search),
                (this._gMatchCase.innerHTML =
                    "&nbsp;&nbsp;&nbsp;" + e.matchCase),
                (this._gWholeWord.innerHTML =
                    "&nbsp;&nbsp;&nbsp;" + e.wholeWord),
            ...
            if (this._shouldAutoHeight()) {
                ...
                (this._viewpanelContainer.style.height = "100%"),
                    (this._viewerContainer.style.height =
                        Math.max(
                            this._viewpanelContainer.getBoundingClientRect()
                                .height,
        ...
        (t.prototype._bindEvents = function () {
            ...
            _addEvent(window, "unload", function () {
                ...
                _addEvent(document, "mousemove", function (t) {
                    if (e.fullScreen && e._miniToolbar) {
                        ...
                        null != e._miniToolbarPinnedTimer && o
                            ...
                            : null == e._miniToolbarPinnedTimer &&
                              e._showMiniToolbar(o);
                    }
                }),
                ...
                this._pageView.pageIndexChanged.addHandler(function () {
                    e._addHistory(!1, !0),
                        e._updatePageIndex(e._pageView.pageIndex);
                }),
                ...
                this._pageView.positionChanged.addHandler(function () {
                    setTimeout(function () {
                        e._historyManager.current.position =
        ...
        (t.prototype._initPageView = function () {
            new _CompositePageView(this._viewpanelContainer).viewMode =
                this.viewMode;
        }),
        ...
        (t.prototype._resetViewPanelContainerWidth = function () {
            ...
            this.hostElement.getBoundingClientRect().width <=
                t._narrowWidthThreshold
                ? wjcCore.addClass(this.hostElement, t._narrowCss)
                : wjcCore.removeClass(this.hostElement, t._narrowCss);
            var e = this._splitter
                    ? this._splitter.getBoundingClientRect().width
                    : 0,
                o = this._leftPanel
                    ? this._leftPanel.getBoundingClientRect().width
                    : 0;
            (this._viewpanelContainer.style.width =
                this._viewerContainer.getBoundingClientRect().width -
                e -
                o +
                "px"),
        ...
        (t.prototype._initSidePanel = function () {
            ...
            t.collapse(),
                ...
                t.expanded.addHandler(function () {
                    e._toggleSplitter(!1);
                    var t = e._splitter
                        ? e._splitter.getBoundingClientRect().width
                        : 0;
                    ...
                    n._pages[n.pageIndex].getContent().then(function (e) {
                        ...
                        for (var n = 0; n < t.length; n++) {
                            ...
                            r.setAttributeNS(
                                null,
                                "x",
                                _twipToPixel(t[n].x).toString()
                            ),
                                r.setAttributeNS(
                                    null,
                                    "y",
                                    _twipToPixel(t[n].y).toString()
                                ),
                                r.setAttributeNS(
                                    null,
                                    "height",
                ...
                o.format(function (n) {
                    var r = _toDOMs(
                        '<div class="wj-searchcontainer"><input class="wj-searchbox" wj-part="search-box" type="text"/><div class="wj-btn-group"><button class="wj-btn wj-btn-searchpre">' +
                            _createSvgBtn(exports.icons.searchPrevious)
                                .innerHTML +
                    ...
                    (e._gMatchCase = r.querySelector(
                        '[wj-part="g-matchCase"]'
                    )),
                        (e._gWholeWord = r.querySelector(
                            '[wj-part="g-wholeWord"]'
                        )),
                        ...
                        n.outContent
                            .querySelector(".wj-tabtitle-wrapper")
                            .appendChild(r);
                    var i = n.outContent.querySelectorAll(
                            'input[type="checkbox"]'
                        )[0],
                        a = n.outContent.querySelectorAll(
                            'input[type="checkbox"]'
                        )[1],
                    ...
                    l.formatItem.addHandler(function (e, t) {
                        ...
                        l.selectedIndexChanged.addHandler(function () {
                            return (e._searchManager.currentIndex =
                                l.selectedIndex);
                        });
                    var d = function (e) {
                        void 0 === e && (e = !0);
                        for (
                            var t = o.outContent.querySelectorAll("input"),
                                n = 0;
                            n < t.length;
                            n++
                        )
                    ...
                    e._searchManager.searchStarted.addHandler(function () {
                        ...
                        e._searchManager.searchCompleted.addHandler(
                            function () {
                                (p = !0),
                                    (l.itemsSource =
                                        e._searchManager.searchResults),
                                    (p = !1),
                                    d(!0);
                            }
                        ),
        ...
        (t.prototype._initSidePanelOutlines = function () {
            var e = this,
                t = wjcCore.Control.getControl(this._sidePanel),
                o = t.addPage(
                    wjcCore.culture.Viewer.outlines,
                    exports.icons.outlines
                );
                    ...
                    n.selectionChanged.addHandler(function (o, n) {
                        if (!r) {
                            ...
                            if (i) {
                                var a = i.dataItem;
                                if (a.position)
                                    e._scrollToPosition(a.position, !0);
                                else if (a.target) {
                                    if (!e._documentSource) return;
                                    e._documentSource
                                        .getBookmark(a.target)
                                        .then(
                                            function (t) {
                                                (a.position = t),
                                                    o.getSelectedState(
                        ...
                        s = function () {
                            ...
                            var s = function () {
                                if (!e._documentSource.hasOutlines)
                                    return (
                                        (n.itemsSource = null), void t.hide(o)
                                    );
                                e._documentSource
                                    .getOutlines()
                                    .then(function (e) {
        ...
        (t.prototype._initSidePanelThumbnails = function () {
            ...
            (this._gThumbnailsTitle =
                n.outContent.querySelector(".wj-tabtitle")),
                ...
                n.format(function (n) {
                    ...
                    var s = function (e, o) {
                            var n = t._thumbnailWidth,
                                r =
                                    (o.size.height.valueInPixel * n) /
                                    o.size.width.valueInPixel,
                                i = e.parentNode;
                            switch (
                                (_transformSvg(e, n, r, 1, o.rotateAngle),
                                o.rotateAngle)
                            ) {
                                case _RotateAngle.Rotation90:
                                case _RotateAngle.Rotation270:
                        ...
                        c = function () {
                            if (
                                !e._documentSource ||
                                !e._documentSource.isLoadCompleted
                            )
                                return null;
                            for (
                                var t = [], o = 0;
                                o < e._documentSource.pageCount;
                                o++
                            )
                                t.push(
                    ...
                    e._documentSourceChanged.addHandler(p),
                        ...
                        e._pageView.rotateAngleChanged.addHandler(function () {
                            for (
                                var t = r.hostElement.querySelectorAll("svg"),
                                    o = 0;
                                o < t.length;
                                o++
                            )
        ...
        (t.prototype._initSidePanelExports = function () {
            ...
            (this._gExportsPageTitle =
                o.outContent.querySelector(".wj-tabtitle")),
                    ...
                    r.refresh(),
                        n.itemsSource &&
                            n.itemsSource.forEach(function (e) {
                                e.name =
                                    t._exportItemDescriptions[e.format].name;
                            }),
                        n.refresh();
                else {
                    var i = [];
            ...
            if (!this._actionIsDisabled(e))
                switch (e) {
                    ...
                    case _ViewerActionType.SearchMatchCase:
                        this._searchManager.matchCase =
                            !this._searchManager.matchCase;
                        break;
                    case _ViewerActionType.SearchMatchWholeWord:
                        this._searchManager.wholeWord =
                            !this._searchManager.wholeWord;
                        break;
        ...
        (t.prototype._actionIsDisabled = function (e) {
            ...
            switch (e) {
                ...
                case _ViewerActionType.ShowExportsPanel:
                    return (
                        !this._exportFormats || 0 === this._exportFormats.length
                    );
                case _ViewerActionType.Landscape:
                case _ViewerActionType.Portrait:
                case _ViewerActionType.ShowPageSetupDialog:
                ...
                case _ViewerActionType.NextPage:
                    return (
                        this._pageIndex >= this._documentSource.pageCount - 1
                    );
                case _ViewerActionType.Backward:
                ...
                case _ViewerActionType.Single:
                    return (
                        !this._documentSource || !this._documentSource.paginated
                    );
                case _ViewerActionType.ZoomOut:
        ...
        (t.prototype._actionIsShown = function (e) {
            ...
            switch (e) {
                ...
                case _ViewerActionType.ShowPageSetupPanel:
                    return t
                        ? t.pageSettings
                        : this._supportsPageSettingActions();
                case _ViewerActionType.SelectTool:
                case _ViewerActionType.MoveTool:
                case _ViewerActionType.MagnifierTool:
                case _ViewerActionType.RubberbandTool:
                ...
                case _ViewerActionType.ShowSearchBar:
                    return (
                        t &&
                        (!this._documentSource.paginated ||
                            t.textSearchInPaginatedMode)
                    );
                case _ViewerActionType.ShowOutlines:
                    return (
                        this._documentSource && this._documentSource.hasOutlines
                    );
            }
            return !0;
        }),
        ...
        (t.prototype._updateUI = function () {
            ...
            Object.keys(_ViewerActionType).forEach(function (t) {
                isNaN(t) ||
                    e._setViewerAction(_ViewerActionType[_ViewerActionType[t]]);
            });
        ...
        (t.prototype._export = function (e) {
            ...
            if (isIOS()) window.open(t);
                ...
                o ||
                    (((o = document.createElement("iframe")).id =
                        "viewDownloader"),
        ...
        (t.prototype.showPageSetupDialog = function () {
            this._pageSetupDialog || this._createPageSetupDialog(),
                this._pageSetupDialog.showWithValue(
                    this._documentSource.pageSettings
                );
        }),
        ...
        (t.prototype._showViewPanelMessage = function (e, t) {
            var o =
                this._viewpanelContainer.querySelector(".wj-viewer-loading");
            o ||
            ...
            if (this._documentSource.isLoadCompleted) {
                ...
                (this._pageView.pages = this._pages),
                    ...
                    this._autoHeightCalculated ||
                        (this._autoCalculateHeight(),
                        (this._autoHeightCalculated = !0));
                var i =
                    this._documentSource.initialPosition ||
                    this._initialPosition;
                if (
        ...
        (t.prototype._getExpiredTime = function () {
            ...
            return e && e.expiredDateTime && e.executionDateTime
                ? ((this._expiredTime =
                      e.expiredDateTime.getTime() -
                      e.executionDateTime.getTime()),
        ...
        (t.prototype._innerMoveToPage = function (e) {
            return (
                this._resolvePageIndex(e) != this.pageIndex &&
                    this._addHistory(!1, !0),
        ...
        (t.prototype._updateHistoryCurrent = function () {
            (this._historyManager.current.position =
        ...
        (t.prototype._innerAddHistory = function (e) {
            ...
            (this._isPositionEquals(t, o.position, e) &&
                ...
                (o.zoomFactor =
                    null == o.zoomFactor ? this.zoomFactor : o.zoomFactor),
        ...
        (t.prototype._ensureDocumentLoadCompleted = function (e) {
            return this._documentSource
                ...
                : (e &&
                      e.reject(
                          "Cannot set page index without document source."
                      ),
                  !1);
        }),
        (t.prototype._updatePageIndex = function (e) {
            this._documentSource &&
                ((e = Math.min(
                    this._documentSource.pageCount - 1,
                    Math.max(e, 0)
                )),
                this._pageIndex !== e &&
        ...
        (t.prototype._onDocumentSourceChanged = function (e) {
            this._clearExportFormats(),
                this._documentSourceChanged.raise(
                    this,
                    e || new wjcCore.EventArgs()
                ),
...
var _PageSetupDialog = (function (e) {
    function t(t) {
        ...
        return (
            ...
            (o._pageSetupEditor = new _PageSetupEditor(
                o._pageSetupEditorElement
            )),
            o._globalize(),
            o._addEvents(),
            o
    ...
    return (
        ...
        (t.prototype.showWithValue = function (t) {
            (this._pageSetupEditor.pageSettings = t),
...
var _Magnifier = (function (e) {
    ...
    return (
            ...
            var o = function () {
                if (!(t._currentPageIndex < 0)) {
                    ...
                    (t._viewPageDiv.style.height =
                        o.height.valueInPixel *
                            t.pageView.zoomFactor *
                            t._Magnification +
                        "px"),
                        (t._viewPageDiv.style.width =
                            o.width.valueInPixel *
                                t.pageView.zoomFactor *
                                t._Magnification +
                            "px"),
        ...
        (t.prototype._start = function (t) {
            e.prototype._start.call(this, t),
                this._showMagnifer(this.startPnt, t);
        }),
        (t.prototype._move = function (e, t) {
                ...
                this.pageView.pages[this._currentPageIndex]
                    ...
                    .then(function (e) {
                        ...
                        (t._viewPageDiv.innerHTML = ""),
                            ...
                            o.setAttribute(
                                "width",
                                new _Unit(o.getAttribute("width"))
                                    .valueInPixel *
                                    t._Magnification +
                                    "px"
                            ),
                            o.setAttribute(
                                "height",
                                new _Unit(o.getAttribute("height"))
                                    .valueInPixel *
                                    t._Magnification +
                                    "px"
                            );
    ...
    ReportViewer = (function (e) {
        ...
        return (
            ...
            (t.prototype._executeAction = function (o) {
                if (
                    (e.prototype._executeAction.call(this, o),
                    !this._actionIsDisabled(o))
                )
                    switch (o) {
            ...
            (t.prototype._initSidePanelParameters = function () {
                var e = this,
                    t = wjcCore.Control.getControl(this._sidePanel),
                    o = t.addPage(
                        wjcCore.culture.Viewer.parameters,
                        parametersIcon,
                        2
                    );
                (this._parametersPageId = o.id),
                    (this._gParameterTitle =
                        o.outContent.querySelector(".wj-tabtitle")),
                    o.format(function (o) {
                                    ...
                                    e._innerDocumentSource
                                        ...
                                        .then(function (t) {
                                            ...
                                            e._paramsEditor._reset(),
                                                n
                                                    ? (e._paramsEditor.itemsSource =
                                                          o)
                                                    : (e._resetDocument(),
                                                      (e._paramsEditor.isDisabled =
                                                          !0),
                                                      e._renderDocumentSource());
                                        })
                                        .catch(function (t) {
                                            e._showViewPanelErrorMessage(
                                                _getErrorMessage(t)
                                            );
                                        }),
                                    e._isMobileTemplate() && t.collapse());
            ...
            (t.prototype._onDocumentStatusChanged = function () {
                this._innerDocumentSource &&
                    this._innerDocumentSource.status ===
            ...
            (t.prototype._setDocumentRendering = function () {
                this._innerDocumentSource._updateStatus(
                    _ExecutionStatus.rendering
                ),
...
var _ParametersEditor = (function (e) {
    ...
    return (
        ...
        (t.prototype._generateComboEditor = function (e) {
            ...
            e.multiValue
                ...
                : ((t = new wjcInput.ComboBox(a)),
                  e.nullable
                      ? i.push({
                            name: wjcCore.culture.Viewer
                                .parameterNoneItemsSelected,
                            value: null,
                        })
                      : null == e.value &&
                        c &&
                ...
                o.checkedItemsChanged.addHandler(function () {
                    r._deferValidate(
                        ...
                        function () {
                            n.length > 0 &&
                                !e.nullable &&
                                r._validateNullValueOfParameter(a);
                        }
                    );
                });
            } else {
        ...
        (t.prototype._generateBoolEditor = function (e) {
            ...
            return (
                e.nullable
                    ...
                    : (((o = document.createElement("input")).type =
                          "checkbox"),
                      (o.checked = e.value),
        ...
        (t.prototype._createTextarea = function (e, o) {
            ...
            return (
                (r.wrap = "off"), r.setAttribute("data-type", o.toString()), r
            );
        }),
            ...
            _addEvent(e, "change,keyup,paste,input", function () {
                o._deferValidate(
                    ...
                    function () {
                        e.value &&
                            !t.nullable &&
                            o._validateNullValueOfParameter(e);
                    }
                );
            });
        }),
        ...
        (t.prototype._validateNullValueOfParameter = function (e) {
            ...
            if (o && o.length)
                for (var n = 0; n < o.length; n++)
                    if (
                        o[n].key ===
                        e.parentElement.getAttribute(t._paramIdAttr)
                    ) {
            ...
            if (e._selectAllItem) {
                ...
                (e._selectedAll =
                    ...
                    e._selectedAll !== n &&
                        ((e._innerCheckedItemsChanged = !0),
                        e._selectedAll
                            ? (e._multiSelect.checkedItems = t.concat(
                                  e._selectAllItem
                              ))

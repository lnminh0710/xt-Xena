...
var PivotGrid = (function (t) {
  function e(e) {
    return (
      t.call(this, e, wjcOlap.PivotGrid, {
        objectProps: ['childItemsPath', 'mergeManager', 'itemsSource'],
      }) || this
    );
  }
...
var PivotChart = (function (t) {
  function e(e) {
    return (
      t.call(this, e, wjcOlap.PivotChart, {
        objectProps: ['itemsSource'],
      }) || this
    );
  }
  return __extends(e, t), e;
...
var PivotPanel = (function (t) {
  function e(e) {
    return (
      t.call(this, e, wjcOlap.PivotPanel, {
        objectProps: ['engine', 'itemsSource'],
      }) || this
    );
  }
  return __extends(e, t), e;

...
var _CalcEngine = (function () {
    ...
    return (
        (e.prototype.onUnknownFunction = function (e, t) {
            ...
            throw (
                'The function "' + e + '" has not supported in FlexSheet yet.'
            );
        }),
        ...
        (e.prototype._registerAggregateFunction = function () {
            ...
            (e._functionTable.sum = new _FunctionDefinition(function (t, o) {
                ...
                (e._functionTable.average = new _FunctionDefinition(function (
                    t,
                    o
                ) {
                    return e._getAggregateResult(wjcCore.Aggregate.Avg, t, o);
                })),
                (e._functionTable.max = new _FunctionDefinition(function (
                    t,
                    o
                ) {
                    return e._getAggregateResult(wjcCore.Aggregate.Max, t, o);
                })),
                (e._functionTable.min = new _FunctionDefinition(function (
                    t,
                    o
                ) {
                    return e._getAggregateResult(wjcCore.Aggregate.Min, t, o);
                })),
                (e._functionTable.var = new _FunctionDefinition(function (
                    t,
                    o
                ) {
                    return e._getAggregateResult(wjcCore.Aggregate.Var, t, o);
                })),
                (e._functionTable.varp = new _FunctionDefinition(function (
                    t,
                    o
                ) {
                    return e._getAggregateResult(
                        wjcCore.Aggregate.VarPop,
                        t,
                        o
                    );
                })),
                (e._functionTable.stdev = new _FunctionDefinition(function (
                    t,
                    o
                ) {
                    return e._getAggregateResult(wjcCore.Aggregate.Std, t, o);
                })),
                (e._functionTable.stdevp = new _FunctionDefinition(function (
                    t,
                    o
                ) {
                    return e._getAggregateResult(
                        wjcCore.Aggregate.StdPop,
                        t,
                        o
                    );
                })),
                (e._functionTable.count = new _FunctionDefinition(function (
                    t,
                    o
                ) {
                ...
                (e._functionTable.counta = new _FunctionDefinition(function (
                    t,
                    o
                ) {
                    return e._getFlexSheetAggregateResult(
                ...
                (e._functionTable.countblank = new _FunctionDefinition(
                    function (t, o) {
                        return e._getFlexSheetAggregateResult(
        ...
        (e.prototype._registerMathFunction = function () {
            ...
            (e._functionTable.pi = new _FunctionDefinition(
                ...
                (e._functionTable.atan2 = new _FunctionDefinition(
                    function (t, o) {
                        var n = _Expression.toNumber(
                                t[0],
                                e._rowIndex,
                                e._columnIndex,
                                o
                            ),
                            i = _Expression.toNumber(
                                t[1],
                                e._rowIndex,
                                e._columnIndex,
                                o
        ...
        (e.prototype._registerTextFunction = function () {
            ...
            (e._functionTable.char = new _FunctionDefinition(
                ...
                (e._functionTable.find = new _FunctionDefinition(
                    function (t, o) {
                        var n,
                            i = _Expression.toString(
                                t[0],
                                e._rowIndex,
                                e._columnIndex,
                                o
                            ),
                            r = _Expression.toString(
                                t[1],
                                e._rowIndex,
                                e._columnIndex,
                                o
                ...
                (e._functionTable.text = new _FunctionDefinition(
                    function (t, o) {
                        ...
                        if (
                            (!wjcCore.isPrimitive(i) && i && (i = i.value),
                            wjcCore.isDate(i))
                        )
                            r = r
                                .replace(/\[\$\-.+\]/g, "")
                ...
                (e._functionTable.value = new _FunctionDefinition(
                    function (t, o) {
                        ...
                        if (
                            ...
                            if (
                                i[0] ===
                                wjcCore.culture.Globalize.numberFormat.currency
                                    .symbol
                            )
                                return +(i = i.substring(1));
                            if ("%" === i[i.length - 1])
                                return (
                                    +(i = i.substring(0, i.length - 1)) / 100
                                );
                        }
                        return (
                            (n = +i),
                ...
                (e._functionTable.datedif = new _FunctionDefinition(
                    function (t, o) {
                        var n,
                            ...
                            l,
                            s,
                            a = _Expression.toDate(
                                t[0],
                                e._rowIndex,
                                e._columnIndex,
                                o
                            ),
                            h = _Expression.toDate(
                                t[1],
                                e._rowIndex,
                                e._columnIndex,
                                o
                    ...
                    if (((d = ""), null != (u = this._owner._getTable(e)))) {
                        if ("" === (d = this._getTableRelatedSheet(e)))
                            throw (
                                "The Table(" +
                                e +
                                ") is not located in any sheet."
                            );
                        if (
                            (this._getToken(),
                            this._token.tokenType !==
                                _TokenType.SQUAREBRACKETS ||
        ...
        (e.prototype._getTableToken = function () {
            for (
                ...
                this._pointer++;
            for (
                "[" === (t = this._expression[this._pointer]) && (n = !0),
                    e = 1;
                e + this._pointer < this._expressLength;
                e++
            ) {
        ...
        (e.prototype._parseDigit = function () {
            ...
            for (e = 0; e + this._pointer < this._expressLength; e++)
                if (
                    (t = this._expression[this._pointer + e]) >= "0" &&
                    t <= "9"
                )
                    (r = 10 * r + (+t - 0)), o > -1 && (o *= 10);
                else if ("." === t && o < 0) o = 1;
        ...
        (e.prototype._getCellRange = function (e) {
            ...
            if (
                ...
                (t = e.split(":")).length > 0 &&
                t.length < 3 &&
                ((o = this._parseCell(t[0])),
                (i = o.cellRange) && 2 === t.length)
            ) {
                if (
                    ...
                    for (var a = 0; a < l.length; a++) {
                        ...
                        if ("@" === (o = l[a])[0]) {
                            ...
                            if (null == (i = e.getColumnRange(o.substring(1))))
                                throw "Invalid Table Refernce.";
                            if (
                                this._rowIndex >= i.topRow &&
                                this._rowIndex <= i.bottomRow
                            )
                                return (
                                    (i.row = this._rowIndex),
                                    (i.row2 = this._rowIndex),
                                    i
                                );
                            throw (
                                "The row is out of the table (" +
        ...
        (e.prototype._getAggregateResult = function (e, t, o) {
            ...
            return (
                (n = wjcCore.getAggregate(e, i.items)),
                i.isDate && (n = new Date(n)),
                n
            );
        }),
        (e.prototype._getFlexSheetAggregateResult = function (e, t, o) {
            ...
            switch (e) {
                ...
                case _FlexSheetAggregate.Product:
                    return (
                        (n = this._getItemList(t, o)),
                        this._getProductOfNumbers(n.items)
                    );
            }
        ...
        (e.prototype._countCellsByCriterias = function (e, t, o, n) {
            ...
            for (; h < u; h++) {
                ...
                e: for (c = 0; c < e.length; c++)
                    if (
                        ((l = e[c]), (s = l[h]), "string" == typeof (a = _[c]))
                    ) {
                        if ("*" !== a && (null == s || "" === s)) {
                            i = !1;
                            break e;
                        ...
                        !(i = i = a.reg.test(s.toString()) === a.checkMathces)
                    )
                        break e;
                i &&
                    (n
            ...
            for (; h < u; h++) {
                ...
                e: for (c = 0; c < e.length; c++)
                    if (
                        ...
                        !(r = a.reg.test(s.toString()) === a.checkMathces)
                    )
                        break e;
            ...
            if (
                ...
                for (r = g.topRow, l = g.bottomRow; l > g.topRow; l--) {
                    for (u = [], _ = [], s = g.leftCol; s <= g.rightCol; s++)
                        if (
                            null !=
                                (h = this._owner.getCellValue(l, s, !1, i)) &&
                            "" !== h
                        ) {
                            if (
            ...
            if (e.indexOf("?") > -1 || e.indexOf("*") > -1) {
                ...
                return (
                    (o = new RegExp(
                        "^" +
                            (t[1].length > 0
                                ? this._parseRegCriteria(t[1])
                                : "") +
                            t[2] +
                            (t[3].length > 0
                                ? this._parseRegCriteria(t[3])
                                : "") +
                            t[4] +
                            (t[5].length > 0
                                ? this._parseRegCriteria(t[5])
                                : "") +
                            "$",
                        "i"
                    )),
        ...
        (e.prototype._combineExpr = function (e, t) {
            return (
                (wjcCore.isString(e) || wjcCore.isDate(e)) &&
                    (e = '"' + e + '"'),
                (e = "=" + e) + t
            );
        }),
        ...
        (e.prototype._exactMatch = function (e, t, o, n) {
            ...
            for (i = t.leftCol; i <= t.rightCol; i++)
                if (((r = this._owner.getCellValue(a, i, !1, o)), null != s)) {
                    ...
                    (wjcCore.isString(r) && (r = r.toLowerCase()), e === r)
                )
                    return i;
            return -1;
        }),
        (e.prototype._approximateMatch = function (e, t, o) {
            ...
            for (
                l.sort(function (e, t) {
                    return (
                        wjcCore.isString(e.value) &&
                            (e.value = e.value.toLowerCase()),
                        wjcCore.isString(t.value) &&
        ...
        (e.prototype._parseToScientificValue = function (e, t, o, n, i) {
            ...
            if (((s = wjcCore.Globalize.format(e, "D" + t.length)), o))
                for (
                    ...
                    (s += "0"), a++;
            if (
                ((s += "E" + l + wjcCore.Globalize.format(h, "D" + n.length)),
                i)
            ) {
                s += ".";
        ...
        (e.prototype._getTableRelatedSheet = function (e) {
            for (var t = 0; t < this._owner.sheets.length; t++)
                for (
                    var o = this._owner.sheets[t], n = 0;
                    n < o.tableNames.length;
                    n++
                )
            ...
            if (wjcCore.isString(i)) {
                if (i) {
                    if (isNaN(+i)) {
                        for (var l in r)
                            if (i.indexOf(r[l]) > -1)
                                return this._toOADate(new Date(i));
                        return +i;
                    }
                    return +i;
                }
            ...
            if (this.token.tokenID === _TokenID.SUB)
                return (
                    null == this._evaluatedValue &&
                        (this._evaluatedValue = -_Expression.toNumber(
                            this._expr,
                            e,
                            t,
                            o
...
var _CellRangeExpression = (function (e) {
    ...
    return (
        ...
        (t.prototype.evaluate = function (e, t, o) {
            return (
                null == this._evaluatedValue &&
                    (this._evaluatedValue = this._getCellValue(
                        this._cells,
                        o,
                        e,
                        t
                ...
                if (e || !1 !== o.grid.rows[i].isVisible)
                    for (t = r; t <= l; t++) {
                        ...
                        (e || !1 !== o.grid.columns[t].isVisible) &&
                            ((n = this._getCellValue(
                                new wjcGrid.CellRange(i, t),
                                o
                            )),
        ...
        (t.prototype.getValuseWithTwoDimensions = function (e, t) {
            ...
            var o,
                ...
                s = 0,
                a = 0;
            if (!(t = this._getSheet() || t || this._flex.selectedSheet))
                return null;
            for (i = this._cells.topRow; i <= this._cells.bottomRow; i++) {
                ...
                if (e || !1 !== t.grid.rows[i].isVisible) {
                    for (
                        ...
                        e || !1 !== t.grid.columns[r].isVisible
                            ? ((o = this._getCellValue(
                                  new wjcGrid.CellRange(i, r),
                                  t
                              )),
        ...
        (t.prototype._getCellValue = function (e, t, o, n) {
            ...
            try {
                if (this._flex)
                    return (
                        (this._evalutingRange[i] = !0),
                        this._flex.getCellValue(r, l, !1, t)
                    );
            } finally {
        ...
        (t.prototype._getSheet = function () {
            ...
            for (; t < this._flex.sheets.length; t++)
                if (
                    (e = this._flex.sheets[t]).name.toLowerCase() ===
                    this._sheetRef
                )
                    return e;
                    ...
                    for (r = o.leftCol; r <= o.rightCol; r++)
                        (l =
                            ...
                            (l = t.getCellData(
                                i,
                                r,
                                t.columns[r] && !!t.columns[r].dataMap
                            ))
                                ? ""
                                : l),
                        ...
                        for (t = 0; t < e._deletedTables.length; t++)
                            (o = e._deletedTables[t]),
                                e._owner.selectedSheet.tableNames.splice(
                                    e._owner.selectedSheet.tableNames.indexOf(
                                        o.name
                                    ),
                                    1
                                ),
            ...
            for (this._newValues = {}, e = 0; e < this._selections.length; e++)
                for (
                    ...
                    for (i = t.leftCol; i <= t.rightCol; i++) {
                        ...
                        (r =
                            null ==
                            (r = this._owner.getCellData(n, i, !!o.dataMap))
                                ? ""
                                : r),
...
var _RowResizeAction = (function (e) {
    function t(t, o, n) {
        ...
        return (
            (i._panel = o),
            (i._rowIndex = n),
            (i._oldRowHeight = o.rows[n].height),
            i
        );
    }
    return (
    ...
    return (
        ...
        (t.prototype.undo = function () {
            ...
            if (c._owner.selectedSheet) {
                ...
                if (
                    (c._affectedFormulas &&
                        (l = c._affectedFormulas.oldFormulas),
                    c._owner.deferUpdate(function () {
                        if (l && l.length > 0)
                            for (t = 0; t < l.length; t++)
                                null != (r = l[t]).point
                                    ? r.sheet.name ===
                                      c._owner.selectedSheet.name
                                        ? c._owner.setCellData(
                                              r.point.x,
                                              r.point.y,
                                              r.formula
                                          )
                                        : r.sheet.grid.setCellData(
                                              r.point.x,
                                              r.point.y,
                                              r.formula
                                          )
                        ...
                        if (c._deletedTables && c._deletedTables.length > 0)
                            for (o = 0; o < c._deletedTables.length; o++)
                                (i = c._deletedTables[o]),
                                    ...
                                    c._owner.selectedSheet.tableNames.push(
                                        i.name
                                    );
                    }),
                    ...
                    for (t = 0; t < s.length; t++)
                        (a = s[t]),
                            (h = c._owner._getDefinedNameIndexByName(a.name)) >
                                -1 &&
        ...
        (t.prototype.redo = function () {
            ...
            if (c._owner.selectedSheet) {
                ...
                if (
                    (c._affectedFormulas &&
                        (l = c._affectedFormulas.newFormulas),
                    c._owner.deferUpdate(function () {
                        if (l && l.length > 0)
                            for (t = 0; t < l.length; t++)
                                null != (r = l[t]).point
                            ...
                            for (o = 0; o < c._deletedTables.length; o++)
                                (i = c._deletedTables[o]),
                                    c._owner.selectedSheet.tableNames.splice(
                                        c._owner.selectedSheet.tableNames.indexOf(
                                            i.name
                                        ),
                                        1
                                    ),
        ...
        (t.prototype.saveNewState = function () {
            ...
            if (
                ...
                for (
                    t = 0;
                    t < this._owner.selectedSheet.tableNames.length;
                    t++
                )
    ...
    return (
        ...
        (t.prototype.undo = function () {
            ...
            if (u._owner.selectedSheet) {
                if (
                    ...
                    u._owner.collectionView.beginUpdate(),
                        ...
                        u._owner.itemsSource instanceof wjcCore.CollectionView
                            ? ((d = [
                                  0,
                                  u._owner.itemsSource.items.length,
                              ].concat(u._oldValue.itemsSource)),
                              Array.prototype.splice.apply(
                                  u._owner.itemsSource.items,
                                  d
                              ))
                            : (u._owner.itemsSource =
                                  u._oldValue.itemsSource.slice()),
                ...
                if (
                    (u._affectedFormulas &&
                        (s = u._affectedFormulas.oldFormulas),
                    u._owner.deferUpdate(function () {
                        if (s && s.length > 0)
                            for (o = 0; o < s.length; o++)
                                null != (l = s[o]).point
                                    ? l.sheet.name ===
                                      u._owner.selectedSheet.name
                                        ? u._owner.setCellData(
                                              l.point.x,
                                              l.point.y,
                                              l.formula
                                          )
                                        : l.sheet.grid.setCellData(
                                              l.point.x,
                                              l.point.y,
                                              l.formula
                                          )
                        ...
                        if (u._deletedTables && u._deletedTables.length > 0)
                            for (n = 0; n < u._deletedTables.length; n++)
                                (r = u._deletedTables[n]),
                                    ...
                                    u._owner.selectedSheet.tableNames.push(
                                        r.name
                                    );
                    }),
                    ...
                    for (o = 0; o < a.length; o++)
                        (h = a[o]),
                            (c = u._owner._getDefinedNameIndexByName(h.name)) >
                                -1 &&
        ...
        (t.prototype.redo = function () {
            ...
            if (u._owner.selectedSheet) {
                    ...
                    u._owner.collectionView.beginUpdate(),
                        ...
                        u._owner.itemsSource instanceof wjcCore.CollectionView
                            ? ((d = [
                                  0,
                                  u._owner.itemsSource.items.length,
                              ].concat(u._newValue.itemsSource)),
                              Array.prototype.splice.apply(
                                  u._owner.itemsSource.items,
                                  d
                              ))
                            : (u._owner.itemsSource =
                                  u._newValue.itemsSource.slice()),
                        u._owner.collectionView.endUpdate();
                else
                    for (
                        u._owner.rows.beginUpdate(), e = 0;
                ...
                if (
                    (u._affectedFormulas &&
                        (s = u._affectedFormulas.newFormulas),
                    u._owner.deferUpdate(function () {
                        if (s && s.length > 0)
                            for (o = 0; o < s.length; o++)
                                null != (l = s[o]).point
                            ...
                            for (n = 0; n < u._deletedTables.length; n++)
                                (r = u._deletedTables[n]),
                                    u._owner.selectedSheet.tableNames.splice(
                                        u._owner.selectedSheet.tableNames.indexOf(
                                            r.name
                                        ),
                                        1
                                    ),
        ...
        (t.prototype.saveNewState = function () {
            ...
            if (
                ...
                for (
                    o = 0;
                    o < this._owner.selectedSheet.tableNames.length;
                    o++
                )
            ...
            return (
                this._owner.itemsSource &&
                    (r =
                        this._owner.itemsSource instanceof
        ...
        (t.prototype.saveNewState = function () {
            return (
                (this._newStyledCells = this._owner.selectedSheet
                    ? JSON.parse(
                          JSON.stringify(this._owner.selectedSheet._styledCells)
                      )
                    : null),
                !0
            );
                ...
                for (l = n.leftCol; l <= n.rightCol; l++)
                    d._isDraggingColumns &&
                        ...
                        (h = d._owner.selectedSheet._styledCells[s]
                            ? JSON.parse(
                                  JSON.stringify(
                                      d._owner.selectedSheet._styledCells[s]
                                  )
                              )
                            : null),
                    ...
                    for (r = o.topRow; r <= o.bottomRow; r++)
                        for (l = o.leftCol; l <= o.rightCol; l++)
                            (c = d._owner.selectedSheet.findTable(r, l)) &&
                                c.showHeaderRow &&
                                r === c.range.topRow &&
                                (d._draggingTableColumns ||
                                    (d._draggingTableColumns = []),
                                d._draggingTableColumns.push({
                                    rowIndex: r,
                                    columnIndex: l,
                                    cellContent:
                                        c.columns[l - c.range.leftCol].name,
                                }));
            } else
                for (
                    d._draggingCells = [],
        ...
        (t.prototype.undo = function () {
            ...
            c._owner.selectedSheet &&
                ...
                c._owner.deferUpdate(function () {
                    ...
                    if (
                        (c._affectedFormulas &&
                            (r = c._affectedFormulas.oldFormulas),
                        r && r.length > 0)
                    )
                    ...
                    if (
                        ...
                        for (e = 0; e < s.length; e++)
                            (a = s[e]),
                                (h = c._owner._getDefinedNameIndexByName(
                                    a.name
                                )) > -1 &&
                                    (c._owner.definedNames[h].value = a.value);
                    for (e = 0; e < c._oldDroppingCells.length; e++)
                        (t = c._oldDroppingCells[e]),
                            ...
                            (d = c._owner.selectedSheet.findTable(
                                ...
                                (d.columns[
                                    t.columnIndex - d.range.leftCol
                                ].name = t.cellContent),
                            (o =
                                t.rowIndex * c._owner.columns.length +
                                t.columnIndex),
                            t.cellStyle
                                ? (c._owner.selectedSheet._styledCells[o] =
                                      t.cellStyle)
                                : delete c._owner.selectedSheet._styledCells[o];
                    if (
                        (c._isDraggingColumns &&
                            c._oldDroppingColumnSetting &&
                            Object.keys(c._oldDroppingColumnSetting).forEach(
                                function (e) {
                                    (c._owner.columns[+e].dataType = c
                                        ._oldDroppingColumnSetting[+e].dataType
                                        ? c._oldDroppingColumnSetting[+e]
                                              .dataType
                        ...
                        if (
                            c._draggingTableColumns &&
                            c._draggingTableColumns.length > 0
                        )
                        ...
                        if (
                            (c._isDraggingColumns &&
                                ...
                                Object.keys(c._draggingColumnSetting).forEach(
                                    function (e) {
                                        (c._owner.columns[+e].dataType = c
                                            ._draggingColumnSetting[+e].dataType
                                            ? c._draggingColumnSetting[+e]
                                                  .dataType
                                            : wjcCore.DataType.Object),
                                            (c._owner.columns[+e].align =
                                                c._draggingColumnSetting[
        ...
        (t.prototype.redo = function () {
            ...
            d._owner.selectedSheet &&
                ...
                d._owner.deferUpdate(function () {
                    if (
                        (d._affectedFormulas &&
                            (r = d._affectedFormulas.newFormulas),
                        r && r.length > 0)
                    )
                        for (e = 0; e < r.length; e++)
                            (l = r[e]).sheet.name ===
                            d._owner.selectedSheet.name
                    ...
                    if (
                        ...
                        for (e = 0; e < s.length; e++)
                            (a = s[e]),
                                (h = d._owner._getDefinedNameIndexByName(
                                    a.name
                                )) > -1 &&
                    ...
                    if (d._isCopyCells) {
                        if (
                            d._draggingTableColumns &&
                            d._draggingTableColumns.length > 0
                        )
                            for (e = 0; e < d._draggingTableColumns.length; e++)
                                (t = d._draggingTableColumns[e]),
                                    (c = d._owner.selectedSheet.findTable(
                                        ...
                                        (c.columns[
                                            t.columnIndex - c.range.leftCol
                                        ].name = t.updatedCellContent));
                    } else {
                        for (e = 0; e < d._draggingCells.length; e++)
                            (t = d._draggingCells[e]),
                                ...
                                (o =
                                    t.rowIndex * d._owner.columns.length +
                                    t.columnIndex),
                                d._owner.selectedSheet._styledCells[o] &&
                                    delete d._owner.selectedSheet._styledCells[
                                        o
                                    ];
                        d._isDraggingColumns &&
                            d._draggingColumnSetting &&
                            Object.keys(d._draggingColumnSetting).forEach(
                                function (e) {
                                    (d._owner.columns[+e].dataType =
                                        wjcCore.DataType.Object),
                    ...
                    if (
                        (d._isDraggingColumns &&
                            ...
                            Object.keys(d._newDroppingColumnSetting).forEach(
                                function (e) {
                                    (d._owner.columns[+e].dataType = d
                                        ._newDroppingColumnSetting[+e].dataType
                                        ? d._newDroppingColumnSetting[+e]
                                              .dataType
                                        : wjcCore.DataType.Object),
        ...
        (t.prototype.saveNewState = function () {
            ...
            if (this._dropRange) {
                for (
                    ...
                    for (
                        t = this._dropRange.leftCol;
                        t <= this._dropRange.rightCol;
                        t++
                    )
                ...
                if (this._isDraggingColumns)
                    if (this._isCopyCells) {
                        if (
                            ...
                            for (
                                r = 0;
                                r < this._draggingTableColumns.length;
                                r++
                            )
                                (l = this._draggingTableColumns[r]),
                                    (s = this._owner.selectedSheet.findTable(
                                        ...
                                        (l.updatedCellContent =
                                            s.columns[
                                                l.columnIndex - s.range.leftCol
                                            ].name);
                    } else if (
                        this._draggingCells &&
                        this._draggingCells.length > 0
                    )
...
var _CutAction = (function (e) {
    function t(t) {
        ...
        for (
            ...
            if (null != r.rows[o])
                for (
                    n = l._cutSelection.leftCol;
                    n <= l._cutSelection.rightCol;
                    n++
                )
                    (i =
                        null ==
                        (i = r.getCellData(o, n, !!r.columns[n].dataMap))
                            ? ""
                            : i),
    ...
    return (
                    ...
                    var t,
                        ...
                        n =
                            e._cutSheet === e._owner.selectedSheet
                                ...
                                : e._cutSheet.grid;
                    for (
                        e._owner.selectedSheet.selectionRanges.push(
                            e._selection
                        ),
                            t = 0;
                        ...
                        (o = e._oldCutValues[t]),
                            n.setCellData(o.row, o.col, o.value);
        ...
        (t.prototype.saveNewState = function () {
            ...
            for (
                ...
                if (null != n.rows[e])
                    for (
                        ...
                        (o =
                            null ==
                            (o = n.getCellData(e, t, !!n.columns[t].dataMap))
                                ? ""
                                : o),
            ...
            for (
                ...
                for (
                    t = this._selection.leftCol;
                    t <= this._selection.rightCol;
                    t++
                ) {
        ...
        (t.prototype.updateForPasting = function (e) {
            ...
            (t = null == t ? "" : t),
                ...
                (this._selection.row = Math.min(
                    this._selection.topRow,
                    e.topRow
                )),
                ...
                (this._selection.col = Math.min(
                    this._selection.leftCol,
                    e.leftCol
                )),
                (this._selection.col2 = Math.max(
                    this._selection.rightCol,
                    e.rightCol
                ));
        }),
        t
    ...
    return (
        ...
        (t.prototype.undo = function () {
            (this._owner._isUndoing = !0),
                ...
                (this._table.showHeaderRow =
                    this._oldTableSetting.showHeaderRow),
                (this._table.showTotalRow = this._oldTableSetting.showTotalRow),
                (this._table.showBandedRows =
                    this._oldTableSetting.showbandedRows),
                (this._table.showBandedColumns =
                    this._oldTableSetting.showBandedColumns),
                (this._table.showFirstColumn =
                    this._oldTableSetting.showFirstColumn),
                (this._table.showLastColumn =
                    this._oldTableSetting.showLastColumn),
        ...
        (t.prototype.redo = function () {
            (this._owner._isUndoing = !0),
                ...
                (this._table.showHeaderRow =
                    this._newTableSetting.showHeaderRow),
                (this._table.showTotalRow = this._newTableSetting.showTotalRow),
                (this._table.showBandedRows =
                    this._newTableSetting.showbandedRows),
                (this._table.showBandedColumns =
                    this._newTableSetting.showBandedColumns),
                (this._table.showFirstColumn =
                    this._newTableSetting.showFirstColumn),
                (this._table.showLastColumn =
                    this._newTableSetting.showLastColumn),
                (this._owner._isUndoing = !1);
        }),
        (t.prototype.saveNewState = function () {
            return (
    ...
    return (
        ...
        (t.prototype.undo = function () {
            ...
            this._owner.selectedSheet.tableNames.splice(
                this._owner.selectedSheet.tableNames.indexOf(
                    this._addedTable.name
                ),
                1
            ),
        ...
        (t.prototype.redo = function () {
            ...
            this._owner.tables.push(this._addedTable),
                this._owner.selectedSheet.tableNames.push(
                    this._addedTable.name
                ),
                this._owner.refresh();
        }),
...
var _FilteringAction = (function (e) {
    ...
    return (
        ...
        (t.prototype.saveNewState = function () {
            return (
                this._oldFilterDefinition !==
                    this._owner._filter.filterDefinition &&
                ((this._newFilterDefinition =
                    this._owner._filter.filterDefinition),
                !0)
            );
        }),
    ...
    return (
        ...
        (t.prototype.moveToLast = function () {
            ...
            this._removeSelectedState(e),
                ...
                e[this._idx] &&
                    "none" === e[this._idx].style.display &&
                    this._idx--,
                wjcCore.addClass(e[this._idx], "wj-context-menu-item-selected");
        }),
        (t.prototype.handleContextMenu = function () {
            if (-1 === this._idx) this.moveToNext();
                ...
                switch (
                    this.hostElement.querySelectorAll(".wj-context-menu-item")[
                        this._idx
                    ]
                ) {
                    case this._insCols:
...
var _FlexSheetCellFactory = (function (e) {
    ...
    return (
            ...
            switch (
                    ...
                    (l = FlexSheet.convertNumberToAlpha(n)),
                        i.textContent
                            ? (i.innerHTML = i.innerHTML
                                  .replace(
                                      wjcCore.escapeHtml(i.textContent.trim()),
                                      l
                                  )
                ...
                case wjcGrid.CellType.Cell:
                    if (
                        ...
                        r &&
                            !r.isSingleCell &&
                            ((o = (m = this._getFirstVisibleCell(a, r)).row),
                            (n = m.col)),
                        ...
                        t.columns[n].dataType === wjcCore.DataType.Boolean
                            ? 1 === i.childElementCount &&
                              ...
                              (i.innerHTML = wjcCore.escapeHtml(
                                  t.columns[n].header
                              ))
                            : i.innerHTML ||
                              (i.innerHTML = wjcCore.escapeHtml(
                        ...
                        for (var R in _)
                            "className" === R
                                ? _.className &&
                                  wjcCore.addClass(i, _.className)
                                : "format" !== R &&
                                  (y = _[R]) &&
                                  ...
                                  ("color" !== R && "backgroundColor" !== R)
                                      ? "whiteSpace" === R && "normal" === y
                                          ? (v[R] = "")
                                          : R.toLowerCase().indexOf("color") >
                                                -1 && !wjcCore.isString(y)
                                          ? (v[R] =
                                                null != y
                                                    ? a._getThemeColor(
                                                          y.theme,
        ...
        (t.prototype._getFirstVisibleCell = function (e, t) {
            ...
            for (
                n = t.leftCol;
                n <= t.rightCol && !e.columns[n].isVisible;
                n++
            );
    ...
    FlexSheet = (function (e) {
        ...
        return (
                ...
                get: function () {
                    return (
                        this._sheets ||
                            ...
                            this._sheets.sheetCleared.addHandler(
                                this.onSheetCleared,
                                this
                            )),
                        this._sheets
            ...
            (t.prototype.onLoaded = function (e) {
                var t = this;
                t._toRefresh &&
                    (clearTimeout(t._toRefresh), (t._toRefresh = null)),
            ...
            (t.prototype.refresh = function (t) {
                ...
                if (
                    ...
                    !this.preserveSelectedState &&
                        ...
                        this.selectedSheet.selectionRanges.push(
                            this.selection
                        )),
                ...
                if (this.selectedSheet) {
                    if (this.selectedSheet._freezeHiddenRowCnt > 0)
                        for (
                            o = 0;
                            o < this.selectedSheet._freezeHiddenRowCnt;
                            o++
                        )
                            (n = this.rows[o]) instanceof HeaderRow ||
                                (n.visible = !1);
                    if (this.selectedSheet._freezeHiddenColumnCnt > 0)
                        for (
                            i = 0;
                            i < this.selectedSheet._freezeHiddenColumnCnt;
                            i++
                        )
            ...
            (t.prototype.setCellData = function (e, t, o, n, i) {
                ...
                return (
                    ...
                    this.cells.setCellData(e, t, o, n && !r, i)
                );
            }),
            (t.prototype.containsFocus = function () {
                return (
                    this.isFunctionListOpen ||
            ...
            (t.prototype.applyCellsStyle = function (e, t, o) {
                ...
                if (this.selectedSheet) {
                    ...
                    if (a) {
                            ...
                            t || o
                                ? o &&
                                  ...
                                  (this._cloneStyle = JSON.parse(
                                      JSON.stringify(
                                          this.selectedSheet._styledCells
                                      )
                                  ))
                                : ((s = new _CellStyleAction(
                                      this,
                                      this._cloneStyle
                                  )),
                                  (this._cloneStyle = null)),
                        ...
                        t ||
                            o ||
                            (s.saveNewState(), this._undoStack._addAction(s));
                    }
                    t || this.refresh(!1);
                }
            }),
                ...
                if (r.selectedSheet) {
                    if (
                        ...
                        (o = r.selection.leftCol > 0 ? r.selection.leftCol : 0),
                            (n =
                                r.selection.topRow > 0
                                    ? r.selection.topRow
                                    : 0);
                    } else {
                        for (e = 0; e < r.frozenRows - 1; e++)
                            r.rows[e].visible = !0;
                        for (t = 0; t < r.frozenColumns - 1; t++)
                            r.columns[t].visible = !0;
                        r._filter.apply(),
                            (o = 0),
                            (n = 0),
                    ...
                    (r.frozenRows = r.selectedSheet.grid.frozenRows = n),
                        (r.frozenColumns = r.selectedSheet.grid.frozenColumns =
                            o),
                        setTimeout(function () {
            ...
            (t.prototype.insertRows = function (e, t) {
                ...
                if (this.selectedSheet) {
                    if (
                        ...
                        (r._affectedFormulas = this._updateAffectedFormula(
                            n,
                            i,
                            !0,
                            !0
                        )),
                        (r._affectedDefinedNameVals =
                            this._updateAffectedNamedRanges(n, i, !0, !0)),
                        this.collectionView)
                    )
                    ...
                    this._updateTablesForUpdatingRow(n, i),
                        ...
                        this.onRowChanged(
                            new RowColumnChangedEventArgs(n, i, !0)
                        );
                }
            }),
            (t.prototype.deleteRows = function (e, t) {
                ...
                if (
                    ...
                    for (
                        this.onPrepareChangingRow(),
                            this._updateCellsForUpdatingRow(
                                this.rows.length,
                                r,
                                i,
                                !0
                            ...
                            s._affectedDefinedNameVals =
                                this._updateAffectedNamedRanges(
                                    l,
                                    l - r + 1,
                                    !1,
                                    !0
                        ...
                        ((o = this.rows[l]) && o.constructor === HeaderRow) ||
                            (o.dataItem && this.collectionView
                                ? (this.collectionView.beginUpdate(),
                                  this._getCvIndex(l) > -1 &&
                                      (this.itemsSource instanceof
                                      wjcCore.CollectionView
                                          ? this.itemsSource.items.splice(
                                                l - 1,
                                                1
                                            )
                            ...
                            (a = !0));
                    this.rows.endUpdate(),
                        (s._deletedTables = this._updateTablesForUpdatingRow(
                            r,
                            i,
                            !0
                        )),
                        ...
                        a &&
                            ...
                            this.onRowChanged(
                                new RowColumnChangedEventArgs(r, i, !1)
                            ));
                }
            }),
                ...
                if (this.selectedSheet && !this.itemsSource) {
                    for (
                        this._clearCalcEngine(),
                            ...
                            this._updateCellsForUpdatingColumn(
                                this.columns.length,
                                i,
                                r
                            ),
                            ...
                            l._affectedDefinedNameVals =
                                this._updateAffectedNamedRanges(i, r, !0, !1),
                    ...
                    this.columns.endUpdate(),
                        ...
                        this.onColumnChanged(
                            new RowColumnChangedEventArgs(i, r, !0)
                        );
                }
            }),
                ...
                if (
                    ...
                    for (
                        this.onPrepareChangingColumn(),
                            ...
                            l._deletedTables =
                                this._updateTablesForUpdatingColumn(i, n, !0),
                            this.columns.beginUpdate();
                        r >= i;
                        r--
                    )
                        this.columns.removeAt(r),
                            this._sortManager.deleteSortLevel(r);
                    this.columns.endUpdate(),
                        ...
                        this._undoStack._addAction(l),
                        this.onColumnChanged(
                            new RowColumnChangedEventArgs(i, n, !1)
                        );
                }
            }),
                ...
                if (this.selectedSheet) {
                    if (l) {
                        ...
                        if (
                            (e ||
                                t ||
                                ((r = new _CellMergeAction(this)),
                                this.hostElement.focus()),
                            !this._resetMergedRange(l))
                        ) {
                            for (o = l.topRow; o <= l.bottomRow; o++)
                                if (
                                    (s < 0 && this.rows[o].visible && (s = o),
                                    !(s < 0))
                                )
                                    for (n = l.leftCol; n <= l.rightCol; n++)
                                        (i = o * this.columns.length + n),
                                            (this.selectedSheet._mergedRanges[
                                                i
                                            ] = new wjcGrid.CellRange(
                                                s,
                                                l.leftCol,
            ...
            (t.prototype.getMergedRange = function (t, o, n, i) {
                ...
                var r,
                    ...
                    c = this.selectedSheet
                        ? this.selectedSheet._mergedRanges[h]
                        : null;
                    ...
                    "=" === n._functionTarget.value[0]
                        ? ((n._functionList._cv.filter = function (e) {
                          ...
                          (t =
                              ...
                              e.clientHeight +
                              2 +
                              (wjcCore.hasClass(e, "wj-grid-editor")
                                  ? this._ptScrl.y
                                  : 0)),
                          (o =
                              i.x +
                          ...
                          wjcCore.setCss(n._functionListHost, {
                              height:
                                  n._functionList._cv.items.length > 5
                                      ? "218px"
                                      : "auto",
                              display:
                                  n._functionList._cv.items.length > 0
                                      ? "block"
                                      : "none",
                              top: "",
                              left: "",
                          ...
                          n._functionListHost.offsetHeight + t >
                          r.y + n._root.offsetHeight
                              ? (t =
                                    t -
                                    e.clientHeight -
                                    n._functionListHost.offsetHeight -
                                    5)
                              : (t += 5),
                          n._functionListHost.offsetWidth + o >
                              r.x + n._root.offsetWidth &&
                              (o =
                                  r.x +
                                  n._root.offsetWidth -
                                  n._functionListHost.offsetWidth),
                          wjcCore.setCss(n._functionListHost, {
                              top: t,
                              left: o,
                          }))
            ...
            (t.prototype.applyFunctionToCell = function () {
                ...
                t._functionTarget &&
                    (-1 ===
                    (e = t._getCurrentFormulaIndex(t._functionTarget.value))
            ...
            (t.prototype.getClipString = function (e) {
                    ...
                    if (this._isMultipleRowsSelected()) {
                        for (
                            r = "",
                                0 ===
                                    (t =
                                        this.selectedSheet.selectionRanges.slice(
                                            0
                                        )).length && (t = [this.selection]),
                ...
                if (!(e = wjcCore.asType(e, wjcGrid.CellRange)).isValid)
                    return "";
                    ...
                    if (this.rows[a].isVisible) {
                        ...
                        for (var h = e.leftCol, c = !0; h <= e.rightCol; h++)
                            this.columns[h].isVisible &&
                                (c || (r += "\t"),
                                (c = !1),
                                (i = (i = this.getCellValue(
                                    a,
                                    h,
                                    !0
                                ).toString()).replace(/\t/g, " ")).indexOf(
                                    "\n"
                                ) > -1 &&
                                    (i = '"' + i.replace(/"/g, '""') + '"'),
                                (r += i));
            ...
            (t.prototype.setClipString = function (t, o) {
                ...
                if (
                    ((o = o
                        ? wjcCore.asType(o, wjcGrid.CellRange)
                        : this.selection),
                    (t = wjcCore
                        .asString(t)
                        .replace(/\r\n/g, "\n")
                    ...
                    for (
                        ...
                        if (((v = 0), this.rows[i].isVisible)) {
                            for (
                                ...
                                y++;
                            if (y >= S.rowSpan) {
                                if (R % S.rowSpan != 0 || x % S.columnSpan != 0)
                                    break;
                                y %= S.rowSpan;
                            }
                            if (!this._copiedSheet.grid.rows[S.topRow + y])
                                break;
                            for (
                                C = i - S.topRow - y,
                                    h = a[u],
            ...
            (t.prototype.getBuiltInTableStyle = function (e) {
                ...
                return (
                    null ==
                        (t = this._builtInTableStylesCache[e.toLowerCase()]) &&
            ...
            (t.prototype.addTableFromDataSource = function (
                e,
                t,
                o,
                n,
            ...
            (t.prototype._init = function () {
                ...
                t.hostElement.setAttribute("tabindex", "-1"),
                    ...
                    t._filter.filterApplied.addHandler(function () {
                        t.selectedSheet &&
                            ((t.selectedSheet._filterDefinition =
                                t._filter.filterDefinition),
                    ...
                    t.loadedRows.addHandler(function () {
                        if (
                            t.itemsSource &&
                            !(t.rows[0] instanceof HeaderRow)
                        ) {
                            for (
                                var e, o = new HeaderRow(), n = 0;
                                n < t.columns.length;
                                n++
                            )
                                (e = t.columns[n]),
                    ...
                    t.itemsSourceChanged.addHandler(function () {
                        var e;
                        for (e = 0; e < t.columns.length; e++)
                            t.columns[e].isRequired = !1;
                    }),
                    t.copied.addHandler(function (e, o) {
                        ...
                        (t._copiedSheet = t.selectedSheet),
                            ...
                            t._isMultipleRowsSelected()
                                ? ((n =
                                      t.selectedSheet.selectionRanges.slice(
                                          0
                                      )).sort(t._sortByRow),
                                  (t._copiedRanges = n))
                    ...
                    t.definedNames.collectionChanged.addHandler(function (
                        e,
                        o
                    ) {
                        if (
                            o.action ===
                                wjcCore.NotifyCollectionChangedAction.Add ||
                            o.action ===
                            ...
                            if (
                                ...
                                throw (
                                    ...
                                    "The " +
                                        o.item.name +
                                        " already existed in definedNames.")
                                );
                        }
                    }),
                    t.addEventListener(
                        ...
                        function (e) {
                            document.addEventListener("mouseup", n),
                                t._isDescendant(t._divContainer, e.target) &&
                                    t._mouseDown(e);
                        },
                        !0
                    ),
                            ...
                            o.defaultPrevented ||
                                ...
                                n &&
                                    ...
                                    n.cellType !== wjcGrid.CellType.Cell ||
                                        ...
                                        (t.selection = d),
                                        t.selectedSheet.selectionRanges.push(
                                            d
                                        )),
                                    e.itemsSource ||
                                        t._contextMenu.show(o, a)));
                        }
                    ),
                    t.prepareCellForEdit.addHandler(
                        t._prepareCellForEditHandler,
                        t
                    ),
                    t.cellEditEnded.addHandler(function (e, o) {
                        (!o.data ||
                            (46 !== o.data.keyCode && 8 !== o.data.keyCode)) &&
                            setTimeout(function () {
                                t.hideFunctionList();
                            }, 200);
                    }),
                        ...
                        (t._needCopyToSheet = !0),
                            ...
                            t.collectionView &&
                                t.deferUpdate(function (o) {
                                    ...
                                    n &&
                                        n.dataItem &&
                                        (t.collectionView.moveCurrentTo(
                                            n.dataItem
                                        ),
                                        t.refresh(!0));
                                });
                        ...
                        if (
                            (o.ctrlKey &&
                                ...
                                (67 !== o.keyCode && 45 != o.keyCode) ||
                                    (t.activeEditor &&
                                        ((t._copiedRanges = null),
                                        (t._copiedSheet = null)),
                                    (t._cutValue = null)),
                                88 === o.keyCode &&
                                    (t.activeEditor ||
                                        (t.finishEditing(),
                                        (n = new wjcGrid.CellRangeEventArgs(
                                            t.cells,
                                            t.selection
                                        )),
                                        t.onCopying(n) &&
                                ...
                                o.keyCode === wjcCore.Key.Space &&
                                    t.selection.isValid &&
                                    t.selectionMode ===
                                        wjcGrid.SelectionMode.CellRange &&
                                    t.select(
                                        new wjcGrid.CellRange(
                                            e.itemsSource ? 1 : 0,
                                            t.selection.col,
                            ...
                            switch (o.keyCode) {
                                ...
                                case wjcCore.Key.Enter:
                                    t.scrollIntoView(
                                        ...
                                        (r =
                                            t.selectedSheet.selectionRanges
                                                .length) > 0 &&
                        ...
                        function (e) {
                            (!t._isDescendant(t.hostElement, e.target) &&
                                ...
                                t._contextMenu.visible &&
                                    ...
                                    e.keyCode === wjcCore.Key.Up &&
                                        t._contextMenu.moveToPrev(),
                                    e.keyCode === wjcCore.Key.Home &&
                                        t._contextMenu.moveToFirst(),
                                    e.keyCode === wjcCore.Key.End &&
                                        t._contextMenu.moveToLast(),
            ...
            (t.prototype._addSheet = function (e, t, o, n, i) {
                ...
                return (
                    ...
                    "number" == typeof n
                        ? (n < 0 && (n = 0),
                          n >= r.sheets.length && (n = r.sheets.length))
                        : (n = r.sheets.length),
                    r.sheets.insert(n, l),
                    l
                );
            ...
            (t.prototype._showSheet = function (e) {
                !this.sheets ||
                    ...
                    this.sheets[e] &&
                        ((this._selectedSheetIndex = e),
                        this._copyFrom(this.sheets[e])),
                ...
                null == s ||
                    ...
                    (n = l.selectedSheet._styledCells[r])
                        ? ((n.className =
                          ...
                          (n.verticalAlign =
                              o.verticalAlign || n.verticalAlign),
                            ...
                            for (a = !0, i = s.topRow; i <= s.bottomRow; i++)
                                for (r = s.leftCol; r <= s.rightCol; r++)
                                    (l = i * this.columns.length + r),
                                        delete this.selectedSheet._mergedRanges[
                                            l
                                        ];
                return a;
            }),
                        ...
                        (l = r - o * this.columns.length),
                            ...
                            (a = this.selectedSheet._mergedRanges[r]) &&
                                (t <= a.topRow && t + o > a.bottomRow
                                    ...
                                    : this._updateCellMergeRangeForRow(
                                          a,
                                          t,
                                          o,
                                          c,
            ...
            (t.prototype._updateCellMergeRangeForRow = function (
                e,
                t,
                o,
                n,
                        ...
                        (r =
                            ...
                            (a = this.selectedSheet._mergedRanges[i]) &&
                                (t <= a.leftCol && t + o > a.rightCol
                                    ...
                                    : this._updateCellMergeRangeForColumn(
                                          a,
                                          t,
                                          o,
                                          e,
            ...
            (t.prototype._copyTo = function (e) {
                ...
                if (
                    ...
                    if (
                        ...
                        for (
                            e.grid.collectionView.sortDescriptions.clear(),
                                n = 0;
                ...
                e.grid.collectionView &&
                    (i._resetMappedColumns(e.grid),
                    e.grid.collectionView.endUpdate()),
                    e._setRowSettings(),
            ...
            (t.prototype._copyFrom = function (e, t) {
                ...
                if (
                    ...
                    for (n = 0; n < e.grid.rows.length; n++)
                        a.rows.push(e.grid.rows[n]);
                for (o = 0; o < e.grid.columns.length; o++)
                    ((l = e.grid.columns[o]).isRequired = !1),
                        a.columns.push(l);
                for (
                    a.collectionView &&
                        (navigator.userAgent.toLowerCase().indexOf("chrome") >
                            -1 && (a.collectionView.useStableSort = !0),
                        a._resetMappedColumns(a),
                        a.collectionView.endUpdate(),
                        a.collectionView.collectionChanged.addHandler(function (
                            e,
                            t
                        ) {
                            t.action ===
                                wjcCore.NotifyCollectionChangedAction.Reset &&
                                a.invalidate();
                        },
                        a)),
                        a.rows.length &&
                    ...
                    (r = e._rowSettings[n]) &&
                        ...
                        (s.visible = r.visible),
                        s instanceof wjcGrid.GroupRow &&
                            (s.isCollapsed = r.isCollapsed));
            ...
            (t.prototype._resetMappedColumns = function (e) {
                ...
                if (((e._mappedColumns = null), e.collectionView))
                    for (
                        o = e.collectionView.sortDescriptions;
                        n < o.length;
                        n++
                    )
                ...
                if (null != e.sheets && 0 !== e.sheets.length) {
                    for (
                        ...
                        if (
                            ...
                            wjcGridXlsx.FlexGridXlsxConverter.load(
                                r.selectedSheet.grid,
                                e,
                                { sheetIndex: i, includeColumnHeaders: !1 }
                            ),
                            (r.selectedSheet.name =
                                r.selectedSheet.grid.wj_sheetInfo.name),
                            ...
                            null !=
                                r.selectedSheet.grid.wj_sheetInfo.tableNames &&
                                r.selectedSheet.grid.wj_sheetInfo.tableNames
                                    .length > 0)
                        )
                            for (
                    ...
                    if (e.tables && e.tables.length > 0) {
                        ...
                        for (n = 0; n < e.tables.length; n++)
                            (r.selectedSheetIndex = r._getTableSheetIndex(
                                e.tables[n].name
                            )),
                                (s[n] = this._parseFromWorkbookTable(
                                    e.tables[n]
                                ));
            ...
            (t.prototype._saveToWorkbook = function () {
                    ...
                    n = this.sheets[0],
                        0 === this.selectedSheetIndex &&
                            ...
                            n.tableNames.length > 0 &&
                                (n.grid.wj_sheetInfo.tableNames =
                                    n.tableNames)),
                        n._setRowSettings(),
                ...
                if (this._tables && this._tables.length > 0)
                    for (r = 0; r < this._tables.length; r++)
                        e.tables.push(
                            this._parseToWorkbookTable(this._tables[r])
                        );
            ...
            (t.prototype._mouseDown = function (e) {
                ...
                if (
                    (this.selectedSheet &&
                        (this.selectedSheet._scrollPosition =
                            this.scrollPosition),
                    ...
                    return (
                        ...
                        this.onDraggingRowColumn(
                            new DraggingRowColumnEventArgs(
                                this._draggingRow,
                                e.shiftKey
                            )
                        ),
                ...
                if (
                    ...
                    if (
                        i.cellType === wjcGrid.CellType.RowHeader &&
                        3 === e.which
                    )
                        return (
            ...
            (t.prototype._showDraggingMarker = function (e) {
                ...
                if ((this.scrollIntoView(d.row, d.col), this._draggingColumn)) {
                    ...
                    (h =
                        ...
                        this._dropRange
                            ? ((this._dropRange.col = i),
                              (this._dropRange.col2 = i + n - 1))
                    ...
                    (l = (l = this.cells.width) > s ? s : l),
                        (h = i + 1 + " : " + (i + n)),
                        this._dropRange
                            ? ((this._dropRange.row = i),
                              (this._dropRange.row2 = i + n - 1))
                            : (this._dropRange = new wjcGrid.CellRange(
                                  i,
                                  0,
                                  i + n - 1,
                ...
                if (o) {
                    if (
                        ((c = {
                            ...
                            top:
                                o.top -
                                (this._draggingColumn ? this._ptScrl.y : 0) +
                                w.y,
                            left:
                                o.left -
                                (this._draggingRow ? this._ptScrl.x : 0) +
                                w.x,
                            height: r,
                            width: l,
                        }),
                        (o.top =
                            ...
                            (this._draggingColumn ? this._ptScrl.y : 0)),
                        (o.left =
                            o.left - (this._draggingRow ? this._ptScrl.x : 0)),
                        this.rightToLeft &&
                            this._draggingRow &&
                            ((c.left =
                                c.left - l + o.width + 2 * this._ptScrl.x),
                ...
                if (
                    ...
                    if (
                        ...
                        (a._draggingColumn &&
                            ...
                            (a._draggingRow &&
                                a._draggingCells.topRow > a._dropRange.topRow))
                    )
                        if (e.shiftKey) {
                            if (a._draggingColumn)
                                for (
                                    i = a._dropRange.leftCol,
                            ...
                            for (
                                ...
                                for (
                                    ...
                                    a._moveCellContent(t, o, n, i, e.ctrlKey),
                                        a._draggingColumn &&
                                            n === a._dropRange.topRow &&
                                            ((a.columns[i].dataType = a.columns[
                                                o
                                            ].dataType
                    ...
                    e.ctrlKey ||
                        ...
                        a._undoStack._pendingAction &&
                            ((a._undoStack._pendingAction._affectedFormulas =
                                l),
                            (a._undoStack._pendingAction._affectedDefinedNameVals =
                                s)),
            ...
            (t.prototype._moveCellContent = function (e, t, o, n, i) {
                ...
                if (
                    (i &&
                        ...
                        "string" == typeof d &&
                        "=" === d[0] &&
                        (r = this._updateCellRefForDropping(
                            d,
            ...
            (t.prototype._exchangeCellStyle = function (e) {
                ...
                if (e) {
                    if (this._draggingColumn)
                        for (
                            r =
                                this._draggingCells.rightCol -
                                this._draggingCells.leftCol +
                                1,
                            ...
                            for (t = 0; t < this.rows.length; t++)
                                (n = t * this.columns.length + o),
                                    ...
                                    this.selectedSheet._styledCells[n]
                                        ? ((this.selectedSheet._styledCells[i] =
                                              JSON.parse(
                                                  JSON.stringify(
                                                      this.selectedSheet
                                                          ._styledCells[n]
                        ...
                        for (
                            r =
                                this._draggingCells.bottomRow -
                                this._draggingCells.topRow +
                                1,
            ...
            (t.prototype._multiSelectColumns = function (e) {
                ...
                e &&
                    ...
                    (((t = new wjcGrid.CellRange(e.row, e.col)).row = this
                        .selectedSheet.itemsSource
                        ? 1
                        : 0),
            ...
            (t.prototype._checkHitWithinSelection = function (e) {
                ...
                if (null != e && e.cellType === wjcGrid.CellType.Cell) {
                    if (
                        ...
                        return !0;
                    if (
                        this.selection.row === e.row &&
                        this.selection.col === e.col
                    )
                        return !0;
                }
                return !1;
                    ...
                    if (
                        ...
                        for (
                            ...
                            if (
                                ((t = u[n]),
                                (o = new wjcGrid.CellRange()),
                                (d = new wjcGrid.CellEditEndingEventArgs(
                                    this.cells,
                                    o,
                                    e
                                )),
                                    ...
                                    (a = s[l]),
                                        (h = this._getTable(a)) &&
                                            ...
                                            this.selectedSheet.tableNames.splice(
                                                this.selectedSheet.tableNames.indexOf(
                                                    a
                                                ),
                                                1
                                            ));
            ...
            (t.prototype._isMultipleRowsSelected = function (e, t) {
                ...
                for (var i = 0; i < n.length; i++)
                    if (((o = n[i]), t)) {
                        if (
                            0 !== o.leftCol ||
                            o.rightCol !== t.grid.columns.length - 1
                        )
                            return !1;
                    } else if (
                        0 !== o.leftCol ||
                        o.rightCol !== this.columns.length - 1
                    )
                        return !1;
                return !0;
            }),
            (t.prototype._isMultipleColumnsSelected = function (e, t) {
                ...
                for (var i = 0; i < n.length; i++)
                    if (((o = n[i]), t)) {
                        ...
                        if (!this.selectedSheet.itemsSource && 0 !== o.topRow)
                            return !1;
                        if (this.selectedSheet.itemsSource && 1 !== o.topRow)
                            return !1;
                    }
                return !0;
            }),
                ...
                return (
                    ...
                    this.onPastingCell(a) &&
                        ...
                        ((h = e.match(/\n/g)) &&
                            ...
                            (this.rows[t].height =
                                this.rows.defaultSize * (h.length + 1))),
                        this.onPastedCell(a),
                        (c = !0)),
                    c
                );
                ...
                for (var h = 0; h < this.columns.length; h++)
                    if (
                        ...
                        for (var c = 0; c < n.length; c++)
                            (i = n[c]),
                                (s =
                                    (l = wjcXlsx.Workbook.tableAddress(i)).row +
                                    a) < 0
                                    ? (s = 0)
                                    : s >= this.rows.length &&
                                      (s = this.rows.length - 1),
                                (l.row = s),
            ...
            (t.prototype._updateNamedRangesForDropping = function () {
                ...
                for (e = 0; e < this.definedNames.length; e++)
                    (o = (t = this.definedNames[e]).value) &&
                        wjcCore.isString(o) &&
                        (n = this._updateCellRefForDropping(
                            o,
                            this.selectedSheetIndex
                        )) &&
                        ...
                        if (
                            ...
                            if (
                                ...
                                if (
                                    u &&
                                    u.toLowerCase() !==
                                        this.selectedSheet.name.toLowerCase()
                                )
                                    continue;
                            } else if (
                                !u ||
            ...
            (t.prototype._updateDefinedNameWithSheetRefUpdating = function (
                e,
                t
            ) {
            ...
            (t.prototype._copy = function (t, o) {
                ...
                if ("columns" == t) {
                    if (
                        ...
                        this.itemsSource &&
                            (n = this.rows[0]) instanceof HeaderRow)
                    ) {
                        (n._ubv = null), (n._ubv = {});
            ...
            (t.prototype._copyRowsToSelectedSheet = function () {
                ...
                if (t.selectedSheet) {
                    for (
                        t.selectedSheet.grid.rows.clear(), e = 0;
                        e < t.rows.length;
                        e++
                    )
            ...
            (t.prototype._parseFromWorkbookTableStyleElement = function (e) {
                ...
                return (
                    (t = {
                        ...
                        textDecoration:
                            e.font && e.font.underline ? "underline" : "none",
                        fontFamily:
                            e.font && e.font.family ? e.font.family : "",
                        fontSize:
                            e.font && e.font.size ? e.font.size + "px" : "",
                        color: e.font && e.font.color ? e.font.color : "",
                        backgroundColor:
                            e.fill && e.fill.color ? e.fill.color : "",
                    }),
                    e.borders &&
                        (e.borders.left &&
                        ...
                        e.borders.horizontal &&
                            ...
                            (t.borderHorizontalColor =
                                e.borders.horizontal.color))),
                ...
                (n.name = e.name),
                    ...
                    null != e.style &&
                        (e.style.isBuiltIn
                            ...
                            : (n.style = this._parseToWorkbookTableStyle(
                                  e.style
                              ))),
            ...
            (t.prototype._parseToWorkbookTableStyle = function (e) {
                ...
                return (
                    ...
                    null != e.firstBandedColumnStyle &&
                        (t.firstBandedColumnStyle =
                            this._parseToWorkbookTableStyleElement(
                                e.firstBandedColumnStyle,
                                !0
                            )),
                    null != e.firstBandedRowStyle &&
            ...
            (t.prototype._parseToWorkbookTableStyleElement = function (e, t) {
                void 0 === t && (t = !1);
                var o,
                    n = wjcGridXlsx.FlexGridXlsxConverter._parseCellStyle(
                        e,
                        !0
                    );
                return (
                    t
                        ? ((o = new wjcXlsx.WorkbookTableBandedStyle()).size =
                              e.size)
            ...
            (t.prototype._isBuiltInStyleName = function (e) {
                ...
                if (0 === e.search(/TableStyleLight/i)) {
                    if (
                        ((t = +e.substring(15)), !isNaN(t) && t >= 1 && t <= 21)
                    )
                        return !0;
                } else if (0 === e.search(/TableStyleMedium/i)) {
                    if (
                        ((t = +e.substring(16)), !isNaN(t) && t >= 1 && t <= 28)
                    )
                        return !0;
                } else if (
            ...
            (t.prototype._getTable = function (e) {
                ...
                for (var o = 0; o < this.tables.length; o++)
                    if (
                        (t = this.tables[o]).name.toLowerCase() ===
                        e.toLowerCase()
                    )
                        return t;
                return null;
            ...
            (t.prototype._addTable = function (e, t, o, n, i, r) {
                ...
                return (
                    ...
                    r
                        ? r.tableNames.push(t)
                        : this.selectedSheet.tableNames.push(t),
                    l
                );
            }),
                    ...
                    : ((s = t.childNodes[l]) &&
                          ((null != this.grid.editRange &&
                              ...
                              (this.grid.selectedSheet &&
                                  (h = this.grid.selectedSheet.findTable(
                                      o,
                                      n
                                  )) &&
                                  h._updateCell(o, n, s)),
...
var DefinedName = (function () {
    function e(e, t, o, n) {
        if (
            ((this._owner = e), (this._name = t), (this._value = o), null != n)
        ) {
    ...
    return (
        Object.defineProperty(e.prototype, "name", {
            ...
            set: function (e) {
                ...
                if (this._name !== e) {
                    if (
                        this._owner._checkExistDefinedName(
                            name,
                            this._sheetName
                        )
                    )
                        throw (
                            "The " + name + " already existed in definedNames."
                        );
                    (t = this._name),
                        (this._name = e),
                        this._owner._updateFormulasWithNameUpdating(
                            t,
                            this._name
                        );
                }
...
var Sheet = (function () {
    function e(e, t, o, n, i) {
        ...
        (r._owner = e),
            ...
            r._grid.itemsSourceChanged.addHandler(
                this._gridItemsSourceChanged,
                this
            ),
            r._addHeaderRow(),
                    ...
                    if (
                        ...
                        for (e = 0; e < r._owner.rows.length; e++)
                            e !== (t = r._owner.rows[e])._idx &&
                                r._owner._updateFormulaForReorderingRows(
                                    t._idx,
                                    e
                                );
    ...
    return (
        ...
        Object.defineProperty(e.prototype, "itemsSource", {
            ...
            set: function (e) {
                ...
                null == t._grid &&
                    (t._createGrid(),
                    t._grid.itemsSourceChanged.addHandler(
                        t._gridItemsSourceChanged,
                        t
                    )),
...
var SheetCollection = (function (e) {
    ...
    return (
        ...
        (t.prototype.splice = function (t, o, n) {
            ...
            return n
                ? ((i = n.name
                      ? this.getValidSheetName(n)
                      : this._getUniqueName()) !== n.name && (n.name = i),
        ...
        (t.prototype._moveCurrentTo = function (e) {
            ...
            if (this._current < o || 0 === o)
                ...
                for (; o >= 0 && !this[o].visible; ) o--;
            if (o === this.length)
                for (o = e; o >= 0 && !this[o].visible; ) o--;
            return (
                !(o < 0) &&
                (o !== this._current &&
        ...
        (t.prototype._postprocessSheet = function (e) {
            ...
            e.nameChanged.addHandler(function () {
                ...
                t.isValidSheetName(e) ||
                    e._setValidName(t.getValidSheetName(e)),
...
var _SheetTabs = (function (e) {
    function t(t, o, n) {
        ...
        return (
            ...
            (r._sheets = o.sheets),
            (r._rtl =
                "rtl" == getComputedStyle(r._owner.hostElement).direction),
    ...
    return (
        ...
        (t.prototype._sourceChanged = function (e, t) {
            void 0 === t &&
                (t = wjcCore.NotifyCollectionChangedEventArgs.reset);
            var o = t;
            switch (o.action) {
                ...
                case wjcCore.NotifyCollectionChangedAction.Remove:
                    this._tabContainer.removeChild(
                        this._tabContainer.children[o.index]
                    ),
        ...
        (t.prototype._initControl = function () {
            ...
            e.applyTemplate("", e.getTemplate(), {
                ...
                e._sheets.selectedSheetChanged.addHandler(
                    e._selectedSheetChanged,
                    e
                ),
        ...
        (t.prototype._updateTabShown = function (e, t) {
            t.index < 0 ||
                ...
                (t.item.visible
                    ? wjcCore.removeClass(
                          this._tabContainer.children[t.index],
                          "hidden"
                      )
                    : wjcCore.addClass(
                          this._tabContainer.children[t.index],
                ...
                switch (wjcGrid.FlexGrid._getRtlMode()) {
                    case "rev":
                        (t = -this._tabContainer.offsetLeft) +
                            ...
                            e.offsetWidth >
                        r + o
                            ? (this._tabContainer.parentElement.scrollLeft +=
                                  e.offsetWidth)
                            : t + e.offsetLeft < o &&
                              (this._tabContainer.parentElement.scrollLeft -=
                                  e.offsetWidth);
    ...
    return (
        ...
        (e.prototype.checkSortItemExists = function (e) {
            for (var t = 0, o = this._sortDescriptions.itemCount; t < o; t++)
                if (+this._sortDescriptions.items[t].columnIndex === e)
                    return t;
            return -1;
        }),
                ...
                if (
                    ...
                    for (
                        (c = this._owner.editableCollectionView) &&
                            ...
                            !1 === d &&
                                (r =
                                    this._owner.selectedSheet.grid
                                        .collectionView
                                        .sortDescriptions).clear(),
                            l = 0;
                        ...
                        (o = this._sortDescriptions.items[l]).columnIndex >
                            -1 &&
            ...
            if (this._owner.selectedSheet) {
                if (
                    ...
                    for (
                        ...
                        null !=
                            (t = this._owner.selectedSheet._unboundSortDesc[e])
                                .column &&
                            o.push(
                                new ColumnSortDescription(
                                    t.column.index,
    ...
    function e(e) {
        ...
        (t._owner = e),
            ...
            t._owner.resizingRow.addHandler(function (e, o) {
                t._resizingTriggered ||
                    ((t._pendingAction = new _RowResizeAction(
                        t._owner,
                        o.panel,
                        o.row
                    )),
            ...
            t._owner.draggingRowColumn.addHandler(function (e, o) {
                o.isShiftKey &&
                    (o.isDraggingRows
                        ...
                        : (t._pendingAction = new _ColumnsChangedAction(
                              t._owner
                          )));
            }, t),
    ...
    return (
        ...
        Object.defineProperty(e.prototype, "canRedo", {
            get: function () {
                return (
                    this._pointer + 1 > -1 &&
                    this._pointer + 1 < this._stack.length
                );
            },
            enumerable: !0,
            configurable: !0,
        ...
        (e.prototype._addAction = function (e) {
            this._stack.length > 0 &&
                ...
                this._stack.length >= this.MAX_STACK_SIZE &&
                    this._stack.splice(
                        0,
                        this._stack.length - this.MAX_STACK_SIZE + 1
                    ),
...
var Table = (function () {
    ...
    return (
        ...
        (e.prototype._moveDownCellsBelowTable = function () {
            var e, t, o, n, i;
            for (
                e = this._owner.rows.length - 2;
                e > this._range.bottomRow;
                e--
            )
                for (t = this._range.leftCol; t <= this._range.rightCol; t++)
                    (o = this._owner.getCellData(e, t, !1)),
        ...
        (e.prototype._moveUpCellsBelowTable = function () {
            var e, t, o, n, i;
            for (
                e = this._range.bottomRow + 1;
                e < this._owner.rows.length;
                e++
            )
                for (t = this._range.leftCol; t <= this._range.rightCol; t++)
                    (o = this._owner.getCellData(e, t, !1)),
        ...
        (e.prototype._checkColumnNameExist = function (e) {
            ...
            for (t = 0; t < this.columns.length; t++)
                if (this.columns[t].name.toLowerCase() === e.toLowerCase())
                    return !0;
            return !1;
        }),
            ...
            if (this.showTotalRow)
                for (var n = 0; n < this._columns.length; n++)
                    (o = (e = this._columns[n]).totalRowFunction
                        ? null !=
                          (t = this._getSubtotalFunction(
                              e.totalRowFunction.toLowerCase()
                          ))
                            ? "=subtotal(" + t + ", [" + e.name + "])"
        ...
        (t.prototype.apply = function (e) {
            ...
            "" === (t = r.getCellValue(e, i.index)) &&
                ...
                i.dataMap
                    ...
                    : wjcCore.isDate(t)
                    ? (wjcCore.isString(l.value) ||
                          wjcCore.isString(s.value)) &&
                      (o = n = t = r.getCellValue(e, i.index, !0))
                    : wjcCore.isNumber(t) &&
                      ((o =
                          n =
                          t =
                              wjcCore.Globalize.parseFloat(
                                  r.getCellValue(e, i.index, !0)
                              )),
                      0 !== t ||
                          i.dataType ||
...
var _FlexSheetColumnFilterEditor = (function (e) {
    ...
    return (
        ...
        (t.prototype.cloneElement = function (e) {
            for (var t = e.cloneNode(); e.firstChild; )
                t.appendChild(e.lastChild);
            return t;
        }),
        t
    );
                            ...
                            case "condition":
                                ...
                                (l.condition1.value =
                                    i.dataType == wjcCore.DataType.Date
                                        ...
                                        : n.condition1.value),
                                    (l.condition1.operator =
                                        n.condition1.operator),
                                    (l.and = n.and),
                                    (l.condition2.value =
                                        i.dataType == wjcCore.DataType.Date
                                            ? wjcCore.changeType(
                                            ...
                                            : n.condition2.value),
                                    (l.condition2.operator =
                                        n.condition2.operator);
                                break;
                            case "value":
                                var s = r.valueFilter;
                                (s.filterText = n.filterText),
                                    (s.showValues = n.showValues);
                        }
                }
                this.apply();
            },
                    ...
                    if (!((t = e.grid.rows[r]) instanceof HeaderRow || r <= i))
                        if (
                            ...
                            if (
                                ((n = t.getCellRange()),
                                null == t.dataItem ||
                                    t.dataItem instanceof
                                        wjcCore.CollectionViewGroup)
                            )
                                t.visible = e._checkGroupVisible(n);
                            else if (
                                ((t.visible = o), (i = n.bottomRow), n.isValid)
                            )
                                for (var l = n.topRow; l <= n.bottomRow; l++)
                                    e.grid.rows[l].visible = o;
                        } else t.visible = o;
                e.grid._isCopying ||
                    e.grid._resettingFilter ||
                    e.onFilterApplied();
            });
        }),
        (t.prototype.editColumnFilter = function (e, t) {
            ...
            if ((o.onFilterChanging(n), !n.cancel)) {
                ...
                var i = document.createElement("div"),
                    ...
                    l = new _FlexSheetColumnFilterEditor(
                        i,
                        r,
                        o.showSortButtons
                    );

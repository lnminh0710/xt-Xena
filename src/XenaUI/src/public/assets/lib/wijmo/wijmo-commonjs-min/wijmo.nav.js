...
var TreeView = (function (e) {
    ...
    return (
        ...
        Object.defineProperty(t.prototype, "childItemsPath", {
            ...
            set: function (e) {
                e != this.childItemsPath &&
                    ((this._itmPath.path = e), this._reload());
            },
            enumerable: !0,
            configurable: !0,
        }),
        ...
        Object.defineProperty(t.prototype, "imageMemberPath", {
            ...
            set: function (e) {
                e != this.imageMemberPath &&
                    ((this._imgPath.path = e), this._reload());
            },
            enumerable: !0,
            configurable: !0,
        }),
        ...
        Object.defineProperty(t.prototype, "allowDragging", {
            ...
            set: function (e) {
                if (e != this.allowDragging) {
                    ...
                    for (
                        var r = this.hostElement.querySelectorAll("." + t._CND),
                            n = 0;
                        n < r.length;
                        n++
                    ) {
        ...
        (t.prototype.getLastNode = function (e, r) {
            var n = this.hostElement.querySelectorAll(
                    "." + t._CND + ":last-child"
                ),
            ...
            if (!e.defaultPrevented) {
                ...
                if (n) {
                    ...
                    if (
                        ...
                        (this.rightToLeft
                            ? l.right - e.clientX
                            : e.clientX - l.left) <= s.offsetHeight
                            ? (a
                                  ? this.collapseToLevel(
                                        i.isCollapsed ? i.level + 1 : i.level
                                    )
        ...
        (t.prototype._keypress = function (e) {
            ...
            if (!e.defaultPrevented) {
                ...
                if (e.charCode > 32 || (32 == e.charCode && this._srch)) {
                    e.preventDefault(),
                        (this._srch += String.fromCharCode(
                            e.charCode
                        ).toLowerCase()),
        ...
        (t.prototype._loadTree = function (e) {
            ...
            if (r) {
                ...
                if (e && wjcCore.isFunction(window.Map)) {
                    o = new Map();
                    for (
                        var s = this.hostElement.querySelectorAll("." + t._CND),
                            a = 0;
                        a < s.length;
                        a++
                    ) {
                        l = s[a];
                        wjcCore.hasClass(l, t._CCLD) &&
                            o.set(l[t._DATAITEM_KEY], !0);
                    }
                }
            ...
            if (
                ...
                if (
                    (r > this._ldLvl
                        ? ((this._ldLvl = r),
                          0 == s.length &&
                              (wjcCore.addClass(a, t._CCLD), (c = !1)))
...
var TreeNode = (function () {
    ...
    return (
        ...
        (e.prototype.ensureVisible = function () {
            for (var e = this.parentNode; e; e = e.parentNode)
                e.isCollapsed = !1;
        ...
        Object.defineProperty(e.prototype, "index", {
            get: function () {
                for (
                    var t = 0, r = this._pse(this.element);
                    r;
                    r = this._pse(r)
                )
                    e._isNode(r) && t++;
        ...
        Object.defineProperty(e.prototype, "isCollapsed", {
            get: function () {
                return (
                    this.hasChildren &&
                    wjcCore.hasClass(this._e, TreeView._CCLD)
                );
            },
            set: function (e) {
        ...
        (e.prototype.previous = function (t, r) {
            ...
            if (
                ...
                for (; e._isNodeList(n) && n.childElementCount; )
                    n = n.lastChild;
        ...
        (e.prototype.previousSibling = function () {
            ...
            return (
                e._isNodeList(t) && (t = this._pse(t)),
                t ? new e(this._t, t) : null
            );
        }),
        (e.prototype.nextSibling = function () {
            var t = this.element.nextSibling;
            return (
                e._isNodeList(t) && (t = t.nextSibling),
                t ? new e(this._t, t) : null
            );
        }),
        ...
        (e._isCollapsed = function (t) {
            return (
                e._isNode(t) &&
                !e._isEmpty(t) &&
                wjcCore.hasClass(t, TreeView._CCLD)
            );
        }),
...
var FormatNodeEventArgs = (function (e) {
    function t(t, r, n) {
        ...
        return (
            (i._data = t),
            (i._e = wjcCore.asType(r, HTMLElement)),
            (i._level = n),
            i
        );
    }
...
var _TreeDragDropManager = (function () {
    ...
    return (
        ...
        (e.prototype._handleDragDrop = function (t, r) {
            ...
            if (!t.defaultPrevented && s._drgSrc) {
                ...
                if ((h == s._drgSrc.element && (h = null), h)) {
                    ...
                    null == u.element
                        ? ((i = wjcCore.Rect.fromBoundingRect(i)).inflate(
                              -12,
                              -12
                          ),
                          (l = a.Before))
                        ...
                        s._drgSrc._contains(u)
                            ? (h = null)
                            : (((n = new TreeNodeDragDropEventArgs(
                                  s._drgSrc,
                                  u,
                                  l
                              )).cancel = s._drgSrc.treeView != u.treeView),
        ...
        (e.prototype._showDragMarker = function (t, r) {
            ...
            if (t) {
                var o = n.hostElement.getBoundingClientRect(),
                    ...
                    a = {
                        top: Math.round(
                            s - o.top + n.hostElement.scrollTop - 2
                        ),
                        width: "75%",
        ...
        (e._dMarker = wjcCore.createElement(
    ...
    return (
        Object.defineProperty(e.prototype, "path", {
            ...
            set: function (e) {
                ...
                this._maxLevel = this._bindings
                    ? this._bindings.length - 1
                    : -1;
            },
            enumerable: !0,
            configurable: !0,

...
var Gauge = (function (t) {
    function e(i, n) {
        ...
        return (
            ...
            r.addEventListener(o, "mousedown", function (t) {
                0 == t.button &&
                    (r.focus(), (r._dragging = !0), r._applyMouseValue(t));
            }),
    ...
    return (
        ...
        Object.defineProperty(e.prototype, "value", {
            ...
            set: function (t) {
                t != this.value &&
                    ((this._pointer.max = wjcCore.asNumber(t, !0)),
                    this._updateAria());
            },
            enumerable: !0,
            configurable: !0,
        ...
        Object.defineProperty(e.prototype, "min", {
            ...
            set: function (t) {
                t != this.min &&
                    ((this._face.min = wjcCore.asNumber(t)),
                    this._updateAria());
            },
            enumerable: !0,
            configurable: !0,
        ...
        Object.defineProperty(e.prototype, "max", {
            ...
            set: function (t) {
                t != this.max &&
                    ((this._face.max = wjcCore.asNumber(t)),
                    this._updateAria());
            },
            enumerable: !0,
            configurable: !0,
        ...
        Object.defineProperty(e.prototype, "getText", {
            ...
            set: function (t) {
                t != this._getText &&
                    ((this._getText = wjcCore.asFunction(t)),
                    this.invalidate());
            },
            enumerable: !0,
            configurable: !0,
        ...
        Object.defineProperty(e.prototype, "face", {
            ...
            set: function (t) {
                t != this._face &&
                    (this._face &&
                        this._face.propertyChanged.removeHandler(
                            this._rangeChanged
                        ),
                    (this._face = wjcCore.asType(t, Range)),
                    this._face &&
                        this._face.propertyChanged.addHandler(
                            this._rangeChanged,
                            this
                        ),
                    this.invalidate());
        ...
        Object.defineProperty(e.prototype, "pointer", {
            ...
            set: function (t) {
                if (t != this._pointer) {
                    ...
                    this._pointer &&
                        ((e = this.value),
                        this._pointer.propertyChanged.removeHandler(
                            this._rangeChanged
                        )),
        ...
        Object.defineProperty(e.prototype, "showText", {
            ...
            set: function (t) {
                t != this._showText &&
                    ((this._showText = wjcCore.asEnum(t, ShowText)),
                    this.invalidate());
            },
            enumerable: !0,
            configurable: !0,
        ...
        Object.defineProperty(e.prototype, "showTicks", {
            ...
            set: function (t) {
                t != this._showTicks &&
                    ((this._showTicks = wjcCore.asBoolean(t)),
                    this.invalidate());
            },
            enumerable: !0,
            configurable: !0,
        ...
        Object.defineProperty(e.prototype, "tickSpacing", {
            ...
            set: function (t) {
                t != this._tickSpacing &&
                    ((this._tickSpacing = wjcCore.asNumber(t, !0)),
                    this.invalidate());
            },
            enumerable: !0,
            configurable: !0,
        ...
        Object.defineProperty(e.prototype, "thumbSize", {
            ...
            set: function (t) {
                t != this._thumbSize &&
                    ((this._thumbSize = wjcCore.asNumber(t, !0, !0)),
                    this.invalidate());
            },
            enumerable: !0,
            configurable: !0,
        ...
        (e.prototype.refresh = function (e) {
            if (
                ...
                this._rangesDirty = !1;
                for (
                    var i = this._gRanges, n = 0;
                    n < this._rngElements.length;
                    n++
                )
        ...
        (e.prototype.hitTest = function (t, e) {
            ...
            var i = wjcCore.Rect.fromBoundingRect(
            ...
            if (
                ...
                if (
                    ...
                    this._animInterval = wjcCore.animate(function (n) {
                        (i._animColor =
                            o && s
                                ? wjcCore.Color.interpolate(o, s, n).toString()
                                : null),
                            i._updateRange(
                                t,
                                e.oldValue + n * (e.newValue - e.oldValue)
                            ),
                            n >= 1 &&
                                ((i._animColor = null),
        ...
        (e.prototype._centerText = function (t, i, n) {
            if ("none" != t.getAttribute("display")) {
                ...
                var s = wjcCore.Rect.fromBoundingRect(e._getBBox(t)),
                    a = n.x - s.width / 2,
                    h = n.y + s.height / 4;
                t.setAttribute("x", this._fix(a)),
                    t.setAttribute("y", this._fix(h));
            }
        }),
            ...
            if (!this.isReadOnly && this.containsFocus()) {
                ...
                if (null != i) {
                    ...
                    return (
                        e && (this._animated = !1),
                        null != this._step &&
                            (i = Math.round(i / this._step) * this._step),
...
var LinearGauge = (function (t) {
    ...
    return (
        ...
        (e.prototype._updateRangeElement = function (t, e, i) {
            ...
            if (
                (r &&
                    this._centerText(this._tValue, i, new wjcCore.Point(s, a)),
                r || o)
            ) {
        ...
        (e.prototype._updateTicks = function () {
            ...
            if (this.showTicks && t > 0)
                for (
                    var i = this._getRangeRect(this._face),
                        n = void 0,
                        r = this.min + t;
                    r < this.max;
                    r += t
                    ...
                    switch (this._getDirection()) {
                        case GaugeDirection.Right:
                            e +=
                                "M " +
                                (n = this._fix(
                                    i.left + i.width * this._getPercent(r)
                                )) +
                                " " +
                                this._fix(i.top) +
                                " L " +
                        ...
                        case GaugeDirection.Left:
                            e +=
                                "M " +
                                (n = this._fix(
                                    i.right - i.width * this._getPercent(r)
                                )) +
                                " " +
                                i.top.toFixed(2) +
                                " L " +
        ...
        (e.prototype._getRangeRect = function (t, e) {
            ...
            switch (this._getDirection()) {
                ...
                case GaugeDirection.Down:
                    ...
                    break;
                case GaugeDirection.Up:
                    (i.top = i.bottom - i.height * a),
                        (i.height = i.height * (a - s));
            }
            return i;
        }),
        (e.prototype._getValueFromPoint = function (t) {
...
var RadialGauge = (function (t) {
    ...
    return (
        ...
        Object.defineProperty(e.prototype, "autoScale", {
            ...
            set: function (t) {
                t != this._autoScale &&
                    ((this._autoScale = wjcCore.asBoolean(t)),
                    this.invalidate());
            },
            enumerable: !0,
            configurable: !0,
        ...
        (e.prototype.refresh = function (e) {
            if (
                ...
                var i = wjcCore.Rect.fromBoundingRect(
                    Gauge._getBBox(this._pFace)
                );
                0 != (this.showText & ShowText.Value) &&
                    (i = wjcCore.Rect.union(
                        i,
                        wjcCore.Rect.fromBoundingRect(
                            Gauge._getBBox(this._tValue)
                        )
                    )),
                    0 != (this.showText & ShowText.MinMax) &&
                        ((i = wjcCore.Rect.union(
                            i,
                            wjcCore.Rect.fromBoundingRect(
                                Gauge._getBBox(this._tMin)
                            )
                        )),
                        (i = wjcCore.Rect.union(
                            i,
                            wjcCore.Rect.fromBoundingRect(
                                Gauge._getBBox(this._tMax)
                            )
                        )));
                var n = [
                    this._fix(i.left),
            ...
            if (this.showTicks && t > 0)
                for (
                    ...
                    var u =
                        this.startAngle +
                        180 +
                        this.sweepAngle * this._getPercent(c);
                    e +=
                        "M " +
    ...
    return (
        ...
        Object.defineProperty(t.prototype, "thickness", {
            ...
            set: function (t) {
                this._setProp(
                    "_thickness",
                    wjcCore.clamp(wjcCore.asNumber(t), 0, 1)
                );
            },
            enumerable: !0,
            configurable: !0,

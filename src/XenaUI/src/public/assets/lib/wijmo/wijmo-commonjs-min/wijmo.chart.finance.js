    ...
    return (
        ...
        (e.prototype._getValues = function () {
            ...
            switch (this.fields) {
                ...
                case DataFields.HL2:
                    for (t = 0; t < a; t++)
                        e.push(_average(this.highs[t], this.lows[t]));
                    break;
                ...
                if (
                    ...
                    ((u =
                        this._trendExists(i) || 1 === this.size
                            ? i[0]
                                  .slice(-this.size)
                                  .concat(i[1].slice(-this.size))
                            : i[0]
                                  .slice(1 - this.size)
                                  .concat(i[1].slice(1 - this.size))),
    ...
    return (
        ...
        (e.prototype.calculate = function () {
            ...
            for (var s, o, l, h, c, u, _, g, p, d, f = 1; f < e; f++) {
                ...
                if (
                    (this.unit === RangeMode.Percentage && (t = l * this.size),
                    -1 === c)
                ) {
                    if (
                        ((o = i ? this.xs[0] : 0),
...
var _HeikinAshiPlotter = (function (t) {
    ...
    return (
        ...
        (e.prototype._drawSymbol = function (
            ...
            if (
                ((C = e.convert(o - w * s)), (m = e.convert(o + w * s)), C > m)
            ) {
                var y = C;
                (C = m), (m = y);
            }
        ...
        (e.prototype._calculate = function (t) {
            ...
            (this._calculator = new _HeikinAshiCalculator(e, a, i, r)),
                ...
                (null === this._haValues ||
                    wjcCore.isUndefined(this._haValues)) &&
                    this._init();
        }),
    ...
    return (
        ...
        (e.prototype.plotSeries = function (t, e, a, i, r, n, s) {
            ...
            for (var m, w, y, v, x = 0, j = 0; j < h; j++)
                if (
                    ((m = j), wjcChart._DataInfo.isValid(m) && c <= m && m <= u)
                ) {
                    if (
            ...
            this._rangeValues.forEach(function (t, n) {
                ...
                (e =
                    r === wjcCore.DataType.Date
                        ...
                        ? i._formatValue(s)
                        : (null !== r && r !== wjcCore.DataType.String) ||
                          !a.chart._xlabels
                        ? s.toString()
                        : a.chart._xlabels[s]),
    ...
    return (
        ...
        (e.prototype._init = function () {
            t.prototype._init.call(this),
                ...
                (this._rangeMode = wjcCore.asEnum(
                    this._rangeMode,
                    RangeMode,
                    !0
                )),
                ...
                (this._fields =
                    this.getOption("fields", "renko") || DataFields.Close),
        ...
        (e.prototype._generateXLabels = function (e) {
            ...
            t.prototype._generateXLabels.call(this, e),
                this._rangeXLabels.forEach(function (t, e) {
                    e > 0 &&
                        a._rangeXLabels[e - 1]._text === t.text &&
                        (t.text = "");
                }, this);
        }),
        e
    ...
    return (
        ...
        (e.prototype._init = function () {
            t.prototype._init.call(this),
                ...
                (this._fields =
                    this.getOption("fields", "kagi") || DataFields.Close),
                (this._fields = wjcCore.asEnum(this._fields, DataFields, !0));
        }),
        (e.prototype.clear = function () {
            t.prototype.clear.call(this),
...
var _PointAndFigurePlotter = (function (t) {
    ...
    return (
        ...
        (e.prototype._init = function () {
            (this._boxSize =
                this.getNumOption("boxSize", "pointAndFigure") || 1),
                (this._reversal =
                    this.getNumOption("reversal", "pointAndFigure") || 3),
                (this._period =
                    this.getNumOption("period", "pointAndFigure") || 20),
                (this._fields =
                    this.getOption("fields", "pointAndFigure") ||
                    DataFields.Close),
                (this._fields = wjcCore.asEnum(this._fields, DataFields, !0)),
                wjcCore.assert(
        ...
        (e.prototype.calcPFHiLo2 = function (t, e, a, i, r, n) {
            for (var s = [], o = 0; o < t.length; o++) {
                ...
                wjcCore.assert(
                    l >= h,
                    "'High' value must be larger than 'low' value."
                );
                var c = t[o][i];
                if (0 == s.length)
                    s.push({
                        ...
                        if (
                            ...
                            (d.y = p),
                                ...
                                wjcCore.isDate(l.date) &&
                                    ((d.x = l.date),
                                    (d.xfmt = wjcCore.Globalize.formatDate(
                                        l.date,
                                        "d"
                                    )));

...
var DropDown = (function (e) {
  ...
  return (
    ...
    Object.defineProperty(t.prototype, 'isDroppedDown', {
      ...
      set: function (e) {
        if (
          (e = wjcCore.asBoolean(e) && !this.isDisabled && !this.isReadOnly) !=
            this.isDroppedDown &&
          ...
          if (e)
            i.style.minWidth ||
              (i.style.minWidth = t.getBoundingClientRect().width + 'px'),
          ...
          this._updateFocusState(),
            wjcCore.toggleClass(t, 'wj-state-collapsed', !this.isDroppedDown),
    ...
    (t.prototype._setText = function (e, t) {
      null == e && (e = ''),
        ...
        e != this._oldText && ((this._oldText = e), this.onTextChanged());
    }),
...
var Calendar = (function (e) {
  ...
  return (
        ...
        (e = wjcCore.asDate(e, !0)),
          ...
          this._valid(e) &&
            ...
            wjcCore.DateTime.equals(this._value, e) ||
              ((this._value = e), this.invalidate(!1), this.onValueChanged()));
      },
      enumerable: !0,
      configurable: !0,
    }),
    Object.defineProperty(t.prototype, 'min', {
      ...
      set: function (e) {
        e != this.min && ((this._min = wjcCore.asDate(e, !0)), this.refresh());
      },
      enumerable: !0,
      configurable: !0,
    }),
    Object.defineProperty(t.prototype, 'max', {
      ...
      set: function (e) {
        e != this.max && ((this._max = wjcCore.asDate(e, !0)), this.refresh());
      },
      enumerable: !0,
      configurable: !0,
    }),
    ...
    Object.defineProperty(t.prototype, 'formatDayHeaders', {
      ...
      set: function (e) {
        e != this._fmtDayHdr &&
          ((this._fmtDayHdr = wjcCore.asString(e)), this.invalidate());
      },
      enumerable: !0,
      configurable: !0,
    }),
    ...
    Object.defineProperty(t.prototype, 'formatMonths', {
      ...
      set: function (e) {
        e != this._fmtMonths &&
          ((this._fmtMonths = wjcCore.asString(e)), this.invalidate());
      },
      enumerable: !0,
      configurable: !0,
    }),
    ...
    Object.defineProperty(t.prototype, 'itemFormatter', {
      ...
      set: function (e) {
        e != this._itemFormatter &&
          ((this._itemFormatter = wjcCore.asFunction(e)), this.invalidate());
      },
      enumerable: !0,
      configurable: !0,
    }),
    ...
    (t.prototype.refresh = function (t) {
      ...
      for (h = 0; h < 7 && h < i.length; h++)
        (n = wjcCore.DateTime.addDays(this._firstDay, h)),
          wjcCore.setText(i[h], wjcCore.Globalize.format(n, this._fmtDayHdr));
      for (h = 7; h < i.length; h++) {
        (o = i[h]),
          (n = wjcCore.DateTime.addDays(this._firstDay, h - 7)),
          wjcCore.setText(o, wjcCore.Globalize.format(n, this._fmtDay));
        var a = !this._valid(n);
        if (
          ...
          wjcCore.toggleClass(
            o,
            'wj-state-selected',
            this._selMode && wjcCore.DateTime.sameDate(n, this.value)
          ),
          wjcCore.toggleClass(
            o,
            'wj-day-today',
          ...
          wjcCore.toggleClass(
            o,
            'wj-day-othermonth',
            a || n.getMonth() != s.getMonth() || !this._inValidRange(n)
          ),
      ...
      c.length &&
        ...
        (i = this._tbYr.querySelectorAll('td')).length &&
          wjcCore.setText(i[0], wjcCore.Globalize.format(s, this._fmtYr));
      for (var h = 1; h < i.length; h++)
        (o = i[h]),
          (n = wjcCore.DateTime.newDate(s.getFullYear(), h - 1, 1)),
          wjcCore.setText(o, wjcCore.Globalize.format(n, this._fmtMonths)),
          (o.className = ''),
          wjcCore.toggleClass(
            o,
            'wj-state-disabled',
    ...
    (t.prototype._createChildren = function () {
      ...
      for (
        var t = this._createElement('tr', this._tbMth, 'wj-header'), i = 0;
        i < 7;
        i++
      )
    ...
    (t.prototype._click = function (e) {
      ...
      if (
        (wjcCore.contains(this._btnMth, i) && !this._monthMode()
          ...
          ? (this._navigate(1), (t = !0))
          : wjcCore.contains(this._btnTdy, i) && (this._navigate(0), (t = !0)),
        ...
        if (this.monthView) {
          if (
            ...
            this._inValidRange(n) && this._valid(n) && (this.value = n),
              (t = !0);
          }
        } else {
        ...
        if (!(e.ctrlKey || e.metaKey || e.shiftKey)) {
          ...
          if (this.value && this._canChangeValue() && (t || i)) {
            ...
            for (var s = 0; !this._valid(n) && s < 31; s++)
              n = wjcCore.DateTime.addDays(n, t > 0 || i > 0 ? 1 : -1);
            this.value = n;
          }
          o && e.preventDefault();
        }
  ...
  return (
    ...
    (t.prototype._mouseDown = function (e) {
      (this._htDown = this._getTargetPanel(e)),
        this._htDown && (e.preventDefault(), this.focus(), this._mouseMove(e));
    }),
    ...
    (t.prototype._updatePalette = function () {
      ...
      for (var i = 0; i < this._palette.length; i++) {
        ...
        for (var r = 0; r < 5; r++) {
          ...
          } else n = wjcCore.Color.fromHsb(s[0], 0.1 + 0.2 * r, 1 - 0.1 * r);
    ...
    (t.prototype._updatePanels = function () {
      var e = wjcCore.Color.fromHsb(this._hsb[0], 1, 1, 1),
        t = wjcCore.Color.fromHsb(this._hsb[0], this._hsb[1], this._hsb[2], 1);
...
var ListBox = (function (e) {
      ...
      o.addEventListener(n, 'wheel', function (e) {
        n.scrollHeight > n.offsetHeight &&
          ((e.deltaY < 0 && 0 == n.scrollTop) ||
            (e.deltaY > 0 && n.scrollTop + n.offsetHeight >= n.scrollHeight)) &&
  ...
  return (
    ...
    Object.defineProperty(t.prototype, 'itemFormatter', {
      ...
      set: function (e) {
        e != this._itemFormatter &&
          ((this._itemFormatter = wjcCore.asFunction(e)), this._populateList());
      },
      enumerable: !0,
      configurable: !0,
    }),
    ...
    Object.defineProperty(t.prototype, 'itemRole', {
      ...
      set: function (e) {
        e != this.itemRole &&
          ((this._itemRole = wjcCore.asString(e)), this._populateList());
      },
      enumerable: !0,
      configurable: !0,
    }),
    ...
    Object.defineProperty(t.prototype, 'selectedValue', {
      get: function () {
        ...
        return (
          e && this.selectedValuePath && (e = this._pathValue.getValue(e)), e
        );
      },
      set: function (e) {
    ...
    (t.prototype.showSelection = function () {
      for (
        ...
        (e = o[n]),
          ...
          wjcCore.setAttribute(e, 'tabindex', n == t ? this._tabIndex : -1);
      if (t > -1 && t < o.length) {
      ...
      t > -1 &&
        ...
        e.focus(),
        wjcCore.setAttribute(i, 'tabindex', t < 0 ? this._tabIndex : -1);
    }),
    ...
    (t.prototype._setItemChecked = function (e, t, i) {
      ...
      if (wjcCore.isObject(o)) {
        ...
        this._pathChecked.getValue(o) != t &&
          ((this._checking = !0),
          n
            ? (n.editItem(o), this._pathChecked.setValue(o, t), n.commitEdit())
            : (this._pathChecked.setValue(o, t), this._cv.refresh()),
          (this._checking = !1));
      }
    ...
    (t.prototype._populateList = function () {
      ...
      if (e) {
          ...
          for (
            ...
            this.checkedMemberPath &&
              (n =
                ...
                ((s = this._pathChecked.getValue(this._cv.items[o]))
                  ? ' checked'
                  : '') +
                '> ' +
                n +
            ...
            if (
              ...
              var l = new FormatItemEventArgs(o, this._cv.items[o], r);
              this.onFormatItem(l);
            }
            i.appendChild(r);
          }
        ...
        0 == e.children.length && e.appendChild(document.createElement('div')),
    ...
    (t.prototype._click = function (e) {
      if (!e.defaultPrevented) {
        for (var t = this.hostElement.children, i = 0; i < t.length; i++)
        ...
        if (this.checkedMemberPath && o > -1) {
          ...
          n == e.target && (t[o].focus(), this.setItemChecked(o, n.checked));
        }
      }
    }),
    (t.prototype._keydown = function (e) {
            ...
            case wjcCore.Key.Space:
              if (this.checkedMemberPath && t > -1) {
                ...
                i &&
                  ...
                  (this.setItemChecked(t, !i.checked), e.preventDefault());
              }
          }
      }
    }),
    ...
    (t.prototype._selectNext = function () {
      for (
        var e = this.hostElement.children.length, t = this.selectedIndex + 1;
        t < e;
        t++
      )
  ...
  return (
    ...
    (t.prototype.getDisplayText = function (e) {
      if (
        ...
        this.headerPath && e > -1 && wjcCore.hasItems(this.collectionView))
      ) {
    ...
    (t.prototype.onLostFocus = function (t) {
      this._composing && ((this._composing = !1), this._setText(this.text, !0)),
        this.isEditable &&
          this.isRequired &&
          !this.text &&
          wjcCore.hasItems(this.collectionView) &&
    ...
    (t.prototype._updateBtn = function () {
      ...
      (this._btn.style.display = this._showBtn && null != e ? '' : 'none'),
    ...
    (t.prototype._setText = function (t, i) {
      if (!this._composing && !this._settingText) {
        (this._settingText = !0), null == t && (t = ''), (t = t.toString());
        var o = this.selectedIndex,
        ...
        if (
          ...
          a &&
            ...
            o < 0 && s > 0 && (o = this.indexOf(t.substr(0, s), !1))),
          o < 0 &&
            !this.isEditable &&
            wjcCore.hasItems(n) &&
            (this.isRequired || t))
        ...
        for (
          ...
          if (
            ...
            (n = this.getDisplayText(o).toLowerCase()) &&
              0 == n.indexOf(e) &&
              (!this.dropDown.children[o] || this.listBox.isItemEnabled(o)))
          )
            return o;
      }
    ...
    (t.prototype._updateInputSelection = function (e) {
      this._elRef == this._tbx && this._setSelRange(e, this._tbx.value.length);
    }),
...
var AutoComplete = (function (e) {
  ...
  return (
    ...
    (t.prototype._getItemText = function (e, t) {
      ...
      return o && (i = null != (i = o.getValue(e)) ? i.toString() : ''), i;
    }),
  ...
  return (
    ...
    (t.prototype.show = function (e) {
      if (!this.isDroppedDown) {
        ...
        (this.selectedIndex = -1),
          this.onIsDroppedDownChanging(new wjcCore.CancelEventArgs()) &&
            (this.owner && (t[wjcCore.Control._OWNR_KEY] = this.owner),
    ...
    (t.prototype.hide = function () {
      this.isDroppedDown &&
        this.onIsDroppedDownChanging(new wjcCore.CancelEventArgs()) &&
        (wjcCore.hidePopup(this.dropDown), this.onIsDroppedDownChanged());
    }),
    ...
    (t.prototype._enableDisableItems = function () {
      if (this.collectionView && (this.command || this.commandPath))
        for (var e = this.collectionView.items, t = 0; t < e.length; t++) {
...
var MultiSelect = (function (e) {
    ...
    return (
      ...
      o.addEventListener(o._selectAll, 'click', function (e) {
        wjcCore.hasItems(o.collectionView) &&
          ...
          (o.checkedItems = e.target.checked ? o.collectionView.items : []);
      }),
  ...
  return (
    ...
    Object.defineProperty(t.prototype, 'showSelectAllCheckbox', {
      ...
      set: function (e) {
        this._selectAll.style.display = wjcCore.asBoolean(e) ? '' : 'none';
      },
      enumerable: !0,
      configurable: !0,
    }),
    Object.defineProperty(t.prototype, 'selectAllLabel', {
      ...
      set: function (e) {
        e != this._selectAllLabel &&
          ((this._selectAllLabel = wjcCore.asString(e)), this.refresh());
      },
      enumerable: !0,
      configurable: !0,
    }),
    ...
    Object.defineProperty(t.prototype, 'maxHeaderItems', {
      ...
      set: function (e) {
        this._maxHdrItems != e &&
          ((this._maxHdrItems = wjcCore.asNumber(e)), this._updateHeader());
      },
      enumerable: !0,
      configurable: !0,
    }),
    Object.defineProperty(t.prototype, 'headerFormat', {
      ...
      set: function (e) {
        e != this._hdrFmt &&
          ((this._hdrFmt = wjcCore.asString(e)), this._updateHeader());
      },
      enumerable: !0,
      configurable: !0,
    }),
    Object.defineProperty(t.prototype, 'headerFormatter', {
      ...
      set: function (e) {
        e != this._hdrFormatter &&
          ((this._hdrFormatter = wjcCore.asFunction(e)), this._updateHeader());
      },
      enumerable: !0,
      configurable: !0,
    }),
    ...
    (t.prototype._createDropDown = function () {
      ...
      (this._lbx = new ListBox(t)), e.prototype._createDropDown.call(this);
    }),
    Object.defineProperty(t.prototype, 'isReadOnly', {
      get: function () {
        return this._readOnly;
    ...
    (t.prototype.refresh = function (t) {
      void 0 === t && (t = !0),
        ...
        this._selectAllSpan &&
          wjcCore.setText(
            this._selectAllSpan,
            this._selectAllLabel || wjcCore.culture.MultiSelect.selectAll
          );
    }),
    (t.prototype.onIsDroppedDownChanged = function (t) {
      var i = this;
    ...
    (t.prototype._updateHeader = function () {
      ...
      var o = null,
        n = this.collectionView;
      wjcCore.hasItems(n) &&
        (0 == e.length ? (o = !1) : e.length == n.items.length && (o = !0)),
        ...
        if (!t.defaultPrevented)
          switch (t.keyCode) {
            ...
            case wjcCore.Key.Enter:
              this._itemOff(),
                this._addItem(!0),
                wjcCore.isIE && wjcCore.setSelectionRange(this._tbx, 0, 0);
              break;
            case wjcCore.Key.Tab:
              this.isDroppedDown
                ? (this._addItem(!1),
      ...
      (e && !n) ||
        (n
          ...
          : this._selItems.length > 0 &&
            ((i = this._selItems[this._selItems.length - 1]), (s = !0)),
        s &&
      ...
      if (t) {
        if (
          ((this._selItems && 0 !== this._selItems.length) ||
            (this._selItems = []),
          null != this._maxtems && this._selItems.length >= this._maxtems)
        )
          return;
        ...
        if (
          ...
          n !== i.length - 1
            ? (wjcCore.removeClass(o, t._clsActive),
              wjcCore.addClass(i[n + 1], t._clsActive),
              this._helperInput.focus())
            : (wjcCore.removeClass(o, t._clsActive), this._tbx.focus());
        }
    }),
      ...
      if (this.selectedMemberPath && '' !== this.selectedMemberPath) {
        ...
        if ((this._selItems.splice(0, this._selItems.length), e))
          for (var t = 0; t < e.sourceCollection.length; t++)
            this._getSelItem(t) && this._selItems.push(e.sourceCollection[t]);
      }
    }),
    ...
    return (
      ...
      o.addEventListener(n, 'keydown', function (e) {
        if (!e.defaultPrevented) {
          ...
          e.keyCode == wjcCore.Key.Tab &&
            o.modal &&
            (e.preventDefault(), wjcCore.moveFocus(n, e.shiftKey ? -1 : 1));
        }
      }),
    ...
    (t.prototype.show = function (e, t) {
      ...
      if (!this.isVisible) {
        ...
        (this.dialogResult = null),
          (this._callback = null),
          this._hideAnim &&
            (clearInterval(this._hideAnim), (this._hideAnim = null));
      ...
      if ((this._makeDraggable(!1), this.isVisible)) {
        ...
        if (this.onHiding(i)) {
          ...
          this._modal &&
            ...
            setTimeout(function () {
              t._updateState(), t.onHidden(i), t._callback && t._callback(t);
            });
        }
      }
    }),
...
var InputDate = (function (e) {
  ...
  return (
    ...
    Object.defineProperty(t.prototype, 'value', {
      ...
      set: function (e) {
        wjcCore.DateTime.equals(this._value, e)
          ? (this._tbx.value = wjcCore.Globalize.format(e, this.format))
          : ((e = wjcCore.asDate(
              e,
    ...
    (t.prototype.onIsDroppedDownChanged = function (t) {
      e.prototype.onIsDroppedDownChanged.call(this, t),
        this.isDroppedDown && ((this._calChanged = !1), this.dropDown.focus());
    }),
    (t.prototype._createDropDown = function () {
      var e = this;
      (this._calendar = new Calendar(this._dropDown)),
        this._calendar.valueChanged.addHandler(function () {
          (e.value = wjcCore.DateTime.fromDateTime(e._calendar.value, e.value)),
            (e._calChanged = !0);
        }),
        this.addEventListener(this._dropDown, 'mouseup', function (t) {
          e._calChanged && !wjcCore.closest(t.target, '.wj-calendar-header')
            ? (e.isDroppedDown = !1)
    ...
    (t.prototype._updateDropDown = function () {
      ...
      (t.value = this.value),
        (t.min = this.min),
        (t.max = this.max),
        this.selectionMode != DateSelectionMode.Month && (t.monthView = !0);
      var i = getComputedStyle(this.hostElement);
      (this._dropDown.style.minWidth = 18 * parseFloat(i.fontSize) + 'px'),
              ...
              var i = t.keyCode == wjcCore.Key.Up ? 1 : -1,
                o =
                  this.selectionMode == DateSelectionMode.Month
                    ? wjcCore.DateTime.addMonths(this.value, i)
                    : wjcCore.DateTime.addDays(this.value, i);
              (this.value = wjcCore.DateTime.fromDateTime(o, this.value)),
                this.selectAll(),
                t.preventDefault();
            }
        }
    ...
    (t.prototype._commitText = function () {
      ...
      if (e || this.isRequired) {
        ...
        t
          ? (this.value = wjcCore.DateTime.fromDateTime(t, this.value))
          : (this._tbx.value = wjcCore.Globalize.format(
              this.value,
              this.format
            ));
    ...
    Object.defineProperty(t.prototype, 'value', {
      ...
      set: function (e) {
        (e = wjcCore.asDate(e, !this.isRequired)) &&
          ...
          this._setText(e ? wjcCore.Globalize.format(e, this.format) : '', !0),
          this.selectedItem &&
            this.selectedItem.value &&
            (e = wjcCore.DateTime.fromDateTime(e, this.selectedItem.value)),
          e == this._value ||
    ...
    Object.defineProperty(t.prototype, 'format', {
      ...
      set: function (e) {
        e != this.format &&
          ((this._format = wjcCore.asString(e)),
          (this._tbx.value = wjcCore.Globalize.format(this.value, this.format)),
          wjcCore.hasItems(this.collectionView) && this._updateItems());
      },
      enumerable: !0,
      configurable: !0,
    }),
    ...
    (t.prototype._updateItems = function () {
      if (!this._hasCustomItems) {
        ...
        if (
          ...
          for (var o = t; o <= i; o = wjcCore.DateTime.addMinutes(o, this.step))
            e.push({
              value: o,
        ...
        if (this.text != e) {
          var t =
            this.selectedItem && this.selectedItem.value
              ...
              : wjcCore.Globalize.parseDate(this.text, this.format);
          t
            ? (this.value = wjcCore.DateTime.fromDateTime(this.value, t))
            : (this._tbx.value = e);
        }
      } else this.value = null;
    }),
...
var InputDateTime = (function (e) {
  function t(t, i) {
    ...
    wjcCore.addClass(o.hostElement, 'wj-inputdatetime'),
      ...
      o._inputTime.valueChanged.addHandler(function () {
        (o.value = wjcCore.DateTime.fromDateTime(o.value, o._inputTime.value)),
          o.containsFocus() &&
            ((o.isTouching && o.showDropDownButton) || o.selectAll());
      });
  ...
  return (
    ...
    (t.prototype._setDropdown = function (e) {
      this._dropDown != e &&
        (this.isDroppedDown && (this.isDroppedDown = !1), (this._dropDown = e));
    }),
    (t.prototype._updateDropDown = function () {
...
var InputNumber = (function (e) {
  function t(t, i) {
    ...
    return (
      ...
      (o._rptUp = new wjcCore._ClickRepeater(o._btnUp.querySelector('button'))),
      (o._rptDn = new wjcCore._ClickRepeater(o._btnDn.querySelector('button'))),
      o.addEventListener(n, 'wheel', function (e) {
  ...
  return (
    ...
    Object.defineProperty(t.prototype, 'repeatButtons', {
      ...
      set: function (e) {
        this._rptUp.disabled = this._rptDn.disabled = !wjcCore.asBoolean(e);
      },
      enumerable: !0,
      configurable: !0,
    }),
    ...
    (t.prototype._updateSymbols = function () {
      var e = wjcCore.culture.Globalize.numberFormat,
        t = this.format ? this.format.match(/([a-z])(\d*)(,*)(.*)/i) : null;
      (this._chrDec = e['.'] || '.'),
    ...
    (t.prototype._getInputRange = function (e) {
      for (var t = [0, 0], i = this.text, o = !1, n = 0; n < i.length; n++)
    ...
    (t.prototype._getSelStartDigits = function () {
      for (
        var e = 0, t = this._tbx.selectionStart, i = this._tbx.value, o = 0;
        o < i.length && o < t;
        o++
      )
    ...
    (t.prototype._increment = function (e) {
      if (e) {
        var t = this._clamp(wjcCore.isNumber(this.value) ? this.value + e : 0),
    ...
    (t.prototype._updateBtn = function () {
      ...
      wjcCore.setCss([this._btnUp, this._btnDn], {
        ...
        wjcCore.toggleClass(this.hostElement, 'wj-input-show-spinner', e),
    ...
    (t.prototype._setText = function (e) {
      if (!this._composing) {
        var t = this._tbx,
          ...
          o = this._delKey;
        if (
          (e && this._rxSym.test(e) && (e = this.isRequired || !o ? '0' : ''),
          (this._delKey = !1),
          ...
          if (!this.isRequired)
            return (
              ...
              this._oldText && ((this._oldText = e), this.onTextChanged()),
              void this._updateBtn()
            );
          e = '0';
        }
        var n = this._format || (e.indexOf(this._chrDec) > -1 ? 'n2' : 'n0'),
        ...
        if (isNaN(s)) t.value = this._oldText;
          ...
          i && s >= 0 && (r = '-' + r),
            ...
            s != this._value && ((this._value = s), this.onValueChanged()),
            this.text != this._oldText &&
              ((this._oldText = this.text), this.onTextChanged()),
            this._updateBtn();
        }
        ...
        switch (i) {
          case '-':
            this.min >= 0
              ...
              ? this._flipSign()
              : this._clamp(-1) < 0 &&
                ((t.value = '-'), wjcCore.setSelectionRange(t, 1)),
              e.preventDefault();
            break;
          case '+':
        ...
        switch (e.keyCode) {
          ...
          case wjcCore.Key.Down:
            this.step &&
              !this.isReadOnly &&
              (this._increment(
                this.step * (e.keyCode == wjcCore.Key.Up ? 1 : -1)
              ),
              setTimeout(function () {
                t.selectAll();
              }),
            ...
            break;
          case wjcCore.Key.Back:
            if (((this._delKey = !0), s - n < 2 && !this.isReadOnly)) {
              var r = o[s - 1];
              (r != this._chrDec && '%' != r && ')' != r) ||
                (setTimeout(function () {
                  (s = '%' == r ? t._getInputRange(!0)[1] : s - 1),
          ...
          case wjcCore.Key.Delete:
            if (((this._delKey = !0), s - n < 2 && !this.isReadOnly))
              if ('0' == o && 1 == n) wjcCore.setSelectionRange(i, 0);
              else {
                var a = o[n];
                (a != this._chrDec && '%' != a) ||
                  (setTimeout(function () {
    ...
    (t.prototype._input = function (e) {
      ...
      this._composing ||
        setTimeout(function () {
          ...
          if (
            ('p' == t._fmtSpc && i.length && i.indexOf('%') < 0 && (i += '%'),
            t._setText(i),
            t.containsFocus())
          ) {
            var r = e.value,
            ...
            if ('-' == i[0] && '-' != r[0]) return void t._setSelStartDigits(s);
            i
              ? i == t._chrDec && a > -1
                ? (n = a + 1)
                : (n <= o && a > -1) || (o < 0 && a < 0)
    ...
    (t.prototype._clickSpinner = function (e) {
      ...
      e.defaultPrevented ||
        ...
        !this.step ||
        (this._increment(
          this.step * (wjcCore.contains(this._btnUp, e.target) ? 1 : -1)
        ),
        this.isTouching ||
          setTimeout(function () {
            return t.selectAll();
...
var InputMask = (function (e) {
  ...
  return (
    ...
    Object.defineProperty(t.prototype, 'promptChar', {
      ...
      set: function (e) {
        var t = this.value;
        (this._msk.promptChar = e), this.value != t && this.onValueChanged();
      },
      enumerable: !0,
      configurable: !0,
    }),
    ...
    (t.prototype.onValueChanged = function (e) {
      this.value != this._oldValue &&
        ((this._oldValue = this.value), this.valueChanged.raise(this, e)),
        this._updateState();
    }),
    (t.prototype.dispose = function () {
...
var InputColor = (function (e) {
  ...
  return (
    ...
    Object.defineProperty(t.prototype, 'value', {
      ...
      set: function (e) {
        e != this.value &&
          ((!e && this.isRequired) || (this.text = wjcCore.asString(e)));
      },
      enumerable: !0,
      configurable: !0,
    }),
    Object.defineProperty(t.prototype, 'text', {
      ...
      set: function (e) {
        e != this.text &&
          (this._setText(wjcCore.asString(e), !0), this._commitText());
      },
      enumerable: !0,
      configurable: !0,
    }),

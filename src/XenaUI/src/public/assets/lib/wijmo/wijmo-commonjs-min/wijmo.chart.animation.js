...
var ChartAnimation = (function () {
      ...
      t instanceof wjcChart.FlexPie
        ...
        : (tryGetModuleWijmoChartRadar() &&
          ...
          t instanceof tryGetModuleWijmoChartRadar().FlexRadar
            ? (n._animation = new FlexRadarAnimation(t, n._updateEventArgs))
            : (n._animation = new FlexChartAnimation(t, n._updateEventArgs)),
  ...
  return (
    ...
    Object.defineProperty(t.prototype, 'duration', {
      ...
      set: function (t) {
        t !== this._animation.duration && (this._animation.duration = t);
      },
      enumerable: !0,
      configurable: !0,
    }),
...
var FlexAnimation = (function () {
    ...
    return (
      Object.defineProperty(t.prototype, 'animationMode', {
        ...
        set: function (t) {
          t !== this._animationMode &&
            (this._clearState(),
            (this._animationMode = wjcCore.asEnum(t, AnimationMode, !1)));
        },
        enumerable: !0,
        configurable: !0,
      }),
      Object.defineProperty(t.prototype, 'easing', {
        ...
        set: function (t) {
          t !== this._easing && (this._easing = wjcCore.asEnum(t, Easing, !1));
        },
        enumerable: !0,
        configurable: !0,
      }),
                ...
                t.forEach(function (t, c) {
                  if (t && t.ele) {
                    if (a === r - 1 && 0 === c) {
                      var l = t.done;
                      t.done = function () {
                        i._toggleDataLabelVisibility(!0), l && l();
                      };
                    }
                    wjcCore.isArray(t.ele)
                      ? ((s = AnimationHelper.playAnimations(
                          t.ele,
                          t.from,
                          t.to,
                          t.done,
                        ...
                        (n._timers = n._timers.concat.apply(s)))
                      : ((s = AnimationHelper.playAnimation(
                          t.ele,
                          t.from,
                          t.to,
                          t.done,
        ...
        return (
          t > 1 &&
            (this._previousState
              ...
              : ((n.duration = 0.5 * e), (n.delay = (0.5 * e) / (t - 1)))),
          n
        );
      }),
      t
      ...
      (e.prototype._getElementRotate = function (t) {
        ...
        return (n =
          n && n.indexOf('rotate') > -1
            ? (n = n.replace('rotate(', '').replace(')', '')).indexOf(',') > -1
      ...
      (e.prototype._playPieAnimation = function (t) {
        ...
        if (
          ...
          (e._currentState = {
            ...
            pels: n._pels,
            rotate:
              n._pels.length && e._getElementRotate(n._pels[0].parentNode),
          }),
      ...
      (e.prototype._playSelectPieAnimation = function (t) {
        if (null != this._previousState) {
          var e,
            ...
            l = s[0];
          c !== l &&
            (c - l > 180 ? (s[0] += 360) : l - c > 180 && (r[0] += 360),
              ...
              l[e] &&
                ...
                (e < p &&
                  ...
                  1 === u
                    ...
                    : l[e].childNodes[0].setAttribute(
                        'd',
                        s.pels[e].childNodes[0].getAttribute('d')
                      )),
                e < p
                  ? ((i = c[e]),
                    (n.to = {
        ...
        n._pels.forEach(function (n, o) {
          ...
          s &&
            (i === AnimationMode.Point
              ? (e._parsePathByAngle(a[o], c, l), (r = e._getAnimation(t, o)))
              : (e._parsePathByRadius(a[o], c, l), (r = e._getAnimation(t, 0))),
    ...
    return (
      ...
      (e.prototype.playAnimation = function () {
        ...
        var e,
          ...
          m =
            ...
            h instanceof tryGetModuleWijmoChartFinance().FinancialChart,
          d = h.series,
          _ = d.length,
          f = [];
        for (
            ...
            u._previousState &&
              ...
              s.length > 2 &&
                ...
                ((e = c.indexOf(s[0])) > 0 && e < c.length - 2
                  ? c[e + 1] === s[1] && c[e + 2] === s[2] && (u._addStart = e)
                  : (e = s.indexOf(c[0])) > 0 &&
                    e < s.length - 2 &&
                    s[e + 1] === c[1] &&
                    s[e + 2] === c[2] &&
          ...
          if (
            ...
            if (p || (l && l.seriesType !== a)) u._playLoadAnimation(f, e, i);
            else if (
              (u._playUpdateAnimation(f, e, i, n, (l && l.ele) || null),
              e === _ - 1 && e < o - 1)
            )
              for (e++; e <= o - 1; e++)
      ...
      (e.prototype._playAxesAnimation = function () {
        var t,
          ...
          o = a.length;
        for (
          i._prevAxesStates = i._currAxesStates, i._currAxesStates = [], e = 0;
          e < o;
          e++
        )
          (t = a[e]).hostElement &&
        ...
        if (i._prevAxesStates)
          for (
            n = Math.max(i._prevAxesStates.length, i._currAxesStates.length),
              e = 0;
            e < n;
            e++
          )
            i._playAxisAnimation(i._prevAxesStates[e], i._currAxesStates[e]);
      }),
      (e.prototype._playAxisAnimation = function (t, e) {
        ...
        e &&
          ...
          i._convertAxisAnimation(a, n.major, e.axis, t.maxValue, t.minValue),
          i._convertAxisAnimation(a, n.minor, e.axis, t.maxValue, t.minValue)),
          t &&
          ...
          (i = e[n]).text &&
            t.some(function (t) {
              if (t.text && t.text === i.text)
                return a._combineAxisAnimation(t, i), e.splice(n, 1), !0;
            });
      }),
      ...
      (e.prototype._convertAxisAnimation = function (t, e, n, i, a) {
        ...
        e.forEach(function (e, l) {
          ...
          isNaN(u) ||
            ((o = {}),
            e.majorGrid &&
              (o.majorGrid = r._getAxisAnimationAttrs(e.majorGrid, s, u, c)),
            e.label &&
              ((o.label = r._getAxisAnimationAttrs(e.label, s, u, c)),
              (o.text = e.label.innerHTML || e.label.textContent)),
            e.tick && (o.tick = r._getAxisAnimationAttrs(e.tick, s, u, c)),
            t.push(o));
        });
      }),
            ...
            ['majorGrid', 'label', 'tick'].forEach(function (n) {
              ...
              if (i) {
                ...
                var a = i.ele,
                  o = i.elePos,
                  r = i.calcPos;
                AnimationHelper.playAnimation(a, r, o, null, Easing.Swing, e);
              }
            });
          });
      }),
              ...
              if (i) {
                ...
                a.appendChild(o),
                  AnimationHelper.playAnimation(
                    ...
                    s,
                    function () {
                      o.parentNode === a && a.removeChild(o);
                    },
                    Easing.Swing,
                    e
                  );
          ...
          r &&
            r.forEach(function (t, e) {
              ...
              l.push(s),
                ...
                (r = a[o]),
                n.majorGrid &&
                  wjcCore.hasClass(r, wjcChart.FlexChart._CSS_GRIDLINE) &&
                  ((s.majorGrid = r), (r = a[++o])),
                i
                  ? (u &&
                      r &&
                      n.majorTickMarks !== wjcChart.TickMark.None &&
                      wjcCore.hasClass(r, wjcChart.FlexChart._CSS_TICK) &&
                      ((s.tick = r), (r = a[++o])),
                    u &&
                      r &&
                      (wjcCore.hasClass(r, wjcChart.FlexChart._CSS_LABEL) ||
                        r.querySelector('.' + wjcChart.FlexChart._CSS_LABEL)) &&
                      ((s.label = r), o++))
                  : (u &&
                      r &&
                      (wjcCore.hasClass(r, wjcChart.FlexChart._CSS_LABEL) ||
            ...
            s.forEach(function (t, e) {
              ...
              u.push(r),
                ...
                n.minorTickMarks !== wjcChart.TickMark.None &&
                  wjcCore.hasClass(i, wjcChart.FlexChart._CSS_TICK_MINOR) &&
                  ((r.tick = i), (i = a[++o])),
                n.minorGrid &&
        ...
        if ('g' === m && e.childNodes)
          ...
          if ('polyline' === m || 'polygon' === m) {
            for (
              ...
              (s = c[r] || c.getItem(r)),
                h.rotated ? d.push({ x: A, y: s.y }) : d.push({ x: s.x, y: y }),
                _.push({ x: s.x, y: s.y });
            (g[m] = d), (v[m] = _);
          } else
            'ellipse' === m &&
      ...
      (e.prototype._setLineMoveAnimation = function (t, e, n, i, a) {
        if (null != e && null != n) {
          ...
          for (
            ...
            p < o && ((r = s[p] || s.getItem(p)), f.push({ x: r.x, y: r.y })),
              p < c && ((l = u[p] || u.getItem(p)), y.push({ x: l.x, y: l.y }));
          d._addStart
            ? (d._adjustStartLinePoints(d._addStart, f, s), (o += d._addStart))
            : d._removeStart &&
      ...
      (e.prototype._adjustEndLinePoints = function (t, e, n, i, a) {
        ...
        for (
          a && (i.length >= 3 || i.numberOfItems >= 3)
            ? ((r = n.pop()),
              (o = n.pop()),
              (s = i[i.length - 3] || i.getItem(i.numberOfItems - 3)))
            : (i.length > 0 || i.numberOfItems > 0) &&
              (s = i[i.length - 1] || i.getItem(i.numberOfItems - 1));
          t > e && s;
        ...
        (i = e.hostElement),
          ...
          [].slice.call(i.childNodes).forEach(function (t, e) {
            (r = t.nodeName),
              (o = a[e]),
              'g' === r && t.nodeChilds
                ? [].slice.call(t.nodeChilds).forEach(function (t, e) {
      ...
      (e.prototype._playLoadBarAnimation = function (t, e, n) {
        ...
        [].slice.call(r.childNodes).forEach(function (a, r) {
          ...
          (s =
            ...
            'g' === c
              ? a.childNodes &&
                [].slice.call(a.childNodes).forEach(function (t, e) {
      ...
      (e.prototype._setMoveBarAnimation = function (t, e, n) {
        ...
        null != e &&
          null != n &&
          (['width', 'height', 'x', 'y', 'top', 'left'].forEach(function (t) {
      ...
      (e.prototype._playBarMoveAnimation = function (t, e, n, i) {
        ...
        p._chart;
        if (
          ((a = e.hostElement), (r = [].slice.call(n.childNodes)), p._addStart)
        )
          for (u = 0, s = r[0]; u < p._addStart; ) r.splice(0, 0, s), u++;
        if (p._removeStart)
            ...
            if (n < c) {
              if (
                ...
                for (a = p._getAnimation(t, 0), n++; n < c; n++)
                  (s = r[n]), p._removeBarAnimation(a, e, s, i);
      ...
      (e.prototype._playScatterMoveAnimation = function (t, e, n) {
        ...
        if (
          ((i = e.hostElement), (o = [].slice.call(n.childNodes)), u._addStart)
        )
          for (l = 0, r = o[0]; l < u._addStart; ) o.splice(0, 0, r), l++;
        if (u._removeStart)
            ...
            if (e < s) {
              if (
                (e < u._addStart
                  ...
                  : ((r = o[e]), u._setUpdateScatterAnimation(p, r, t)),
                e === c - 1 && e < s - 1)
              )
                for (e++; e < s; e++)
                  (r = o[e]), u._removeScatterAnimation(p, t, r);
    ...
    return (
      ...
      (e.prototype._setRadarLinePointAnimation = function (t, e, n, i, a) {
        ...
        if ('polyline' === d || 'polygon' === d) {
          for (o = (c = e.points).length || c.numberOfItems, r = 0; r < o; r++)
            v[(p = h._getScatterAnimationIndex(t, i[r]))] || (v[p] = []),
              v[p].push(r),
              (s = c[r] || c.getItem(r)),
              _.push({ x: g.x, y: g.y }),
              f.push({ x: s.x, y: s.y });
      ...
      (t.parseAttrs = function (e, n) {
        ...
        for (var a in e)
          if (null != n[a])
            switch (a) {
              case 'polyline':
                i.points = t.parseAttr(e[a], n[a], function (t, e) {
                  if (1 === e) {
                    for (var n, i, a; t.length > 1; ) {
                      if (
                        ((i = t[0]), (a = t[1]), i.x !== a.x || i.y !== a.y)
                      ) {
                        (i = null), (a = null);
                        break;
                      }
              ...
              case 'pie':
                ...
                break;
              case 'rotate':
                i.transform = t.parseAttr(e[a], n[a], function (t) {
        ...
        var o = 0,
          r = setInterval(function () {
            ...
            (s = EasingHelper[Easing[n]](s)),
              t(s),
              (o += a) >= i &&
                (clearInterval(r), (s < 1 || s > 1) && t(1), e && e());
          }, a);
        return r;
      }),

...
export declare class FlexGridXlsxConverter {
    ...
    static _getMeasureCell(
        panel: wjcGrid.GridPanel,
        colIndex: number,
        patternCell: HTMLDivElement,

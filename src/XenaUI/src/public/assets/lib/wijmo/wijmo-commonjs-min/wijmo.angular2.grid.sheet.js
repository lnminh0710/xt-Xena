...
var WjFlexSheet = (function (e) {
  ...
  return (
    ...
    (t.prototype.addEventListener = function (t, o, r, n) {
      var i = this;
      void 0 === n && (n = !1);
      ...
      s && a.outsideZoneEvents[o]
        ? s.runOutsideAngular(function () {
            e.prototype.addEventListener.call(i, t, o, r, n);
          })
        : e.prototype.addEventListener.call(this, t, o, r, n);
    }),
    (t.meta = {
      outputs: exports.wjFlexSheetMeta.outputs,
      changeEvents: { selectedSheetChanged: ['selectedSheetIndex'] },
    }),
    (t.decorators = [
      {
...
(exports.WjFlexSheet = WjFlexSheet),
  (exports.wjSheetMeta = {
    ...
    outputs: ['initialized', 'nameChangedNg: nameChanged'],
    providers: [],
  });
var WjSheet = (function (e) {
  function t(t, o, r) {
    ...
    return (n._flexSheet = r), n.created(), n;
  }
  return (
    __extends(t, e),
    (t.prototype.created = function () {}),
    (t.prototype.ngOnInit = function () {
      return (
        this._wjBehaviour.ngOnInit(),
        this.itemsSource
          ? this._flexSheet.addBoundSheet(this.name, this.itemsSource)
          : this._flexSheet.addUnboundSheet(
              this.name,
              null != this.boundRowCount ? +this.boundRowCount : null,
              null != this.boundColumnCount ? +this.boundColumnCount : null
            )
      );
    }),
    (t.prototype.ngAfterViewInit = function () {
    ...
    (t.prototype.ngOnChanges = function (e) {
      ...
      (t = e.rowCount) &&
        t.isFirstChange &&
        (this.boundRowCount = t.currentValue),
        (t = e.columnCount) &&
          t.isFirstChange &&
          (this.boundColumnCount = t.currentValue);
    }),
    (t.meta = { outputs: exports.wjSheetMeta.outputs }),
    (t.decorators = [
      {
        type: core_1.Component,
        args: [
...
var moduleExports = [WjFlexSheet, WjSheet],

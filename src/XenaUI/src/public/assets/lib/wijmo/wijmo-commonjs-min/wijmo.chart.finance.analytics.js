...
var Fibonacci = (function (t) {
  ...
  return (
    ...
    Object.defineProperty(e.prototype, 'high', {
      ...
      set: function (t) {
        t != this._high &&
          ((this._high = wjcCore.asNumber(t, !0)), this._invalidate());
      },
      enumerable: !0,
      configurable: !0,
    }),
    ...
    Object.defineProperty(e.prototype, 'uptrend', {
      ...
      set: function (t) {
        t != this._uptrend &&
          ((this._uptrend = wjcCore.asBoolean(t, !0)), this._invalidate());
      },
      enumerable: !0,
      configurable: !0,
    }),
    Object.defineProperty(e.prototype, 'levels', {
      ...
      set: function (t) {
        t != this._levels &&
          ((this._levels = wjcCore.asArray(t, !0)), this._invalidate());
      },
      enumerable: !0,
      configurable: !0,
    }),
    ...
    (e.prototype._updateLevels = function () {
      ...
      if (void 0 === this._low || void 0 === this._high) {
        ...
        if (a)
          for (
            var r = a.length, n = this._getMinX(), l = this._getMaxX(), o = 0;
            o < r;
            o++
          ) {
            var h = a[o],
    ...
    (e.prototype._render = function (t, e) {
      ...
      for (var u = i._levels ? i._levels.length : 0, p = 0; p < u; p++) {
        var d = i._levels[p],
          ...
          f = i.uptrend
            ? s.convert(
                i._actualLow + 0.01 * d * (i._actualHigh - i._actualLow)
              )
            : s.convert(
                i._actualHigh - 0.01 * d * (i._actualHigh - i._actualLow)
              );
        if (
          ...
          var y = d.toFixed(1) + '%',
            m = 0;
          switch (
            (((i.uptrend && 0 == p) || (!i.uptrend && p == u - 1)) && (m = 2),
            i.labelPosition)
          ) {
...
var FibonacciArcs = (function (t) {
  ...
  return (
    ...
    Object.defineProperty(e.prototype, 'levels', {
      ...
      set: function (t) {
        t !== this._levels &&
          ((this._levels = wjcCore.asArray(t, !1)), this._invalidate());
      },
      enumerable: !0,
      configurable: !0,
    }),
    Object.defineProperty(e.prototype, 'labelPosition', {
      ...
      set: function (t) {
        t !== this.labelPosition &&
          ((this._labelPosition = wjcCore.asEnum(t, wjcChart.LabelPosition)),
          this._invalidate());
      },
      enumerable: !0,
      configurable: !0,
    ...
    (e.prototype._render = function (e, i) {
      ...
      if (
        ...
        var l,
          ...
          d = wjcChart._BasePlotter.cloneStyle(this.style, ['stroke']);
        ...
        for (var P = 0; P < this.levels.length; P++)
          if (
            ...
            isValid(C.x) &&
              ...
              this.labelPosition !== wjcChart.LabelPosition.None && 0 !== j))
          ) {
            switch (
            ...
            c.drawString(V, new wjcCore.Point(g - 0.5 * v.width, f), null, d);
          }
        (c.stroke = null),
          (c.strokeWidth = null),
          (c.textFill = null),
    ...
    (e.prototype._updateLevels = function () {
      if (!this.start || !this.end) {
        var e,
          ...
          o = t.prototype.getValues.call(this, 1) || r.dataInfo.getXVals();
        l &&
          l.length > 0 &&
    ...
    (e.prototype._render = function (e, i) {
      ...
      if (
        ...
        var l = this._getAxisX(),
          ...
          p = wjcChart._BasePlotter.cloneStyle(this.style, ['stroke']);
        ...
        for (var B = 0; B < this.levels.length; B++)
          if (
            ...
            k > 0 && f > o.actualMax
              ? (g = ((f = o.actualMax) - v) / j)
              : k < 0 && f < o.actualMin && (g = ((f = o.actualMin) - v) / j),
            isValid(d) &&
              isValid(w) &&
              isValid(g) &&
              isValid(f) &&
              ((y = new wjcCore.Point(l.convert(d), o.convert(w))),
            ...
            (b = wjcCore.Globalize.format(V, 'p1')),
              ...
              (P = (180 * Math.atan((m.y - y.y) / (m.x - y.x))) / Math.PI),
              (C = m.clone()),
            ...
            switch (this.labelPosition) {
              case wjcChart.LabelPosition.Center:
                (m.y += 0.5 * x.height), (N.y += 0.5 * x.height);
                break;
              case wjcChart.LabelPosition.Bottom:
                m.y += x.height;
            }
            L > 0
              ? (this.labelPosition === wjcChart.LabelPosition.Top ||
                this.labelPosition === wjcChart.LabelPosition.Center
                  ? ((D = N.clone()),
                    (A.x = D.x + x.height * Math.sin(F)),
                    (A.y = D.y - x.height * Math.cos(F)),
                    (O.x =
                      D.x - x.width * Math.cos(F) + x.height * Math.sin(F)),
                    (O.y =
                      D.y - x.width * Math.sin(F) - x.height * Math.cos(F)),
                    (S.x = D.x - x.width * Math.cos(F)),
                    (S.y = D.y - x.width * Math.sin(F)))
                  : this.labelPosition === wjcChart.LabelPosition.Bottom &&
                    ((A = N.clone()),
                    ...
                    (D.x =
                      O.x + x.width * Math.cos(F) - x.height * Math.sin(F)),
                    (D.y =
                      O.y + x.width * Math.sin(F) + x.height * Math.cos(F))),
                k > 0
                  ? (A.y < Y &&
                      ((j =
                        (o.convertBack(A.y) - o.convertBack(O.y)) /
                        (l.convertBack(A.x) - l.convertBack(O.x))),
                      (v = o.convertBack(A.y) - j * l.convertBack(A.x)),
                  ...
                  : k < 0 &&
                    (D.y > T &&
                      ((j =
                        (o.convertBack(S.y) - o.convertBack(D.y)) /
                        (l.convertBack(S.x) - l.convertBack(D.x))),
                      (v = o.convertBack(D.y) - j * l.convertBack(D.x)),
                      (I = l.convert((o.actualMin - v) / j)),
                      (m.x -= Math.max(Math.abs(I - D.x), Math.abs(T - D.y)))),
              ...
              : L < 0 &&
                ...
                k > 0
                  ? (O.y < Y &&
                      ((j =
                        (o.convertBack(O.y) - o.convertBack(A.y)) /
                        (l.convertBack(O.x) - l.convertBack(A.x))),
                      (v = o.convertBack(O.y) - j * l.convertBack(O.x)),
                      (I = l.convert((o.actualMax - v) / j)),
                      (m.x += Math.abs(O.x - I))),
                  ...
                  : k < 0 &&
                    (S.y > T &&
                      ((j =
                        (o.convertBack(D.y) - o.convertBack(S.y)) /
                        (l.convertBack(D.x) - l.convertBack(S.x))),
                      (v = o.convertBack(S.y) - j * l.convertBack(S.x)),
                      (I = l.convert((o.actualMin - v) / j)),
                      (m.x += Math.max(Math.abs(I - S.x), Math.abs(T - S.y)))),
  ...
  return (
    ...
    (e.prototype._render = function (e, i) {
      ...
      if (
        ...
        var r,
          ...
          w = wjcChart._BasePlotter.cloneStyle(this.style, ['stroke']),
          f = _.convert(_.actualMin),
          y = _.convert(_.actualMax),
          m = this.chart._plotrectId;
        if (((p.stroke = d), (p.strokeWidth = 2), (p.textFill = d), 0 !== h)) {
          p.startGroup(null, m);
    ...
    (e.prototype._updateLevels = function () {
      var e = this.chart._getPlotter(this),
        i = t.prototype.getValues.call(this, 1) || e.dataInfo.getXVals();
...
var OverlayIndicatorBase = (function (t) {
  ...
  return (
    ...
    (e.prototype._getXValues = function () {
      return (
        t.prototype.getValues.call(this, 1) || this._plotter.dataInfo.getXVals()
      );
    }),
...
var SingleOverlayIndicatorBase = (function (t) {
  ...
  return (
    ...
    (e.prototype._init = function () {
      t.prototype._init.call(this), (this._yvals = []), (this._xvals = []);
    }),
      ...
      return t.prototype._getLength.call(this) <= 0
        ...
        : (this._shouldCalculate() && (this._init(), this._calculate()),
          (e =
            ...
            wjcChartFinance._minimum(this._yvals.length, this._xvals.length) +
            e),
          t.prototype._getItem.call(this, e));
    }),
    e
    ...
    (e.prototype._calculate = function () {
      if (!(t.prototype._getLength.call(this) <= 0)) {
        var e = t.prototype._getBindingValues.call(this, 0),
          ...
          s = this._getXValues();
        (this._yvals = wjcChartFinance._avgTrueRng(e, i, a, this.period)),
          (this._xvals = s
...
var Envelopes = (function (t) {
  ...
  return (
    ...
    (e.prototype._rendering = function (e, i) {
      if (((i.cancel = !0), !(t.prototype._getLength.call(this) <= 0))) {
        ...
        if (l && !(l <= 0)) {
          ...
          for (
            var _, u, p, d = [], g = [], w = [], f = this._getLength(), y = 0;
            y < l;
            y++
          )
            (p = f - l + y),
    ...
    (e.prototype.getCalculatedValues = function (e) {
      ...
      switch (
        (this._shouldCalculate() && (this._init(), this._calculate()), e)
      ) {
        case 'upperEnvelope':
...
var MacdBase = (function (t) {
  function e(e) {
    var i = t.call(this, e) || this;
    return (
      (i._fastPeriod = 12), (i._slowPeriod = 26), (i._smoothingPeriod = 9), i
    );
  }
  return (
    __extends(e, t),
    ...
    (e.prototype._calculate = function () {
      ...
      if (!(e <= 0)) {
        var i = t.prototype.getValues.call(this, 0),
          a = this._getXValues(),
          s = _macd(i, this.fastPeriod, this.slowPeriod, this.smoothingPeriod);
        (this._macdVals = s.macds),
          (this._signalVals = s.signals),
          (this._histogramVals = s.histograms),
          (this._macdXVals = a
            ? a.slice(e - this._macdVals.length, e)
            : wjcChartFinance._range(e - this._macdVals.length, e - 1)),
          (this._signalXVals = a
            ? a.slice(e - this._signalVals.length, e)
            : wjcChartFinance._range(e - this._signalVals.length, e - 1)),
          (this._histogramXVals = a
            ? a.slice(e - this._histogramVals.length, e)
            : wjcChartFinance._range(e - this._histogramVals.length, e - 1));
      }
    }),
    e
  );
      ...
      if (((i.cancel = !0), !(t.prototype._getLength.call(this) <= 0))) {
        ...
        this.styles &&
          ...
          (this.styles.macdLine &&
            ...
            ((_ = (c = wjcChart._BasePlotter.cloneStyle(this.styles.macdLine, [
              'fill',
            ])).stroke
              ? c.stroke
              : o),
      ...
      if (((i.cancel = !0), !(t.prototype._getLength.call(this) <= 0))) {
        ...
        this.styles &&
          ...
          (this.styles.kLine &&
            ...
            ((_ = (c = wjcChart._BasePlotter.cloneStyle(this.styles.kLine, [
              'fill',
            ])).stroke
              ? c.stroke
              : o),
          ...
          this.styles.dLine &&
            ...
            ((d = (p = wjcChart._BasePlotter.cloneStyle(this.styles.dLine, [
              'fill',
            ])).stroke
              ? p.stroke
              : o),

    ...
    return (
        ...
        (t.prototype.endRender = function () {
            this._applyCSSStyles && this._svgEngine.endRender(),
                this._svgEngine.element.parentNode.removeChild(
                    this._svgEngine.element
                );
        }),
        ...
        (t.prototype.drawPolygon = function (t, e, n, i, r) {
            if (t && e && 0 !== t.length && 0 !== e.length) {
                ...
                return (
                    l.closePath(),
                    this._applyCanvasStyles(a, i, n, !0),
                    l.restore(),
                    a
                );
            }
        ...
        (t.prototype.drawPieSegment = function (t, e, n, i, r, a, o, l) {
            ...
            return (
                this._applyCSSStyles &&
                    (s = this._svgEngine.drawPieSegment(
                        t,
                        e,
                        n,
                        i,
        ...
        (t.prototype.drawDonutSegment = function (t, e, n, i, r, a, o, l, s) {
            ...
            return (
                this._applyCSSStyles &&
                    (p = this._svgEngine.drawDonutSegment(
                        t,
                        e,
                        n,
                        i,
        ...
        (t.prototype.drawString = function (t, e, n, i) {
            ...
            return (
                this._applyCSSStyles &&
                    (r = this._svgEngine.drawString(t, e, n, i)),
                a.save(),
        ...
        (t.prototype.startGroup = function (t, e, n) {
            ...
            return (
                this._applyCSSStyles &&
                    (i = this._svgEngine.startGroup(t, e, n)),
                r.save(),
        ...
        (t.prototype.drawImage = function (t, e, n, i, r) {
            ...
            return (
                this._applyCSSStyles &&
                    (a = this._svgEngine.drawImage(t, e, n, i, r)),
                (l.onload = function () {
                    ...
                    if (null != i.x1)
                        ...
                        if (i.relative) {
                            var o = n.x + i.cx * n.width,
                                ...
                                h =
                                    n.x +
                                    (null == i.fx ? i.cx : i.fx) * n.width,
                                c =
                                    n.y +
                                    (null == i.fy ? i.cy : i.fy) * n.height,

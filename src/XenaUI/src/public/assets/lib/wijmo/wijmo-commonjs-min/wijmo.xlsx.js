    ...
    return (
        (e.load = function (e) {
            ...
            wjcCore.assert(
                ...
                (t = o.file("xl/workbook.xml")) &&
                    this._getWorkbook(t.asText(), s),
                (t = o.file("xl/theme/theme1.xml")) &&
                    this._getTheme(t.asText()),
            ...
            for (var i = s.sheets.length; i--; )
                if (
                    ...
                    for (
                        var n = t.asText().split("<Relationship "),
                            a = n.length;
                        --a;
                        ...
                        s.sheets[i].tableRIds &&
                        -1 !== s.sheets[i].tableRIds.indexOf(c)
        ...
        (e._saveWorkbookToZip = function (e, t) {
            ...
            t
                ...
                l
                    ...
                    .file(
                        ".rels",
                        this._xmlDescription + this._generateRelsDoc()
                    );
            ...
            (this._colorThemes = e.colorThemes),
                s
                    ...
                    .file(
                        "theme1.xml",
                        this._xmlDescription + this._generateThemeDoc()
                    ),
                (this._macroEnabled = !(
            ...
            if (
                (o.file(
                    "core.xml",
                    this._xmlDescription + this._generateCoreDoc(e)
                ),
                ...
                if (
                    ...
                    e.sheets[a].externalLinks &&
                        ...
                        r
                            ...
                            .file(
                                "sheet" + (a + 1) + ".xml.rels",
                                this._xmlDescription + c
                            );
                }
            s.file(
                "styles.xml",
                this._xmlDescription + this._generateStyleDoc()
            ),
                l.file(
                    "[Content_Types].xml",
                ...
                o.file(
                    "app.xml",
                    this._xmlDescription + this._generateAppDoc(e)
                ),
                s
                    .folder("_rels")
                    .file(
                ...
                for (
                    ...
                    (i = null),
                        s
                            ...
                            : (this._sharedStrings[h - 1] =
                                  Workbook._unescapeXML(l[t])),
                        t++;
        }),
        ...
        (e._getStyle = function (e) {
            ...
            if (((this._styles = []), (o = e.indexOf("<numFmts")) >= 0)) {
                var c = e
                    .substring(o + 8, e.indexOf("</numFmts>"))
                    .split("<numFmt");
                for (t = c.length; --t; )
                    (l = c[t]),
                        (h[+this._getAttr(l, "numFmtId")] = this._getAttr(
                            l,
                            "formatCode"
                        ));
            }
                ...
                for (var p, g, y, _, b, S; --t; )
                    (l = m[t]),
                        (g = (p = h[(y = +this._getAttr(l, "numFmtId"))])
                            ...
                            : "unknown"),
                        (_ =
                            (y = +this._getAttr(l, "fontId")) > 0
                                ? i[y]
                                : null),
                        (b =
                            (y = +this._getAttr(l, "fillId")) > 1
                                ? n[y]
                                : null),
                        (S =
                            (y = +this._getAttr(l, "borderId")) > 0
                                ? a[y]
                                : null),
                        ...
                        this._styles.unshift({
                            ...
                            vAlign:
                                o >= 0
                                    ? Workbook._parseStringToVAlign(
                                          this._getAttr(l, "vertical")
                                      )
                                    : null,
                            wordWrap:
                                o >= 0
                                    ? "1" === this._getAttr(l, "wrapText")
                                    : null,
                            quotePrefix: 1 === r,
                        });
            }
        ...
        (e._getSheet = function (e, t, l) {
                ...
                for (
                    ...
                    2 === (o = this._getAttr(r[i], "ref").split(":")).length &&
                        s.unshift({
                            ...
                            leftCol: this._alphaNum(
                                o[0].match(/[a-zA-Z]*/g)[0]
                            ),
                            bottomRow: +o[1].match(/\d*/g).join("") - 1,
                            rightCol: this._alphaNum(
                                o[1].match(/[a-zA-Z]*/g)[0]
                            ),
                        });
            ...
            if (n[0].indexOf("<dimension") >= 0) {
                var h = this._getAttr(
                    n[0].substr(n[0].indexOf("<dimension")),
                    "ref"
                );
                h &&
            ...
            if (n.length > 0 && n[0].indexOf("<cols>") > -1)
                for (
                    ...
                    var g = this._parseCharWidthToPixel(
                        +this._getAttr(c[p], "width")
                    );
                    (m = null),
                        c[p].indexOf("style") > -1 &&
                            (m = this._styles[
                                +this._getAttr(c[p], "style")
                            ] || { type: "General", formatCode: null }),
                        (d = null),
                        m &&
                            (m.font ||
                                m.fillColor ||
            ...
            for (
                ...
                if (
                    (n[i].substring(0, n[i].indexOf(">")).indexOf("hidden") >
                        -1 &&
                    ...
                    var v = +this._getAttr(
                        n[i]
                            .substring(0, n[i].indexOf(">"))
                            .replace("customHeight", ""),
                        "ht"
                    );
                    S.height = (96 * v) / 72;
                }
                ...
                for (var C = n[i].split("<c "), x = C.length; --x; ) {
                    ...
                    k.indexOf("<f") > -1 &&
                        ...
                        "str" === T || "e" === T || A || (F = F ? +F : ""),
                        (y = this._alphaNum(
                            this._getAttr(k, "r").match(/[a-zA-Z]*/g)[0]
                        ));
                    var N = null;
                    switch (T) {
                        case "s":
        ...
        (e._getTable = function (e) {
            ...
            this._isBuiltInStyleName(r)
                ...
                (t.showBandedColumns =
                    "1" === this._getAttr(s, "showColumnStripes")),
                (t.showBandedRows = "1" === this._getAttr(s, "showRowStripes")),
                (t.showFirstColumn =
                    "1" === this._getAttr(s, "showFirstColumn")),
        ...
        (e._getTableStyles = function (e, t) {
            for (var l = e.split("<tableStyle "), o = l.length; --o; ) {
                ...
                for (
                    var i = r.split("<tableStyleElement "), n = i.length;
                    --n;
        ...
        (e._generateSheetGlobalSetting = function (e, t, l) {
            var o =
                    t.rows && t.rows[0] && t.rows[0].cells
                    ...
                    : ((s += ">"),
                      (s +=
                          ...
                          (0 !== t.frozenPane.rows && 0 !== t.frozenPane.columns
                              ...
                              : "topRight") +
                          '" topLeftCell="' +
                          (this._numAlpha(t.frozenPane.columns) +
                              (t.frozenPane.rows + 1)) +
                          '" ySplit="' +
        ...
        (e._generateMergeSetting = function (e) {
            for (
                var t = '<mergeCells count="' + e.length.toString() + '">',
                    l = 0;
                l < e.length;
                l++
            )
        ...
        (e._generateFontStyle = function (e, t) {
            ...
            return (
                ...
                (l +=
                    '<name val="' +
                    (e.family || this._defaultFontName) +
                    '"/>'),
                (l += '<family val="2"/>'),
        ...
        (e._generateWorkbookRels = function () {
            for (
                var e = '<Relationships xmlns="' + this._relationshipsNS + '">',
                    t = 0;
        ...
        (e._generateWorkSheet = function (e, t, l) {
                    ...
                    f = -1,
                        ...
                        a[c] &&
                            ...
                            a[c].groupLevel &&
                                (A +=
                                    ' outlineLevel="' +
                                    a[c].groupLevel.toString() +
                                    '"'),
                            (m = a[c].style
                                ? this._cloneStyle(a[c].style)
                                : null) &&
                                ((m = this._resolveStyleInheritance(m)).font &&
                                    m.font.color &&
                                    (m.font.color = this._parseColor(
                                        m.font.color
                                    )),
                                m.fill &&
                                    m.fill.color &&
                                    (m.fill.color = this._parseColor(
                                        m.fill.color
                                    )),
                                null == m.hAlign ||
            ...
            if (
                ...
                for (F += "<hyperlinks>", c = 0; c < x.length; c++)
                    ...
                    /^\$?[A-Za-z]{1,2}\$?\d+(:\$?[A-Za-z]{1,2}\$?\d+)?$/.test(
                        x[c].href
                    )
                        ? (F +=
                              '<hyperlink ref="' +
            ...
            if (
                ...
                for (
                    F += '<tableParts count="' + s.tableNames.length + '">',
                        c = 0;
        ...
        (e._generateTable = function (e, t, l) {
            ...
            for (var i = "", n = 0; n < t.columns.length; n++) {
                var a = t.columns[n];
                (i +=
                    '<tableColumn name="' + a.name + '" id="' + (n + 1) + '" '),
                    a.totalRowFunction
                        ? this._tableColumnFunctions.indexOf(
                              a.totalRowFunction
                          ) > -1
                            ? (i +=
                                  'totalsRowFunction="' +
            ...
            if (
                ...
                -1 === this._tableStyles.indexOf(h) &&
                    this._tableStyles.push(h);
            }
        ...
        (e._generateTableFilterSetting = function (e, t, l) {
            ...
            if (t) {
                ...
                (r.row -= 1),
                    (o =
                        o.substring(0, s) + Workbook.xlsxAddress(r.row, r.col));
            }
            for (
                ...
                ? ((l = new wjcCore.Color("#" + s)),
                  ...
                  (o[2] =
                      t < 0
                          ? o[2] * (1 + t)
                          : o[2] * (1 - t) + (1 - 1 * (1 - t))),
                  (l = wjcCore.Color.fromHsl(o[0], o[1], o[2]))
                      .toString()
                      .substring(1))
                : s;
        }),
                ...
                for (var r = 0; r < s.length; r++)
                    (t = s[r]),
                        ...
                        (o = (o = this._getAttr(t, "ref"))
                            ...
                            : ""),
                        (t = t.replace(/(\<f.*>)(.+)/, "$2")),
                        (this._sharedFormulas[+l] =
                            this._parseSharedFormulaInfo(o, t));
        }),
            ...
            if (
                ...
                if (((c = l.formula), (u = l.formulaRefs) && u.length > 0)) {
                    ...
                    for (var m = 0; m < u.length; m++)
                        (i =
                            (f = u[m]).cellAddress.row +
                            (f.cellAddress.absRow ? 0 : s)),
                            (n =
                                f.cellAddress.col +
                                (f.cellAddress.absCol ? 0 : r)),
        ...
        (e._convertDate = function (e) {
            ...
            return s
                ...
                ? ((t = e > 59 ? 1 : 0),
                  (l = new Date(
                      1e3 * Math.round((+o + 864e5 * (e - t)) / 1e3)
                  )),
                  0 !==
                  (r = 6e4 * (l.getTimezoneOffset() - o.getTimezoneOffset()))
                      ? new Date(
                            1e3 * Math.round((+o + r + 864e5 * (e - t)) / 1e3)
                        )
                      : l)
                : null;
        }),
        (e._parseBorder = function (e, t) {
            for (var l in {
                ...
                var o = e[l];
                o &&
                    (wjcCore.isString(o.color) &&
                        (o.color = this._parseColor(o.color)),
                    null == o.style ||
        ...
        (e._numAlpha = function (e) {
            ...
            return (
                (t > -1 ? this._numAlpha(t) : "") +
                this._alphabet.charAt(e % 26)
            );
        }),
        ...
        (e._cloneStyle = function (e) {
            ...
            t = {};
            for (var l in e)
                e.hasOwnProperty(l) && (t[l] = this._cloneStyle(e[l]));
            return t;
        }),
...
var Workbook = (function () {
    ...
    return (
        Object.defineProperty(e.prototype, "sheets", {
            get: function () {
                return (
                    null == this._sheets && (this._sheets = []), this._sheets
                );
            },
            enumerable: !0,
            configurable: !0,
        ...
        Object.defineProperty(e.prototype, "styles", {
            get: function () {
                return (
                    null == this._styles && (this._styles = []), this._styles
                );
            },
            enumerable: !0,
            configurable: !0,
        ...
        Object.defineProperty(e.prototype, "tables", {
            get: function () {
                return (
                    null == this._tables && (this._tables = []), this._tables
                );
            },
            enumerable: !0,
            configurable: !0,
        ...
        (e.prototype._serialize = function () {
            ...
            return (
                ...
                this._reservedContent &&
                    (e.reservedContent = this._reservedContent),
        ...
        (e.prototype._deserialize = function (e) {
            this._deserializeWorkSheets(e.sheets),
                ...
                e.tables &&
                    e.tables.length > 0 &&
                    this._deserializeTables(e.tables),
                e.colorThemes &&
        ...
        (e.prototype._getBase64String = function (e) {
            ...
            return (
                -1 !== (t = e.search(/base64,/i)) && (e = e.substring(t + 7)), e
            );
        }),
        (e.toXlsxDateFormat = function (e) {
            ...
            if (1 === e.length)
                switch (e) {
                    ...
                    case "O":
                        t = (t =
                            wjcCore.culture.Globalize.calendar.patterns[
                                e
                            ]).replace(/f+k/gi, "000");
                        break;
                    default:
        ...
        (e.toXlsxNumberFormat = function (e) {
            ...
            if (
                (/^[ncpfdg]\d*,*$/.test(a) &&
                    ((t = a[0]), (l = this._formatMap[t])),
                l)
            ) {
                if (
                    ((o =
                        wjcCore.culture.Globalize.numberFormat.currency.symbol),
                    (s = a.split(",")),
                    "c" === t && (l = l.replace(/\{1\}/g, o)),
                    a.length > 1
                        ? (n = parseInt(s[0].substr(1)))
                        : "d" !== t && (n = 2),
                    !isNaN(n))
                )
        ...
        (e.tableAddress = function (e) {
            ...
            return l
                ? (l[3] &&
                      ((o.col = this._alphaNum(l[3])), (o.absCol = !!l[2])),
        ...
        (e.prototype._deserializeWorkSheets = function (e) {
            ...
            for (
                ...
                (l = e[o]) &&
                    ((t = new WorkSheet())._deserialize(l),
                    (this._sheets[o] = t));
        }),
        (e.prototype._deserializeWorkbookStyles = function (e) {
            ...
            for (this._styles = [], o = 0; o < e.length; o++)
                (l = e[o]) &&
                    ((t = new WorkbookStyle())._deserialize(l),
                    (this._styles[o] = t));
        }),
        ...
        (e.prototype._deserializeTables = function (e) {
            ...
            for (this._tables = [], o = 0; o < e.length; o++)
                (l = e[o]) &&
                    ((t = new WorkbookTable())._deserialize(l),
                    (this._tables[o] = t));
        }),
...
var WorkSheet = (function () {
    ...
    return (
        Object.defineProperty(e.prototype, "columns", {
            get: function () {
                return (
                    null == this._columns && (this._columns = []), this._columns
                );
            },
            enumerable: !0,
            configurable: !0,
        ...
        Object.defineProperty(e.prototype, "tableNames", {
            get: function () {
                return (
                    null == this._tableNames && (this._tableNames = []),
                    this._tableNames
                );
            },
            enumerable: !0,
        ...
        (e.prototype._serialize = function () {
            ...
            return this._checkEmptyWorkSheet()
                ...
                : ((e = {}),
                  ...
                  this.frozenPane &&
                      (e.frozenPane = this.frozenPane._serialize()),
                  this.name && (e.name = this.name),
                  null != this.summaryBelow &&
                      (e.summaryBelow = this.summaryBelow),
        ...
        (e.prototype._deserialize = function (e) {
            var t, l;
            e.style &&
                ((l = new WorkbookStyle())._deserialize(e.style),
                (this.style = l)),
                e.columns &&
                    e.columns.length > 0 &&
                ...
                e.rows &&
                    e.rows.length > 0 &&
                    this._deserializeWorkbookRows(e.rows),
                e.frozenPane &&
        ...
        (e.prototype._deserializeWorkbookColumns = function (e) {
            ...
            for (this._columns = [], o = 0; o < e.length; o++)
                (t = e[o]) &&
                    ((l = new WorkbookColumn())._deserialize(t),
                    (this._columns[o] = l));
        }),
        (e.prototype._deserializeWorkbookRows = function (e) {
            ...
            for (this._rows = [], o = 0; o < e.length; o++)
                (t = e[o]) &&
                    ((l = new WorkbookRow())._deserialize(t),
                    (this._rows[o] = l));
        }),
...
var WorkbookRow = (function () {
    ...
    return (
        ...
        (e.prototype._deserialize = function (e) {
            ...
            e.cells &&
                e.cells.length > 0 &&
                this._deserializeWorkbookCells(e.cells),
                e.style &&
                    ((t = new WorkbookStyle())._deserialize(e.style),
                    (this.style = t)),
        ...
        (e.prototype._deserializeWorkbookCells = function (e) {
            ...
            for (this._cells = [], o = 0; o < e.length; o++)
                (t = e[o]) &&
                    ((l = new WorkbookCell())._deserialize(t),
                    (this._cells[o] = l));
        }),
...
var WorkbookStyle = (function () {
    ...
    return (
        ...
        (e.prototype._deserialize = function (t) {
            var l, o, s, r;
            t.basedOn &&
                ((l = new e())._deserialize(t.basedOn), (this.basedOn = l)),
                t.fill &&
                    ((o = new WorkbookFill())._deserialize(t.fill),
                    (this.fill = o)),
                t.font &&
                    ((s = new WorkbookFont())._deserialize(t.font),
                    (this.font = s)),
                t.borders &&
...
var WorkbookBorderSetting = (function () {
    ...
    return (
        (e.prototype._serialize = function () {
            var e;
            return (null != this.color && "" !== this.color) ||
                null != this.style
                ? ((e = {}),
                  this.color &&
                      (wjcCore.isString(this.color)
                ...
                : ((e = { name: this.name }),
                  ...
                  this.firstBandedRowStyle &&
                      (e.firstBandedRowStyle =
                          this.firstBandedRowStyle._serialize()),
                  ...
                  this.secondBandedRowStyle &&
                      (e.secondBandedRowStyle =
                          this.secondBandedRowStyle._serialize()),
                  this.headerRowStyle &&
                  ...
                  this.firstHeaderCellStyle &&
                      (e.firstHeaderCellStyle =
                          this.firstHeaderCellStyle._serialize()),
                  this.lastHeaderCellStyle &&
                      (e.lastHeaderCellStyle =
                          this.lastHeaderCellStyle._serialize()),
                  this.firstTotalCellStyle &&
                      (e.firstTotalCellStyle =
                          this.firstTotalCellStyle._serialize()),
                  this.lastTotalCellStyle &&
                      (e.lastTotalCellStyle =
                          this.lastTotalCellStyle._serialize()),
                  e);
        }),
        (e.prototype._deserialize = function (e) {
            (this.name = e.name),
                ...
                e.firstBandedColumnStyle &&
                    ((this.firstBandedColumnStyle =
                        new WorkbookTableBandedStyle()),
                    this.firstBandedColumnStyle._deserialize(
                        e.firstBandedColumnStyle
                    )),
                e.firstBandedRowStyle &&
                    ((this.firstBandedRowStyle =
                        new WorkbookTableBandedStyle()),
                    this.firstBandedRowStyle._deserialize(
                        e.firstBandedRowStyle
                    )),
                e.secondBandedColumnStyle &&
                    ((this.secondBandedColumnStyle =
                        new WorkbookTableBandedStyle()),
                    this.secondBandedColumnStyle._deserialize(
                        e.secondBandedColumnStyle
                    )),
                e.secondBandedRowStyle &&
                    ((this.secondBandedRowStyle =
                        new WorkbookTableBandedStyle()),
                    this.secondBandedRowStyle._deserialize(
                        e.secondBandedRowStyle
                    )),
                e.headerRowStyle &&
                ...
                e.firstHeaderCellStyle &&
                    ((this.firstHeaderCellStyle =
                        new WorkbookTableCommonStyle()),
                    this.firstHeaderCellStyle._deserialize(
                        e.firstHeaderCellStyle
                    )),
                e.lastHeaderCellStyle &&
                    ((this.lastHeaderCellStyle =
                        new WorkbookTableCommonStyle()),
                    this.lastHeaderCellStyle._deserialize(
                        e.lastHeaderCellStyle
                    )),
                e.firstTotalCellStyle &&
                    ((this.firstTotalCellStyle =
                        new WorkbookTableCommonStyle()),
                    this.firstTotalCellStyle._deserialize(
                        e.firstTotalCellStyle
                    )),
                e.lastTotalCellStyle &&
...
var WorkbookTableBandedStyle = (function (e) {
    ...
    return (
        ...
        (t.prototype._serialize = function () {
            var t;
            return (
                (t = e.prototype._serialize.call(this)), (t.size = this.size), t
            );
        }),
        (t.prototype._deserialize = function (t) {
            e.prototype._deserialize.call(this, t),
    ...
    return (
        ...
        (t.prototype._serialize = function () {
            ...
            return (
                ...
                this.horizontal &&
                    (t.horizontal = this.horizontal._serialize()),
                t
            );
        }),
        (t.prototype._deserialize = function (t) {
            ...
            e.prototype._deserialize.call(this, t),
                t.vertical &&
                    ...
                    (this.vertical = l)),
                t.horizontal &&
                    ((o = new WorkbookBorderSetting())._deserialize(
                        t.horizontal
                    ),
                    (this.horizontal = o));
        }),

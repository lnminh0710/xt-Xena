...
var FlexGrid = (function (e) {
        ...
        return (
            i.deferUpdate(function () {
                (i._rows = new RowCollection(i, l)),
                    ...
                    (i._hdrCols = new ColumnCollection(
                        i,
                        Math.round(1.25 * l)
                    )),
            ...
            i.addEventListener(i._root, "scroll", function (e) {
                i._updateScrollPosition() &&
                    (i.finishEditing(), i._updateContent(!0));
            }),
            i.addEventListener(
                n,
                "focus",
    ...
    return (
        ...
        Object.defineProperty(t.prototype, "showGroups", {
            ...
            set: function (e) {
                e != this._shGroups &&
                    ((this._shGroups = wjcCore.asBoolean(e)),
                    this._bindGrid(!1));
            },
            enumerable: !0,
            configurable: !0,
        ...
        Object.defineProperty(t.prototype, "cloneFrozenCells", {
            ...
            set: function (e) {
                e != this.cloneFrozenCells &&
                    ((this._fzClone = wjcCore.asBoolean(e, !0)),
                    this.invalidate());
            },
            enumerable: !0,
            configurable: !0,
        ...
        Object.defineProperty(t.prototype, "sortRowIndex", {
            ...
            set: function (e) {
                e != this._sortRowIndex &&
                    ((this._sortRowIndex = wjcCore.asNumber(e, !0)),
                    this.invalidate());
            },
            enumerable: !0,
            configurable: !0,
        ...
        Object.defineProperty(t.prototype, "cellFactory", {
            ...
            set: function (e) {
                e != this._cf &&
                    (this._clearCells(),
                    (this._cf = wjcCore.asType(e, CellFactory, !1)));
            },
            enumerable: !0,
            configurable: !0,
        }),
        ...
        (t.prototype.refreshCells = function (e, t, o) {
            this.isUpdating ||
                (e ? this._updateLayout() : this._updateContent(t, o));
        }),
                    ...
                    this.columns.deferUpdate(function () {
                        ...
                        for (
                            ...
                            if (g.isVisible) {
                                if (
                                    ((l = 0),
                                    r.autoSizeMode & AutoSizeMode.Headers)
                                ) {
                                ...
                                if (
                                    r.autoSizeMode & AutoSizeMode.Cells &&
                                    h.isValid
                                )
                                    if (g._getQuickAutoSize()) {
                                        ...
                                        for (
                                            p = h.row;
                                            p <= h.row2 && p < c.rows.length;
                                            p++
                                        )
                                            if (c.rows[p].isVisible) {
                                                f = r._getDesiredWidth(
                                                    c,
                                                    p,
                                                    u,
                                                    i
        ...
        Object.defineProperty(t.prototype, "selectionMode", {
            ...
            set: function (e) {
                e != this.selectionMode &&
                    (this._clearCells(),
                    (this._selHdl.selectionMode = wjcCore.asEnum(
                        e,
                        SelectionMode
                    )));
            },
        ...
        (t.prototype.startEditing = function (e, t, o, i) {
            return (
                void 0 === e && (e = !0), this._edtHdl.startEditing(e, t, o, i)
            );
        }),
        ...
        Object.defineProperty(t.prototype, "showDropDown", {
            ...
            set: function (e) {
                e != this._shDropDown &&
                    ((this._shDropDown = wjcCore.asBoolean(e, !0)),
                    this.invalidate());
            },
            enumerable: !0,
            configurable: !0,
        ...
        (t.prototype._sortConverter = function (e, t, o, i) {
            ...
            if (i) {
                if (((this._mappedColumns = null), this._cv))
                    for (
                        var r = this._cv.sortDescriptions, l = 0;
                        l < r.length;
                        l++
                    )
                    ...
                    if (
                        ...
                        for (h = 0; h < t.rows.length; h++) {
                            ...
                            if (
                                ...
                                var l = r.dataItem;
                                l instanceof wjcCore.CollectionViewGroup &&
                                    (l = l._path),
                                    n.set(l, !0);
                            }
                        }
                        ...
                        t.rows.deferUpdate(function () {
                            for (var e = 0; e < t.rows.length; e++) {
                                ...
                                if (o instanceof GroupRow) {
                                    var i = o.dataItem;
                                    i instanceof wjcCore.CollectionViewGroup &&
                                        (i = i._path),
                ...
                switch (t.action) {
                    ...
                    case wjcCore.NotifyCollectionChangedAction.Add:
                        if (t.index == this._cv.items.length - 1) {
                            ...
                            return (
                                this.rows[o - 1] instanceof _NewRowTemplate &&
                                    o--,
                        ...
                        wjcCore.assert(
                            !1,
                            "added item should be the last one."
                        );
                        break;
        ...
        (t.prototype._getRowIndex = function (e) {
            if (this._cv) {
                ...
                if (
                    1 == this.rows.length &&
                    this.rows[0] instanceof _NewRowTemplate
                )
                    return 0;
                var o = this.selection.row,
                    i = o > -1 ? this.rows[o] : null;
                return i && (i instanceof GroupRow || null == i.dataItem)
                    ? o
                    : -1;
            }
        ...
        (t.prototype._updateLayout = function () {
            ...
            if (this.onUpdatingLayout(e)) {
                ...
                r < 1 && (r = 1),
                    (this._heightBrowser = Math.min(
                        r,
                        t._getMaxSupportedCssHeight()
                    )),
                    ...
                    for (
                        ...
                        if (((r = o[l][n]), wjcCore.isPrimitive(r))) {
                            ...
                            s._setFlag(RowColFlags.AutoGenerated, !0),
                                ...
                                s.dataType == wjcCore.DataType.Number &&
                                    (s.width = 80);
        ...
        (t.prototype._updateColumnTypes = function () {
            ...
            if (wjcCore.hasItems(e))
                for (
                    var t = e.items[0], o = this.columns, i = 0;
                    i < o.length;
                    i++
                ) {
                    var n = o[i];
        ...
        (t.prototype._addGroup = function (e) {
            ...
            if (
                ...
                for (var o = e.items, i = 0; i < o.length; i++)
                    this._addBoundRow(o, i);
            else
...
var GridPanel = (function () {
    ...
    return (
        ...
        (e.prototype.getCellData = function (e, t, o) {
                ...
                switch (this._ct) {
                    ...
                    case CellType.ColumnFooter:
                        if (
                            ...
                            if (s) {
                                var a = wjcCore.tryCast(
                                    s,
                                    wjcCore.CollectionView
                                );
                                r = a
                                    ? a.getAggregate(l.aggregate, l.binding)
                                    : wjcCore.getAggregate(
                                          l.aggregate,
                                          s.items,
                                          l.binding
                                      );
            ...
            return (
                o &&
                    ...
                    (r =
                        null != r
                            ? wjcCore.Globalize.format(r, l.format)
                            : "")),
                r
            );
        }),
        (e.prototype.setCellData = function (e, t, o, i, n) {
            ...
            if (this._ct == CellType.Cell) {
                if (s.dataMap && null != o && (s.isRequired || "" != o)) {
                    ...
                    if (null == c && null == a.getDisplayValue(null)) {
                        if (
                            !a.isEditable ||
                            a.displayMemberPath != a.selectedValuePath
                        )
                            return !1;
                    } else o = c;
                }
            ...
            if (l.dataItem && s.binding) {
                ...
                if (o !== p && !wjcCore.DateTime.equals(o, p)) {
                    ...
                    if (
                        f instanceof wjcCore.CollectionView &&
                        g != f.currentEditItem
                    ) {
        ...
        (e.prototype.getCellBoundingRect = function (e, t, o) {
            ...
            return (
                ...
                t < this.columns.frozen &&
                    (r.left -=
                        this._g.scrollPosition.x *
                        (this._g.rightToLeft ? -1 : 1)),
                r
            );
        }),
        ...
        (e.prototype._clearCells = function () {
            for (
                var e = this.hostElement, t = e.childElementCount - 1;
                t >= 0;
                t--
            ) {
                var o = e.children[t];
            ...
            if (
                ...
                switch (n.selectionMode) {
                    ...
                    case s.ListBox:
                        var a =
                            r.isSelected ||
                            this._g._selHdl.selection.containsRow(e);
        ...
        (e.prototype._getViewRange = function () {
            ...
            if (this._ct == CellType.Cell || this._ct == CellType.RowHeader) {
                ...
                if (
                    ...
                    s.top < 0 &&
                        (n.row = Math.max(
                            n.row,
                            o.getItemAt(-s.top - e._ptScrl.y) - 1
                        )),
                        s.bottom > innerHeight &&
                            (n.row2 = Math.min(
                                n.row2,
                                o.getItemAt(
                                    -s.top - e._ptScrl.y + innerHeight
                                ) + 1
                            ));
                }
            }
            if (
                this._ct == CellType.Cell ||
                this._ct == CellType.ColumnHeader
            ) {
                var a = -t.x,
                    c = e._szClient.width,
        ...
        (e.prototype.updateCell = function (t, o, i, n, r, l) {
                ...
                c == CellType.Cell
                    ...
                    : ((y += " wj-header"),
                      s.showAlternatingRows &&
                          o % 2 != 0 &&
                          (y += " wj-header-alt")),
                (c == CellType.Cell || c == CellType.RowHeader) &&
                    s._getShowErrors())
            ) {
                var x = s._getError(t, o, i);
                wjcCore.setAttribute(n, "title", x),
                    x && (y += " wj-state-invalid");
            }
            ...
            if (0 != l) {
                ...
                if (
                    ...
                    (y +=
                        " wj-sort-" + ("+" == R.currentSort ? "asc" : "desc")),
                        (n.innerHTML =
                            wjcCore.escapeHtml(P) +
                            "&nbsp;" +
                            this._getSortIcon(R));
                else if (
                        ...
                        if (
                            ...
                            if (
                                ...
                                if (wjcCore.isNumber(L)) {
                                    ...
                                    P = wjcCore.Globalize.formatNumber(
                                        L,
                                        I,
                                        !0
                                    );
                            ...
                            c == CellType.Cell &&
                            (u.isContentHtml || R.isContentHtml)
                                ? (n.innerHTML = P)
                                : (n.textContent = P || "");
                    else {
                        var F = n.firstChild;
                    ...
                    B && u.dataItem == B
                        ? (n.innerHTML =
                              '<span class="wj-glyph-pencil"></span>')
            ...
            switch (c) {
                ...
                case CellType.ColumnHeader:
                    (G =
                        g.allowDragging &&
                        0 != (s.allowDragging & AllowDragging.Columns)),
                        wjcCore.setAttribute(n, "draggable", G ? "true" : null);
            }
...
var CellRange = (function () {
    ...
    return (
        ...
        (e.prototype.intersectsRow = function (e) {
            return (
                e && !(this.bottomRow < e.topRow || this.topRow > e.bottomRow)
            );
        }),
        (e.prototype.intersectsColumn = function (e) {
            return (
                e && !(this.rightCol < e.leftCol || this.leftCol > e.rightCol)
            );
        }),
...
var Column = (function (e) {
    ...
    return (
                ...
                if (e != this.binding) {
                    ...
                    if (
                        ...
                        if (
                            o &&
                            o.sourceCollection &&
                            o.sourceCollection.length
                        ) {
                            var i = o.sourceCollection[0];
                            this._type = wjcCore.getType(
                                this._binding.getValue(i)
                            );
                        }
                    }
                    this.onPropertyChanged();
        ...
        Object.defineProperty(t.prototype, "width", {
            ...
            set: function (e) {
                null != t._parseStarSize(e)
                    ...
                    : ((this._szStar = null),
                      (this.size = wjcCore.asNumber(e, !0)));
            },
            enumerable: !0,
            configurable: !0,
        }),
        ...
        (t.prototype._getQuickAutoSize = function () {
            return (
                ...
                (wjcCore.isBoolean(this._quickSize)
                    ? this._quickSize
                    : !this.isContentHtml &&
                      !this._getFlag(RowColFlags.HasTemplate))
            );
        }),
        ...
        Object.defineProperty(t.prototype, "align", {
            ...
            set: function (e) {
                this._align != e &&
                    ((this._align = e), this.onPropertyChanged());
            },
            enumerable: !0,
            configurable: !0,
        }),
        ...
        Object.defineProperty(t.prototype, "dataMap", {
            ...
            set: function (e) {
                this._map != e &&
                    ...
                    this._map &&
                        this._map.mapChanged.addHandler(
                            this.onPropertyChanged,
                            this
                        ),
                    this.onPropertyChanged());
        ...
        Object.defineProperty(t.prototype, "currentSort", {
            get: function () {
                if (
                    ...
                    for (
                        var e = this.grid.collectionView.sortDescriptions,
                            t = 0;
                        t < e.length;
                        t++
                    )
    ...
    return (
        ...
        Object.defineProperty(t.prototype, "level", {
            ...
            set: function (e) {
                wjcCore.asInt(e),
                    e != this._level &&
                        ((this._level = e), this.onPropertyChanged());
            },
            enumerable: !0,
            configurable: !0,
        }),
...
var RowColCollection = (function (e) {
    ...
    return (
        ...
        (t.prototype.getItemAt = function (e) {
            if ((this._dirty && this._update(), e <= 0 && this.length > 0))
                return 0;
            e = Math.round(e);
            for (var t, o, i = this.length, n = 0, r = i - 1; n <= r; )
                if (((t = (n + r) >>> 1), (o = this[t])._pos > e && t > 0))
                    r = t - 1;
                else {
        ...
        (t.prototype.splice = function (t, o, i) {
            return (
                i && (i._list = this), e.prototype.splice.call(this, t, o, i)
            );
        }),
                    ...
                    r.isVisible &&
                        ...
                        (r == t && n > 0
                            ...
                            : ((r._sz = Math.max(
                                  0,
                                  Math.round(
                                      (Column._parseStarSize(r._szStar) / o) * e
                                  )
                              )),
                              (n -= r.renderWidth)));
                }
            ...
            if (
                ...
                !this._p &&
                    ...
                    (o.y < g
                        ...
                        : (this._p =
                              o.x < d ? i.bottomLeftCells : i.columnFooters)),
                null != this._p)
            ) {
                var w = this._p.rows,
                    _ = this._p.columns,
    ...
    return (
        (e.prototype.getMergedRange = function (e, t, o, i) {
            ...
            if (
                ...
                if (
                    ((n = new CellRange(t, o)),
                    h.aggregate == wjcCore.Aggregate.None)
                ) {
                    for (
                        ;
                        n.col > 0 &&
            ...
            if (s[o].allowMerging) {
                ...
                for (
                    var p = t - 1;
                    p >= u && this._mergeCell(e, p, o, t, o);
                    p--
                )
                    n.row = p;
                for (
                    var f = t + 1;
                    f <= g && this._mergeCell(e, t, o, f, o);
                    f++
                )
                    n.row2 = f;
            ...
            if (a[t].allowMerging) {
                ...
                for (
                    var C = o - 1;
                    C >= w && this._mergeCell(e, t, C, t, o);
                    C--
                )
                    n.col = C;
                for (
                    var m = o + 1;
                    m <= _ && this._mergeCell(e, t, o, t, m);
                    m++
                )
                    n.col2 = m;
                for (; n.col < o && !s[n.col].visible; ) n.col++;
        ...
        (e.prototype._mergeCell = function (e, t, o, i, n) {
            ...
            if (o != n && e.columns.isFrozen(o) != e.columns.isFrozen(n))
                return !1;
            if (t != i) {
                if (
                    o > 0 &&
    ...
    return (
                ...
                if (e != this._mode) {
                    ...
                    if (e == t.ListBox || this._mode == t.ListBox)
                        for (var o = this._g.rows, i = 0; i < o.length; i++) {
                            var n = o[i],
                                r =
                                    e == SelectionMode.ListBox &&
                                    this._sel.containsRow(i);
        ...
        (e.prototype.select = function (e, t) {
            ...
            if ((r && n.row > -1 && !o.rows[n.row].isSelected && (s = !1), s))
                ...
                if (o.onSelectionChanging(a)) {
                    if (
                        r &&
                        (n.row != i.row || n.rowSpan > 1 || i.rowSpan > 1)
                    ) {
        ...
        (e.prototype.moveSelection = function (e, t, o) {
            ...
            if (t == SelMove.NextCell)
                ...
                ((i = l.getNextCell(a.row, e, c)),
                (n = s.getNextCell(a.col, t, c)),
                o)
            ) {
    ...
    return (
            ...
            if (
                ...
                switch (a) {
                    ...
                    case wjcCore.Key.Escape:
                        if (
                            ((r = !1),
                            s && (s.currentAddItem || s.currentEditItem))
                        ) {
                            var p = new CellRangeEventArgs(
                                t.cells,
                                t.selection
                            );
                            (p.cancel = !0),
        ...
        (e.prototype._deleteSel = function (e) {
            ...
            if (
                ...
                !t.isReadOnly &&
                (null == o ||
                    (o.canRemove && !o.isAddingNew && !o.isEditingItem))
            )
                switch (t.selectionMode) {
                    case a.CellRange:
                        if (
                            0 == i.leftCol &&
                            i.rightCol == t.columns.length - 1
                        )
                            for (c = i.topRow; c > -1 && c <= i.bottomRow; c++)
                                r.push(n[c]);
                        break;
                    case a.ListBox:
                        for (c = 0; c < n.length; c++)
                            n[c].isSelected && r.push(n[c]);
                        break;
                    case a.Row:
    ...
    function e(e) {
        ...
        (this._g = e),
            ...
            e.addEventListener(o, "mousedown", function (o) {
                if (
                    ((e._rcBounds = null), !o.defaultPrevented && 0 == o.button)
                ) {
                    var r = o.target;
                    if (!e.containsFocus()) {
                        var l =
                            r instanceof HTMLElement && r.tabIndex > -1
                                ? r
                                : e._eFocus;
                    ...
                    if (
                        ...
                        wjcCore.closest(o.target, ".wj-flexgrid") !=
                            e.hostElement ||
    ...
    return (
        ...
        (e.prototype._mousedown = function (e) {
            ...
            if (((this._selDown = t.selection), o.panel == t.cells)) {
                if (wjcCore.closestClass(e.target, CellFactory._WJC_DROPDOWN))
                    return (
                        t._edtHdl._toggleListBox(e, o.range),
            ...
            if (e.target != r || !t._isInputElement(e.target))
                if (i != CellType.None) {
                    if (
                        ...
                        return (
                            r != t._eFocus &&
                                ((t._eFocus.tabIndex = 0), t._eFocus.focus()),
                    ...
                    if (
                        i == CellType.Cell &&
                        t.rows.maxGroupLevel > -1 &&
                        wjcCore.closestClass(
                            e.target,
                            CellFactory._WJC_COLLAPSE
                        )
                    ) {
                        var l = wjcCore.tryCast(t.rows[o.row], GroupRow);
                        if (l)
        ...
        (e.prototype._mousemove = function (e) {
            if (null != this._htDown) {
                ...
                if (((this._eMouse = e), this._szRowCol))
        ...
        (e.prototype._handleClick = function (e) {
            ...
            if (!e.defaultPrevented && i.grid == t && !t._isInputElement(o))
                if (i.panel == t.topLeftCells)
                    ...
                    t.select(
                        new CellRange(i.row, 0, i.row, t.columns.length - 1)
                    );
                else if (i.panel == t.cells)
                    if (i.row < 0) this._clickSort(e, i);
                    else if (
                        wjcCore.closestClass(o, CellFactory._WJC_COLLAPSE)
                    ) {
                        var n = t.rows[i.row];
                        n instanceof GroupRow &&
                            (e.ctrlKey
                                ? t.collapseGroupsToLevel(
                                      n.isCollapsed ? n.level + 1 : n.level
                                  )
        ...
        (e.prototype._clickSort = function (e, t) {
            ...
            if (i && i.canSort && o.allowSorting) {
                ...
                if (l.allowSorting && s) {
                    for (
                        var a = t.grid.collectionView.sortDescriptions,
                            c = null,
                            h = 0;
                        h < a.length;
                        h++
                    ...
                    o.onSortingColumn(d) &&
                        ...
                        n
                            ...
                            : a.splice(
                                  0,
                                  a.length,
                                  new wjcCore.SortDescription(s, c)
                              ),
                        o.onSortedColumn(d));
                }
            }
            ...
            if (!e.defaultPrevented)
                if (i.edgeRight && o.allowResizing & AllowResizing.Columns) {
                    if (
                        ...
                        e.preventDefault(),
                            e.ctrlKey && r.containsColumn(i.col) && (l = r);
                        for (var s = l.leftCol; s <= l.rightCol; s++)
                            o.columns[s].allowResizing &&
                                ((t = new CellRangeEventArgs(
                                    o.cells,
                                    new CellRange(-1, s)
                                )),
                    ...
                    i.edgeBottom &&
                    o.allowResizing & AllowResizing.Rows
                ) {
                    if (
        ...
        (e.prototype._hover = function (e) {
            if (null == this._htDown) {
                ...
                return (
                    ...
                    (this._szStart = this._szRowCol
                        ? this._szRowCol.renderSize
                        : 0),
        ...
        (e.prototype._getResizeRow = function (e) {
            for (
                var t = e.panel.rows, o = t[e.row], i = e.row + 1;
                i < t.length;
                i++
            )
                if ((n = t[i]).visible) {
            ...
            if (
                e.row == t.length - 1 &&
                (e.cellType == CellType.TopLeft ||
                    e.cellType == CellType.ColumnHeader)
            ) {
                t = this._g.rows;
                for (i = 0; i < t.length; i++) {
                    var n = t[i];
            ...
            if (this._szRowCol instanceof Row) {
                var o = this._g,
                    ...
                    n = Math.round(
                        Math.max(
                            e._SZ_MIN,
                            this._szStart + (r - this._htDown.point.y)
                        )
                    );
                if (this._szRowCol.renderSize != n) {
                    if (null == this._szArgs) {
        ...
        (e.prototype._dragover = function (e) {
            ...
            this._htDown &&
                ...
                (o.cellType == CellType.ColumnHeader
                    ? ((n.cancel = !t.columns.canMoveElement(
                          this._htDown.col,
                          o.col
                      )),
                      (i = t.onDraggingColumnOver(n)))
                    : o.cellType == CellType.RowHeader &&
                      ((n.cancel = !t.rows.canMoveElement(
                          this._htDown.row,
                          o.row
                      )),
                ...
                switch (e.cellType) {
                    case CellType.ColumnHeader:
                        ...
                        (n.left = r.pos - n.width / 2),
                            e.col > this._htDown.col &&
                                (n.left += r.renderWidth),
                            t.rightToLeft &&
                                (n.left =
                                    o.parentElement.clientWidth -
                                    n.left -
                                    n.width);
                        break;
                    case CellType.RowHeader:
                        ...
                        (n.top = l.pos - n.height / 2),
                            e.row > this._htDown.row &&
                                (n.top += l.renderHeight);
                }
                wjcCore.setCss(o, n);
            }
        }),
        ...
        (e.prototype._handleSelection = function (e, t) {
            ...
            if (e.row > -1 && e.col > -1)
                if (null != this._lbSelRows) {
                    ...
                    l && o.refreshCells(!1, !0, !0),
                        o.scrollIntoView(e.row, e.col);
                } else
                    e.cellType == CellType.RowHeader &&
    ...
    _EditHandler = (function () {
                    ...
                    if (t.finishEditing()) {
                        ...
                        if (n != i.row) {
                            ...
                            (n > -1 && n < r ? e.rows[n].dataItem : null) !=
                                (i.row > -1 && i.row < r
                                    ? e.rows[i.row].dataItem
                                    : null) && t._commitRowEdits();
                        }
                    } else i.cancel = !0;
                }),
                ...
                e.addEventListener(
                    ...
                    function (o) {
                        if (
                            ...
                            var i = e.hitTest(o);
                            if (
                                i.cellType != CellType.Cell &&
                                i.cellType != CellType.None
                            )
                                t.finishEditing();
                            else if (i.cellType != CellType.None) {
                                var n = wjcCore.tryCast(
                                    o.target,
                                    HTMLInputElement
                                );
        ...
        return (
            (e.prototype.startEditing = function (e, t, o, i, n) {
                ...
                if ((r.select(l, !0), !r.rows[t] || s != r.rows[t].dataItem))
                    return !1;
                ...
                if (u) {
                    ...
                    if ((r.onPrepareCellForEdit(a), u.disabled || u.readOnly))
                        return !1;
                }
            ...
            (e.prototype.finishEditing = function (e) {
                ...
                return (
                    wjcCore.contains(g, wjcCore.getActiveElement()) &&
                        g.focus(),
                    n.cancel || !n.refresh
            ...
            (e.prototype._expandClipRows = function (e, t) {
                ...
                for (
                    var r = this._g, l = 0, s = 0, a = t.topRow;
                    a <= t.bottomRow;
                    a++
                )
                    r.rows[a].isVisible && l++;
                for (c = t.leftCol; c <= t.rightCol; c++)
                    r.columns[c].isVisible && s++;
                if (
                    (l > 1 || s > 1) &&
                    (1 == l && (l = o),
                    1 == s && (s = i),
            ...
            (e.prototype._updateEditorCell = function (e, t, o) {
                var i = this._g,
                    ...
                    r =
                        i._useFrozenDiv() &&
                        (e < i.frozenRows || t < i.frozenColumns);
            ...
            (e.prototype._allowEditing = function (e, t) {
                var o = this._g;
                if (o.isReadOnly || o.selectionMode == SelectionMode.None)
                    return !1;
                if (
                    e < 0 ||
                    e >= o.rows.length ||
            ...
            (e.prototype._keypress = function (e) {
                ...
                if (
                    ...
                    e.target == t &&
                        (o++, (i += String.fromCharCode(e.charCode))),
                        (i = i.toLowerCase());
            ...
            (e.prototype._toggleListBox = function (e, t) {
                ...
                if (
                    (t || (t = i),
                    this._lbx && (this._removeListBox(), i.contains(t)))
                )
                    return (
                        o.activeEditor
            ...
            (e.prototype._createListBox = function () {
                ...
                return (
                    s
                        ...
                        : (wjcCore.showPopup(
                              r,
                              t.getCellBoundingRect(o.row, o.col)
                          ),
    ...
    return (
        ...
        (e.prototype.updateNewRowTemplate = function () {
            ...
            if (!i && n > -1) {
                ...
                i &&
                    ...
                    l &&
                        (this._top
                            ? o.insert(0, this._nrt)
                            : o.push(this._nrt)),
                    this._nrt &&
                        this._nrt._setFlag(RowColFlags.ParentCollapsed, !1));
        }),
        (e.prototype._attach = function () {
            ...
            e &&
                ...
                e.hostElement.addEventListener(
                    "keydown",
                    this._keydownBnd,
                    !0
                ));
        ...
        (e.prototype._detach = function () {
            ...
            e &&
                ...
                e.hostElement.removeEventListener(
                    "keydown",
                    this._keydownBnd,
                    !0
                ));
            ...
            if (null == t.activeEditor) {
                ...
                if (t.startEditing(!1, o.row, o.col, !1)) {
                    ...
                    o.row < t.frozenRows && (r += i.parentElement.scrollTop),
                        o.col < t.frozenColumns &&
                            (n += i.parentElement.scrollLeft);

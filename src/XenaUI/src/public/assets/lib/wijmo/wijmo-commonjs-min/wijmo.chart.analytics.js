            ...
            return (
                ...
                null == r._originXValues || null == r._originYValues
                    ...
                    : (t.prototype.getValues.call(this, e),
                      (null != r._xValues && null != r._yValues) ||
                          r._calculateValues(),
                      0 === e
                          ? r._yValues || null
                          : 1 === e
...
var TrendLine = (function (t) {
    function e(e) {
        var r = t.call(this) || this;
        return (
            (r._fitType = TrendLineFitType.Linear),
            (r._order = 2),
            r.initialize(e),
            r
        );
    ...
    return (
        ...
        Object.defineProperty(e.prototype, "fitType", {
            ...
            set: function (t) {
                (t = wjcCore.asEnum(t, TrendLineFitType, !1)) !=
                    this._fitType && ((this._fitType = t), this._invalidate());
            },
            enumerable: !0,
            configurable: !0,
        }),
        Object.defineProperty(e.prototype, "order", {
            ...
            set: function (t) {
                t != this._order &&
                    ((this._order = wjcCore.asNumber(t, !1, !0)),
                    this._invalidate());
            },
            enumerable: !0,
            configurable: !0,
...
var Calculator = (function () {
                ...
                get: function () {
                    return (
                        null == this._sumOfSquareX &&
                            (this._sumOfSquareX = MathHelper.sumOfSquares(
                                this._x
                            )),
                        this._sumOfSquareX
                    );
                ...
                get: function () {
                    return (
                        null == this._sumOfSquareY &&
                            (this._sumOfSquareY = MathHelper.sumOfSquares(
                                this._y
                            )),
                        this._sumOfSquareY
                    );
                ...
                get: function () {
                    return (
                        null == this._sumOfSquareLogX &&
                            (this._sumOfSquareLogX = MathHelper.sumOfSquares(
                                this.LogX
                            )),
                ...
                get: function () {
                    return (
                        null == this._sumOfSquareLogY &&
                            (this._sumOfSquareLogY = MathHelper.sumOfSquares(
                                this.LogY
                            )),
    ...
    TrendHelperBase = (function () {
        ...
        return (
            ...
            Object.defineProperty(t.prototype, "count", {
                ...
                set: function (t) {
                    t !== this.count &&
                        (this._count = wjcCore.asInt(t, !1, !0));
                },
                enumerable: !0,
                configurable: !0,
            }),
            ...
            (t.prototype.calculateValues = function () {
                for (
                    ...
                    var i = this.xMin + t * r,
                        n = this.calcY(i);
                    e[0].push(n),
                        this._isXString ? e[1].push(i - 1) : e[1].push(i);
                }
                return e;
            }),
            ...
            (t.prototype.calcB = function () {
                ...
                return (
                    (t * r - i * e.sumY) /
                    (t * e.sumOfSquareX - MathHelper.square(i))
                );
            }),
    ...
    LinearHelper = (function (t) {
        ...
        return (
            ...
            Object.defineProperty(e.prototype, "yOffset", {
                ...
                set: function (t) {
                    t !== this.yOffset &&
                        (this._yOffset = wjcCore.asNumber(t, !0));
                },
                enumerable: !0,
                configurable: !0,
            }),
    ...
    LogHelper = (function (t) {
        ...
        return (
            ...
            (e.prototype.calcB = function () {
                ...
                return (
                    (t * r - i * n) /
                    (t * e.sumOfSquareLogX - MathHelper.square(n))
                );
            }),
            (e.prototype._calculateCoefficients = function () {
                var t = this.calcB(),
    ...
    ExpHelper = (function (t) {
        ...
        return (
            ...
            (e.prototype.calcA = function () {
                ...
                return Math.exp(
                    (r * i - n * a) / (t * i - MathHelper.square(n))
                );
            }),
            (e.prototype.calcB = function () {
                var t = this.y.length,
    ...
    FourierHelper = (function (t) {
        function e(e, r, i, n) {
            return (
                (n = null == n ? r.length : n), t.call(this, e, r, i, n) || this
            );
        }
        return (
            __extends(e, t),
    ...
    FunctionSeries = (function (t) {
        function e(e) {
            ...
            return (
                ...
                r.initialize(e),
                null == r.itemsSource &&
                    (r.itemsSource = [new wjcCore.Point(0, 0)]),
                r
            );
        }
        return (
            ...
            Object.defineProperty(e.prototype, "min", {
                ...
                set: function (t) {
                    this._min !== t &&
                        ((this._min = wjcCore.asNumber(t, !1)),
                        this._invalidate());
                },
                enumerable: !0,
                configurable: !0,
            ...
            Object.defineProperty(e.prototype, "max", {
                ...
                set: function (t) {
                    this._max !== t &&
                        ((this._max = wjcCore.asNumber(t, !1)),
                        this._invalidate());
                },
                enumerable: !0,
                configurable: !0,
            ...
            (e.prototype.getValues = function (t) {
                var e = this;
                return (
                    (null != e._xValues && null != e._yValues) ||
                        e._calculateValues(),
                    0 === t
                        ? e._yValues || null
                        : 1 === t
    ...
    return (
        ...
        Object.defineProperty(e.prototype, "func", {
            ...
            set: function (t) {
                t &&
                    this._func !== t &&
                    ((this._func = wjcCore.asFunction(t, !1)),
                    this._invalidate());
            },
            enumerable: !0,
            configurable: !0,
    ...
    return (
        ...
        Object.defineProperty(e.prototype, "xFunc", {
            ...
            set: function (t) {
                t &&
                    this._xFunc !== t &&
                    ((this._xFunc = wjcCore.asFunction(t, !1)),
                    this._invalidate());
            },
            enumerable: !0,
            configurable: !0,
        ...
        Object.defineProperty(e.prototype, "yFunc", {
            ...
            set: function (t) {
                t &&
                    this._yFunc !== t &&
                    ((this._yFunc = wjcCore.asFunction(t, !1)),
                    this._invalidate());
            },
            enumerable: !0,
            configurable: !0,
        ...
        Object.defineProperty(e.prototype, "period", {
            ...
            set: function (t) {
                (t = wjcCore.asNumber(t, !1, !0)) != this._period &&
                    ((this._period = wjcCore.asNumber(t, !1, !0)),
                    this._invalidate());
            },
            enumerable: !0,
            configurable: !0,
        ...
        (e.prototype._checkPeriod = function () {
            ...
            t <= 1 && wjcCore.assert(!1, "period must be greater than 1."),
                e &&
                    ...
                    wjcCore.assert(
                        !1,
                        "period must be less than itemSource's length."
                    );
        }),
        (e.prototype._calculateValues = function () {
            this._type;
...
var Waterfall = (function (t) {
    ...
    return (
        ...
        Object.defineProperty(e.prototype, "relativeData", {
            ...
            set: function (t) {
                t != this._relativeData &&
                    ((this._relativeData = wjcCore.asBoolean(t, !0)),
                    this._invalidate());
            },
            enumerable: !0,
            configurable: !0,
        ...
        Object.defineProperty(e.prototype, "start", {
            ...
            set: function (t) {
                t != this._start &&
                    ((this._start = wjcCore.asNumber(t, !0)),
                    this._invalidate());
            },
            enumerable: !0,
            configurable: !0,
        ...
        Object.defineProperty(e.prototype, "startLabel", {
            ...
            set: function (t) {
                t != this._startLabel &&
                    ((this._startLabel = wjcCore.asString(t, !1)),
                    this._invalidate());
            },
            enumerable: !0,
            configurable: !0,
        ...
        Object.defineProperty(e.prototype, "showTotal", {
            ...
            set: function (t) {
                t != this._showTotal &&
                    ((this._showTotal = wjcCore.asBoolean(t, !0)),
                    this._invalidate());
            },
            enumerable: !0,
            configurable: !0,
        ...
        Object.defineProperty(e.prototype, "totalLabel", {
            ...
            set: function (t) {
                t != this._totalLabel &&
                    ((this._totalLabel = wjcCore.asString(t, !1)),
                    this._invalidate());
            },
            enumerable: !0,
            configurable: !0,
        ...
        Object.defineProperty(e.prototype, "intermediateTotalPositions", {
            ...
            set: function (t) {
                t != this._intermediateTotalPositions &&
                    ((this._intermediateTotalPositions = wjcCore.asArray(
                        t,
                        !0
                    )),
                    this._invalidate());
        ...
        (e.prototype.getValues = function (e) {
                ...
                if (!this._yValues) {
                    ...
                    (i = this._yValues) &&
                        ...
                        (this.showIntermediateTotal &&
                            ...
                            this.intermediateTotalPositions.reduceRight(
                                function (t, e) {
                                    var r = 0 === e ? i[0] : i[e - 1];
                                    return (
                                        i.length > e
                                            ? (i.splice(e, 0, r),
                                              o._intermediateTotalPos.splice(
                                                  e,
                                                  0,
                                                  !0
                                              ))
                                            : i.length === e &&
                                              (i.push(r),
                                              o._intermediateTotalPos.push(!0)),
                                        0
                                    );
                                },
                                0
            ...
            if (
                ...
                this._xValues &&
                    ...
                    (a = this._xValues[h - 1]),
                    (u = Math.abs(
                        this._xValues[h - 1] - this._xValues[h - 2]
                    ))),
                ...
                if (
                    ...
                    p &&
                        this.intermediateTotalPositions.reduceRight(function (
                            t,
                            e,
                            r
                        ) {
        ...
        (e.prototype._getStyles = function () {
            ...
            return (
                (this._wfstyle = {
                    ...
                    intermediateTotal: this._getStyleByKey(
                        i,
                        "intermediateTotal",
                        e,
                        r
        ...
        Object.defineProperty(e.prototype, "groupWidth", {
            ...
            set: function (t) {
                t != this._groupWidth &&
                    t >= 0 &&
                    t <= 1 &&
                    ((this._groupWidth = wjcCore.asNumber(t, !0)),
                    this._invalidate());
            },
            enumerable: !0,
            configurable: !0,
        ...
        Object.defineProperty(e.prototype, "gapWidth", {
            ...
            set: function (t) {
                t != this._gapWidth &&
                    t >= 0 &&
                    t <= 1 &&
                    ((this._gapWidth = wjcCore.asNumber(t, !0)),
                    this._invalidate());
            },
            enumerable: !0,
            configurable: !0,
        ...
        Object.defineProperty(e.prototype, "showMeanLine", {
            ...
            set: function (t) {
                t != this._showMeanLine &&
                    ((this._showMeanLine = wjcCore.asBoolean(t, !0)),
                    this._invalidate());
            },
            enumerable: !0,
            configurable: !0,
        ...
        Object.defineProperty(e.prototype, "showOutliers", {
            ...
            set: function (t) {
                t != this._showOutliers &&
                    ((this._showOutliers = wjcCore.asBoolean(t, !0)),
                    this._invalidate());
            },
            enumerable: !0,
            configurable: !0,
        ...
        (e.prototype._rendering = function (t, e) {
            ...
            if (v) {
                ...
                if (p.rotated) {
                    ...
                    s.convert(O);
                    for (
                        var T = u.actualMin, B = u.actualMax, X = 0;
                        X < C;
                        X++
                    ) {
                        var A = x ? x[X] : X,
                        ...
                        if (
                            (p._getSymbolOrigin &&
                                u.convert(p._getSymbolOrigin(O, X)),
                            p._getSymbolStyles)
                        ) {
                        ...
                        if (
                            ...
                            var k = new _BoxPlot(q, m, d),
                                I = {
                                    ...
                                    outlierPoints: this._convertPoints(
                                        k.outlierPoints,
                                        s
                                    ),
                                    innerPoints: this._convertPoints(
                                        k.innerPoints,
                                        s
                                    ),
                                },
                            ...
                            if (o.itemFormatter) {
                                ...
                                R._setData(a, X),
                                    o.itemFormatter(h, R, function () {
                                        r._drawBoxWhisker(h, I, W, i, n, a),
                                            (i = I),
                                            (n = W);
                                    }),
                                    h.endGroup();
                            } else
                                this._drawBoxWhisker(h, I, W, i, n, a),
                                    (i = I),
                                    (n = W);
                    ...
                    u.convert(O);
                    for (
                        var z = s.actualMin, K = s.actualMax, X = 0;
                        X < C;
                        X++
                    ) {
                        A = x ? x[X] : X;
                        ...
                        if (
                            (p._getSymbolOrigin &&
                                u.convert(p._getSymbolOrigin(O, X, C)),
                            p._getSymbolStyles &&
                                ((P =
                                    (Y = p._getSymbolStyles(X, C)) && Y.fill
                                        ? Y.fill
                                        : P),
                                (M = Y && Y.fill ? Y.fill : M),
                            ...
                            o.itemFormatter
                                ? (h.startGroup(),
                                  ...
                                  o.itemFormatter(h, R, function () {
                                      r._drawBoxWhisker(h, Z, I, i, n, a),
                                          (i = Z),
                                          (n = I);
                                  }),
                                  h.endGroup())
                                : (this._drawBoxWhisker(h, Z, I, i, n, a),
                                  (i = Z),
                                  (n = I)),
                                a._setPointIndex(X, E),
                                E++,
                                ((G = new wjcChart._DataPoint(
                                    f,
                                    X,
                                    A,
                                    q
    ...
    return (
        ...
        (t.prototype._parse = function () {
            ...
            (this._outlierPoints = []),
                ...
                (this._iqr =
                    1.5 * Math.abs(this._thirdQuartile - this._firstQuartile));
...
var ErrorBar = (function (t) {
    ...
    return (
        ...
        Object.defineProperty(e.prototype, "direction", {
            ...
            set: function (t) {
                t != this._direction &&
                    ((this._direction = wjcCore.asEnum(
                        t,
                        ErrorBarDirection,
                        !0
                    )),
        ...
        (e.prototype._getCustomValue = function (t) {
            var e,
                r = this.value,
                i = { minus: 0, plus: 0 };
            return null != this._minusBindingValues ||
                null != this._plusBindingValues
                ? ((i.minus =
                      (this._minusBindingValues &&
                          this._minusBindingValues[t]) ||
                      0),
                  (i.plus =
                      (this._plusBindingValues && this._plusBindingValues[t]) ||
                      0),
                  i)
                : null == r
                ? i
                : (wjcCore.isArray(r)
                      ...
                      : wjcCore.isNumber(r)
                      ? ((i.minus = r), (i.plus = r))
                      : (r.minus && (i.minus = r.minus),
                        r.plus && (i.plus = r.plus)),
                  i);
        }),

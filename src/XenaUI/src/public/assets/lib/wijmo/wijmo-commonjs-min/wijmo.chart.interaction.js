    ...
    return (
        ...
        Object.defineProperty(t.prototype, "isHorizontal", {
            ...
            set: function (t) {
                if (t != this._isHorizontal) {
                    if (
                        ((this._isHorizontal = wjcCore.asBoolean(t)),
                        !this._rsContainer)
                    )
                        return;
                    this._invalidate();
        ...
        Object.defineProperty(t.prototype, "minScale", {
            ...
            set: function (t) {
                t >= 0 &&
                    t != this._minScale &&
                    (this._minScale = wjcCore.asNumber(t));
            },
            enumerable: !0,
            configurable: !0,
        }),
        Object.defineProperty(t.prototype, "maxScale", {
            ...
            set: function (t) {
                t >= 0 &&
                    t != this._maxScale &&
                    (this._maxScale = wjcCore.asNumber(t));
            },
            enumerable: !0,
            configurable: !0,
        }),
        ...
        (t.prototype._createSlider = function (e) {
            ...
            (this._rsContainer = e),
                ...
                (this._wrapperSliderMousedown =
                    this._onSliderMousedown.bind(this)),
                ...
                (this._wrapperRangeMouseleave =
                    this._onRangeMouseleave.bind(this)),
        ...
        (t.prototype._onSliderMousedown = function (e) {
            this._isVisible &&
                ...
                this._movingEle != this._rangeHandler
                    ? (this._isHorizontal
                          ? (this._movingOffset.left +=
                                0.5 * this._movingEle.offsetWidth)
                          : (this._movingOffset.top +=
                                0.5 * this._movingEle.offsetHeight),
                      wjcCore.addClass(
                          this._movingEle,
                          t._RANGESLIDER_HANDLE_ACTIVE
                      ))
                ...
                (n !== this._rsContent && n !== this._rsEle) ||
                    (this._isHorizontal
                        ? ((o = s.width / i.width),
                          e.x < s.left
                              ? (o *= -1)
                              : e.x > s.left + s.width && (o *= 1))
                        : ((o = s.height / i.height),
                          e.y < s.top
                              ? (o *= 1)
                              : e.y > s.top + s.height && (o *= -1)),
                    0 !== o && this._doSliding(o, e));
        }),
        (t.prototype._onRangeMouseleave = function (t) {
            t.stopPropagation(),
                t.preventDefault(),
                this._isBtnMousedown &&
                    (this._clearInterval(), this.onRangeChanged());
        }),
...
var RangeSelector = (function () {
    ...
    return (
        ...
        Object.defineProperty(t.prototype, "orientation", {
            ...
            set: function (t) {
                if (
                    (t = wjcCore.asEnum(t, Orientation)) !== this._orientation
                ) {
        ...
        (t.prototype._createRangeSelector = function () {
            ...
            (this._rangeSelectorEle = wjcCore.createElement(
                ...
                (this._rangeSlider = new _RangeSlider(
                    this._rangeSelectorEle,
                    !1,
                    !1,
                    {
        ...
        (t.prototype._adjustMinAndMax = function () {
            var t = this,
                ...
                a = wjcCore.isDate(o.actualMin)
                    ? o.actualMin.valueOf()
                    : o.actualMin,
                r = wjcCore.isDate(o.actualMax)
                    ? o.actualMax.valueOf()
                    : o.actualMax;
            (t._min =
                null === s || isNaN(s) || void 0 === s || s < a || s > r
                    ? a
                    : s),
                (t._max =
                    null === n || isNaN(n) || void 0 === n || n < a || n > r
                        ? r
                        : n);
        ...
        (t.prototype._getMinAndMax = function () {
            ...
            return (
                i &&
                    (this._orientation === Orientation.X
                        ? ((s = e.axisX.convertBack(
                              i.left + t._minPos * i.width
                          )),
                          (n = e.axisX.convertBack(
                              i.left + t._maxPos * i.width
                          )))
                        : ((s = e.axisY.convertBack(
                              i.top + (1 - t._minPos) * i.height
                          )),
                          (n = e.axisY.convertBack(
                              i.top + (1 - t._maxPos) * i.height
                          )))),
                { min: s, max: n }
            );
        }),
...
!(function (t) {
    ...
    (InteractiveAxes =
        exports.InteractiveAxes || (exports.InteractiveAxes = {}))
);
    ...
    return (
        ...
        Object.defineProperty(t.prototype, "interactiveAxes", {
            ...
            set: function (t) {
                t !== this._interactiveAxes &&
                    (this._interactiveAxes = wjcCore.asEnum(
                        t,
                        InteractiveAxes
                    ));
            },
        ...
        Object.defineProperty(t.prototype, "scaleX", {
            ...
            set: function (t) {
                t !== this._scaleX &&
                    ((this._scaleX =
                        t < 0 ? 0 : t > 1 ? 1 : wjcCore.asNumber(t)),
                    this._seriesGroup &&
        ...
        (t.prototype._onMouseup = function (t) {
            this._enable &&
                (this._mouseup(t), this._disabledOthersInteraction(!1));
        }),
            ...
            t.preventManipulation && t.preventManipulation(),
                ...
                1 === this._startPointers.length
                    ...
                    : 2 === this._startPointers.length &&
                      ...
                      (this._startDistance = {
                          x:
                              this._startPointers[0].x -
                              this._startPointers[1].x,
                          y:
                              this._startPointers[0].y -
                              this._startPointers[1].y,
                      }));
        }),
                ...
                this._scaling &&
                    ...
                    this._mvPointers[e] &&
                        ...
                        (Math.abs(this._startDistance.x) > this._threadHold &&
                            this._interactiveAxes !== InteractiveAxes.Y &&
                            ((s =
                                this._mvPointers[e].x - this._plotOffset.left),
                            (n =
                                this._startPointers[0].x -
                                this._plotOffset.left),
                            (r.x = Math.abs(
                                (this._mvPointers[e].x -
                                    this._mvPointers[i].x) /
                        ...
                        Math.abs(this._startDistance.y) > this._threadHold &&
                            ...
                            (r.y = Math.abs(
                                (this._mvPointers[e].y -
                                    this._mvPointers[i].y) /
            ...
            switch (this._interactiveAxes) {
                ...
                case InteractiveAxes.XY:
                    Math.abs(e) >= this._threadHold &&
                        ...
                        e > 0 &&
                            (s.left = t.x - this._zoomEleOffset.left + "px")),
                        Math.abs(i) >= this._threadHold &&
                            ((s.height = Math.abs(i) + "px"),
                            i > 0 &&
                                (s.top = t.y - this._zoomEleOffset.top + "px"));
            }
        ...
        (t.prototype._zoomedAxis = function (t, e) {
            ...
            t &&
                ...
                ((i = n.convertBack(
                    this._startFirstPt[o] -
                        this._plotOffset[a] +
                        this._plotBox[o]
                )),
                (s = n.convertBack(
                    t[o] - this._plotOffset[a] + this._plotBox[o]
                )) -
                    i !=
                    0 &&
                    this._updateAxisRange(n, Math.min(i, s), Math.max(i, s)));
        }),
        ...
        (t.prototype._getAxisMin = function (t) {
            return wjcCore.isDate(t.actualMin)
                ? t.actualMin.valueOf()
                : t.actualMin;
        }),
        (t.prototype._getAxisMax = function (t) {
            return wjcCore.isDate(t.actualMax)
                ? t.actualMax.valueOf()
                : t.actualMax;
        }),
        (t.prototype._getTransFormGroups = function () {
            ...
            return (
                0 === t.length && (t = this._seriesGroup.querySelectorAll("g")),
                t
            );
        }),

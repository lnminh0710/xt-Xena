...
var AnnotationBase = (function () {
    ...
    return (
        Object.defineProperty(t.prototype, "attachment", {
            ...
            set: function (t) {
                (t = wjcCore.asEnum(t, AnnotationAttachment)) !=
                    this._attachment &&
        ...
        Object.defineProperty(t.prototype, "pointIndex", {
            ...
            set: function (t) {
                t !== this._pointIndex &&
                    ((this._pointIndex = wjcCore.asNumber(t, !1, !0)),
                    this._repaint());
            },
            enumerable: !0,
            configurable: !0,
        ...
        (t.prototype._convertPoint = function (t) {
            ...
            switch (
                (_._layer &&
                    _._layer._chart &&
                    (n = (e = _._layer._chart)._plotRect),
                p)
            ) {
                case AnnotationAttachment.DataIndex:
                    if (!e.series || e.series.length <= _.seriesIndex) break;
                    if (
                        ((r = e.series[_.seriesIndex]),
                        !(s = r._getItem(_.pointIndex)))
                    )
                        break;
                    (o = r.axisX || e.axisX),
                        (i = r.axisY || e.axisY),
                        "string" == typeof (a = s[r.bindingX] || s.x) &&
                            (a = _.pointIndex),
        ...
        (t.prototype._renderCenteredText = function (t, e, n, o, i, r) {
            ...
            this._isValidPoint(n) &&
                (i
                    ? e.drawStringRotated(t, n, n, i, o, r)
                    : e.drawString(t, n, o, r),
        ...
        (t.prototype._getPositionOffset = function (t) {
            ...
            return (
                (n & AnnotationPosition.Top) === AnnotationPosition.Top
                    ? (e.y -= o.height / 2)
                    : (n & AnnotationPosition.Bottom) ===
                          AnnotationPosition.Bottom && (e.y += o.height / 2),
                (n & AnnotationPosition.Left) === AnnotationPosition.Left
                    ? (e.x -= o.width / 2)
                    : (n & AnnotationPosition.Right) ===
                          AnnotationPosition.Right && (e.x += o.width / 2),
                e
            );
        }),
        ...
        (e.prototype._renderText = function (t) {
            ...
            (e = i._convertPoint(i._getContentCenter())),
                ...
                i._isValidPoint(e) &&
                    ((o =
                        (o =
                            (180 * Math.atan2(s.y - r.y, s.x - r.x)) /
                            Math.PI) < -90
                            ? o + 180
                            : o > 90
                            ? o - 180
...
var Circle = (function (t) {
    ...
    return (
        ...
        Object.defineProperty(e.prototype, "radius", {
            ...
            set: function (t) {
                t !== this._radius &&
                    ((this._radius = wjcCore.asNumber(t, !1, !0)),
                    this._repaint());
            },
            enumerable: !0,
            configurable: !0,
...
var Square = (function (t) {
    ...
    return (
        ...
        Object.defineProperty(e.prototype, "length", {
            ...
            set: function (t) {
                t !== this._length &&
                    ((this._length = wjcCore.asNumber(t, !1, !0)),
                    this._repaint());
            },
            enumerable: !0,
            configurable: !0,
    ...
    return (
        ...
        (e.prototype._renderShape = function (e) {
            ...
            i.length > 0 &&
                n._isValidPoint(o) &&
                (n._adjustOffset(o, a),
                e.drawImage(i, o.x - r / 2, o.y - s / 2, r, s)),
    ...
    return (
        ...
        (t.prototype._renderAnnotations = function () {
            var t,
                e = this.items,
                n = e.length;
            for (this._renderGroup(), t = 0; t < n; t++)
                this._renderAnnotation(e[t]);
        }),
        ...
        (t.prototype._destroyAnnotation = function (t) {
            this._layerEle && this._layerEle.removeChild(t._element),
                t.destroy();
        }),

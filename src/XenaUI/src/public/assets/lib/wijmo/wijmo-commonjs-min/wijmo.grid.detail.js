    ...
    return (
        ...
        (e.prototype.showDetail = function (e, t) {
            ...
            var i = this._g,
                o = i.rows;
            if (
                ((e = this._toIndex(e)) > 0 && o[e] instanceof DetailRow && e--,
                t)
            ) {
        ...
        (e.prototype._toIndex = function (e) {
            return (
                e instanceof wjcGrid.Row && (e = e.index),
        ...
        (e.prototype._formatItem = function (e, t) {
            ...
            if (
                ...
                if (
                    ...
                    this._maxHeight > 0 &&
                        ...
                        (r = this._maxHeight),
                        (o.height = r),
                        o.detail.style.height ||
                            (o.detail.style.height = "100%");
            ...
            if (
                ...
                var a =
                    t.row < i.rows.length - 1 &&
                    i.rows[t.row + 1] instanceof DetailRow;
                t.cell.innerHTML = a
        ...
        (t.prototype.getMergedRange = function (t, i, o, n) {
            switch ((void 0 === n && (n = !0), t.cellType)) {
                ...
                case wjcGrid.CellType.RowHeader:
                    ...
                    if (
                        i < t.rows.length - 1 &&
                        t.rows[i + 1] instanceof DetailRow
                    )

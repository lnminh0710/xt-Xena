...
var ValueFilter = (function () {
    ...
    return (
        ...
        Object.defineProperty(e.prototype, "isActive", {
            get: function () {
                return (
                    null != this._values && Object.keys(this._values).length > 0
                );
            },
            enumerable: !0,
            configurable: !0,
...
var ValueFilterEditor = (function (e) {
    function t(t, i) {
        ...
        if (
            ...
            wjcCore.setText(
                r._spSelectAll,
                wjcCore.culture.FlexGridFilter.selectAll
            ),
        ...
        return (
            ...
            r._cbSelectAll.addEventListener(
                "click",
                r._cbSelectAllClicked.bind(r)
            ),
            r.updateEditor(),
            r
        );
    ...
    return (
        ...
        (t.prototype.clearEditor = function () {
            (this._cmbFilter.text = ""),
                ...
                this._view.refresh();
            for (var e = this._view.items, t = 0; t < e.length; t++)
                e[t].show = !1;
        ...
        (e.prototype.apply = function (e) {
            ...
            (e = this._bnd.getValue(e)),
                t.dataMap
                    ...
                    : wjcCore.isDate(e)
                    ? (wjcCore.isString(i.value) ||
                          wjcCore.isString(r.value)) &&
    ...
    return (
        ...
        (t.prototype.updateEditor = function () {
            ...
            (this._cmb1.selectedValue = e.operator),
                ...
                this._val1 instanceof wjcInput.ComboBox
                    ...
                    : ((this._val1.value = e.value),
                      (this._val2.value = t.value)),
        ...
        (t.prototype._createValueInput = function (e) {
            var t = this._filter.column,
                i = null;
            return (
                t.dataType != wjcCore.DataType.Date ||
                this._isTimeFormat(t.format)
                    ? t.dataType != wjcCore.DataType.Number || t.dataMap
                        ? ((i = new wjcInput.ComboBox(e)).itemsSource = this
                              ._filter.dataMap
...
var ColumnFilter = (function () {
    ...
    return (
        ...
        Object.defineProperty(e.prototype, "dataMap", {
            ...
            set: function (e) {
                (this.conditionFilter.dataMap = e),
                    (this.valueFilter.dataMap = e);
            },
            enumerable: !0,
            configurable: !0,
        }),
            ...
            if (
                ...
                if (e.target != this._aVal)
                    if (e.target != this._aCnd) {
                        if (
                            e.target == this._btnAsc ||
                            e.target == this._btnDsc
                        ) {
    ...
    return (
                                ...
                                case "condition":
                                    ...
                                    (l.condition1.value =
                                        ...
                                        (l.condition2.operator =
                                            r.condition2.operator);
                                    break;
                                case "value":
                                    var a = o.valueFilter;
                                    (a.filterText = r.filterText),
                                        (a.showValues = r.showValues);
                            }
                    }
                }
                this.apply();
        ...
        (e.prototype.editColumnFilter = function (e, t) {
            ...
            if (this.onFilterChanging(r)) {
                ...
                p
                    ? wjcCore.showPopup(n, p, !1, !1, !1)
                    : wjcCore.showPopup(n, u),
                    l.focus(),
                    (this._divEdt = n),
                    (this._edtCol = e);
            }
        ...
        (e.prototype._toggleEditor = function (t) {
            ...
            if (((this._tmd = !1), !t.defaultPrevented && 0 == t.button))
                if (wjcCore.closestClass(t.target, e._WJC_FILTER)) {
                    ...
                    if (
                        (n.panel || (n = r.hitTest(t, !0)),
                        n.panel == r.columnHeaders)
                    ) {

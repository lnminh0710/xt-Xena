        ...
        return (
            ...
            (e._draw = function (e, t, r, o, i, n) {
                ...
                try {
                    ...
                    globCell &&
                        (wjcCore.removeChild(globCell), (globCell = null));
                }
            }),
            (e._getScaleFactor = function (e, t, r) {
                ...
                if (t === ScaleMode.SinglePage)
                    (n = Math.min(r.width / i.width, r.height / i.height)) <
                        1 && (o = n);
                else {
            ...
            (e._getPages = function (e, t, r, o, i, n) {
                ...
                (s.length && s[s.length - 1] === t.rightCol) ||
                    s.push(t.rightCol);
                for (
                    var W = [],
                        z = !1,
        ...
        return (
            ...
            Object.defineProperty(e.prototype, "renderSize", {
                get: function () {
                    ...
                    return (
                        this._columnHeader.visibleRows > 0 &&
                            (e -= this._borderWidth),
                        this._columnFooter.visibleRows > 0 &&
                            (e -= this._borderWidth),
                        this._rowHeader.visibleColumns > 0 &&
                            (t -= this._borderWidth),
            ...
            Object.defineProperty(e.prototype, "showColumnFooter", {
                get: function () {
                    return (
                        this._lastPage &&
                        this._flex.columnFooters.rows.length > 0
                    );
                },
                enumerable: !0,
                configurable: !0,
                ...
                switch (e.cellType) {
                    case wjcGrid.CellType.Cell:
                        this.isGroupRow(t)
                            ...
                            : this.isAlternatingRow(t) &&
                              _merge(i, o.altCellStyle, !0);
                        break;
        ...
        return (
            ...
            (t.prototype.getCellValue = function (t, r, o) {
                return t.cellType === wjcGrid.CellType.Cell
                    ? t.rows[o] instanceof
                      tryGetModuleWijmoGridSheet().HeaderRow
            ...
            Object.defineProperty(e.prototype, "visibleColumns", {
                get: function () {
                    if (
                        ...
                        for (
                            var e = this._range.leftCol;
                            e <= this._range.rightCol;
                            e++
                        )
                            this._panel.columns[e].isVisible &&
    ...
    PanelSectionRenderer = (function (e) {
        ...
        return (
            ...
            (t.prototype.render = function (e, t, r) {
                ...
                if (i.isValid) {
                    for (var d = {}, c = i.leftCol; c <= i.rightCol; c++)
                        d[c] = r;
            ...
            (e.prototype._renderBooleanCell = function (e, t, r, o, i) {
                if ((this._renderEmptyCell(t, r, o, i), o)) {
                    ...
                    if (
                        ...
                        !0 ===
                            wjcCore.changeType(e, wjcCore.DataType.Boolean, ""))
                    ) {
                        var s = a / 20,
                            d = a - 0.5 - 2 * s,
                            c = a / 8;
        ...
        return (
            ...
            (e.prototype.getRenderSize = function (e) {
                for (
                    ...
                    (t.width = Math.max(t.width, o.width)),
                        (t.height += o.height);
                }
                return t;
            }),
                ...
                if (t >= 0 && r > 0)
                    for (
                        ...
                        if (((a = l + (d.bottomRow - d.topRow)), !(t > a))) {
                            ...
                            n.push(new wjcGrid.CellRange(c, g, h, u)),
                                (r -= h - c + 1);
                        }
                    }

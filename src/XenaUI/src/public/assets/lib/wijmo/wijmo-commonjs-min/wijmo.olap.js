    ...
    return (
        ...
        (e.prototype.matchesItem = function (e) {
            for (var t = 0; t < this._vals.length; t++)
                if (this.getValue(t, !0) != this._fields[t]._getValue(e, !0))
                    return !1;
            return !0;
        }),
        (e.prototype.toString = function () {
            if (!this._key) {
                ...
                this._valueFields
                    ? (e +=
                          this._valueFields[this._valueFieldIndex]._getName() +
                          ":0;")
                    : (e += "{total}"),
                    (this._key = e);
            }
    ...
    return (
        (e.prototype.getNode = function (t, i, r, o, n) {
            ...
            if (r && o > -1) {
                var a = r[o].header,
                    c = s._nodes[a];
                c || ((c = new e(t, i, r, o, n, s)), (s._nodes[a] = c)),
                    (s = c);
            }
            return s;
        }),
...
var PivotCollectionView = (function (e) {
    ...
    return (
        ...
        (t.prototype._performSort = function (e) {
            ...
            if (
                t.sortableGroups &&
                t._getShowRowTotals() == ShowTotals.Subtotals
            ) {
                var i = 0,
                    r = e.length - 1;
        ...
        (t.prototype._sortGroups = function (t, i, r, o) {
            ...
            if (n.length) {
                ...
                for (var l = [], s = 0; s < n.length; s++) {
                    for (
                        var a = this._getGroupRange(t, n[s]),
                            c = l.length,
                            d = a[0];
                        d <= a[1];
                        d++
    ...
    return (
                ...
                if (e != this.binding) {
                    ...
                    if (
                        ...
                        if (
                            ...
                            this._dataType = wjcCore.getType(
                                this._binding.getValue(o)
                            );
                        }
                    }
                    var n = new wjcCore.PropertyChangedEventArgs(
                        "binding",
                        t,
                        e
                    );
        ...
        Object.defineProperty(e.prototype, "header", {
            ...
            set: function (e) {
                ...
                !e || (t && t != this)
                    ? wjcCore.assert(
                          !1,
                          "field headers must be unique and non-empty."
                      )
        ...
        Object.defineProperty(e.prototype, "aggregate", {
            ...
            set: function (e) {
                this._setProp(
                    "_aggregate",
                    wjcCore.asEnum(e, wjcCore.Aggregate)
                );
            },
            enumerable: !0,
            configurable: !0,
        ...
        Object.defineProperty(e.prototype, "sortComparer", {
            ...
            set: function (e) {
                e != this.sortComparer &&
                    (this._srtCmp = wjcCore.asFunction(e));
            },
            enumerable: !0,
            configurable: !0,
        }),
                        ...
                        for (
                            ...
                            for (var o = i[r], n = 0; n < o.length; n++)
                                ((l = o[n]) != this && l.parentField != this) ||
                                    (o.removeAt(n), n--);
                        for (
                            var s = this._ng.fields, n = s.length - 1;
                            n >= 0;
                            n--
                        ) {
                            var l = s[n];
        ...
        (e.prototype._getWeight = function (e) {
            var t = this._weightField
                ? this._weightField._getValue(e, !1)
                : null;
    ...
    return (
        ...
        Object.defineProperty(t.prototype, "dimensionType", {
            ...
            set: function (e) {
                this._setProp(
                    "_dimensionType",
                    wjcCore.asEnum(e, DimensionType, !1)
                );
            },
            enumerable: !0,
            configurable: !0,
        ...
        (t.prototype.push = function () {
            ...
            for (var r = this._ng, o = 0; t && o < t.length; o++) {
                ...
                if (
                    ...
                    return (
                        wjcCore.assert(!1, "PivotField keys must be unique."),
                        -1
                    );
                if (null != this._maxItems && this.length >= this._maxItems)
                    break;
...
var PivotFilter = (function () {
    ...
    return (
        Object.defineProperty(e.prototype, "filterType", {
            ...
            set: function (e) {
                e != this._filterType &&
                    ((this._filterType = wjcCore.asEnum(
                        e,
                        wjcGridFilter.FilterType,
                        !0
                    )),
                    this.clear());
            },
        ...
        Object.defineProperty(e.prototype, "isActive", {
            get: function () {
                return (
                    this._conditionFilter.isActive || this._valueFilter.isActive
                );
            },
            enumerable: !0,
            configurable: !0,
        ...
        (e.prototype.clear = function () {
            ...
            this._valueFilter.isActive && (this._valueFilter.clear(), (e = !0)),
                this._conditionFilter.isActive &&
                    (this._valueFilter.clear(), (e = !0)),
                e &&
                    this._fld.onPropertyChanged(
                        new wjcCore.PropertyChangedEventArgs(
                            "filter",
                            null,
                            null
                        )
...
var PivotFieldEditor = (function (e) {
    ...
    return (
        ...
        Object.defineProperty(t.prototype, "field", {
            ...
            set: function (e) {
                e != this._fld &&
                    ((this._fld = wjcCore.asType(e, PivotField)),
                    this.updateEditor());
            },
            enumerable: !0,
            configurable: !0,
        ...
        (t.prototype.updateField = function () {
            if (this._fld) {
                ...
                (this._fld.header =
                    e || wjcCore.toHeaderCase(this._fld.binding)),
                    ...
                    (this._fld.format =
                        this._cmbFmt.selectedValue || this._cmbFmt.text);
            }
        }),
            ...
            (this._cmbAgg.itemsSource = r),
                (this._cmbAgg.collectionView.filter = function (t) {
                    ...
                    if (e._fld) {
                        ...
                        return (
                            i == wjcCore.DataType.Number ||
                            i == wjcCore.DataType.Boolean
                        );
                    }
                    return !1;
                }),
...
(exports.PivotFilterEditor = PivotFilterEditor),
    (wjcCore.culture.olap = wjcCore.culture.olap || {}),
    (wjcCore.culture.olap.PivotEngine = window.wijmo.culture.olap
        .PivotEngine || { grandTotal: "Grand Total", subTotal: "Subtotal" });
var ShowTotals;
!(function (e) {
    (e[(e.None = 0)] = "None"),
...
var PivotEngine = (function () {
    ...
    return (
        ...
        Object.defineProperty(e.prototype, "defaultFilterType", {
            ...
            set: function (e) {
                this._defaultFilterType = wjcCore.asEnum(
                    e,
                    wjcGridFilter.FilterType
                );
            },
            ...
            get: function () {
                for (
                    var e = {
                            ...
                            fields: [],
                            rowFields: this._getFieldCollectionProxy(
                                this.rowFields
                            ),
                            columnFields: this._getFieldCollectionProxy(
                                this.columnFields
                            ),
                            filterFields: this._getFieldCollectionProxy(
                                this.filterFields
                            ),
                            valueFields: this._getFieldCollectionProxy(
                                this.valueFields
                            ),
                        },
                        t = 0;
                    ...
                    this.deferUpdate(function () {
                        ...
                        for (var n = 0; n < r.fields.length; n++) {
                            ...
                            wjcCore.isString(t.weightField) &&
                                (i.fields[n].weightField = i.fields.getField(
                                    t.weightField
                                ));
                        }
                        i._setFieldCollectionProxy(i.rowFields, r.rowFields),
                            i._setFieldCollectionProxy(
                                i.columnFields,
                                r.columnFields
                            ),
                            i._setFieldCollectionProxy(
        ...
        (e.prototype.endUpdate = function () {
            this._updating--,
                this._updating <= 0 &&
                    (this.onViewDefinitionChanged(), this.refresh());
        }),
        ...
        (e.prototype.refresh = function (e) {
            void 0 === e && (e = !1),
                (this.isUpdating && !e) || this._updateView();
        }),
        ...
        Object.defineProperty(e.prototype, "async", {
            ...
            set: function (e) {
                e != this._async &&
                    ...
                    (this._async = wjcCore.asBoolean(e)));
            },
            enumerable: !0,
            configurable: !0,
        }),
        ...
        (e.prototype._updateView = function () {
            ...
            if (
                ...
                this._server.getOutputView(function (t) {
                    e.isViewDefined &&
                        (e._server.updateTallies(t), e._updatePivotView());
                });
            else {
        ...
        (e.prototype._updateTallies = function (t, i) {
            ...
            0 == s.length &&
                ...
                (s = new PivotFieldCollection(this)).push(
                    new PivotField(this, "")
                );
            for (
                var l = ShowTotals,
                ...
                switch (r.showAs) {
                    ...
                    case ShowAs.RunTotPct:
                        for (h = i; h < this._colBindings.length; h += t) {
                            for (a = 0; a < e.length; a++)
                                (c = e[a])[(l = this._colBindings[h])] =
                                    this._getRunningTotal(e, a, h, r.showAs);
                            if (r.showAs == ShowAs.RunTotPct)
                                for (a = 0; a < e.length; a++) {
                                    var o = (c = e[a])[
                                        (l = this._colBindings[h])
                                    ];
                                    if (wjcCore.isNumber(o)) {
                                        var n = this._getLastValueInRowGroup(
                                            e,
                                            a,
                                            h
                                        );
                    ...
                    case ShowAs.PctCol:
                        ...
                        if (r.showAs == ShowAs.PctGrand)
                            for (h = i; h < this._colBindings.length; h += t)
                                -1 == this._getColLevel(h) &&
                                    (s += this._getColTotal(e, h));
                        for (h = i; h < this._colBindings.length; h += t) {
                            r.showAs == ShowAs.PctCol &&
                                (s = this._getColTotal(e, h));
                            for (
                                var l = this._colBindings[h], a = 0;
                                a < e.length;
                                a++
                            ) {
                                u = (c = e[a])[l];
                    ...
                    case ShowAs.DiffRowPct:
                        for (h = i; h < this._colBindings.length; h += t)
                            for (a = e.length - 1; a >= 0; a--)
                                (c = e[a])[(l = this._colBindings[h])] =
                                    this._getRowDifference(e, a, h, r.showAs);
                        break;
                    case ShowAs.DiffCol:
                    case ShowAs.DiffColPct:
                        for (a = 0; a < e.length; a++)
                            for (
                                h = this._colBindings.length - t + i;
                                h >= 0;
                                h -= t
                            )
                                (c = e[a])[(l = this._colBindings[h])] =
                                    this._getColDifference(e, a, h, r.showAs);
                }
            }
        }),
        ...
        (e.prototype._generateFields = function () {
            ...
            for (t = 0; t < this.fields.length; t++)
                (e = this.fields[t])._autoGenerated &&
                    (this.fields.removeAt(t), t--);
            if (this._server)
                        ...
                        for (
                            ...
                            (l = r[a][s]),
                                wjcCore.isPrimitive(l) &&
                                    ...
                                    this.fields.getField(e.header) ||
                                        this.fields.push(e));
                if (o)
                    for (t = 0; t < this.fields.length; t++)
                        null == (e = this.fields[t]).dataType &&
                            e._binding &&
                            (e.dataType = wjcCore.getType(
                                e._binding.getValue(o)
                            ));
            }
        }),
        (e.prototype._createField = function (e, t) {
            ...
            return (
                ...
                (t || wjcCore.isString(e)) &&
                    ((i.format =
                        i.dataType == wjcCore.DataType.Date ? "d" : "n0"),
                    (i.aggregate =
            ...
            if (
                ...
                if (
                    ...
                    for (var r = 0; r < i.subFields.length; r++)
                        t.subFields.push(
                            this._getFieldDefinition(i.subFields[r])
                        );
                }
            }
            return t;
        ...
        (e.prototype._getFilterProxy = function (e) {
            ...
            return (
                wjcCore.assert(!1, "inactive filters shouldn't be persisted."),
                null
            );
        }),
        (e.prototype._setFilterProxy = function (e, t) {
            ...
            switch ((i.clear(), t.type)) {
                case "condition":
                    ...
                    if (
                        (wjcCore.isBoolean(t.and) && (r.and = t.and),
                        t.condition2)
                    ) {
                ...
                case "value":
                    var n = i.valueFilter;
                    (n.filterText = t.filterText),
                        (n.showValues = t.showValues);
            }
        }),
        (e._BATCH_SIZE = 1e4),
        (e._BATCH_TIMEOUT = 0),
    ...
    return (
                ...
                wjcCore.httpRequest(this._getUrl("Fields"), {
                    ...
                    success: function (e) {
                        (t = JSON.parse(e.responseText)),
                            wjcCore.isArray(t) ||
                                console.error(
                                    "Failed to get fields from server: " +
                                        e.responseText
                                );
                    },
                    error: function (t) {
        ...
        (e.prototype.getDetail = function (t, i) {
            for (
                ...
                l < s
                    ? o.push(e._getRequestedValue(t.values[l]))
                    : o.push(null);
            (n = this._ng.columnFields.length), (s = i ? i.values.length : 0);
            for (l = 0; l < n; l++)
                l < s
                    ? o.push(e._getRequestedValue(i.values[l]))
                    : o.push(null);
            return (
            ...
            e.forEach(function (e, l, a) {
                ...
                for (var g = 0; g < n; g++) {
                    ...
                    v
                        ? wjcCore.assert(
                              !1,
                              "Server tallies have a single value."
                          )
                        : ((i._keys[f] = _),
                          (v = p[f] = new _ServerTally()).add(
                              t._getFieldValue(w, e, !1)
                          ));
                }
            });
        }),
            ...
            switch (e.executingStatus.toLowerCase()) {
                ...
                case "notset":
                    ...
                    (this._progress = e.progress),
                        this._ng.onUpdatingView(
                            new ProgressEventArgs(this._progress)
                        ),
                        this._clearTimeout(),
    ...
    return (
        ...
        (t.prototype.attach = function (e) {
            ...
            i.addEventListener("contextmenu", function (r) {
                t._selectField(e, r) &&
                    (r.preventDefault(), (t.owner = i), t.show(r));
            });
        }),
        ...
        (t.prototype._getMenuItems = function (e) {
            ...
            for (var i = 0; i < t.length; i++) {
                ...
                if (r.parm) {
                    ...
                    wjcCore.assert(
                        o,
                        "missing localized text for item " + r.parm
                    ),
...
var PivotPanel = (function (e) {
    function t(t, i) {
        ...
        return (
            ...
            (l = r._ctxMenuFull = new _ListContextMenu(!0)).attach(
                r._lbFilters
            ),
            l.attach(r._lbRows),
            l.attach(r._lbCols),
    ...
    return (
        ...
        Object.defineProperty(t.prototype, "engine", {
            ...
            set: function (e) {
                this._ng &&
                    (this._ng.itemsSourceChanged.removeHandler(
        ...
        (t.prototype._viewDefinitionChanged = function (e, t) {
            e.isUpdating ||
                (this.invalidate(), this.onViewDefinitionChanged(t));
        }),
        ...
        (t.prototype._dragstart = function (e) {
            ...
            t &&
                ...
                (this._dragSource =
                    this._dragField instanceof PivotField
                        ? t.hostElement
                        : null),
                this._dragSource &&
                    e.dataTransfer &&
                ...
                if (this._dragSource == this._dFields && i != this._lbFields) {
                    ...
                    if (null == r.maxItems || r.length < r.maxItems) {
                        ...
                        i.itemsSource.indexOf(o) < 0
                            ? (t = !0)
                            : i == this._lbVals &&
                              (t = !(o instanceof CubePivotField));
                    }
                }
                this._dragSource &&
                    this._dragSource != this._dFields &&
                    (t = !0);
            }
            if (
                t &&
                this._getRestrictDrag() &&
                this._dragSource != i.hostElement
            ) {
        ...
        (t.prototype.attach = function (e) {
            ...
            i.addEventListener("contextmenu", function (r) {
                if (
                    ...
                    var o = t.dropDown;
                    (t.selectedIndex = -1),
                        t.onIsDroppedDownChanging(
                            new wjcCore.CancelEventArgs()
                        ) &&
                            (wjcCore.showPopup(o, r),
                            t.onIsDroppedDownChanged(),
                            o.focus());
                }
            });
        }),
        (t.prototype._selectField = function (e) {
            ...
            switch (r.cellType) {
                case wjcGrid.CellType.Cell:
                    t.select(r.range),
                        (this._targetField =
                            i.valueFields[r.col % i.valueFields.length]),
                        (this._htDown = r);
                    break;
        ...
        (t.prototype._getMenuItems = function () {
            for (
                ...
                if (i.parm) {
                    ...
                    wjcCore.assert(
                        r,
                        "missing localized text for item " + i.parm
                    ),
...
var _PivotMergeManager = (function (e) {
    ...
    return (
        ...
        (t.prototype.getMergedRange = function (t, i, r, o) {
            ...
            if (
                ((this._ng =
                    n instanceof PivotCollectionView ? n.engine : null),
                !this._ng)
            )
            ...
            switch (t.cellType) {
                ...
                case wjcGrid.CellType.RowHeader:
                    return this._getMergedRowHeaderRange(
                        t,
                        i,
                        r,
                        o ? t.viewRange : null
        ...
        (t.prototype._getMergedTopLeftRange = function (e, t, i) {
            ...
            for (
                ;
                r.col2 < e.columns.length - 1 &&
                !e.getCellData(t, r.col2 + 1, !0);
        ...
        (t.prototype._sameColumnValues = function (e, t, i, r) {
            for (; r >= 0; r--)
                if (e.getCellData(t, r, !1) != e.getCellData(i, r, !1))
                    return !1;
            return !0;
        }),
        ...
        (t.prototype._sameRowValues = function (e, t, i, r) {
            for (; t >= 0; t--)
                if (e.getCellData(t, i, !1) != e.getCellData(t, r, !1))
                    return !1;
            return !0;
        }),
        t
...
var PivotGrid = (function (e) {
    ...
    return (
        ...
        Object.defineProperty(t.prototype, "centerHeadersVertically", {
            ...
            set: function (e) {
                e != this._centerVert &&
                    ((this._centerVert = wjcCore.asBoolean(e)),
                    this.invalidate());
            },
            enumerable: !0,
            configurable: !0,
        ...
        (t.prototype._getQuickAutoSize = function () {
            return wjcCore.isBoolean(this.quickAutoSize)
                ? this.quickAutoSize
                : this.formatItem.handlerCount <= 1 &&
                      null == this.itemFormatter;
        }),
                ...
                if (
                    ...
                    for (
                        ...
                        (g = u ? u[_PivotKey._ROW_KEY_NAME] : null) &&
                            ...
                            o[g.toString()] &&
                            i._setRowCollapsed(
                                new wjcGrid.CellRange(h, g.level - 1),
                                !0
                            );
                    }
                    (a = l ? s.length - 1 : 0),
                    ...
                    for (h = a; h != c; h += d) {
                        ...
                        g &&
                            ...
                            o[g.toString()] &&
                            i._setColCollapsed(
                                new wjcGrid.CellRange(g.level - 1, h),
                                !0
                            );
                    }
                }
        ...
        (t.prototype.onResizedColumn = function (t) {
            ...
            if (
                ...
                (t.panel == this.topLeftCells &&
                    ...
                    ((r = i.rowFields[t.col]).width =
                        t.panel.columns[t.col].renderWidth),
            ...
            if (i) {
                ...
                if (
                    ...
                    if (
                        ...
                        s =
                            this.getMergedRange(t.panel, t.row, t.col, !1) ||
                            t.range;
                        t.col < i.rowFields.length - 1 &&
                            s.rowSpan > 1 &&
                            (t.cell.innerHTML =
                                this._getCollapsedGlyph(
                                    this._getRowCollapsed(s)
                                ) + t.cell.innerHTML);
                    }
                    if (
                        t.panel == this.columnHeaders &&
        ...
        (t.prototype._mousedown = function (e) {
            if (e.defaultPrevented || 0 != e.button) this._htDown = null;
                ...
                null !=
                    wjcCore.closest(e.target, "[" + t._WJA_COLLAPSE + "]") &&
        ...
        (t.prototype._mouseup = function (e) {
            if (
                ...
                if (
                    ...
                    if (
                        t.panel == r &&
                        t.row == r.rows.length - 1 &&
                        t.col > -1
                    ) {
                        if (
                            this.allowSorting &&
                            t.panel.columns[t.col].allowSorting
                        ) {
                            var o = new wjcGrid.CellRangeEventArgs(
                                t.panel,
                                t.range
                            );
        ...
        (t.prototype._setRowCollapsed = function (e, t) {
            ...
            null != n &&
                ...
                this.deferUpdate(function () {
                    i.rows[
                        r.totalsBeforeData ? e.row - 1 : e.row2 + 1
                    ].visible = !0;
                    for (var n = e.row; n <= e.row2; n++)
                        i.rows[n].visible = !t;
                    if (!t) {
                        for (
                            var s = i._getRowLevel(o), l = [], a = e.row;
                            a <= e.row2;
                            a++
                        )
                            if (i._getRowLevel(a) > -1) {
                                var c = i._getGroupedRows(
                                    new wjcGrid.CellRange(a, s)
                                );
                                wjcCore.assert(
        ...
        (t.prototype._getColCollapsed = function (e) {
            ...
            var t = this._ng,
                i = t.totalsBeforeData
                    ? e.col - t.valueFields.length
                    : e.col2 + 1,
                r =
        ...
        (t.prototype._setColCollapsed = function (e, t) {
            ...
            e = this._getGroupedCols(e);
            var r = this._ng,
                o = r.totalsBeforeData
                    ? e.col - r.valueFields.length
                    : e.col2 + 1,
                n =
            ...
            null != n &&
                ...
                this.deferUpdate(function () {
                    for (var n = 1; n <= r.valueFields.length; n++)
                        i.columns[
                            r.totalsBeforeData ? e.col - n : e.col2 + n
                        ].visible = !0;
                    for (var s = e.col; s <= e.col2; s++)
                        i.columns[s].visible = !t;
                    if (!t) {
                        for (
                            var l = i._getColLevel(o), a = [], c = e.col;
                            c <= e.col2;
                            c++
                        )
                            if (i._getColLevel(c) > -1) {
                                var d = i._getGroupedCols(
                                    new wjcGrid.CellRange(l, c)
                                );
                                wjcCore.assert(
...
var PivotChart = (function (e) {
    ...
    return (
        ...
        Object.defineProperty(t.prototype, "legendPosition", {
            ...
            set: function (e) {
                e != this.legendPosition &&
                    ((this._legendPosition = wjcCore.asEnum(
                        e,
                        wjcChart.Position
                    )),
                    this._updatePivotChart());
        ...
        Object.defineProperty(t.prototype, "maxSeries", {
            ...
            set: function (e) {
                e != this._maxSeries &&
                    ((this._maxSeries = wjcCore.asNumber(e)),
                    this._updatePivotChart());
            },
            enumerable: !0,
            configurable: !0,
        ...
        Object.defineProperty(t.prototype, "maxPoints", {
            ...
            set: function (e) {
                e != this._maxPoints &&
                    ((this._maxPoints = wjcCore.asNumber(e)),
                    this._updatePivotChart());
            },
            enumerable: !0,
            configurable: !0,
        ...
        (t.prototype._onItemsSourceChanged = function (e) {
            this._ng &&
                this._ng.updatedView.removeHandler(
                    this._updatePivotChart,
                    this
                ),
                e &&
                    e.collectionChanged.removeHandler(
                        this._updatePivotChart,
                        this
                    );
            var t = this._itemsSource;
            (this._ng = t instanceof PivotCollectionView ? t.engine : null),
                this._ng &&
                    this._ng.updatedView.addHandler(
                        this._updatePivotChart,
                        this
                    ),
                this._itemsSource &&
            ...
            this.hostElement.appendChild(i),
                ...
                (this._flexPie.tooltip.content = function (t) {
                    return (
                        "<b>" +
                        e._getLabel(
                            e._dataItms[t.pointIndex][_PivotKey._ROW_KEY_NAME]
                        ) +
                        "</b> <br/>" +
                        e._getValue(t)
                    );
            ...
            if (this._ng && this._ng.pivotView) {
                for (
                    ...
                    var a = n.items[l],
                        c = a.$rowKey;
                    if (
                        (0 == l && this._getColumns(a),
                        t.length >= this._maxPoints)
                    )
                        break;
                    if (!this._isTotalRow(a[_PivotKey._ROW_KEY_NAME])) {
                        t.push(a),
                            i.push({
                                value: t.length - 1,
                                text: this._getLabel(
                                    a[_PivotKey._ROW_KEY_NAME]
                                ),
                            });
                        for (u = 0; u < s.length; u++)
                            if (
                                (r.length <= u && r.push([]),
                                this._getMergeIndex(c, e) < u)
                            ) {
                                o = r[u].length - 1;
                                var d = r[u][o];
                                if (
                ...
                if (
                    ...
                    if (this._showHierarchicalAxes && i.length > 0) {
                        if (
                            ...
                            for (s = i.length - 2; s >= 0; s--)
                                this._createGroupAxes(i[s]);
                    } else
                        (o.axisY.labelAngle = void 0),
                            (o.axisY.itemsSource = t);
                    o.axisX.itemsSource = void 0;
                } else {
                    if (this._showHierarchicalAxes && i.length > 0) {
                        if (
                            ((o.axisX.itemsSource = i[i.length - 1]),
                            i.length >= 2)
                        )
        ...
        (t.prototype._updatePieInfo = function () {
            var e = this;
            this._flexPie &&
                (this._flexPie._labels = this._flexPie._labels.map(function (
                    t,
                    i
                ) {
        ...
        (t.prototype._swapChartAndPie = function (e) {
            var t = this;
            this._flexChart &&
                (this._flexChart.hostElement.style.display = e
                    ? "block"
                    : "none"),
                this._flexPie &&
                    (this._flexPie.hostElement.style.display = e
                        ? "none"
                        : "block"),
                this._colMenu &&
                    this._colMenu.hostElement &&
                    ((this._colMenu.hostElement.style.display = e
                        ? "none"
                        : "block"),
        ...
        (t.prototype._getValue = function (e) {
            var t = this._ng.valueFields[0].format,
                ...
                r =
                    (this._ng.valueFields[i] &&
                        this._ng.valueFields[i].format) ||
                    t;

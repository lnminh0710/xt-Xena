...
function tryGetModuleWijmoChartFinanceAnalytics() {
    var e, t, r;
    return (
        (e = window.wijmo) && (t = e.chart) && (r = t.finance) && r.analytics
    );
}
        ...
        (e.getMetaData = function (e) {
            switch (e) {
                ...
                case tryGetModuleWijmoInput() &&
                    tryGetModuleWijmoInput().DropDown:
                ...
                case tryGetModuleWijmoInput() &&
                    tryGetModuleWijmoInput().ComboBox:
                ...
                case tryGetModuleWijmoInput() &&
                    tryGetModuleWijmoInput().AutoComplete:
                ...
                case tryGetModuleWijmoInput() &&
                    tryGetModuleWijmoInput().Calendar:
                ...
                case tryGetModuleWijmoInput() &&
                    tryGetModuleWijmoInput().ColorPicker:
                    return this.getMetaData(wjcCore.Control)
                        .add(
                            [
                                this.CreateProp(
                        ...
                        .addOptions({ ngModelProperty: "value" });
                case tryGetModuleWijmoInput() &&
                    tryGetModuleWijmoInput().ListBox:
                    return this.getMetaData(wjcCore.Control)
                        .add(
                            [
                                this.CreateProp(
                ...
                case tryGetModuleWijmoInput() &&
                    tryGetModuleWijmoInput().InputDate:
                    return this.getMetaData(tryGetModuleWijmoInput().DropDown)
                        .add(
                            [
                                this.CreateProp(
                        ...
                        .addOptions({ ngModelProperty: "value" });
                case tryGetModuleWijmoInput() &&
                    tryGetModuleWijmoInput().InputDateTime:
                    return this.getMetaData(tryGetModuleWijmoInput().InputDate)
                        ...
                        .addOptions({ ngModelProperty: "value" });
                case tryGetModuleWijmoInput() &&
                    tryGetModuleWijmoInput().InputNumber:
                    return this.getMetaData(wjcCore.Control)
                        .add(
                            [
                                this.CreateProp(
                        ...
                        .addOptions({ ngModelProperty: "value" });
                case tryGetModuleWijmoInput() &&
                    tryGetModuleWijmoInput().InputMask:
                    return this.getMetaData(wjcCore.Control)
                        .add(
                            [
                                this.CreateProp("mask", PropertyType.String),
                        ...
                        .addOptions({ ngModelProperty: "value" });
                case tryGetModuleWijmoInput() &&
                    tryGetModuleWijmoInput().InputTime:
                    return this.getMetaData(tryGetModuleWijmoInput().ComboBox)
                        ...
                        .addOptions({ ngModelProperty: "value" });
                case tryGetModuleWijmoInput() &&
                    tryGetModuleWijmoInput().InputColor:
                    return this.getMetaData(tryGetModuleWijmoInput().DropDown)
                        .add(
                            [
                                this.CreateProp(
                ...
                case tryGetModuleWijmoInput() &&
                    tryGetModuleWijmoInput().MultiSelect:
                    return this.getMetaData(tryGetModuleWijmoInput().ComboBox)
                        .add(
                            [
                                this.CreateProp(
                ...
                case tryGetModuleWijmoGrid() &&
                    tryGetModuleWijmoGrid().FlexGrid:
                    return this.getMetaData(wjcCore.Control).add(
                        [
                            this.CreateProp(
                                "newRowAtTop",
                ...
                case tryGetModuleWijmoChart() &&
                    tryGetModuleWijmoChart().FlexChartBase:
                    return this.getMetaData(wjcCore.Control).add(
                        [
                            this.CreateProp("binding", PropertyType.String),
                ...
                case tryGetModuleWijmoChart() &&
                    tryGetModuleWijmoChart().FlexChartCore:
                    return this.getMetaData(
                        tryGetModuleWijmoChart().FlexChartBase
                    ).add(
                        [
                ...
                case tryGetModuleWijmoChart() &&
                    tryGetModuleWijmoChart().FlexChart:
                    return this.getMetaData(
                        tryGetModuleWijmoChart().FlexChartCore
                    ).add([
                        this.CreateProp(
                ...
                case tryGetModuleWijmoChart() &&
                    tryGetModuleWijmoChart().DataLabelBase:
                    return new MetaDataBase(
                        [
                ...
                case tryGetModuleWijmoChart() &&
                    tryGetModuleWijmoChart().DataLabel:
                    return this.getMetaData(
                        tryGetModuleWijmoChart().DataLabelBase
                    ).add([
                        this.CreateProp(
                ...
                case tryGetModuleWijmoChart() &&
                    tryGetModuleWijmoChart().PieDataLabel:
                    return this.getMetaData(
                        tryGetModuleWijmoChart().DataLabelBase
                    ).add([
                        this.CreateProp(
                ...
                case tryGetModuleWijmoChart() &&
                    tryGetModuleWijmoChart().SeriesBase:
                    return new MetaDataBase(
                        [
                ...
                case tryGetModuleWijmoChart() &&
                    tryGetModuleWijmoChart().LineMarker:
                    return new MetaDataBase(
                        [
                ...
                case tryGetModuleWijmoChart() &&
                    tryGetModuleWijmoChart().DataPoint:
                    return new MetaDataBase(
                        [
                ...
                case tryGetModuleWijmoChart() &&
                    tryGetModuleWijmoChart().PlotArea:
                    return new MetaDataBase(
                        [
                ...
                case tryGetModuleWijmoGauge() && tryGetModuleWijmoGauge().Gauge:
                    return this.getMetaData(wjcCore.Control)
                        ...
                        .addOptions({ ngModelProperty: "value" });
                case tryGetModuleWijmoGauge() &&
                    tryGetModuleWijmoGauge().LinearGauge:
                ...
                case tryGetModuleWijmoGauge() &&
                    tryGetModuleWijmoGauge().BulletGraph:
                    return this.getMetaData(
                        tryGetModuleWijmoGauge().LinearGauge
                    ).add([
                ...
                case tryGetModuleWijmoGauge() &&
                    tryGetModuleWijmoGauge().RadialGauge:
                    return this.getMetaData(tryGetModuleWijmoGauge().Gauge).add(
                        [
                ...
                case tryGetModuleWijmoOlap() &&
                    tryGetModuleWijmoOlap().PivotGrid:
                    return this.getMetaData(
                        tryGetModuleWijmoGrid().FlexGrid
                    ).add([
                        this.CreateProp(
                ...
                case tryGetModuleWijmoOlap() &&
                    tryGetModuleWijmoOlap().PivotChart:
                    return this.getMetaData(wjcCore.Control).add([
                        this.CreateProp(
                            "chartType",
                            PropertyType.Enum,
                ...
                case tryGetModuleWijmoOlap() &&
                    tryGetModuleWijmoOlap().PivotPanel:
                    return this.getMetaData(wjcCore.Control).add(
                        [
                            this.CreateProp(
                                "autoGenerateFields",
                ...
                case tryGetModuleWijmoOlap() &&
                    tryGetModuleWijmoOlap().PivotField:
                    return new MetaDataBase(
                        [
                            this.CreateProp("binding", PropertyType.String),
                            this.CreateProp("header", PropertyType.String),
                ...
                case tryGetModuleWijmoViewer() &&
                    tryGetModuleWijmoViewer().ViewerBase:
                    return new MetaDataBase(
                        [
                ...
                case tryGetModuleWijmoViewer() &&
                    tryGetModuleWijmoViewer().PdfViewer:
                    return this.getMetaData(
                        tryGetModuleWijmoViewer().ViewerBase
                    );

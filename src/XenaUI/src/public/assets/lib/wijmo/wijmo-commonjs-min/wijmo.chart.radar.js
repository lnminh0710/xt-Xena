    ...
    return (
            ...
            set: function (t) {
                t != this._totalAngle &&
                    ...
                    this._totalAngle <= 0 &&
                        (wjcCore.assert(
                            !1,
                            "totalAngle must be greater than 0."
                        ),
                        (this._totalAngle = 0)),
        ...
        (e.prototype._convertPoint = function (t, e) {
            var r = new wjcCore.Point(),
                a = this._center;
            return (
                (r.x = a.x + t * Math.sin(e)), (r.y = a.y - t * Math.cos(e)), r
            );
        }),
        ...
        Object.defineProperty(e.prototype, "chartType", {
            ...
            set: function (t) {
                t != this._finChartType &&
                    ((this._finChartType = wjcCore.asEnum(
                        t,
                        RadarChartType,
                        !0
                    )),
    ...
    return (
                    ...
                    var i = function () {
                        var t =
                            r.axisType == wjcChart.AxisType.X
                                ? "wj-axis-x-labels " +
                                  wjcChart.FlexChart._CSS_AXIS_X
                                : "wj-axis-y-labels " +
                                  wjcChart.FlexChart._CSS_AXIS_Y;
                        e.startGroup(t),
        ...
        (e.prototype._updateActualLimits = function (e, r, a, i, n) {
            ...
            var o,
                h = this._chart,
                l = this._lbls,
                c = this.actualMin.valueOf
                    ? this.actualMin.valueOf()
                    : this.actualMin,
                _ = this.actualMax.valueOf
                    ? this.actualMax.valueOf()
                    : this.actualMax;
            this._lbls &&
                this === h.axisX &&
                ((h._angles = []),
        ...
        (e.prototype.convert = function (t, e, r) {
            ...
            if (this.axisType === wjcChart.AxisType.X)
                return n.reversed
                    ? ((n.startAngle - ((t - i) / (a - i)) * n.totalAngle) *
                          Math.PI) /
                          180
                    : ((n.startAngle + ((t - i) / (a - i)) * n.totalAngle) *
                          Math.PI) /
        ...
        (e.prototype._renderLabelsAndTicks = function (
            t,
            e,
            r,
            a,
            ...
            if (this.axisType == wjcChart.AxisType.Y) {
                ...
                if (
                    ...
                    ((l = ((c.startAngle % 360) + 360) % 360) <= 90 &&
                        l >= 75) ||
                    (l >= 270 && l <= 285)
                        ? (x = 2)
                        : ((l > 90 && l <= 105) || (l < 270 && l >= 255)) &&
                          (x = 0);
        ...
        (e.prototype.plotSeries = function (t, e, r, a, i, n, s) {
            ...
            if (_) {
                ...
                var j = new Array(),
                    P = new Array(),
                    A =
                        this.stacking != wjcChart.Stacking.None &&
                        !o._isCustomAxisY(),
                    m =
                ...
                for (
                    var T = this.chart.interpolateNulls, b = !1, L = 0;
                    L < d;
                    L++
                ) {
                    var S = y ? u[L] : L,
                    ...
                    if (
                        ...
                        wjcChart._DataInfo.isValid(k)
                    ) {
                        if (A)
                            if (
                                (m && (k /= this.dataInfo.getStackedAbsSum(S)),
                                k >= 0)
                            ) {
                                M = isNaN(this.stackPos[S])
                                    ? 0
                                    : this.stackPos[S];
                                k = this.stackPos[S] = M + k;
                            } else {
                                var M = isNaN(this.stackNeg[S])
                                    ? 0
                                    : this.stackNeg[S];
                        ...
                        if (((S = N.x), (k = N.y), isNaN(S) || isNaN(k)))
                            (b = !0),
                                !0 !== T && (j.push(void 0), P.push(void 0));
                        else {
                            j.push(S), P.push(k);
    ...
    return (
        ...
        (e.prototype.plotSeries = function (t, e, r, a, i, n, s) {
            ...
            if (C) {
                ...
                var S = e.actualMin,
                    k = e.actualMax;
                h._isCustomAxisY() && (y = g = !1),
                    c._areas[o] || (c._areas[o] = []);
                for (var M = 0; M < A; M++) {
                    var R = v ? v[M] : M,
                        I = C[M];
                    if (
                        (this._getSymbolOrigin &&
                            r.convert(this._getSymbolOrigin(b, M, A)),

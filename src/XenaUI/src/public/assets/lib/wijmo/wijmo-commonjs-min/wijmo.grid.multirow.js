            ...
            switch (t.cellType) {
                ...
                case wjcGrid.CellType.RowHeader:
                    if (t.rows[r] instanceof wjcGrid.GroupRow)
                        return e.prototype.getMergedRange.call(
                            this,
                            t,
                            r,
                            o,
...
var _NewRowTemplate = (function (e) {
    ...
    MultiRow = (function (e) {
                ...
                o.addEventListener(
                    ...
                    function (e) {
                        switch (o.collapsedHeaders) {
                            case null:
                            case !1:
                                (o._collapsedHeadersWasNull =
                                    null == o.collapsedHeaders),
                                    (o.collapsedHeaders = !0);
                                break;
                            case !0:
                                o.collapsedHeaders =
                                    !!o._collapsedHeadersWasNull && null;
                        }
        ...
        return (
            ...
            (t.prototype.getColumn = function (e) {
                for (
                    var t = this._cellBindingGroups, r = 0;
                    r < t.length;
                    r++
                ) {
                ...
                set: function (e) {
                    if (e != this._collapsedHeaders) {
                        ...
                        this.onCollapsedHeadersChanging(t) &&
                            ((this._collapsedHeaders = wjcCore.asBoolean(
                                e,
                                !0
                            )),
                ...
                if (wjcCore.hasItems(t))
                    for (
                        ...
                        for (
                            ...
                            null == s.dataType &&
                                s._binding &&
                                (s.dataType = wjcCore.getType(
                                    s._binding.getValue(r)
                                ));
                        }
            }),
                ...
                if (this.autoGenerateColumns && 0 == this.columns.length)
                    ...
                    switch (t.action) {
                        ...
                        case wjcCore.NotifyCollectionChangedAction.Add:
                            if (
                                t.index ==
                                this.collectionView.items.length - 1
                            ) {
                                for (
                                    var r = this.rows.length;
                                    r > 0 &&
                                    this.rows[r - 1] instanceof
                                        wjcGrid._NewRowTemplate;
                                ...
                                for (var o = 0; o < this._rowsPerItem; o++)
                                    this.rows.insert(
                                        r + o,
                                        new _MultiRow(t.item, t.index, o)
                                    );
                                return;
                            }
                            wjcCore.assert(

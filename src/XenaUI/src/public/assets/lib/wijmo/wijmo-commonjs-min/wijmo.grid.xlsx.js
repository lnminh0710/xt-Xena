    ...
    return (
        ...
        (e.load = function (e, o, l) {
            ...
            if (o instanceof Blob) {
                ...
                (t.onload = function () {
                    var o = wjcXlsx.Workbook._base64EncArr(
        ...
        (e._saveFlexGridToWorkbook = function (e, o) {
            var l,
                ...
                g =
                    (new wjcXlsx.WorkbookStyle(),
                    new wjcXlsx.WorkbookFrozenPane()),
                x =
                    !o ||
                    null == o.includeColumnHeaders ||
                    o.includeColumnHeaders,
            ...
            if (
                ...
                u ||
                    (!b && !C) ||
                    (((w = document.createElement("div")).style.visibility =
                        "hidden"),
                    ...
                    if (!(e.rowHeaders.rows[a].renderSize <= 0)) {
                        for (
                            ...
                            (t = e._getBindingColumn(
                                ...
                                0 === c &&
                                    ((s =
                                        new wjcXlsx.WorkbookColumn())._deserialize(
                                        n
                                    ),
                ...
                (W = 0),
                    ...
                    (f = e.rows[a]) instanceof wjcGrid._NewRowTemplate ||
                        ((h = f instanceof wjcGrid.GroupRow)
                            ...
                            : e.rows.maxGroupLevel > -1 &&
                              (k = e.rows.maxGroupLevel + 1),
                        y &&
                            (W = this._parseFlexGridRowToSheetRow(
                                e.rowHeaders,
                                l,
            ...
            for (
                S = e.cells.rows.length, a = 0;
                a < e.columnFooters.rows.length;
                a++
            )
                (W = 0),
                    (l = {}),
                    (r = new wjcXlsx.WorkbookRow()),
                    (h =
                        (f = e.columnFooters.rows[a]) instanceof
                        wjcGrid.GroupRow),
                    y &&
                        (W = this._parseFlexGridRowToSheetRow(
                            e.rowHeaders,
        ...
        (e._loadToFlexGrid = function (e, o, l) {
            var r,
                ...
                B =
                    !l ||
                    null == l.includeColumnHeaders ||
                    l.includeColumnHeaders,
                D =
                    !l ||
                    null == l.includeColumnHeaders ||
                    l.includeColumnHeaders,
                E =
                    l && null != l.sheetIndex && !isNaN(l.sheetIndex)
                        ? l.sheetIndex
                        : 0,
                    ...
                    for (
                        g && !_
                            ? (C && (C.isCollapsed = P),
                              ...
                              (C.level = isNaN(f.groupLevel)
                                  ? 0
                                  : f.groupLevel),
                              (V[C.level] = P),
                              this._checkParentCollapsed(V, C.level) &&
                                  C._setFlag(
                                      wjcGrid.RowColFlags.ParentCollapsed,
                                      !0
                                  ),
                              e.rows.push(C))
                            : ((j = new wjcGrid.Row()),
                        ...
                        if (f) {
                            if (
                                ...
                                if (
                                    ...
                                    switch (F) {
                                        ...
                                        default:
                                            N =
                                                G && 0 === G.search(/[n,c,p]/i)
                                                    ? "right"
                                                    : "left";
                                    }
                                (X[W] = {
                                    fontWeight:
                                        T.font && T.font.bold ? "bold" : "none",
                                    fontStyle:
                                        T.font && T.font.italic
                                            ? "italic"
                                            : "none",
                                    textDecoration:
                                        T.font && T.font.underline
                                            ? "underline"
                                            : "none",
                                    textAlign: N,
                                    fontFamily:
                                        T.font && T.font.family
                                            ? T.font.family
                                            : "",
                                    fontSize:
                                        T.font && T.font.size
                                    ...
                                    T.borders &&
                                        ...
                                        T.borders.right &&
                                            ...
                                            (X[W].borderRightColor =
                                                T.borders.right.color)),
                                        T.borders.top &&
                                            (this._parseBorderStyle(
                                                T.borders.top.style,
                                                "Top",
                                        ...
                                        T.borders.bottom &&
                                            ...
                                            (X[W].borderBottomColor =
                                                T.borders.bottom.color))),
                                    T.font &&
                            ...
                            e.setCellData(D ? O - 1 : O, L, ""),
                                this._setColumn(s, L, null);
                    f &&
                        (this._checkParentCollapsed(V, f.groupLevel) ||
                            f.visible ||
                            null == f.visible ||
                ...
                X = (w = e.grid).wj_sheetInfo,
                    ...
                    (f.constructor === wjcGrid.Row ||
                        ...
                        (tryGetModuleWijmoGridMultirow() &&
                            f.constructor ===
                                tryGetModuleWijmoGridMultirow()._MultiRow)) &&
                        (I = !0),
                    m = 0;
                m < e.columns.length;
                m++
                    ...
                    if (
                        ...
                        I || a
                            ? ((x = G ? e.getCellData(l, m, !0) : null),
                              ...
                              v && v.format
                                  ? ((p = v.format),
                                    (g = wjcXlsx.Workbook._parseCellFormat(
                                        v.format,
                                        R
                                    )))
                              ...
                              g ||
                                  (R
                                      ...
                                      : (g = "General")))
                            : ((x = G
                                  ? w.columnHeaders.getCellData(0, m, !0)
                                  : null),
                              (g = "General")),
                        wjcCore.isString(x) &&
                            -1 !== x.indexOf("<span") &&
                        ...
                        !(R = wjcCore.isDate(_)) &&
                            ...
                            (_ =
                                "string" == typeof _
                                    ? wjcXlsx.Workbook._unescapeXML(_)
                                    : _),
                            m === w.columns.firstVisibleIndex &&
                                w.treeIndent &&
                                (E = c),
                        ...
                        (x = wjcCore.isString(x)
                            ? wjcXlsx.Workbook._unescapeXML(x)
                            : x),
                            (b = wjcCore.isString(b)
                                ? wjcXlsx.Workbook._unescapeXML(b)
                                : b),
                            !R &&
                                p &&
                                "d" === p.toLowerCase() &&
                            ...
                            m !== w.columns.firstVisibleIndex ||
                                !w.treeIndent ||
                                (D !== wjcXlsx.HAlign.Left &&
                                    D !== wjcXlsx.HAlign.General) ||
                                (E = c),
                            (N = {
                                ...
                                formula: j
                                    ...
                                    : null,
                                colSpan:
                                    m < w.columns.firstVisibleIndex ? 1 : T,
                                rowSpan: W,
                                style: this._extend(B, {
                                    format: g,
                                    hAlign: D,
        ...
        (e._parseCellStyle = function (e, o) {
            ...
            var l = e.fontSize;
            (l = l ? +l.substring(0, l.indexOf("px")) : null),
                isNaN(l) && (l = null);
            var r = e.fontWeight;
            r = "bold" === r || +r >= 700;

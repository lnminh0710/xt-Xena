            ...
            this._initData(),
                this._cv &&
                    ...
                    this._cv.groups && this._cv.groups.length
                        ? (this._processedData =
                              HierarchicalUtil.parseDataToHierarchical(
                                  this._cv,
                                  this.binding,
                                  this.bindingName,
                                  this.childItemsPath
                    ...
                    this._processedData &&
                        ...
                        ((this._sum = this._calculateValueAndLevel(
                            this._processedData,
                            1
                        )),
                ...
                t.forEach(function (t) {
                    ...
                    t.items
                        ? ((n = i._calculateValueAndLevel(t.items, e + 1)),
                          ...
                          o.push(n),
                          a.push(t.name))
                        : ((n = i._getBindData(t, o, a, "value", "name")),
                          (t.value = n)),
                        (r += n);
                }),
                r
        ...
        (e.prototype._renderHierarchicalSlices = function (
            ...
            for (var I = 0; I < y; I++)
                (w = e),
                    ...
                    1 === c &&
                        ((t.fill = this._getColorLight(I)),
                        (t.stroke = this._getColor(I))),
                    (m = r[I]),
                    (f = Math.abs(m.value)),
...
var TreeMap = (function (t) {
    function e(e, i) {
        ...
        return (
            ...
            (r._currentRenderEngine = new wjcChart._SvgRenderEngine(
                r.hostElement
            )),
    ...
    return (
        ...
        Object.defineProperty(e.prototype, "type", {
            ...
            set: function (t) {
                t != this._type &&
                    ((this._type = wjcCore.asEnum(t, TreeMapType)),
                    this.invalidate());
            },
            enumerable: !0,
            configurable: !0,
        ...
        Object.defineProperty(e.prototype, "maxDepth", {
            ...
            set: function (t) {
                t != this._maxDepth &&
                    ((this._maxDepth = wjcCore.asNumber(t, !0)),
                    this.invalidate());
            },
            enumerable: !0,
            configurable: !0,
        ...
        (e.prototype._performBind = function () {
            ...
            this._initData(),
                this._cv &&
                    ...
                    this._processedData &&
                        this._processedData.length &&
                        ((this._sum = this._calculateValueAndDepth(
                            this._processedData,
                            1
                        )),
            ...
            t &&
                ...
                t.forEach(function (t, o) {
                    ...
                    (l.items = []),
                        ...
                        (l.depth = i),
                        t.items &&
                            a._getTMItemsAndLabelsAndValues(
                                t.items,
                                l.items,
                                i + 1,
                                l
            ...
            for (var s = 0; s < i; s++) {
                ...
                if (h) {
                    ...
                    if (
                        ...
                        var p = new wjcChart.DataLabelRenderEventArgs(
                            t,
                            u,
                            e,
                            _
        ...
        (e.prototype._renderText = function (t, e, i, r, o, a, n, l) {
            ...
            return (
                ...
                this.type === TreeMapType.Horizontal && c.isTitle
                    ? (s.width > i.height &&
                          (h = this._cutText(r, s.width, i.height)),
                      ...
                      null)
                    : (s.width > i.width &&
                          (h = this._cutText(r, s.width, i.width)),
        ...
        (e.prototype.hitTest = function (t, e) {
            ...
            if (wjcChart.FlexChart._contains(this._rectHeader, i))
                ...
                for (
                    var a, n = this._areas.length, l = NaN, s = 0;
                    s < n;
                    s++
                ) {
                    var h = i.clone(),
                ...
                0 !== r._dist &&
                    null != a &&
                    (r._setData(null, a.tag), (r._dist = l)),
...
var _TreeMapItem = (function () {
        ...
        return (
            (t.prototype.draw = function (e) {
                ...
                (e.strokeWidth = 0),
                    this.isTitle
                        ? ((e.fill = this.titleFill),
                          (e.stroke = this.titleStroke))
    ...
    _ColorConverter = (function () {
        ...
        return (
            ...
            (t.prototype._resetmaxColor = function (t) {
                (this.maxColor = new wjcCore.Color(t)),
                    this._calculateMidColor();
            }),
            ...
            (t.prototype._calculateMidColorValue = function () {
                null == this.originalMidColorValue &&
                    (this.midColorValue =
                        (this.maxColorValue + this.minColorValue) / 2);
            }),
            (t.prototype._calculateMidColor = function () {
                null == this.originalMidColor &&
                    (this.midColor = this._calculateColorByVal(
                        this.midColorValue,
                        !0
                    ));
            }),
            (t.prototype._calculateColorByVal = function (t, e) {
                ...
                if (t >= this.maxColorValue)
                    return new wjcCore.Color(i.toString());
                if (t <= this.minColorValue)
                    return new wjcCore.Color(r.toString());
                if (!e) {
        ...
        return (
            ...
            (t.horizontal = function (e, i, r) {
                ...
                e.forEach(function (e) {
                    var a = [
                        { item: e, val: (e.value * i.width * i.height) / r },
                    ];
                ...
                r &&
                    r.forEach(function (r) {
                        ...
                        (a[i.field] = r),
                            n.flatDataOrder
                                ? ((o = []),
                                  t.convertFlatToHierarchical(o, n),
                                  (a.items = o))
                                : (a.value = n),
                            e.push(a);
                    });

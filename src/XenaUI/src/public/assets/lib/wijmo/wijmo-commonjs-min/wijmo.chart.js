...
var FlexChartBase = (function (t) {
    ...
    return (
        ...
        Object.defineProperty(e.prototype, "plotMargin", {
            ...
            set: function (t) {
                t != this._plotMargin &&
                    ((this._plotMargin = t), this.invalidate());
            },
            enumerable: !0,
            configurable: !0,
        }),
        ...
        Object.defineProperty(e.prototype, "header", {
            ...
            set: function (t) {
                t != this._header &&
                    ((this._header = wjcCore.asString(t, !0)),
                    this.invalidate());
            },
            enumerable: !0,
            configurable: !0,
        ...
        Object.defineProperty(e.prototype, "footer", {
            ...
            set: function (t) {
                t != this._footer &&
                    ((this._footer = wjcCore.asString(t, !0)),
                    this.invalidate());
            },
            enumerable: !0,
            configurable: !0,
        ...
        Object.defineProperty(e.prototype, "headerStyle", {
            ...
            set: function (t) {
                t != this._headerStyle &&
                    ((this._headerStyle = t), this.invalidate());
            },
            enumerable: !0,
            configurable: !0,
        }),
        Object.defineProperty(e.prototype, "footerStyle", {
            ...
            set: function (t) {
                t != this._footerStyle &&
                    ((this._footerStyle = t), this.invalidate());
            },
            enumerable: !0,
            configurable: !0,
        }),
        ...
        Object.defineProperty(e.prototype, "itemFormatter", {
            ...
            set: function (t) {
                t != this._itemFormatter &&
                    ((this._itemFormatter = wjcCore.asFunction(t)),
                    this.invalidate());
            },
            enumerable: !0,
            configurable: !0,
        ...
        (e.prototype._render = function (t, e) {
            ...
            if (0 != r) {
                if (
                    ...
                    (this._chartRectId =
                        "chartRect" + (1e6 * Math.random()).toFixed()),
            ...
            (e.width = o),
                ...
                i
                    ? ((this._legendHost = t.startGroup(
                      ...
                      (this._rectLegend = new wjcCore.Rect(
                          r.x,
                          r.y,
                          i.width,
                          i.height
        ...
        (e.prototype._drawTitle = function (t, e, i, r, n) {
            var o = FlexChart._CSS_TITLE,
                ...
                a = null;
            if (
                (n ? (this._rectFooter = null) : (this._rectHeader = null),
                null != i)
            ) {
                var h = null,
                    l = null,
        ...
        (e.prototype._highlightItems = function (t, e, i) {
            if (i) for (r = 0; r < t.length; r++) wjcCore.addClass(t[r], e);
                ...
                for (var r = 0; r < t.length; r++) wjcCore.removeClass(t[r], e);
        }),
        ...
        (e.prototype._clearTimeouts = function () {
            this._toShow && (clearTimeout(this._toShow), (this._toShow = null)),
                this._toHide &&
                    (clearTimeout(this._toHide), (this._toHide = null));
        }),
        ...
        return (
            ...
            (t.getDataUri = function (e) {
                ...
                return (
                    "svg" == e.tagName
                        ? ((r =
                              (i = wjcCore.getElementRect(e.parentNode || e))
                                  .width || 0),
                          (n = i.height || 0),
                          (o =
                    ...
                    "data:image/svg+xml;base64," +
                        window.btoa(
                            window.unescape(
                                encodeURIComponent(t.doctype + u.innerHTML)
                            )
                        )
                );
            }),
            (t.getStyles = function (t) {
                ...
                return null == i || 0 === i.length
                    ...
                    : ([].forEach.call(i, function (i) {
                          var r;
                          try {
                              if (null == i.cssRules || 0 === i.cssRules.length)
                                  return !0;
                          } catch (t) {
                              if ("SecurityError" == t.name)
                                  return (
                                      console.log(
                                          "SecurityError. Can't read: " + i.href
                                      ),
                                      !0
                                  );
                          }
    ...
    FlexPie = (function (t) {
                ...
                r.hostElement.addEventListener("mousemove", function (t) {
                    ...
                    if (e.content && !n.isTouching) {
                        ...
                        if (i.distance <= e.threshold) {
                            ...
                            n._showToolTip(
                                r,
                                new wjcCore.Rect(t.clientX, t.clientY, 5, 5)
                            );
                        } else n._hideToolTip();
                    }
                }),
        ...
        return (
            ...
            Object.defineProperty(e.prototype, "bindingName", {
                ...
                set: function (t) {
                    t != this._bindingName &&
                        ((this._bindingName = wjcCore.asString(t, !0)),
                        this._bindChart());
                },
                enumerable: !0,
                configurable: !0,
            ...
            Object.defineProperty(e.prototype, "startAngle", {
                ...
                set: function (t) {
                    t != this._startAngle &&
                        ((this._startAngle = wjcCore.asNumber(t, !0)),
                        this.invalidate());
                },
                enumerable: !0,
                configurable: !0,
            ...
            Object.defineProperty(e.prototype, "offset", {
                ...
                set: function (t) {
                    t != this._offset &&
                        ((this._offset = wjcCore.asNumber(t, !0)),
                        this.invalidate());
                },
                enumerable: !0,
                configurable: !0,
            ...
            Object.defineProperty(e.prototype, "innerRadius", {
                ...
                set: function (t) {
                    t != this._innerRadius &&
                        ((this._innerRadius = wjcCore.asNumber(t, !0)),
                        this.invalidate());
                },
                enumerable: !0,
                configurable: !0,
            ...
            Object.defineProperty(e.prototype, "reversed", {
                ...
                set: function (t) {
                    t != this._reversed &&
                        ((this._reversed = wjcCore.asBoolean(t, !0)),
                        this.invalidate());
                },
                enumerable: !0,
                configurable: !0,
            ...
            Object.defineProperty(e.prototype, "selectedItemPosition", {
                ...
                set: function (t) {
                    t != this._selectedItemPosition &&
                        ((this._selectedItemPosition = wjcCore.asEnum(
                            t,
                            Position,
                            !0
                        )),
            ...
            (e.prototype.hitTest = function (t, e) {
                ...
                if (FlexChart._contains(this._rectHeader, i))
                    ...
                    for (
                        var o, s = this._areas.length, a = NaN, h = 0;
                        h < s;
                        h++
                    ) {
                        var l = i.clone();
            ...
            (e.prototype._renderChart = function (t, i, r) {
                ...
                var a = this._parseMargin(this.plotMargin),
                    ...
                    c = l
                        ? (wjcCore.isNumber(h.offset) ? h.offset : 0) + 24
                        : 0;
            ...
            (e.prototype._renderSlice = function (
                t,
                e,
                i,
                r,
            ...
            (e.prototype._measureLegendItem = function (t, e) {
                ...
                if (
                    ...
                    (i.width += r.width),
                        i.height < r.height && (i.height = r.height);
                }
                return (
            ...
            (e.prototype._select = function (t, e) {
                ...
                (this.selectedItemOffset > 0 ||
                    ...
                    ? ((this._selectedIndex = null == t ? -1 : t),
                      this.invalidate())
            ...
            (e.prototype._highlight = function (t, e, i) {
                if (
                    ...
                    if (t) {
                        ...
                        if (h > 0 && n && 0 == n.length) {
                            var l = (this._selectedOffset.x =
                                    Math.cos(o) * h * this._radius),
                                c = (this._selectedOffset.y =
                                    Math.sin(o) * h * this._radius);
                            r &&
                                r.setAttribute(
                                    "transform",
                                    "translate(" +
                        ...
                        r &&
                            (r.parentNode.insertBefore(
                                r,
                                r.parentNode.childNodes.item(e)
                            ),
            ...
            (e.prototype._getHitTestItem = function (t) {
                ...
                return (
                    (e =
                        null != this._cv ? this._cv.items : this.itemsSource) &&
                        t < e.length &&
                        (i = e[t]),
                    i
                );
...
var FlexChartCore = (function (t) {
    ...
    return (
        ...
        Object.defineProperty(e.prototype, "symbolSize", {
            ...
            set: function (t) {
                t != this._symbolSize &&
                    ((this._symbolSize = wjcCore.asNumber(t, !1, !0)),
                    this.invalidate());
            },
            enumerable: !0,
            configurable: !0,
        ...
        Object.defineProperty(e.prototype, "interpolateNulls", {
            ...
            set: function (t) {
                t != this._interpolateNulls &&
                    ((this._interpolateNulls = wjcCore.asBoolean(t)),
                    this.invalidate());
            },
            enumerable: !0,
            configurable: !0,
        ...
        Object.defineProperty(e.prototype, "legendToggle", {
            ...
            set: function (t) {
                t != this._legendToggle &&
                    (this._legendToggle = wjcCore.asBoolean(t));
            },
            enumerable: !0,
            configurable: !0,
        }),
            ...
            if (FlexChart._contains(this._rectHeader, i))
                ...
                (r._chartElement = ChartElement.Legend),
                    null !== (n = this.legend._hitTest(i)) &&
                        ...
                        (this._getChartType() === ChartType.Bar
                            ? r._setData(
                                  this.series[this.series.length - 1 - n]
                              )
                ...
                if (o)
                    ...
                    for (
                        ...
                        if (
                            this.series[l].hitTest !== Series.prototype.hitTest
                        ) {
                            var c = this.series[l].hitTest(t);
                            if (
                                c &&
                                ((!a || c.distance < a.distance) &&
                                    ((a = c), (h = l)),
                                0 === c.distance)
                            )
                                break;
                    ...
                    s && s.area
                        ? a && a.distance < s.distance
                            ...
                            : a &&
                              ...
                              h > s.area.tag.seriesIndex
                            ? (r = a)
                            : (r._setDataPoint(s.area.tag),
                              (r._dist = s.distance))
                        : a && (r = a),
        ...
        (e.prototype.dataToPoint = function (t, e) {
            ...
            var i = t.clone();
            return (
                (i.x = this.axisX.convert(i.x)),
                (i.y = this.axisY.convert(i.y)),
                i
            );
        }),
        ...
        (e.prototype._hitTestData = function (t) {
            ...
            return (
                r &&
                    r.area &&
                    (i._setDataPoint(r.area.tag), (i._dist = r.distance)),
                i
            );
        }),
        ...
        (e.prototype._renderChart = function (t, e, i) {
                ...
                for (p = 0; p < l.length; p++) {
                    ...
                    (v =
                        y.axisType == AxisType.X
                            ? t.startGroup(
                                  FlexChart._CSS_AXIS_X,
                                  this._chartRectId
                              )
                            : t.startGroup(
                                  FlexChart._CSS_AXIS_Y,
                                  this._chartRectId
                              )),
            ...
            t.startGroup("wj-series-group"),
                (this._plotrectId =
                    "plotRect" + (1e6 * Math.random()).toFixed()),
            ...
            for (p = 0; p < _; p++) {
                ...
                var v = t.startGroup(
                    b.cssClass,
                    g.clipping ? this._plotrectId : null
                );
        ...
        (e.prototype._renderLegendElements = function (
            t,
            e,
            i,
            r,
                    ...
                    if (C._hasOrigin) {
                        ...
                        y == Position.Bottom
                            ? ((S = new wjcCore.Rect(
                              ...
                              (d += Math.max(
                                  0,
                                  S.bottom - this._plotRect.bottom
                              )))
                            : y == Position.Top
                            ? ((S = new wjcCore.Rect(
                                  a,
        ...
        (e.prototype._layoutMultiple = function (t, e, i) {
            for (
                ...
                if ((((C = a[l])._plotrect = null), C.axisType == AxisType.X)) {
                    for (
                        var c = C.plotArea ? C.plotArea.column : 0;
                        o.length <= c;
                    ...
                    for (
                        var _ = C.plotArea ? C.plotArea.row : 0;
                        s.length <= _;
                ...
                for (l = 0; l < k.axes.length; l++) {
                    ...
                    (C._desiredSize = w),
                        0 == v &&
                            (k.left = Math.max(
                                k.left,
                                0.5 * C._annoSize.width
                            )),
                        v == u - 1 &&
                            (k.right = Math.min(
                                k.right,
                                r - 0.5 * C._annoSize.width
                            )),
            ...
            for (V = 0; V < p; V++) {
                ...
                for (l = 0; l < k.axes.length; l++) {
                    ...
                    S.height > f.height && (S.height = f.height),
                        (C._desiredSize = S),
                        0 == V &&
                            (k.top = Math.max(k.top, 0.5 * C._annoSize.width)),
                        V == p - 1 &&
                            (k.bottom = Math.min(
                                k.bottom,
                                n - 0.5 * C._annoSize.width
                            )),
            ...
            for (
                var A = this._plotRect.clone(),
                    L = g,
                    N = this.plotAreas._calculateWidths(
            ...
            for (
                var O = m,
                    F = this.plotAreas._calculateHeights(
                        this._plotRect.height,
                        p
                    ),
                    V = 0;
                V < p;
                ...
                for (var k = s[V], X = F[V], l = 0; l < k.axes.length; l++) {
                    ...
                    C._plotrect
                        ? ((R.left = C._plotrect.left),
                          (R.width = C._plotrect.width))
        ...
        (e.prototype._select = function (t, e) {
            var i = !1;
            if (
                ((t == this._selection && e == this._selectionIndex) ||
                    (i = !0),
                this._selection &&
            ...
            if (
                ...
                e
                    ...
                    : n.parentNode.insertBefore(
                          n,
                          n.parentNode.childNodes.item(r)
                      );
                s = this._find(n, [
                    "rect",
                    "ellipse",
        ...
        (e.prototype._updateAuxAxes = function (t, e) {
            for (var i = 2; i < t.length; i++) {
                ...
                for (var a, h, o = 0; o < n.length; o++) {
                    ...
                    l &&
                        ((r.axisType == AxisType.X && !e) ||
                        (r.axisType == AxisType.Y && e)
    ...
    _DataInfo = (function () {
        ...
        return (
            (t.prototype.analyse = function (e, i, r, n, o, s) {
                ...
                if (
                    ...
                    for (var _ = n.length, u = 0; u < _; u++) {
                        P = n[u];
                        if (
                            ((isNaN(this.minX) || this.minX > P) &&
                                (this.minX = P),
                            (isNaN(this.maxX) || this.maxX < P) &&
                                (this.maxX = P),
                            P > 0 &&
                ...
                for (u = 0; u < e.length; u++) {
                    var p = e[u],
                        ...
                        g = p.visibility;
                    if (
                        g != SeriesVisibility.Hidden &&
                        g != SeriesVisibility.Legend
                    ) {
                        var m,
                            y = p.getDataRect();
                        y &&
                        ...
                        if (
                            ...
                            this.dataTypeX ||
                                (this.dataTypeX = p.getDataType(1));
                            for (C = 0; C < b.length; C++) {
                                S = b[C];
                                if (
                                    t.isValid(S) &&
                                    ((isNaN(this.minX) || this.minX > S) &&
                                        (this.minX = S),
                                    (isNaN(this.maxX) || this.maxX < S) &&
                                        (this.maxX = S),
                                    C > 0 &&
                                        (!d ||
                                            d == ChartType.Column ||
                        ...
                        if (
                            ...
                            x &&
                                (this.dataTypeY ||
                                    w ||
                                    (this.dataTypeY = p.getDataType(0)),
                                isNaN(this.minX)
                                    ? (this.minX = 0)
                                    : b ||
                                      n ||
            ...
            (t.prototype._parseYVal = function (e, i, r, n, o, s) {
                t.isValid(e) &&
                    (null != e &&
                        (isNaN(this.minY) || this.minY > e) &&
                        (this.minY = e),
                    null != e &&
                        (isNaN(this.maxY) || this.maxY < e) &&
                        (this.maxY = e),
                    e > 0 &&
                        (isNaN(this.minYp) || this.minYp > e) &&
                        (this.minYp = e),
                    r ||
                        (e > 0
                            ? isNaN(o[i])
...
var ChartTooltip = (function (t) {
    function e() {
        ...
        return (
            (e._content = "<b>{seriesName}</b><br/>{x} {y}"),
            (e._threshold = 15),
            e
        );
    }
...
var FlexChart = (function (t) {
    ...
    return (
        ...
        Object.defineProperty(e.prototype, "chartType", {
            ...
            set: function (t) {
                t != this._chartType &&
                    ((this._chartType = wjcCore.asEnum(t, ChartType)),
                    this.invalidate());
            },
            enumerable: !0,
            configurable: !0,
        ...
        Object.defineProperty(e.prototype, "stacking", {
            ...
            set: function (t) {
                t != this._stacking &&
                    ((this._stacking = wjcCore.asEnum(t, Stacking)),
                    this.invalidate());
            },
            enumerable: !0,
            configurable: !0,
...
var Axis = (function () {
    ...
    return (
        ...
        Object.defineProperty(t.prototype, "reversed", {
            ...
            set: function (t) {
                this._reversed != t &&
                    ((this._reversed = wjcCore.asBoolean(t)),
                    this._invalidate());
            },
            enumerable: !0,
            configurable: !0,
        ...
        Object.defineProperty(t.prototype, "majorUnit", {
            ...
            set: function (t) {
                t != this._majorUnit &&
                    ((this._majorUnit = wjcCore.asNumber(t, !0)),
                    this._invalidate());
            },
            enumerable: !0,
            configurable: !0,
        ...
        Object.defineProperty(t.prototype, "minorUnit", {
            ...
            set: function (t) {
                t != this._minorUnit &&
                    ((this._minorUnit = wjcCore.asNumber(t, !0)),
                    this._invalidate());
            },
            enumerable: !0,
            configurable: !0,
        ...
        Object.defineProperty(t.prototype, "title", {
            ...
            set: function (t) {
                t != this._title &&
                    ((this._title = wjcCore.asString(t, !0)),
                    this._invalidate());
            },
            enumerable: !0,
            configurable: !0,
        ...
        Object.defineProperty(t.prototype, "format", {
            ...
            set: function (t) {
                t != this._format &&
                    ((this._format = wjcCore.asString(t, !0)),
                    this._invalidate());
            },
            enumerable: !0,
            configurable: !0,
        ...
        Object.defineProperty(t.prototype, "majorGrid", {
            ...
            set: function (t) {
                t != this._majorGrid &&
                    ((this._majorGrid = wjcCore.asBoolean(t, !0)),
                    this._invalidate());
            },
            enumerable: !0,
            configurable: !0,
        ...
        Object.defineProperty(t.prototype, "minorGrid", {
            ...
            set: function (t) {
                t != this._minorGrid &&
                    ((this._minorGrid = wjcCore.asBoolean(t, !0)),
                    this._invalidate());
            },
            enumerable: !0,
            configurable: !0,
        ...
        Object.defineProperty(t.prototype, "axisLine", {
            ...
            set: function (t) {
                t != this._axisLine &&
                    ((this._axisLine = wjcCore.asBoolean(t, !0)),
                    this._invalidate());
            },
            enumerable: !0,
            configurable: !0,
        ...
        Object.defineProperty(t.prototype, "labels", {
            ...
            set: function (t) {
                t != this._labels &&
                    ((this._labels = wjcCore.asBoolean(t, !0)),
                    this._invalidate());
            },
            enumerable: !0,
            configurable: !0,
        ...
        Object.defineProperty(t.prototype, "labelAlign", {
            ...
            set: function (t) {
                t != this._labelAlign &&
                    ((this._labelAlign = wjcCore.asString(t, !0)),
                    this._invalidate());
            },
            enumerable: !0,
            configurable: !0,
        ...
        Object.defineProperty(t.prototype, "labelAngle", {
            ...
            set: function (t) {
                t != this._labelAngle &&
                    ((this._labelAngle = wjcCore.asNumber(t, !0)),
                    this._invalidate());
            },
            enumerable: !0,
            configurable: !0,
        ...
        Object.defineProperty(t.prototype, "origin", {
            ...
            set: function (t) {
                t != this._origin &&
                    ((this._origin = wjcCore.asNumber(t, !0)),
                    this._invalidate());
            },
            enumerable: !0,
            configurable: !0,
        ...
        Object.defineProperty(t.prototype, "itemFormatter", {
            ...
            set: function (t) {
                this._ifmt != t &&
                    ((this._ifmt = wjcCore.asFunction(t, !0)),
                    this._invalidate());
            },
            enumerable: !0,
            configurable: !0,
        ...
        Object.defineProperty(t.prototype, "logBase", {
            ...
            set: function (t) {
                t != this._logBase &&
                    ((this._logBase = wjcCore.asNumber(t, !0, !0)),
                    this._invalidate());
            },
            enumerable: !0,
            configurable: !0,
        ...
        Object.defineProperty(t.prototype, "plotArea", {
            ...
            set: function (t) {
                t != this._parea &&
                    ((this._parea = wjcCore.asType(t, PlotArea, !0)),
                    this._invalidate());
            },
            enumerable: !0,
            configurable: !0,
        ...
        (t.prototype._isOverlapped = function (t, e, i, r) {
            ...
            if (null != n && n.length > 1)
                for (
                    var o = n.length,
                        s =
                            this._values && this._values.length == o
                                ? this._values
                                : null,
                        a = 0,
                        h = 0,
                    ...
                    if (c >= this._actualMin && c <= this._actualMax) {
                        ...
                        if (this.axisType == AxisType.X) {
                            if (
                                l > 0 &&
                                Math.abs(_ - a) < Math.max(u.width, h) + 12
                            )
                                return !0;
                            (a = _), (h = u.width);
        ...
        (t.prototype._getHeight = function (t, e) {
            ...
            if (
                this.labels &&
                this._chart._getChartType() !== ChartType.Funnel
            ) {
                if (
                    ((s = this._updateAutoFormat(s)), null != a && a.length > 0)
                ) {
                    var l = a.length,
                        c =
                            this._values && this._values.length == l
                                ? this._values
                                : null;
        ...
        (t.prototype._updateActualLimits = function (t, e, i, r, n) {
            ...
            if (
                (((o != this._actualMin &&
                    (wjcCore.isNumber(o) ||
                        wjcCore.isNumber(this._actualMin))) ||
                    (s != this._actualMax &&
                        (wjcCore.isNumber(s) ||
                            wjcCore.isNumber(this._actualMax)))) &&
                    this.onRangeChanged(),
                this._items)
            ) {
                ...
                for (var y = 0; y < d; y++) {
                    var b = this._items[y],
                        v = b[f];
                    wjcCore.isNumber(v) &&
                        (this._values.push(v), this._lbls.push(b[g]));
                }
        ...
        (t.prototype._renderLabelsAndTicks = function (
            t,
            e,
            i,
            r,
            ...
            if (_) {
                ...
                if (
                    ...
                    if (s) {
                        var P = new wjcCore.Point(
                            S,
                            this._axrect.bottom - h - p
                        );
                        c =
                            0 != n
                                ? this._renderRotatedLabel(
                        ...
                        function (t) {
                            if (c)
                                for (var e = l.length, i = 0; i < e; i++)
                                    if (FlexChart._intersects(l[i], t))
                                        return !1;
                            return !0;
                        }
                    );
        ...
        (t.prototype._createLogarithmicLabels = function (t, e, i, r, n, o) {
            ...
            if (o) {
                var d = this._getPosition(),
                    f = this._getAnnoNumber(
                        d == Position.Left || d == Position.Right
                    );
                u > f
                    ? (p = Math.floor(u / f + 1))
                    : _ &&
                ...
                if (_)
                    for (var m = Math.pow(s, g), y = 0; y * c < s - 1; y++)
                        (b = m * (1 + y * c)) >= t &&
                            ...
                            (0 == y
                                ? (r.unshift(b),
                                  n && n.unshift(this._formatValue(b)))
                                : (r.push(b),
                                  n && n.push(this._formatValue(b))));
                else {
                    var b = Math.pow(c, g);
                    b >= t &&
                        b <= e &&
        ...
        (t.prototype._createTimeLabels = function (t, e, i, r) {
            ...
            if (u.TotalDays >= 365 && !wjcCore.isNumber(this._majorUnit)) {
                ...
                u.TotalDays >= 30 &&
                !wjcCore.isNumber(this._majorUnit)
            ) {
                ...
                for (
                    x > b &&
                    (v = new Date(v.getTime() + Math.floor(x / b) * b));
                    v <= a && b;
        ...
        return (
            ...
            (t.RoundTime = function (e, i, r) {
                ...
                if (n > 0) {
                    ...
                    return n < _tmInc.minute
                        ? ((o.second = this.tround(o.second, n, r)),
                          o.getTimeAsDouble())
                        : ((o.second = 0),
                          n < _tmInc.hour
                              ? ((n /= _tmInc.minute),
            ...
            (t.NiceTimeSpan = function (e, i) {
                ...
                if (r < _tmInc.second && e.TotalSeconds < 10) {
                    for (
                        n = e.Ticks, o = t.TimeSpanFromTmInc(r).Ticks;
                        n > 10 * o;
                ...
                if (0 == (n = Math.ceil(e.TotalSeconds)))
                    return t.TimeSpanFromTmInc(r);
                ...
                if (r < _tmInc.year) {
                    if (
                        n < _tmInc.year &&
                        0 != (o = t.getNiceInc([1, 2, 3, 4, 6], n, r))
                    )
                        return _timeSpan.fromSeconds(o);
                    r = _tmInc.year;
                }
            ...
            (t.GetTimeDefaultFormat = function (t, e) {
                ...
                if (n >= _tmInc.year) i = "yyyy";
                    ...
                    var o = r.Ticks;
                    for (i = "s."; o < _timeSpan.TicksPerSecond; )
                        (o *= 10), (i += "f");
                }
                return i;
            }),
    ...
    PlotArea = (function () {
        ...
        return (
            ...
            Object.defineProperty(t.prototype, "height", {
                ...
                set: function (t) {
                    t != this._height &&
                        ((this._height = t), this._invalidate());
                },
                enumerable: !0,
                configurable: !0,
            }),
...
var SeriesBase = (function () {
    ...
    return (
        ...
        Object.defineProperty(t.prototype, "altStyle", {
            ...
            set: function (t) {
                t != this._altStyle &&
                    ((this._altStyle = t), this._invalidate());
            },
            enumerable: !0,
            configurable: !0,
        }),
        Object.defineProperty(t.prototype, "symbolStyle", {
            ...
            set: function (t) {
                t != this._symbolStyle &&
                    ((this._symbolStyle = t), this._invalidate());
            },
            enumerable: !0,
            configurable: !0,
        }),
        ...
        Object.defineProperty(t.prototype, "visibility", {
            ...
            set: function (t) {
                t != this._visibility &&
                    ...
                    this._invalidate(),
                    this._chart &&
                        this._chart.onSeriesVisibilityChanged(
                            new SeriesEventArgs(this)
                        ));
            },
            enumerable: !0,
            configurable: !0,
        ...
        (t.prototype.hitTest = function (t, e) {
            return (
                ...
                wjcCore.asType(t, wjcCore.Point),
                this._chart
                    ? this._chart._hitTestSeries(
                          t,
                          this._chart.series.indexOf(this)
                      )
                    : null
            );
        }),
        ...
        Object.defineProperty(t.prototype, "axisX", {
            ...
            set: function (t) {
                if (t != this._axisX) {
                    if (
                        ((this._axisX = wjcCore.asType(t, Axis, !0)),
                        this._axisX)
                    ) {
                        var e = (this._axisX._chart = this._chart);
                        e &&
                            -1 == e.axes.indexOf(this._axisX) &&
        ...
        Object.defineProperty(t.prototype, "axisY", {
            ...
            set: function (t) {
                if (t != this._axisY) {
                    if (
                        ((this._axisY = wjcCore.asType(t, Axis, !0)),
                        this._axisY)
                    ) {
                        var e = (this._axisY._chart = this._chart);
                        e &&
                            -1 == e.axes.indexOf(this._axisY) &&
                            e.axes.push(this._axisY);
                    }
                    this._invalidate();
                }
            },
        ...
        (t.prototype._getSymbolSize = function () {
            return null != this.symbolSize
                ? this.symbolSize
                : this.chart.symbolSize;
        }),
                ...
                if (null == this._values)
                    if (((this._valueDataType = null), null != this._cv)) {
                        ...
                        (this._values = i.values),
                            (this._valueDataType = i.dataType);
                    } else if (
                        null != this.binding &&
                        null != this._chart &&
                ...
                if (null == this._xvalues) {
                    ...
                    if (null != this.bindingX)
                        if (null != e._cv) {
                            ...
                            (this._xvalueDataType = i.dataType),
                                (this._xvalues = i.values);
                        } else {
                            if (null == this._bindingX) return null;
                            if (
                                null != e._chart &&
                                null != e._chart.collectionView
                            ) {
        ...
        (t.prototype._isCustomAxisX = function () {
            return (
                !!this._axisX &&
                (!this._chart || this._axisX != this.chart.axisX)
            );
        }),
        (t.prototype._isCustomAxisY = function () {
            return (
                !!this._axisY &&
                (!this._chart || this._axisY != this.chart.axisY)
            );
        }),
        ...
        (t.prototype._drawLegendItem = function (t, e, i, r, n, o) {
            ...
            var s = Series._LEGEND_ITEM_MARGIN,
                ...
                h = null;
            null === a &&
                (a = this._chart._getColorLight(
                    this._chart.series.indexOf(this)
                )),
                null === h &&
                    (h = this._chart._getColor(
                        this._chart.series.indexOf(this)
                    )),
                (t.fill = a),
                (t.stroke = h);
        ...
        (t.prototype._cvCurrentChanged = function (t, e) {
            this._chart &&
                this._chart._notifyCurrentChanged &&
                this._invalidate();
        }),
                ...
                for (var a = 0; a < s; a++) {
                    ...
                    null != e && (h = h[e]),
                        ...
                        wjcCore.isNumber(h)
                            ...
                            : wjcCore.isDate(h)
                            ? ((r[a] = h.valueOf()),
                              (n = wjcCore.DataType.Date))
                            : i &&
                              h &&
                              ((r[a] = a), (n = wjcCore.DataType.Number)),
...
var _SvgRenderEngine = (function () {
    ...
    return (
        ...
        (t.prototype.drawString = function (t, e, i, r) {
            ...
            return (
                n.setAttribute("y", (e.y - (o.y + o.height - e.y)).toFixed(1)),
                n
            );
        }),
        (t.prototype.drawStringRotated = function (e, i, r, n, o, s) {
            ...
            return (
                a.setAttribute("y", (i.y - (l.y + l.height - i.y)).toFixed(1)),
                a
            );
        }),
        ...
        (t.prototype.startGroup = function (e, i, r) {
            ...
            return (
                ...
                this._appendChild(n),
                r &&
                    n.transform.baseVal.appendItem(
                        this._svg.createSVGTransform()
                    ),
                (this._group = n),
                n
            );
                ...
                try {
                    ...
                    for (
                        var r =
                                ...
                                i +
                                "</svg>",
                            n = new DOMParser().parseFromString(r, "text/xml")
        ...
        (t.prototype._createText = function (e, i) {
            ...
            return (
                ...
                this._fontFamily &&
                    r.setAttribute("font-family", this._fontFamily),
                r
            );
        }),
                    ...
                    if (null == this._savedGradient[r]) {
                        ...
                        null != n.x1
                            ? ((o = document.createElementNS(
                              ...
                              ["x1", "y1", "x2", "y2", "gradientUnits"].forEach(
                                  function (t) {
                            ...
                            n.colors &&
                                ...
                                n.colors.forEach(function (e) {
                                    ...
                                    null != e.color &&
                                        i.setAttribute("stop-color", e.color),
                                        null != e.offset &&
            ...
            (t.tryParse = function (e) {
                ...
                "l" === n || "L" === n
                    ...
                    : ("r" !== n && "R" !== n) ||
                      ...
                      "r" === n && (o = !0),
                      ["cx", "cy", "r", "fx", "fy", "fr"].forEach(function (
                          t,
                          e
                      ) {
                          null != s[e] &&
...
var HitTestInfo = (function () {
    ...
    return (
        ...
        Object.defineProperty(t.prototype, "x", {
            get: function () {
                return (
                    void 0 === this._x && (this._x = this._getValue(1, !1)),
                    this._x
                );
            },
            enumerable: !0,
        ...
        Object.defineProperty(t.prototype, "y", {
            get: function () {
                return (
                    void 0 === this._y && (this._y = this._getValue(0, !1)),
                    this._y
                );
            },
            enumerable: !0,
        ...
        Object.defineProperty(t.prototype, "_xfmt", {
            get: function () {
                return (
                    void 0 === this.__xfmt &&
                        (this.__xfmt = this._getValue(1, !0)),
                    this.__xfmt
                );
            },
            enumerable: !0,
        ...
        Object.defineProperty(t.prototype, "_yfmt", {
            get: function () {
                return (
                    void 0 === this.__yfmt &&
                        (this.__yfmt = this._getValue(0, !0)),
                    this.__yfmt
                );
            },
            enumerable: !0,
...
var DataLabelBase = (function () {
    ...
    return (
        ...
        Object.defineProperty(t.prototype, "border", {
            ...
            set: function (t) {
                t != this._bdr &&
                    ((this._bdr = wjcCore.asBoolean(t, !0)),
                    this._invalidate());
            },
            enumerable: !0,
            configurable: !0,
        ...
        Object.defineProperty(t.prototype, "connectingLine", {
            ...
            set: function (t) {
                t != this._line &&
                    ((this._line = wjcCore.asBoolean(t, !0)),
                    this._invalidate());
            },
            enumerable: !0,
            configurable: !0,
...
var DataLabel = (function (t) {
    ...
    return (
        ...
        Object.defineProperty(e.prototype, "position", {
            ...
            set: function (t) {
                t != this._pos &&
                    ((this._pos = wjcCore.asEnum(t, LabelPosition)),
                    this._invalidate());
            },
            enumerable: !0,
            configurable: !0,
...
!(function (t) {
    ...
    (LineMarkerLines =
        exports.LineMarkerLines || (exports.LineMarkerLines = {}))
);
    ...
    return (
        ...
        Object.defineProperty(t.prototype, "seriesIndex", {
            ...
            set: function (t) {
                var e = this;
                t !== e._seriesIndex &&
                    (e._seriesIndex = wjcCore.asNumber(t, !0));
            },
            enumerable: !0,
            configurable: !0,
        }),
        ...
        Object.defineProperty(t.prototype, "alignment", {
            ...
            set: function (t) {
                ...
                t !== e._alignment &&
                    ((e._alignment = t),
                    e._marker && e._updatePositionByAlignment());
            },
            enumerable: !0,
            configurable: !0,
        }),
        ...
        Object.defineProperty(t.prototype, "dragThreshold", {
            ...
            set: function (t) {
                t != this._dragThreshold &&
                    (this._dragThreshold = wjcCore.asNumber(t));
            },
            enumerable: !0,
            configurable: !0,
        }),
        ...
        Object.defineProperty(t.prototype, "dragLines", {
            ...
            set: function (t) {
                t != this._dragLines &&
                    (this._dragLines = wjcCore.asBoolean(t));
            },
            enumerable: !0,
            configurable: !0,
        }),
        ...
        (t.prototype._attachDrag = function () {
            ...
            t._interaction === LineMarkerInteraction.Drag &&
                (t._wrapperMousedown ||
                    (t._wrapperMousedown = t._onMousedown.bind(t)),
        ...
        (t.prototype._toggleDragEventAttach = function (t) {
            ...
            i[r]("mousedown", e._wrapperMousedown),
                ...
                "ontouchstart" in window &&
                    i[r]("touchstart", e._wrapperMousedown),
                "ontouchend" in window &&
                    document[r]("touchend", e._wrapperMouseup);
        }),
        (t.prototype._onMousedown = function (e) {
            ...
            a._interaction === LineMarkerInteraction.Drag &&
                ((o = !(
                    0 === (i = wjcCore.getElementRect(a._hLine)).width ||
                    0 === i.height
                )),
                (s = !(
                    0 === (r = wjcCore.getElementRect(a._vLine)).width ||
                    0 === r.height
                )),
        ...
        (t.prototype._onMouseup = function (e) {
            ...
            (i._capturedEle = void 0),
                ...
                r &&
                    (i._updatePositionByAlignment(),
                    i._updatePositionByAlignment()),
                wjcCore.removeClass(
                    i._chart.hostElement,
                    t._CSS_LINE_DRAGGABLE
                );
        }),
        (t.prototype._moveMarker = function (t) {
            ...
            if (
                ...
                if (null != d && d >= 0 && d < h.series.length) {
                    ...
                    (r = e.axisX || h.axisX),
                        (n = e._getAxisY()),
                        (o = wjcCore.isDate(i.x)
                            ? FlexChart._toOADate(i.x)
                            : i.x),
                        (o = wjcCore.isString(o) ? i.pointIndex : o),
                        (s = wjcCore.isDate(i.y)
                            ? FlexChart._toOADate(i.y)
                            : i.y),
        ...
        (t.prototype._initialize = function () {
            var t,
                e = this,
                i = e._chart.hostElement.querySelector(
                    "." + FlexChart._CSS_PLOT_AREA
                );
            (e._plot = i),
        ...
        (t.prototype._updateContent = function () {
            var t,
                ...
                r = e._targetPoint,
                n = i.hitTest(r);
            (t = e._content.call(null, n, r)),
                (e._markerContent.innerHTML = t || "");
        }),
        ...
        (t.prototype.distance = function (t) {
            ...
            return t.x < i.left
                ? t.y < i.top
                    ...
                    ? this.pointDistance(
                          t,
                          new wjcCore.Point(i.left, i.bottom),
                          e
                      )
                    : e == _MeasureOption.Y
                    ? 0
                ...
                ? t.y < i.top
                    ? this.pointDistance(
                          t,
                          new wjcCore.Point(i.right, i.top),
                          e
                      )
                    : t.y > i.bottom
                    ? this.pointDistance(
                          t,
                          new wjcCore.Point(i.right, i.bottom),
                          e
                      )
                    : e == _MeasureOption.Y
                    ? 0
...
var _BasePlotter = (function () {
    ...
    return (
        ...
        (t.prototype._renderLabel = function (t, e, i, r, n, o, s, a) {
            ...
            if (
                (this._getPointAndPosition(p, h, e, r), r._plotRect.contains(p))
            ) {
        ...
        (t.prototype.isValid = function (t, e, i, r) {
            return (
                ...
                _DataInfo.isValid(e) &&
                FlexChart._contains(
                    this.chart._plotRect,
                    new wjcCore.Point(t, e)
                )
            );
        }),
    ...
    return (
                ...
                for (s = 0; s < this.chart.series.length; s++) {
                    ...
                    if (
                        ...
                        (this._volHelper = new _VolumeHelper(n, a, l, c, o)),
                            ...
                            (i._customConvertBack =
                                this._volHelper.convertBack.bind(
                                    this._volHelper
                                )),
                            h &&
                                h.length > 0 &&
                                (this._itemsSource = i.itemsSource = h);
                        break;
                    }
                }
            }
        ...
        (e.prototype.plotSeries = function (t, e, i, r, n, o, s, a) {
            ...
            if (x) {
                ...
                if (
                    (void 0 !== c._getChartType() && (D = R = !1), this.rotated)
                ) {
                    I < e.actualMin
                        ? (I = e.actualMin)
                        ...
                        if (
                            ...
                            if (D) {
                                ...
                                Y > 0
                                    ...
                                    a &&
                                        h.push(
                                            new wjcCore.Point(nt, i.convert(B))
                                        );
                                q = new wjcCore.Rect(
                                    Math.min(G, nt),
                                    Math.min(et, it),
                    ...
                    for (X = 0; X < L; X++) {
                        ...
                        if (
                            (this._getSymbolStyles &&
                                ((T =
                                    (H = this._getSymbolStyles(X, L)) && H.fill
                                        ? H.fill
                                        : T),
                                (M = H && H.fill ? H.fill : M),
                            ...
                            if (D) {
                                ...
                                if (
                                    ...
                                    (nt = e.convert(nt)),
                                    !_DataInfo.isValid(G) ||
                                        !_DataInfo.isValid(nt))
                                )
                                    continue;
                                var et, it;
                                R &&
                                    (Y /= W =
                                        this.dataInfo.getStackedAbsSum(B));
                                var rt = 0;
                                Y > 0
                                    ? ((rt = isNaN(v[B]) ? 0 : v[B]),
                                      (et = i.convert(rt)),
                                    ...
                                    a &&
                                        h.push(
                                            new wjcCore.Point(e.convert(B), it)
                                        );
                                q = new wjcCore.Rect(
                                    Math.min(G, nt),
                                    Math.min(et, it),
...
var _LinePlotter = (function (t) {
    ...
    return (
        ...
        (e.prototype.plotSeries = function (t, e, i, r, n, o, s, a) {
            ...
            if (_) {
                ...
                var w = new Array(),
                    ...
                    M =
                        this.stacking == Stacking.Stacked100pc &&
                        !l._isCustomAxisY();
                void 0 !== l._getChartType() && (T = M = !1);
                for (
                    var j = this.chart.interpolateNulls, A = !1, L = 0;
                    L < d;
                    L++
                ) {
                    var N = f ? u[L] : L,
                    ...
                    if (_DataInfo.isValid(N) && _DataInfo.isValid(k)) {
                        if (T)
                            if (
                                (M && (k /= this.dataInfo.getStackedAbsSum(N)),
                                k >= 0)
                            ) {
                                I = isNaN(this.stackPos[N])
                                    ? 0
                                    : this.stackPos[N];
                                k = this.stackPos[N] = I + k;
                            } else {
                                var I = isNaN(this.stackNeg[N])
                                    ? 0
                                    : this.stackNeg[N];
                        ...
                        if (isNaN(N) || isNaN(k))
                            ...
                            var R = new _CircleArea(
                                new wjcCore.Point(N, k),
                                0.5 * x
                            );
        ...
        (e.prototype._drawLines = function (t, e, i, r, n, o) {
            this.isSpline
                ? t.drawSplines(e, i, r, n, o)
                : t.drawLines(e, i, r, n, o);
        }),
            ...
            if (_) {
                ...
                if (p) {
                    ...
                    for (
                        ...
                        if (
                            ...
                            if (b) {
                                ...
                                var N = 0;
                                A >= 0
                                    ? ((N = isNaN(this.stackPos[j])
                                          ? 0
                                          : this.stackPos[j]),
                                      (A = this.stackPos[j] = N + A))
                                    : ((N = isNaN(this.stackNeg[j])
                                          ? 0
                                          : this.stackNeg[j]),
                    ...
                    if (!b && !0 !== C && w) {
                        for (var V = [], X = [], M = 0; M < p; M++)
                            void 0 === f[M]
                                ? (V.length > 1 &&
                                      ...
                                      x
                                          ? (V.push(
                                                e.convert(e.actualMin),
                                                e.convert(e.actualMin)
                                            ),
                                            X.push(
                                                i.convert(i.actualMax),
                                                i.convert(i.actualMin)
                                            ))
                        ...
                        V.length > 1 &&
                            (this.isSpline &&
                                ((V = (B = this._convertToSpline(V, X)).xs),
                                (X = B.ys)),
                            (t.stroke = R),
                            (t.strokeWidth = E),
                            (t.fill = "none"),
                        ...
                        if (b) {
                            ...
                            (f = f.concat(m.reverse())),
                                (g = g.concat(y.reverse()));
                        } else
                            x
                                ? (f.push(
                                      e.convert(e.actualMin),
    ...
    return (
        ...
        (e.prototype.adjustLimits = function (e, i) {
            ...
            if (d.logBase <= 0) {
                ...
                (p.left -= (0.5 * this._maxSize) / g),
                    (p.width += this._maxSize / g);
            }
            if (f.logBase <= 0) {
                var m = (i.height - this._maxSize) / p.height;
                (p.top -= (0.5 * this._maxSize) / m),
                    (p.height += this._maxSize / m);
            }
            return p;
        }),
        (e.prototype._drawSymbol = function (t, e, i, r, n, o) {
            ...
            if (l) {
                ...
                if (c) {
                    ...
                    if (_DataInfo.isValid(r)) {
                        ...
                        var p =
                            this.hitTester._map[this.chart.series.indexOf(n)];
                        if (null != p)
        ...
        (e.prototype.parseSymbolWidth = function (t) {
            if (((this._isPixel = void 0), t))
                if (wjcCore.isNumber(t)) {
                    ...
                    isFinite(e) &&
                        e > 0 &&
                        ((this._symWidth = e), (this._isPixel = !0));
                } else if (wjcCore.isString(t)) {
        ...
        (e.prototype.plotSeries = function (t, e, i, r, n, o, s, a) {
            ...
            if (!(h > 0)) {
                ...
                if (g) {
                    ...
                    var L = g.length;
                    for (
                        null != m && (L = Math.min(L, m.length)), w = 0;
                        w < L;
                        w++
                    )
                        C += g[w];
        ...
        (t.prototype.distance = function (t) {
            ...
            return t.y < e.y
                ? t.x < e.x
                    ...
                    : t.x > e.x + i
                    ? Math.sqrt(
                          Math.pow(t.x - e.x - i, 2) + Math.pow(e.y - t.y, 2)
                      )
                    : e.y - t.y
                : t.y > e.y + r
                ? t.x < e.x
                    ? Math.sqrt(
                          Math.pow(e.x - t.x, 2) + Math.pow(t.y - e.y - r, 2)
                      )
                    : t.x > e.x + i
                    ? Math.sqrt(
                          Math.pow(t.x - e.x - i, 2) +
                              Math.pow(t.y - e.y - r, 2)
                      )
                    : t.y - e.y - r
                : t.y > e.y + o
                ? t.x < e.x + n
                ...
                ? Math.min(
                      Math.sqrt(
                          Math.pow(e.x - t.x, 2) + Math.pow(t.y - e.y, 2)
                      ),
                      Math.sqrt(
                          Math.pow(t.x - n / 2 - e.x, 2) +
                              Math.pow(t.y - o / 2 - e.y, 2)
                      ),
                      Math.sqrt(
                          Math.pow(t.x - n - e.x, 2) +
                              Math.pow(t.y - o - e.y, 2)
                      )
                  )
                : Math.min(
                      Math.sqrt(
                          Math.pow(t.x - i - e.x, 2) + Math.pow(t.y - e.y, 2)
                      ),
                      Math.sqrt(
                ...
                for (t = 1; e < i; t++)
                    (e = new Date(e)).setDate(e.getDate() + 1),
                        (e = e.valueOf()) !== this._xVals[t] &&
                            (this._xVals.splice(t, 0, e),
                            this._volumes.splice(t, 0, 0));
            }
        }),
        t
    );

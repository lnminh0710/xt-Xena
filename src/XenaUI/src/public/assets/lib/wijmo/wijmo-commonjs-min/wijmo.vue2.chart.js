...
(exports.Vue = vue_1.default || VueModule),
    (exports.WjFlexChart = exports.Vue.component("wj-flex-chart", {
        ...
        props: wjcVue2Base._getProps("wijmo.chart.FlexChart", [
            "tooltipContent",
        ]),
        mounted: function () {
            ...
            this.$children.forEach(function (t) {
                switch (t.$options.name) {
                    ...
                    case "wj-flex-chart-legend":
                        var o = wjcVue2Base._initialize(
                            t,
                            new wjcChart.Legend(null)
                        );
                        e.legend = o;
                        break;
                ...
                this.tooltipContent &&
                    (e.tooltip.content = this.tooltipContent),

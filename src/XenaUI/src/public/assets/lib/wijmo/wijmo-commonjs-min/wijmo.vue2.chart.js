...
(exports.Vue = vue_1.default || VueModule),
  (exports.WjFlexChart = exports.Vue.component('wj-flex-chart', {
    ...
    mounted: function () {
      var e = new wjcChart.FlexChart(this.$el);
      this.$children.forEach(function (t) {
        switch (t.$options.name) {
          case 'wj-flex-chart-series':
            var r = wjcVue2Base._initialize(t, new wjcChart.Series());
            if (t.$el.style.cssText.length) {
              var i = {};
              t.$el.style.cssText.split(';').forEach(function (e) {
                var t = e.split(':');
          ...
          case 'wj-flex-chart-legend':
            var o = wjcVue2Base._initialize(t, new wjcChart.Legend(null));
            e.legend = o;
            break;
          case 'wj-flex-chart-axis':
            var s = wjcVue2Base._initialize(t, new wjcChart.Axis());
            t.wjProperty ? (e[t.wjProperty] = s) : e.axes.push(s);
        }
        wjcCore.removeChild(t.$el);
      }),
        this.tooltipContent && (e.tooltip.content = this.tooltipContent),
        wjcVue2Base._initialize(this, e);
    },
  })),

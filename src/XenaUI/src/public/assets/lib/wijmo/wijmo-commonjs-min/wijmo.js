...
function _getFocusableElements(t) {
    for (
        ...
        if (
            ...
            (!Control.getControl(i) && _getFocusableElements(i).length) ||
                e.push(i);
        }
    }
    return e;
...
function httpRequest(t, e) {
    ...
    if (
        (null == i ||
            isString(i) ||
            ((l = isObject(i)), (i = JSON.stringify(i))),
        (u.onload = function () {
            4 == u.readyState &&
                (u.status < 300
        ...
        for (var c in e.requestHeaders)
            u.setRequestHeader(c, e.requestHeaders[c]);
    return (
    ...
    return (
        ...
        (t.newDate = function (t, e, n, r, i, o, s) {
            ...
            var u = new Date(t, e, n, r, i, o, s),
                l = u.getFullYear();
            return (
                t < 100 && l >= 1900 && u.setFullYear(u.getFullYear() - 1900), u
            );
        }),
        (t.clone = function (e) {
    ...
    return (
        ...
        (t.formatNumber = function (e, n, r, i) {
            ...
            if (
                ...
                o =
                    d > -1
                        ? o.substr(0, d).replace(g, f) + o.substr(d)
                        : o.replace(g, f);
            }
            if ("c" == u) {
            ...
            return (
                "p" == u &&
                    (o = (_ = s.percent.pattern[e < 0 ? 0 : 1]).replace(
                        "n",
                        o
                    )),
                o
        ...
        (t.formatDate = function (e, n) {
            ...
            n = t._expandFormat(n);
            for (
                var r = t._parseDateFormat(n), i = "", o = 0;
                o < r.length;
                o++
            )
        ...
        (t._formatDatePart = function (e, n, r) {
            ...
            switch (r) {
                ...
                case "e":
                    ...
                    var c =
                        r.length < 3 ? a % 100 : 3 == r.length ? a % 1e3 : a;
    ...
    return (
        ...
        (t.prototype.getValue = function (t) {
            if (t) {
                ...
                for (var e = 0; e < this._parts.length && t; e++)
                    t = t[this._parts[e]];
            }
            return t;
        }),
    ...
    Event = (function () {
        ...
        return (
            (t.prototype.addHandler = function (t, e) {
                (t = asFunction(t)),
                    this._handlers.push(new EventHandler(t, e));
            }),
    ...
    return (
        ...
        (t.prototype.applyTemplate = function (e, n, r, i) {
            ...
            if (
                (l
                    ? (s.tabIndex = -1)
                    : s.getAttribute("tabindex") || (s.tabIndex = 0),
                this._updateState(),
                r)
            )
                for (var g in r) {
        ...
        (t.prototype.dispose = function () {
            ...
            for (var i in this)
                i.length > 2 &&
                    0 == i.indexOf("on") &&
                    (s = this[i[2].toLowerCase() + i.substr(3)]) instanceof
                        Event &&
                    s.removeAllHandlers();
            ...
            get: function () {
                return (
                    null == this._rtlDir &&
                        (this._rtlDir =
                            !!this._e &&
                            "rtl" == getComputedStyle(this._e).direction),
                    this._rtlDir
                );
            },
            enumerable: !0,
        ...
        (t.prototype.invalidate = function (e) {
            ...
            void 0 === e && (e = !0),
                ...
                this._toInv &&
                    (clearTimeout(this._toInv), (this._toInv = null)),
                this.isUpdating ||
        ...
        Object.defineProperty(t.prototype, "isDisabled", {
            ...
            set: function (t) {
                (t = asBoolean(t, !0)) != this.isDisabled &&
                    enable(this._e, !t);
            },
            enumerable: !0,
            configurable: !0,
...
var NotifyCollectionChangedEventArgs = (function (t) {
    ...
    return (
        __extends(e, t),
        (e.reset = new e(NotifyCollectionChangedAction.Reset)),
        e
    );
})(EventArgs);
...
var ArrayBase = (function (t) {
    function e() {
        var e = this;
        return (
            canChangePrototype ? (e.length = 0) : (e = t.call(this) || this), e
        );
    }
    return __extends(e, t), e;
})(Array);
    ...
    return (
        ...
        (t.prototype.addNew = function () {
            if (
                ...
                return (
                    assert(!1, "cannot add items (canAddNew == false)."), null
                );
            var t = null,
        ...
        (t.prototype._trackItemChanged = function (t) {
            if (this._trackChanges) {
                ...
                if (e && e.indexOf(t) > -1) {
                    ...
                    if (n < 0 && this._chgAdded.indexOf(t) < 0)
                        this._chgEdited.push(t);
                    else if (n > -1) {
        ...
        (t.prototype._mergeGroupItems = function (t) {
            for (var e = [], n = 0; n < t.length; n++) {
                ...
                if (!r._isBottomLevel)
                    for (
                        var i = this._mergeGroupItems(r.groups),
                            o = 0,
                            s = i.length;
                        o < s;
                        o++
                        ...
                        r._items.push(i[o]);
                for (var o = 0, s = r._items.length; o < s; o++)
                    e.push(r._items[o]);
            }
            return e;
        }),
    ...
    return (
        (t.prototype.setTooltip = function (t, e) {
            ...
            n > -1 && (this._detach(t), this._tips.splice(n, 1)),
                e &&
                    (this._attach(t),
                    this._tips.push({ element: t, content: e }));
        }),
        ...
        (t.prototype.show = function (e, n, r) {
            ...
            i ||
                (addClass(
                    (i = t._eTip = document.createElement("div")),
                    "wj-tooltip"
                ),
        ...
        Object.defineProperty(t.prototype, "isVisible", {
            get: function () {
                var e = t._eTip;
                return (
                    null != e && null != e.parentElement && e.offsetWidth > 0
                );
            },
            enumerable: !0,
            configurable: !0,
...
var Color = (function () {
    ...
    return (
        ...
        (t.toOpaque = function (e, n) {
            if (1 == (e = isString(e) ? t.fromString(e) : asType(e, t)).a)
                return e;
            n =
                null == n
    ...
    return (
        ...
        (t.prototype.append = function (t) {
            ...
            r &&
                assert(
                    !1,
                    "child parameter should be an HTML node or an HTML string."
                );
        }),
    ...
    return (
        ...
        (t.prototype.getRawValue = function () {
            ...
            for (var n = 0; n < this._mskArr.length && n < t.length; n++)
                this._mskArr[n].literal ||
                    t[n] == this._promptChar ||
                    (e += t[n]);
            return e;
        }),
        (t.prototype.refresh = function () {
        ...
        (t.prototype._preventKey = function (t) {
            if (t && this._mskArr.length) {
                ...
                if (
                    (n < this._firstPos &&
                        setSelectionRange(e, (n = this._firstPos)),
                ...
                switch (e[r]) {
                    ...
                    case "$":
                        switch (e[r]) {
                            ...
                            case ",":
                                t =
                                    exports.culture.Globalize.numberFormat[
                                        e[r]
                                    ];
                                break;
                            case ":":
            ...
            for (r = 0; r < this._mskArr.length; r++) {
                ...
                if (i.literal)
                    for (var o = 0; o < r; o++) {
                        ...
                        if (
                            s.wildCard &&
                            this._isCharValid(s.wildCard, i.literal)
                        ) {
                            i.vague = !0;
                            break;
                        }
    ...
    return (
        ...
        (t.prototype._clearTimeouts = function () {
            this._toRepeat &&
                ...
                this._toDelay &&
                    (clearInterval(this._toDelay), (this._toDelay = null));
        }),

                        ...
                        h &&
                            ...
                            (p.props = h.map(function (e) {
                                return {
                                    prop: e,
                                    evExposed:
                                        Ng2Utils.getChangeEventNameExposed(e),
                                    evImpl: Ng2Utils.getChangeEventNameImplemented(
                                        e
                                    ),
                                };
                            })),
...
var WjDirectiveBehavior = (function () {
    ...
    return (
        (e.getHostElement = function (t, i) {
            return (
                e.ngZone || (e.ngZone = i.get(core_1.NgZone)), t.nativeElement
            );
        }),
        ...
        (e.prototype.ngAfterViewInit = function () {
            ...
            (this.directive[e.isInitializedPropAttr] = !0),
                setTimeout(function () {
                    t.isDestroyed ||
                        t.directive[e.initializedEventAttr].emit(void 0);
                });
        }),
            ...
            if (!this.isDestroyed) {
                ...
                if (t instanceof wjcCore.Control && t.hostElement) {
                    var s = this.elementRef.nativeElement,
                        a = s && s.parentNode,
                        p = a
                            ? Array.prototype.indexOf.call(a.childNodes, s)
                            : -1;
                    t.dispose(),
                        p > -1 &&
                            Array.prototype.indexOf.call(a.childNodes, s) < 0 &&
                            ((s.textContent = ""),
                            p < a.childNodes.length &&
                                a.replaceChild(s, a.childNodes[p]));
                }
        ...
        (e.prototype._parentInCtor = function () {
            return (
                ...
                "" == this._getParentReferenceProperty()
            );
        }),
                ...
                if (this._isParentInitializer()) {
                    ...
                    if (wjcCore.isArray(n)) {
                        ...
                        (o < 0 || o >= n.length) && (o = n.length),
                            ...
                            r &&
                                ((this._siblingInsertedEH =
                                    this._siblingInserted.bind(this)),
...
var Ng2Utils = (function () {
    ...
    return (
        ...
        (e.getChangeEventNameImplemented = function (t) {
            return (
                e.getChangeEventNameExposed(t) + e.changeEventImplementSuffix
            );
        }),
        ...
        (e.getBaseType = function (e) {
            var t;
            return (
                e && (t = Object.getPrototypeOf(e.prototype)) && t.constructor
            );
        }),
        ...
        (e.equals = function (e, t) {
            return (
                (e != e && t != t) || wjcCore.DateTime.equals(e, t) || e === t
            );
        }),
    ...
    return (
        ...
        (e.prototype._updateDirective = function () {
            if (!this._isFirstChange || null != this._modelValue) {
                if (
                    ...
                    this._directive && this._ngModelProp)
                ) {
        ...
        (e.prototype._ensureSubscribed = function () {
            if (!this._isSubscribed) {
                ...
                if (e) {
                    this._ensureNgModelProp();
                    var t = (this._ngModelProp =
                        e[WjDirectiveBehavior.wjModelPropAttr]);
                    if (t) {

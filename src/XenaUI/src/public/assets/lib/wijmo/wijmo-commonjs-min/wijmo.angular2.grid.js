      ...
      n.deferUpdate(function () {
        if (n.rows.defaultSize < 10) {
          ...
          (n.rows.defaultSize = r),
            ...
            (n.rowHeaders.columns.defaultSize = Math.round(1.25 * r));
        }
      }),
      n.created(),
      n
...
var WjFlexGridColumn = (function (e) {
  function t(t, o, r) {
    ...
    var n = (i._wjBehaviour =
      wijmo_angular2_directiveBase_1.WjDirectiveBehavior.attach(i, t, o, r))
  ...
  return (
    ...
    (e.prototype.ngOnDestroy = function () {
      this.cellTypeStr &&
        ...
        (this.ownerControl[e._getTemplContextProp(this.cellType)] = null),
...
var DirectiveCellFactory = (function (e) {
    function t(o, r) {
      ...
      if (
        ...
        t._templateTypes = [];
        for (var n in CellTemplateType) isNaN(n) && t._templateTypes.push(n);
      }
      var l = i;
      return (
        ...
        o.hostElement.addEventListener(
          'keypress',
          function (e) {
            var t = e.charCode > 32 ? String.fromCharCode(e.charCode) : null;
            t &&
              wjcCore.closest(e.target, '.wj-flexgrid') === o.hostElement &&
    ...
    return (
        ...
        switch (e.cellType) {
          case wjcGrid.CellType.Cell:
            if (p && p.row === o && p.col === r)
              ...
              var _ = !(
                (f = g instanceof wjcCore.CollectionViewGroup) || u.hasChildren
              );
              r == e.columns.firstVisibleIndex
                ? (d = _ ? CellTemplateType.Cell : CellTemplateType.GroupHeader)
                : ((d = _ ? CellTemplateType.Cell : CellTemplateType.Group),
                  (C = !0));
            } else
              u instanceof wjcGrid._NewRowTemplate
                ...
                : (tryGetModuleWijmoGridDetail() &&
                    ...
                    u instanceof tryGetModuleWijmoGridDetail().DetailRow) ||
          ...
          case wjcGrid.CellType.RowHeader:
            (d =
              c.collectionView && c.collectionView.currentEditItem === g
        ...
        if (null != d) {
          var h =
            f && d == CellTemplateType.GroupHeader
              ? c.columns.getColumn(g.groupDescription.propertyName)
          ...
          if (h) {
            ...
            if (
              (j ||
                (d === CellTemplateType.RowHeaderEdit
                  ? ((d = CellTemplateType.RowHeader),
                    (y = WjFlexGridCellTemplate._getTemplContextProp(d)),
                    (j = c[y]))
              ...
              var T = i.getAttribute(wjcGrid.FlexGrid._WJS_MEASURE),
              ...
              if (S) {
                if (w) {
                  ...
                  I && (F || i.focus(), (I.style.display = 'none'));
                } else i.textContent = '';
                this._doDisposeCell(i);
                var N = {};
                x = this._setViewRefContext(N, u, h, g, E, j.valuePaths);
              ...
              if (
                (j.cellOverflow && (i.style.overflow = j.cellOverflow),
                R
                  ...
                  ? setTimeout(function () {
                      if (a === i[t._cellStampProp]) {
                        var r = i.scrollHeight,
                          d = e.rows,
                          p = (n && n.rowSpan) || 1;
                        if (o < d.length && d[o].renderHeight * p < r - 1) {
                          if (((d.defaultSize = r / p), w)) {
                            var u = s._isFullEdit();
                            return c.refresh(), void c.startEditing(u);
                          }
                        } else w && l._initEditInput(G, j, null);
                      }
                    }, 0)
                  : w &&
                    setTimeout(function () {
                ...
                var D = function (e, t) {
                    if (
                      (c.cellEditEnding.removeHandler(D), !t.stayInEditMode)
                    ) {
                      var o = wjcCore.getActiveElement();
                      o && o.dispatchEvent(s._evtBlur), i.focus();
                    }
                    if (
                      ...
                      for (
                        var r = x.localVars,
                          n = 0,
                          l = Object.getOwnPropertyNames(x.bindings);
                        n < l.length;
                        n++
                      ) {
                        var a = l[n];
                        x.bindings[a].setValue(r, x.localVars.values[a]);
                      }
                    var d = i.querySelectorAll('.wj-dropdown');
                    [].forEach.call(d, function (e) {
                      var t = wjcCore.Control.getControl(e);
                      t &&
                        tryGetModuleWijmoInput() &&
                        t instanceof tryGetModuleWijmoInput().DropDown &&
                        (t.isDroppedDown = !1);
                    });
                  },
                  H = function (e, t) {
                ...
                c.cellEditEnding.addHandler(D), c.cellEditEnded.addHandler(H);
              } else this._baseCf.updateCell(e, o, r, i, n, !1);
            }
          }
        }
        v || (this._doDisposeCell(i), this._baseCf.updateCell(e, o, r, i, n));
      }),
      (t.prototype.getEditorValue = function (t) {
        if (this._cellEditorVars) {
          ...
          return (
            o &&
              o.isValid &&
              this._triggerEditorEvents(t.cells.getCellElement(o.row, o.col)),
      ...
      (t.prototype._setViewRefContext = function (e, t, o, r, i, n) {
        (this._needsCdCheck = !0), (e.row = t), (e.col = o), (e.item = r);
        var l = {},
          a = e.cell || {},
          d = {},
      ...
      (t.prototype._findInitialInput = function (e) {
        ...
        if (t)
          for (var o = 0; o < t.length; o++) {
            ...
            if ('none' !== i.display && 'visible' === i.visibility) return r;
          }
        return null;
      }),

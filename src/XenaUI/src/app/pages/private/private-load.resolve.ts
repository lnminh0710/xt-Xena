...
import { AccessRightsService, SignalRService, GlobalSettingService } from 'app/services';
...
export class PrivateLoadResolve implements Resolve<any> {
    ...
    resolve(route: ActivatedRouteSnapshot,
        ...
        return forkJoin(this.accessRightsService.loadUserData(), this.globalSettingService.getAllGlobalSettings('-1'));

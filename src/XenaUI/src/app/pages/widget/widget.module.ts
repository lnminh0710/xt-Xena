...
import { MainModuleEffects, ParkedItemEffects, TabSummaryEffects, WidgetTemplateSettingEffects, ModuleSettingEffects, XnCommonEffects, HotkeySettingEffects, GlobalSearchEffects, WidgetContentDetailEffects } from 'app/state-management/effects';

    ...
    if (this.tooltipText && this.tooltipText.length) {
      ...
      switch (newPlacement) {
        case 'top':
          ...
          positionLeft -=
            div.offsetWidth / 2 - this.elementRef.nativeElement.offsetWidth / 2;
          ...
          if (remaining > 0) {
            ...
            div.setAttribute(
              'style',
              `top: ${positionTop}px; left: ${positionLeft - remaining}px;`
            );
          }
        ...
        case 'right':
          positionLeft +=
            defaultDistanceX + this.elementRef.nativeElement.offsetWidth;

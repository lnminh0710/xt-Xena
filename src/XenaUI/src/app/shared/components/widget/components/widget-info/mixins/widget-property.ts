...
export function MixinWidgetProperty<T extends Constructor<PropertyServiceInjector>>(base: T) {
    abstract class AbstracPropertytBase extends base implements WidgetDetailInfo {
        ...
        protected updatePdfColumn() {
            const propPdfColumn = this.propertyPanelService.getItemRecursive(this.properties, 'PdfColumn');
        ...
        protected updateSAVSendLetter() {
            const propSAVListenKey = this.propertyPanelService.getItemRecursive(this.properties, 'SAVListenKey');
        ...
        protected updateWidgetFormLabelStyle(globalProperties) {
            this.formStyle = this.propertyPanelService.updateWidgetFormStyle(globalProperties, this.formStyle, 'labelStyle', 'LabelStyle');
        ...
        protected updateWidgetFormGeneralStyle(globalProperties) {
            this.formStyle = this.propertyPanelService.updateWidgetFormStyle(globalProperties, this.formStyle, 'generalStyle', 'GeneralSettingGlobal');
        }
        ...
        protected updateWidgetTableRowBackground(globalProperties) {
            this.tableStyle = this.propertyPanelService.updateWidgetTableStyle(globalProperties, this.tableStyle);
        }
        ...
        protected updateWidgetFormDataStyle(globalProperties?: any) {
            this.formStyle = this.propertyPanelService.updateWidgetFormStyle(globalProperties, this.formStyle, 'dataStyle', 'DataStyle');
        }

        protected updateWidgetFormSeparatorStyle(globalProperties) {
            this.formStyle = this.propertyPanelService.updateWidgetFormStyle(globalProperties, this.formStyle, 'separateStyle', 'Separator');
        }

        protected updateWidgetFormPanelStyle() {
            this.formStyle = this.propertyPanelService.updateWidgetFormStyle(this.properties, this.formStyle, 'panelStyle', 'PanelStyle');
        }
        ...
        protected updateDesignColumns() {
            const propertyDesignColumnsOnWidget = this.propertyPanelService.getItemRecursive(this.properties, 'DesignColumnsOnWidget');
        ...
        protected updateRowBackground() {
            const propertyApplyRowBackground = this.propertyPanelService.getItemRecursive(this.properties, 'ApplyRowBackground');
        ...
        protected updateWidgetGridBorderRowStyle() {
            const propertyBorderRow = this.propertyPanelService.getItemRecursive(this.properties, 'RowStyleBorder');

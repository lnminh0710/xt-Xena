...
export class PaperworkComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  private getAgGridComponent() {
    ...
    if (this.baseWidgetModuleInfo && this.baseWidgetModuleInfo.agGridComponent)
  ...
  private createPrintContent() {
    ...
    switch (widgetDetail.idRepWidgetType) {
      ...
      case WidgetType.NoteForm:
        ...
        if (bodyContainer)
          bodyContainer = bodyContainer.replaceAll('fa fa-trash-o', '');
        break;
    }
          ...
          buttonList: [
            new ButtonList({
              ...
              callBackFunc: () => {
                ...
                const agGridComponent = this.getAgGridComponent();
                if (agGridComponent) agGridComponent.exportExcel();
              },
            }),
            new ButtonList({

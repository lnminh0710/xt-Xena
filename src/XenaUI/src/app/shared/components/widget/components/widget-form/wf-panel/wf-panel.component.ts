  ...
  implements OnInit, OnDestroy, OnChanges
{
  ...
  public changePropertiesForTitleStyle(controlConfig: any) {
    ...
    const propPanelBackgroundColor = this.propertyPanelService.getItemRecursive(
      controlConfig,
    ...
    this.configTitleStyle = {
      ...
      'text-decoration':
        propPanelUnderline && propPanelUnderline.value ? 'underline' : 'unset',
    };
  }
  ...
  public changePropertiesForPanelStyle(controlConfig: any) {
    ...
    const propPanelBorderWeight = this.propertyPanelService.getItemRecursive(
      controlConfig,
    ...
    const propPanelPaddingRight = this.propertyPanelService.getItemRecursive(
      controlConfig,
      'PanelStyleRight'
    );
  ...
  public changePropertiesForUnderlineStyle(controlConfig: any) {
    ...
    const propUnderlineShadowShow = this.propertyPanelService.getItemRecursive(
      controlConfig,
      'UnderLineStyleShadowShow'
    );
    const propUnderlineShadowColor = this.propertyPanelService.getItemRecursive(
      controlConfig,
  ...
  private switchToAutoHeight(controlConfig: any) {
    ...
    const propPanelAutoHeightOld = this.propertyPanelService.getItemRecursive(
      this.firstTimeConfig,
      'PanelStyleAutoHeight'
    );
    ...
    const propPanelAutoHeightNew = this.propertyPanelService.getItemRecursive(
      controlConfig,
      'PanelStyleAutoHeight'
    );

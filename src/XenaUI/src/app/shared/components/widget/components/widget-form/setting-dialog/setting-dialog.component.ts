    ...
    implements OnInit, OnDestroy, AfterViewInit, OnChanges
{
    ...
    private subscribeWidgetFormSetting() {
        ...
        this.widgetFieldService.generalFieldHeight.subscribe(
            (generalFieldConfig) => {
    ...
    public apply(event?: any) {
        if (this.multiControl && this.multiControl.length > 0) {
            this.multiControl.forEach((x) => {
                const settingControl = this.getProperties(
                    JSON.parse(x.config),
                    this.properties
                );
    ...
    public getProperties(controlConfig, propertiesConfigEmitted) {
        ...
        const propGeneralBackground = Uti.getItemRecursive(
            controlConfig,
            "IGeneralSettingBackgroundColor"
        );
        const propEmittedGeneralBackground = Uti.getItemRecursive(
            propertiesConfigEmitted,
            "IGeneralSettingBackgroundColor"
        );
        if (
            propEmittedGeneralBackground.value &&
            propGeneralBackground.value !== propEmittedGeneralBackground.value
        ) {
            propGeneralBackground.value = propEmittedGeneralBackground.value;
        }
        const propGeneralVerticalAlign = Uti.getItemRecursive(
            controlConfig,
            "IGeneralSettingVerticalAlign"
        );
        const propEmittedGeneralVerticalAlign = Uti.getItemRecursive(
            propertiesConfigEmitted,
            "IGeneralSettingVerticalAlign"
        );
        if (
            propGeneralVerticalAlign.value !==
            propEmittedGeneralVerticalAlign.value
        ) {
            propGeneralVerticalAlign.value =
                propEmittedGeneralVerticalAlign.value;
        }
        const propGeneralHeight = Uti.getItemRecursive(
            controlConfig,
            "IGeneralSettingHeight"
        );
        const propEmittedGeneralHeight = Uti.getItemRecursive(
            propertiesConfigEmitted,
            "IGeneralSettingHeight"
        );
        ...
        const propGeneralAutoHeight = Uti.getItemRecursive(
            controlConfig,
            "IGeneralSettingAutoHeight"
        );
        const propEmittedGeneralAutoHeight = Uti.getItemRecursive(
            propertiesConfigEmitted,
            "IGeneralSettingAutoHeight"
        );
        if (
        ...
        // getPropertiesLabel
        const propLabelAlign = Uti.getItemRecursive(
            controlConfig,
            "ILabelStyleJustifyContent"
        );
        const propConfigEmittedAlign = Uti.getItemRecursive(
            propertiesConfigEmitted,
            "ILabelStyleJustifyContent"
        );
        ...
        const propLabelBackground = Uti.getItemRecursive(
            controlConfig,
            "ILabelStyleBackgroundColor"
        );
        const propConfigEmittedBackground = Uti.getItemRecursive(
            propertiesConfigEmitted,
            "ILabelStyleBackgroundColor"
        );
        if (
            propConfigEmittedBackground.value &&
            propLabelBackground.value !== propConfigEmittedBackground.value
        ) {
            propLabelBackground.value = propConfigEmittedBackground.value;
        }
        const propLabelColor = Uti.getItemRecursive(
            controlConfig,
            "ILabelStyleColor"
        );
        const propConfigEmittedColor = Uti.getItemRecursive(
            propertiesConfigEmitted,
            "ILabelStyleColor"
        );

        if (
            propConfigEmittedColor.value &&
            propLabelColor.value !== propConfigEmittedColor.value
        ) {
            propLabelColor.value = propConfigEmittedColor.value;
        }

        const propLabelFontName = Uti.getItemRecursive(
            controlConfig,
            "ILabelStyleFontName"
        );
        const propConfigEmittedFontName = Uti.getItemRecursive(
            propertiesConfigEmitted,
            "ILabelStyleFontName"
        );
        ...
        const propLabelFontSize = Uti.getItemRecursive(
            controlConfig,
            "ILabelStyleFontSize"
        );
        const propConfigEmittedFontSize = Uti.getItemRecursive(
            propertiesConfigEmitted,
            "ILabelStyleFontSize"
        );
        ...
        const propLabelBold = Uti.getItemRecursive(
            controlConfig,
            "ILabelStyleBold"
        );
        const propConfigEmittedBold = Uti.getItemRecursive(
            propertiesConfigEmitted,
            "ILabelStyleBold"
        );
        ...
        const propLabelItalic = Uti.getItemRecursive(
            controlConfig,
            "ILabelStyleItalic"
        );
        const propConfigEmittedItalic = Uti.getItemRecursive(
            propertiesConfigEmitted,
            "ILabelStyleItalic"
        );
        ...
        const propLabelUnderline = Uti.getItemRecursive(
            controlConfig,
            "ILabelStyleUnderline"
        );
        const propConfigEmittedUnderline = Uti.getItemRecursive(
            propertiesConfigEmitted,
            "ILabelStyleUnderline"
        );
        ...
        const propLabelStyleShow = Uti.getItemRecursive(
            controlConfig,
            "ILabelStyleShow"
        );
        const propConfigEmittedStyleShow = Uti.getItemRecursive(
            propertiesConfigEmitted,
            "ILabelStyleShow"
        );
        ...
        const propLabelWidth = Uti.getItemRecursive(
            controlConfig,
            "ILabelWidth"
        );
        const propConfigEmittedWidth = Uti.getItemRecursive(
            propertiesConfigEmitted,
            "ILabelWidth"
        );
        ...
        const propLabelAutoWidth = Uti.getItemRecursive(
            controlConfig,
            "ILabelAutoWidth"
        );
        const propConfigEmittedAutoWidth = Uti.getItemRecursive(
            propertiesConfigEmitted,
            "ILabelAutoWidth"
        );
        ...
        const propLabelRight = Uti.getItemRecursive(
            controlConfig,
            "ILabelRight"
        );
        const propConfigEmittedRight = Uti.getItemRecursive(
            propertiesConfigEmitted,
            "ILabelRight"
        );
        ...
        const propConfigEmittedLeft = Uti.getItemRecursive(
            propertiesConfigEmitted,
            "ILabelLeft"
        );
        ...
        const propSeparateAlign = Uti.getItemRecursive(
            controlConfig,
            "ISeparateJustifyContent"
        );
        const propEmittedSeparateAlign = Uti.getItemRecursive(
            propertiesConfigEmitted,
            "ISeparateJustifyContent"
        );
        ...
        const propSeparateValue = Uti.getItemRecursive(
            controlConfig,
            "ISeparateValue"
        );
        const propEmittedSeparateValue = Uti.getItemRecursive(
            propertiesConfigEmitted,
            "ISeparateValue"
        );
        ...
        const propSeparateBackground = Uti.getItemRecursive(
            controlConfig,
            "ISeparateBackgroundColor"
        );
        const propEmittedSeparateBackground = Uti.getItemRecursive(
            propertiesConfigEmitted,
            "ISeparateBackgroundColor"
        );
        if (
            propEmittedSeparateBackground.value &&
            propSeparateBackground.value !== propEmittedSeparateBackground.value
        ) {
            propSeparateBackground.value = propEmittedSeparateBackground.value;
        }
        const propSeparateColor = Uti.getItemRecursive(
            controlConfig,
            "ISeparateColor"
        );
        const propEmittedSeparateColor = Uti.getItemRecursive(
            propertiesConfigEmitted,
            "ISeparateColor"
        );
        if (
            propEmittedSeparateColor.value &&
            propSeparateColor.value !== propEmittedSeparateColor.value
        ) {
            propSeparateColor.value = propEmittedSeparateColor.value;
        }
        const propSeparateFontName = Uti.getItemRecursive(
            controlConfig,
            "ISeparateFontName"
        );
        const propEmittedSeparateFontName = Uti.getItemRecursive(
            propertiesConfigEmitted,
            "ISeparateFontName"
        );
        ...
        const propSeparateFontSize = Uti.getItemRecursive(
            controlConfig,
            "ISeparateFontSize"
        );
        const propEmittedSeparateFontSize = Uti.getItemRecursive(
            propertiesConfigEmitted,
            "ISeparateFontSize"
        );
        ...
        const propSeparateBold = Uti.getItemRecursive(
            controlConfig,
            "ISeparateBold"
        );
        const propEmittedSeparateBold = Uti.getItemRecursive(
            propertiesConfigEmitted,
            "ISeparateBold"
        );
        ...
        const propSeparateItalic = Uti.getItemRecursive(
            controlConfig,
            "ISeparateItalic"
        );
        const propEmittedSeparateItalic = Uti.getItemRecursive(
            propertiesConfigEmitted,
            "ISeparateItalic"
        );
        ...
        const propSeparateUnderline = Uti.getItemRecursive(
            controlConfig,
            "ISeparateUnderline"
        );
        const propEmittedSeparateUnderline = Uti.getItemRecursive(
            propertiesConfigEmitted,
            "ISeparateUnderline"
        );
        if (
        ...
        const propSeparateWidth = Uti.getItemRecursive(
            controlConfig,
            "ISeparateWidth"
        );
        const propEmittedSeparateWidth = Uti.getItemRecursive(
            propertiesConfigEmitted,
            "ISeparateWidth"
        );
        ...
        const propSeparateAutoWidth = Uti.getItemRecursive(
            controlConfig,
            "ISeparateAutoWidth"
        );
        const propEmittedSeparateAutoWidth = Uti.getItemRecursive(
            propertiesConfigEmitted,
            "ISeparateAutoWidth"
        );
        if (
        ...
        const propSeparatePaddingRight = Uti.getItemRecursive(
            controlConfig,
            "ISeparateRight"
        );
        const propEmittedSeparatePaddingRight = Uti.getItemRecursive(
            propertiesConfigEmitted,
            "ISeparateRight"
        );
        if (
            propSeparatePaddingRight.value !==
            propEmittedSeparatePaddingRight.value
        ) {
            propSeparatePaddingRight.value =
                propEmittedSeparatePaddingRight.value;
        }
        const propSeparatePaddingLeft = Uti.getItemRecursive(
            controlConfig,
            "ISeparateLeft"
        );
        const propEmittedSeparatePaddingLeft = Uti.getItemRecursive(
            propertiesConfigEmitted,
            "ISeparateLeft"
        );
        if (
            propSeparatePaddingLeft.value !==
            propEmittedSeparatePaddingLeft.value
        ) {
            propSeparatePaddingLeft.value =
                propEmittedSeparatePaddingLeft.value;
        }
        const propSeparateShow = Uti.getItemRecursive(
            controlConfig,
            "ISeparateShow"
        );
        const propEmittedSeparateShow = Uti.getItemRecursive(
            propertiesConfigEmitted,
            "ISeparateShow"
        );
        ...
        // getPropertiesValue
        const propDataAlign = Uti.getItemRecursive(
            controlConfig,
            "IDataStyleJustifyContent"
        );
        const propEmittedValueAlign = Uti.getItemRecursive(
            propertiesConfigEmitted,
            "IDataStyleJustifyContent"
        );
        ...
        const propDataBackground = Uti.getItemRecursive(
            controlConfig,
            "IDataStyleAlignBackgroundColor"
        );
        const propEmittedValueBackground = Uti.getItemRecursive(
            propertiesConfigEmitted,
            "IDataStyleAlignBackgroundColor"
        );
        if (
            propEmittedValueBackground.value &&
            propDataBackground.value !== propEmittedValueBackground.value
        ) {
            propDataBackground.value = propEmittedValueBackground.value;
        }
        const propDataColor = Uti.getItemRecursive(
            controlConfig,
            "IDataStyleColor"
        );
        const propEmittedValueColor = Uti.getItemRecursive(
            propertiesConfigEmitted,
            "IDataStyleColor"
        );
        if (
            propEmittedValueColor.value &&
            propDataColor.value !== propEmittedValueColor.value
        ) {
            propDataColor.value = propEmittedValueColor.value;
        }
        const propDataFontName = Uti.getItemRecursive(
            controlConfig,
            "IDataStyleFontName"
        );
        const propEmittedValueFontName = Uti.getItemRecursive(
            propertiesConfigEmitted,
            "IDataStyleFontName"
        );
        ...
        const propDataFontSize = Uti.getItemRecursive(
            controlConfig,
            "IDataStyleFontSize"
        );
        const propEmittedValueFontSize = Uti.getItemRecursive(
            propertiesConfigEmitted,
            "IDataStyleFontSize"
        );
        ...
        const propDataBold = Uti.getItemRecursive(
            controlConfig,
            "IDataStyleBold"
        );
        const propEmittedValueBold = Uti.getItemRecursive(
            propertiesConfigEmitted,
            "IDataStyleBold"
        );
        ...
        const propDataItalic = Uti.getItemRecursive(
            controlConfig,
            "IDataStyleItalic"
        );
        const propEmittedValueItalic = Uti.getItemRecursive(
            propertiesConfigEmitted,
            "IDataStyleItalic"
        );
        ...
        const propDataUnderline = Uti.getItemRecursive(
            controlConfig,
            "IDataStyleUnderline"
        );
        const propEmittedValueUnderline = Uti.getItemRecursive(
            propertiesConfigEmitted,
            "IDataStyleUnderline"
        );
        ...
        const propDataWidth = Uti.getItemRecursive(
            controlConfig,
            "IDataStyleWidth"
        );
        const propEmittedValueWidth = Uti.getItemRecursive(
            propertiesConfigEmitted,
            "IDataStyleWidth"
        );
        ...
        const propDataAutoWidth = Uti.getItemRecursive(
            controlConfig,
            "IDataStyleAutoWidth"
        );
        const propEmittedValueAutoWidth = Uti.getItemRecursive(
            propertiesConfigEmitted,
            "IDataStyleAutoWidth"
        );
        ...
        const propDataPaddingRight = Uti.getItemRecursive(
            controlConfig,
            "IDataStyleRight"
        );
        const propEmittedValuePaddingRight = Uti.getItemRecursive(
            propertiesConfigEmitted,
            "IDataStyleRight"
        );
        ...
        const propDataPaddingLeft = Uti.getItemRecursive(
            controlConfig,
            "IDataStyleLeft"
        );
        const propEmittedValuePaddingLeft = Uti.getItemRecursive(
            propertiesConfigEmitted,
            "IDataStyleLeft"
        );
        ...
        const propDataShow = Uti.getItemRecursive(
            controlConfig,
            "IDataStyleShow"
        );
        const propEmittedValueShow = Uti.getItemRecursive(
            propertiesConfigEmitted,
            "IDataStyleShow"
        );
    ...
    ngAfterViewInit(): void {
        ...
        (masks[masks.length - 1] as HTMLElement).style.background =
            "transparent";
    }

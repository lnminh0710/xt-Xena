...
export class DialogAddCustomerDoubletComponent extends BaseComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  constructor(
    ...
    public save() {
      ...
      if (!this.customerName){
        ...
        this.searchService.search('customer',this.customerName,2,1,10,'personNr').subscribe((response :any) => {
          ...
          if(results.length !== 1){
            ...
            this.store.dispatch(this.processDataActions.requestAddToDoublet(results[0], this.ofModule));
            this.customerName = ''
          }
          setTimeout(() => {

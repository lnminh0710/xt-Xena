...
import { HistoryHeaderInfo, HistoryHeaderMenuItem } from 'app/models';
    ...
    if (item.action) {
      switch (item.action.type) {
        ...
        case 2:
          ...
          var componentRef: ComponentRef<HistoryDialogComponent> =
            this.containerRef.createComponent(factory);
          const historyDialogComponent: HistoryDialogComponent =

  ...
  implements OnInit, OnDestroy, OnChanges
{
  ...
  @Input() contentDisplayMode: string;
            ...
            if (this.layoutInfo) {
              this.tabContentStyle = {
                ...
                height: `calc(100vh - ${this.layoutInfo.headerHeight}px - ${
                  this.layoutInfo.tabHeaderHeight
                }px - ${this.layoutInfo.smallHeaderLineHeight}px - ${
                  this.layoutInfo.dashboardPaddingTop
                }px ${
                  this.layoutInfo.makeSpaceForTabButton.isActive
                    ? ' - 25px'
                    : ''
                } )`,
              };

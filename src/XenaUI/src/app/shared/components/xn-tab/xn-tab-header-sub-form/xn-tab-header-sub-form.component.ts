...
export class XnTabHeaderSubFormComponent extends BaseComponent implements OnInit, OnDestroy {
    ...
    private appendDefaultValueToTranslateResource() {
        defaultLanguage['XnTabHeaderSubForm__' + this.textData.main.title] = this.textData.main.title;
        defaultLanguage['XnTabHeaderSubForm__' + this.textData.detail.title] = this.textData.detail.title;
    }

    ...
    implements OnInit, OnDestroy, AfterViewInit
{
    ...
    onKeyUp(event) {
        ...
        if (e.keyCode == 34) {
            if (
                this.btnSaveAllWidgetCtrl &&
                !this.btnSaveAllWidgetCtrl["disabled"]
            ) {
                this.btnSaveAllWidgetCtrl["_elementRef"].nativeElement.click();
            } else if (
                this.btnSaveOnlyCtrl &&
                !this.btnSaveOnlyCtrl["disabled"]
            ) {
                        ...
                        this.tabAccessRight =
                            this.accessRightService.getAccessRight(
                                AccessRightTypeEnum.Tab,
                                {
                                    ...
                                    idSettingsGUI: this.ofModule.idSettingsGUI,
                                    tabID: this.selectedTab.tabSummaryInfor
                                        .tabID,
                                }
                            );
            ...
            this.selectedODETabState.subscribe((selectedODETabState: any) => {
                this.appErrorHandler.executeAction(() => {
                    ...
                    if (this.selectedODETab) {
                        ...
                        this.dataEntryProcess.selectedODETab =
                            this.selectedODETab;
    ...
    private subscribeSelectedSubTabState() {
        this.selectedSubTabStateSubscription =
            this.selectedSubTabState.subscribe((selectedSubTabState: any) => {
                this.appErrorHandler.executeAction(() => {
                        ...
                        if (this.selectedSubTab.title === "Main") {
                            switch (this.currentAction) {
                                case TabButtonActionConst.EDIT_OTHER_TAB:
                                    ...
                                    this.store.dispatch(
                                        this.processDataActions.turnOffFormCloneMode(
                                            this.ofModule
                                        )
                                    );
                                    this.store.dispatch(
                ...
                (editingWidgets: Array<EditingWidget>) => {
                    this.appErrorHandler.executeAction(() => {
                        ...
                        if (!this.editingWidgets.length && !this.formDirty) {
                            this.store.dispatch(
                                this.moduleActions.removeDirtyModule(
                                    this.ofModule
                                )
                            );
                        }
        ...
        this.formDirtyStateSubscription = this.formDirtyState.subscribe(
            (formDirtyState: boolean) => {
                this.appErrorHandler.executeAction(() => {
                    ...
                    this.detectDataDirty();
                    this.setStateForSavingButtonState(
                        "disabled",
                        !this.formDirty
                    );
                });
            ...
            (moduleSettingState: ModuleSettingModel[]) => {
                this.appErrorHandler.executeAction(() => {
                    if (
                        ...
                        try {
                            jsonSettings = JSON.parse(
                                moduleSettingState[0].jsonSettings
                            );
                        } catch (e) {
                            jsonSettings = {};
                        }
    ...
    private subcribeSaveMainTabResultState() {
        this.saveMainTabResultStateSubscription =
            this.saveMainTabResultState.subscribe(
                (saveMainTabResultState: any) => {
                    this.appErrorHandler.executeAction(() => {
                        ...
                        if (!isNil(saveMainTabResultState.returnID)) {
                            if (
                                (typeof saveMainTabResultState.returnID ==
                                    "string" ||
                                    typeof saveMainTabResultState.returnID ==
                                        "number") &&
    ...
    private subcribeSaveOtherTabResultState() {
        this.saveOtherTabResultStateSubscription =
            this.saveOtherTabResultState.subscribe(
                (saveOtherTabResultState: any) => {
                    this.appErrorHandler.executeAction(() => {
                        ...
                        if (!isNil(saveOtherTabResultState.returnID)) {
                            if (
                                (typeof saveOtherTabResultState.returnID ==
                                    "string" ||
                                    typeof saveOtherTabResultState.returnID ==
                                        "number") &&
                ...
                (saveOnlyMainTabResultState: any) => {
                    this.appErrorHandler.executeAction(() => {
                        ...
                        if (!isNil(saveOnlyMainTabResultState.returnID)) {
                            if (
                                (typeof saveOnlyMainTabResultState.returnID ==
                                    "string" ||
                                    typeof saveOnlyMainTabResultState.returnID ==
                                        "number") &&
                ...
                (saveOnlyOtherTabResultState: any) => {
                    this.appErrorHandler.executeAction(() => {
                        ...
                        if (!isNil(saveOnlyOtherTabResultState.returnID)) {
                            if (
                                (typeof saveOnlyOtherTabResultState.returnID ==
                                    "string" ||
                                    typeof saveOnlyOtherTabResultState.returnID ==
                                        "number") &&
                        ...
                        if (widgetDataUpdatedState) {
                            switch (this.currentAction) {
                                case TabButtonActionConst.CHANGE_MODULE:
                                    this.store.dispatch(
                                        this.processDataActions.okToChangeModule(
                                            this.ofModule
                                        )
                                    );
                                    break;
                                ...
                                case TabButtonActionConst.CHANGE_SUB_MODULE:
                                    this.store.dispatch(
                                        this.processDataActions.okToChangeSubModule(
                                            this.ofModule
                                        )
                                    );
                                    break;
                                ...
                                case TabButtonActionConst.CHANGE_TAB:
                                    this.store.dispatch(
                                        this.processDataActions.okToChangeTab(
                                            this.ofModule
                                        )
                                    );
                                    break;
                                ...
                                case TabButtonActionConst.REMOVE_TAB:
                                    this.store.dispatch(
                                        this.processDataActions.okToRemoveTab(
                                            this.ofModule
                                        )
                                    );
                                    break;
                                ...
                                case TabButtonActionConst.BEFORE_EDIT_OTHER_TAB:
                                    ...
                                    this.store.dispatch(
                                        this.processDataActions.newOtherTab(
                                            this.ofModule
                                        )
                                    );
                                    break;
                                ...
                                case TabButtonActionConst.REFRESH_TAB:
                                    ...
                                    this.store.dispatch(
                                        this.widgetDetailActions.requestRefreshWidgetsInTab(
                                            this.selectedTab.tabSummaryInfor
                                                .tabID,
                                            this.ofModule
                                        )
                                    );
    ...
    private subcribeRequestChangeParkedItemState() {
        this.requestChangeParkedItemStateSubscription = this.dispatcher
            .filter((action: CustomAction) => {
                return (
                    action.type ===
                        ProcessDataActions.REQUEST_CHANGE_PARKED_ITEM &&
            ...
            .subscribe(() => {
                this.appErrorHandler.executeAction(() => {
                    ...
                    if (!this.selectedTab) {
                        ...
                        this.tabService.isMainTabSelected(this.selectedTab)
                    ) {
                        currentAction =
                    ...
                    if (this.isDirty()) {
                        ...
                        switch (currentAction) {
                            case TabButtonActionConst.FIRST_LOAD:
                                this.store.dispatch(
                                    this.processDataActions.okToChangeParkedItem(
                                        this.ofModule
                                    )
                                );
                                break;
                            ...
                            case TabButtonActionConst.CHANGE_PARKED_ITEM_FROM_MAIN_TAB:
                                ...
                                this.store.dispatch(
                                    this.parkedItemActions.removeDraftItem(
                                        this.ofModule
                                    )
                                );
                                this.store.dispatch(
    ...
    private subcribeRequestCreateNewFromModuleDropdownState() {
        this.requestCreateNewFromModuleDropdownStateSubscription =
            this.dispatcher
                .filter((action: CustomAction) => {
                    return (
                        action.type ===
    ...
    private subcribeRequestCreateNewMainTabState() {
        this.requestCreateNewMainTabStateSubscription = this.dispatcher
            .filter((action: CustomAction) => {
                return (
                    action.type ===
                        ProcessDataActions.REQUEST_CREATE_NEW_MAIN_TAB &&
                    action.module.idSettingsGUI == this.ofModule.idSettingsGUI
                );
            })
            .subscribe(() => {
    ...
    private subcribeRequestAddAsNewAndEditState() {
        this.requestNewStateSubscription = this.dispatcher
            .filter((action: CustomAction) => {
                return (
                    action.type ===
                        TabButtonActions.REQUEST_ADD_AS_NEW_AND_EDIT &&
                    action.module.idSettingsGUI == this.ofModule.idSettingsGUI
                );
            })
            .subscribe(() => {
    ...
    private subcribeRequestChangeSubModuleState() {
        this.requestChangeSubModuleStateSubscription = this.dispatcher
            .filter((action: CustomAction) => {
                return (
                    action.type ===
                        ProcessDataActions.REQUEST_CHANGE_SUB_MODULE &&
                    action.module.idSettingsGUI == this.ofModule.idSettingsGUI
                );
            })
            .subscribe(() => {
    ...
    private subscribeCheckDirtyPropertiesWidget() {
        this.dispatcher
            .filter((action: CustomAction) => {
                return (
                    action.type ===
                    PropertyPanelActions.CHECK_DIRTY_PROPERTIES_OF_WIDGET
                );
            })
    ...
    private subscribeRequestGoToFirstStepState() {
        this.requestGoToFirstStepStateSubscription = this.dispatcher
            .filter((action: CustomAction) => {
                return (
                    action.type ===
                        ProcessDataActions.REQUEST_GO_TO_FIRST_STEP &&
                    action.module.idSettingsGUI == this.ofModule.idSettingsGUI
                );
            })
            .subscribe(() => {
                    ...
                    if (this.isDirty()) {
                        ...
                        switch (currentAction) {
                            case TabButtonActionConst.EDIT_MAIN_TAB_AND_GO_TO_FIRST_STEP:
                                ...
                                this.store.dispatch(
                                    this.processDataActions.okToGoToFirstStep(
                                        this.ofModule
                                    )
                                );
                                break;
    ...
    private subscribeRequestGoToSecondStepState() {
        this.requestGoToSecondStepStateSubscription = this.dispatcher
            .filter((action: CustomAction) => {
                return (
                    action.type ===
                        ProcessDataActions.REQUEST_GO_TO_SECOND_STEP &&
                    action.module.idSettingsGUI == this.ofModule.idSettingsGUI
                );
            })
            .subscribe(() => {
                    ...
                    if (this.isDirty()) {
                        ...
                        switch (currentAction) {
                            case TabButtonActionConst.EDIT_MAIN_TAB_AND_GO_TO_SECOND_STEP:
                                ...
                                this.store.dispatch(
                                    this.processDataActions.okToGoToSecondStep(
                                        this.ofModule
                                    )
                                );
                                break;
    ...
    private subscribeRequestChangeBusinessCostRowState() {
        this.requestChangeBusinessCostRowStateSubscription = this.dispatcher
            .filter((action: CustomAction) => {
                return (
                    action.type ===
                        ProcessDataActions.REQUEST_CHANGE_BUSINESS_COST_ROW &&
                    action.module.idSettingsGUI == this.ofModule.idSettingsGUI
                );
            })
            .subscribe(() => {
        ...
        this.returnAndRefundInvoiceNumberDataStateSubscription =
            this.returnAndRefundInvoiceNumberDataState.subscribe(
                (invoiceNumberData: ReturnRefundInvoiceNumberModel) => {
                    this.appErrorHandler.executeAction(() => {
                        this.returnAndRefundInvoiceNumberData =
                            invoiceNumberData;
                    });
                }
            );
    ...
    private subcribeRequestChangeSearchResultState() {
        this.requestChangeSearchResultStateSubscription = this.dispatcher
            .filter((action: CustomAction) => {
                return (
                    action.type ===
                        ProcessDataActions.REQUEST_CHANGE_SEARCH_RESULT &&
                    action.module.idSettingsGUI == this.ofModule.idSettingsGUI
                );
            })
            .subscribe(() => {
    ...
    private subcribeIsOrderDataEntrySaveDisabledState() {
        ...
        this.isOrderDataEntrySaveDisabledStateSubscription = this.dispatcher
            .filter((action: CustomAction) => {
                return (
                    action.type ===
                        DataEntryActions.DATA_ENTRY_DISABLED_SAVE_BUTTON &&
                    this.selectedODETab &&
    ...
    private subscribeRequestSaveOnlyWithoutControllingTabState() {
        this.requestSaveOnlyWithoutControllingTabStateSubscription =
            this.dispatcher
                .filter((action: CustomAction) => {
                    return (
                        action.type ===
    ...
    private subscribeFormOutputDataState() {
        this.formOutputDataStateSubscription =
            this.formOutputDataState.subscribe((formOutputData: any) => {
                this.appErrorHandler.executeAction(() => {
                ...
                this.appErrorHandler.executeAction(() => {
                    switch (this.currentAction) {
                        case TabButtonActionConst.WAREHOUSE_MOVEMENT_CONFIRM_ALL_SORTING_GOODS:
                            ...
                            this.store.dispatch(
                                this.parkedItemActions.selectPreviousParkedItem(
                                    this.ofModule
                                )
                            );
                            this.store.dispatch(
    ...
    public saveOnlyWithoutControllingTab() {
        setTimeout(() => {
                    ...
                    default:
                        if (
                            ...
                            (this.selectedODETab &&
                                ...
                                !this.idScansContainerItems &&
                                this.isOrderDataEntrySaveDisabled.orderType !=
                                    "2")
                        ) {
                            isValid = false;
            ...
            if (isValid) {
                ...
                const tabId = this.selectedODETab
                    ? this.selectedODETab.TabID
                    : null;
                this.store.dispatch(
                    this.processDataActions.requestSave(
                ...
                if (editingWidget.tabId == tabSetting.CurrentTabID) {
                    if (
                        ...
                        let splitItem = tabSetting.TabContent[
                            ...
                            (si) => si.Page && si.Page.PageId != pageId
                        );
                        if (splitItem) {
                            return true;
                        }
    ...
    private showDirtyWarningMessage() {
        ...
        if (this.ofModule.idSettingsGUI == MenuModuleId.orderDataEntry) {
            ...
            modalOptions.yesButtonDisabled =
                ...
                (this.selectedODETab &&
                    this.selectedODETab.TabID ==
                        OrderDataEntryTabEnum.Scanning &&
                    !this.idScansContainerItems &&
    ...
    private processClose() {
        ...
        this.store.dispatch(
            this.moduleActions.removeWorkingModule(this.ofModule)
        );
        this.store.dispatch(
    ...
    private processNewOtherTabSuccess() {
        ...
        if (
            this.currentAction !== TabButtonActionConst.SAVE_AND_NEW_OTHER_TAB
        ) {
            this.store.dispatch(
                this.processDataActions.turnOffFormEditMode(this.ofModule)
            );
    ...
    private processEditOtherTabSuccess() {
        ...
        if (!this.formOutputData.dontShowMessage) {
            this.toasterService.pop(
                ...
                "Success",
                "Edit " +
                    this.selectedTab.tabSummaryInfor.tabName +
                    " successfully"
            );
        }
    ...
    private getUnsavedDialogSettingFromGlobalSetting() {
        this.globalSettingService
            ...
            .subscribe((globalSetting: any) => {
                this.appErrorHandler.executeAction(() => {
                    this.showUnsavedDialog =
                        this.getUnsavedDialogSetting(globalSetting);
                });
            });
    }
    ...
    public confirmReturnRefund() {
        this.store.dispatch(
            this.returnRefundActions.requestConfirm(this.ofModule)
        );
    }
    ...
    public refreshWidgets() {
        this.store.dispatch(
            this.propertyPanelActions.clearPropertiesWhenRefreshBtn(
                this.ofModule
            )
        );
    }
            ...
            .subscribe((data: any) => {
                this.appErrorHandler.executeAction(() => {
                    ...
                    if (globalSettingItem && globalSettingItem.jsonSettings) {
                        const moduleSetting = JSON.parse(
                            globalSettingItem.jsonSettings
                        );
    ...
    public getTabButtonAccessRight() {
        ...
        if (
            this.ofModule.idSettingsGUI == ModuleList.ReturnRefund.idSettingsGUI
        ) {
        ...
        if (
            this.ofModule.idSettingsGUI ==
            ModuleList.SystemManagement.idSettingsGUI
        ) {
    ...
    public syncMediacode() {
        this.modalService.confirmMessageHtmlContent(
            new MessageModel({
                ...
                callBack1: () => {
                    this.store.dispatch(
                        this.processDataActions.requestSyncMediacode(
                            this.ofModule
                        )
                    );
                },

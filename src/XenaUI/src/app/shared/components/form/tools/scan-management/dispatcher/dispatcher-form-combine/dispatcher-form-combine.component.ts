...
import {
  DispatcherFromStep1Component,
  DispatcherFromStep2Component,
  SmartWizzardComponent,
...
export class DispatcherFromCombineComponent
  ...
  implements OnInit, OnDestroy, AfterViewInit
{
  ...
  constructor(
    ...
    super(router);
    this._globalPropertiesState = _store.select(
      (state) =>

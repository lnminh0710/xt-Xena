...
export class AdMainFieldComponent implements OnInit, OnDestroy {
    ...
    @Input() set initInformation(information: any) {
        ...
        if (information && information.data && information.listComboBox && information.parentFormGroup
            ...
            if (!information.parentFormGroup.contains('adMainFieldForm'))
                information.parentFormGroup.addControl('adMainFieldForm', this.adMainFieldForm);
            else
                information.parentFormGroup.controls['adMainFieldForm'] = this.adMainFieldForm;
            ...
            (this.adMainFieldForm.controls['idRepTitleOfCourtesy'])['label'] = 'Title Of Courtesy';
            this.initFormGroup.emit({ form: this.adMainFieldForm, name: 'adMainFieldForm' });
            this.addValidation();
        }
    }
    ...
    private appendDefaultValueToTranslateResource() {
            defaultLanguage['Ad_Main__' + this.commonConfig['headerText']] = this.commonConfig['headerText'];
    }
    ...
    private addValidation() {
        ...
        Uti.setValidatorRegularExpresionForForm(this.adMainFieldForm, this.regularExpressionData);

...
export class FileSelectDirective {
    ...
    @Output() public exceedMaximumNumOfFiles: EventEmitter<any> = new EventEmitter();
    ...
    public onChange(): any {
        ...
        if (this.maxNumOfFiles && (files.length + this.uploader.queue.length) > this.maxNumOfFiles) {

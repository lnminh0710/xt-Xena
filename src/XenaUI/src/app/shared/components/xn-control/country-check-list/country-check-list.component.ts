...
export class XnCountryCheckListComponent implements OnInit, OnDestroy {
    ...
    @Output() outputIsActiveData: EventEmitter<any> = new EventEmitter();
    @Output() outputAllData: EventEmitter<any> = new EventEmitter();
    ...
    private showSubList(isShowed: boolean) {
        ...
        this.onChangeShowCountry.emit(isShowed);
        this.ref.markForCheck();
    }
    ...
    public getAllActiveCountry() {
        let activeCountries = [];
        const mainActiveList = this.getAllActiveList(this.mainList);
        const subActiveList = this.getAllActiveList(this.subList);
        activeCountries = [...mainActiveList, ...subActiveList];
        return activeCountries;
    }

    private getAllActiveList(checkList: Array<Country[]>) {
        let activeCountries = [];

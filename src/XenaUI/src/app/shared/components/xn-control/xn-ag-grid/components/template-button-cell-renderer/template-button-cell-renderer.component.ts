    ...
    public btnClick(eventData?: any) {
        switch (this.mode) {
            ...
            case "rowColCheckAll":
                switch (eventData) {
                    case "horizontal":
                        ...
                        if (allTrue) {
                            this.params.data.RMDelete =
                                this.params.data.RMDelete != -1
                                    ? 0
                                    : this.params.data.RMDelete;
                            this.params.data.RMEdit =
                                this.params.data.RMEdit != -1
                                    ? 0
                                    : this.params.data.RMEdit;
                            this.params.data.RMExport =
                                this.params.data.RMExport != -1
                                    ? 0
                                    : this.params.data.RMExport;
                            this.params.data.RMNew =
                                this.params.data.RMNew != -1
                                    ? 0
                                    : this.params.data.RMNew;
                            this.params.data.RMRead =
                                this.params.data.RMRead != -1
                                    ? false
                                    : this.params.data.RMRead;
                        } else {
                            this.params.data.RMDelete =
            ...
            case "ReportTypeTemplate":
                switch (eventData) {
                    case "download":
                        this.componentParent.downloadClick.emit(
                            this.params.data
                        );
                        break;

...
export class XnNumbericTextboxComponent
  implements OnInit, OnDestroy, ControlValueAccessor
{
  ...
  public ngOnInit() {
    this.formClass =
      (this.noInForm ? '' : this.formClass) +
      (this.customClassInput ? this.customClassInput : '');
  ...
  public onBlur(e: any) {
    ...
    if (
      !this.isInteger &&
      a.toString().indexOf('.') === a.toString().length - 1
    ) {

...
describe("MatTextareaAutosize", () => {
    ...
    it("should set a min-width based on minRows", () => {
        ...
        expect(textarea.style.minHeight).toBeDefined(
            "Expected a min-height to be set via minRows."
        );
    ...
    it("should set a max-width based on maxRows", () => {
        ...
        expect(textarea.style.maxHeight).toBeDefined(
            "Expected a max-height to be set via maxRows."
        );
    ...
    it("should export the matAutosize reference", () => {
        ...
        expect(
            fixture.componentInstance.autosize.resizeToFitContent
        ).toBeTruthy();
    });
    ...
    it("should initially set the rows of a textarea to one", () => {
        expect(textarea.rows).toBe(
            1,
            "Expected the directive to initially set the rows property to one."
        );
        ...
        expect(textarea.rows).toBe(
            1,
            "Expected the textarea to have the rows property set to one."
        );
    ...
    it("should calculate the proper height based on the specified amount of max rows", () => {
        ...
        expect(textarea.clientHeight).toBe(
            textarea.scrollHeight,
            "Expected textarea to not have a vertical scrollbar."
        );
    ...
    it("should properly resize to content on init", () => {
        ...
        autosize = fixture.debugElement
            ...
            .injector.get(MatTextareaAutosize);
    ...
    it("should resize when an associated form control value changes", fakeAsync(() => {
        const fixtureWithForms = TestBed.createComponent(
            AutosizeTextareaWithNgModel
        );

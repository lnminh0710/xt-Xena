        ...
        CanDisableRipple
{
    ...
    ngAfterContentInit() {
        this._slideRenderer = new SlideToggleRenderer(
            this._elementRef,
            this._platform
        );
        this._focusMonitor
...
class SlideToggleRenderer {
    ...
    constructor(elementRef: ElementRef, platform: Platform) {
        ...
        if (platform.isBrowser) {
            this._thumbEl = elementRef.nativeElement.querySelector(
                ".mat-slide-toggle-thumb-container"
            );
            this._thumbBarEl = elementRef.nativeElement.querySelector(
    ...
    startThumbDrag(checked: boolean) {
        ...
        this._thumbBarWidth =
            this._thumbBarEl.clientWidth - this._thumbEl.clientWidth;

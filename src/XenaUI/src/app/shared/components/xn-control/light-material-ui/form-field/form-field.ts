...
@Component({
  ...
  styleUrls: ['form-field.scss', '../input/input.scss'],
  animations: [
  ...
  host: {
    ...
    '[class.mat-form-field-should-float]':
      '_control.shouldPlaceholderFloat || _shouldAlwaysFloat',
  ...
  implements AfterViewInit, AfterContentInit, AfterContentChecked
{
  ...
  @Input()
  get dividerColor(): 'primary' | 'accent' | 'warn' {
    return this.color;
  }
  ...
  constructor(
    ...
    @Optional()
    @Inject(MAT_PLACEHOLDER_GLOBAL_OPTIONS)
  ...
  _animateAndLockPlaceholder(): void {
    if (this._placeholder && this._canPlaceholderFloat) {
      ...
      first
        .call(fromEvent(this._placeholder.nativeElement, 'transitionend'))
        .subscribe(() => {

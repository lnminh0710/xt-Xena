...
import { AngularMultiSelect, ListFilterPipe, Item, TemplateRenderer, VirtualScrollComponent } from "app/shared/components/xn-control/xn-dropdown";
import { ScrollDirective, styleDirective, setPosition, SafeHtmlPipe, RemoveHtmlPipe } from "app/shared/components/xn-control/xn-dropdown/clickOutside";
import { Badge, Search, CIcon } from "app/shared/components/xn-control/xn-dropdown/menu-item";
...
@NgModule({
    imports: [CommonModule, FormsModule, XnClickOutsideModule, XnInputNumericModule],

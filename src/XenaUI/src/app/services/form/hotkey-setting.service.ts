...
export class HotKeySettingService {
    ...
    public packageNr$: Observable<{ key: string; value: string }>;
    public idRepSalesOrderShipper$: Observable<{ key: string; value: string }>;
    ...
    public paymentTypeCreditCardMonthDefault$: Observable<{
        key: string;
        value: string;
    }>;
    public paymentTypeCreditCardMonth3M$: Observable<{
        key: string;
        value: string;
    }>;
    public paymentTypeCreditCardMonth6M$: Observable<{
        key: string;
        value: string;
    }>;
    public paymentTypeCreditCardMonth12M$: Observable<{
        key: string;
        value: string;
    }>;
    public paymentTypeCreditCardMonthCustom$: Observable<{
        key: string;
        value: string;
    }>;
    public paymentTypeCtrl$: Observable<{ key: string; value: string }>;
    public paymentTypeCreditCardIssuer$: Observable<{
        key: string;
        value: string;
    }>;
    public paymentTypeCreditCardNumber$: Observable<{
        key: string;
        value: string;
    }>;
    public paymentTypeCreditCardValidThru$: Observable<{
        key: string;
        value: string;
    }>;
    public paymentTypeCreditCardCVV$: Observable<{
        key: string;
        value: string;
    }>;
    public paymentTypeChequeAddAmount$: Observable<{
        key: string;
        value: string;
    }>;
    public paymentTypeChequeRemoveAmount$: Observable<{
        key: string;
        value: string;
    }>;
    ...
    constructor(private store: Store<any>) {
        ...
        this.packageNr$ = this.getHotKey("packageNr");
        this.idRepSalesOrderShipper$ = this.getHotKey("idRepSalesOrderShipper");
        ...
        this.paymentTypeCreditCardMonthDefault$ = this.getHotKey(
            "paymentTypeCreditCardMonthDefault"
        );
        this.paymentTypeCreditCardMonth3M$ = this.getHotKey(
            "paymentTypeCreditCardMonth3M"
        );
        this.paymentTypeCreditCardMonth6M$ = this.getHotKey(
            "paymentTypeCreditCardMonth6M"
        );
        this.paymentTypeCreditCardMonth12M$ = this.getHotKey(
            "paymentTypeCreditCardMonth12M"
        );
        this.paymentTypeCreditCardMonthCustom$ = this.getHotKey(
            "paymentTypeCreditCardMonthCustom"
        );
        this.paymentTypeCtrl$ = this.getHotKey("paymentTypeCtrl");
        this.paymentTypeCreditCardIssuer$ = this.getHotKey(
            "paymentTypeCreditCardIssuer"
        );
        this.paymentTypeCreditCardNumber$ = this.getHotKey(
            "paymentTypeCreditCardNumber"
        );
        this.paymentTypeCreditCardValidThru$ = this.getHotKey(
            "paymentTypeCreditCardValidThru"
        );
        this.paymentTypeCreditCardCVV$ = this.getHotKey(
            "paymentTypeCreditCardCVV"
        );
        this.paymentTypeChequeAddAmount$ = this.getHotKey(
            "paymentTypeChequeAddAmount"
        );
        this.paymentTypeChequeRemoveAmount$ = this.getHotKey(
            "paymentTypeChequeRemoveAmount"
        );
    }
    ...
    public getHotKey(key: string): Observable<{ key: string; value: string }> {
        return this.hotKeySettingState$.map((vm) => {
            const obj = {
                key: key,
                value: vm[key],
            };

...
export class CampaignService extends BaseService {
    ...
    public createCampaignArticle(data: any): Observable<any> {
        return this.post<any>(
            this.serUrl.createCampaignArticle,
            JSON.stringify(data)
        );
    }
    ...
    public saveCampaignWizard(data: any): Observable<any> {
        return this.post<any>(
            this.serUrl.saveCampaignWizard,
            JSON.stringify(data)
        );
    }
    ...
    public saveCampaignWizardCountriesT2(data: any): Observable<any> {
        return this.post<any>(
            this.serUrl.saveCampaignWizardCountriesT2,
            JSON.stringify(data)
        );
    }

    public getCampaignWizardCountry(
        idSalesCampaignWizard?: number
    ): Observable<any> {
    ...
    public checkExistingMediaCodeMulti(mediaCodeNrs: string): Observable<any> {
        return this.post<any>(
            this.serUrl.checkExistingMediaCodeMulti,
            JSON.stringify({
    ...
    public getMediaCodeDetail(
        idSalesCampaignWizardItems: any
    ): Observable<any> {
    ...
    public checkMediaCodeNumber(mediaCodeNr: string): Observable<any> {
        ...
        if (mediaCodeNr) {
            return this.get<any>(this.serUrl.searchMediaCode, {
                ...
                return !!res.item.data[0][0].CountReturn
                    ? { exists: true }
                    : null;
            });
        } else {
    ...
    public saveCampaignTracks(data: any): Observable<any> {
        return this.post<any>(
            this.serUrl.saveCampaignTracks,
            JSON.stringify(data)
        );
    }
    ...
    public getCampaignMediaCodeArticleSalesPrice(
        ...
        return this.get<any>(
            this.serUrl.getCampaignMediaCodeArticleSalesPrice,
            {
                idSalesCampaignWizard: idSalesCampaignWizard,
    ...
    public getPaymentTypeSalesPrice(
        idSalesCampaignWizardItems: number
    ): Observable<any> {
    ...
    public saveCampaignMediaCodeArticleSalesPrice(data: any): Observable<any> {
        return this.post<any>(
            this.serUrl.saveCampaignMediaCodeArticleSalesPrice,
            JSON.stringify(data)
        );
    }
    ...
    public savePaymentTypeSalesPrice(data: any): Observable<any> {
        return this.post<any>(
            this.serUrl.savePaymentTypeSalesPrice,
            JSON.stringify(data)
        );
    }

    public saveSalesCampaignAddOn(
        data: any,
        deleteFiles?: any,
        externalParam?: any
    ): Observable<any> {
    ...
    public saveDocumentTemplateSampleDataFile(data: any): Observable<any> {
        return this.post<any>(
            ...
            JSON.stringify({
                JSONText:
                    '{"DocumentTemplateFile":' + JSON.stringify(data) + "}",
            })
        );
    }
    ...
    public checkCampaignNumber(
        checkCampaignNumber: CheckCampaignNumber
    ): Observable<any> {
        return this.get<any>(
            this.serUrl.checkCampaignNumber,
            checkCampaignNumber
        );
    }

    public listDocumentTemplateColumnName(
        idRepAppSystemColumnNameTemplate: any
    ): Observable<any> {
    ...
    public saveAppSystemColumnNameTemplate(data: any): Observable<any> {
        return this.post<any>(
            ...
            JSON.stringify({
                JSONText:
                    '{"SystemColumnNameTemplate":' + JSON.stringify(data) + "}",
            })
        );
    }
    ...
    public listDocumentTemplatesBySharingTreeGroup(
        ...
        return this.get<any>(
            this.serUrl.listDocumentTemplatesBySharingTreeGroup,
            {
    ...
    public listTreeItemByIdSharingTreeGroupsRootname(
        idSharingTreeGroupsRootname: any
    ): Observable<any> {
        return this.get<any>(
            this.serUrl.listTreeItemByIdSharingTreeGroupsRootname,
            {
    ...
    public saveFilesByIdSharingTreeGroups(data: any): Observable<any> {
        return this.post<any>(
            this.serUrl.saveFilesByIdSharingTreeGroups,
            JSON.stringify(data)
        );
    }
}

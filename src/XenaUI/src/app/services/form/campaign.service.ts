...
export class CampaignService extends BaseService {
    ...
    public checkExistingMediaCodeMulti(mediaCodeNrs: string): Observable<any> {
        return this.post<any>(this.serUrl.checkExistingMediaCodeMulti, JSON.stringify({
    ...
    public getCampaignTracksCountries(idSalesCampaignTracks: any, idSalesCampaignWizard: any, idSalesCampaignWizardTrack: any): Observable<any> {
    ...
    public getCampaignMediaCodeArticleSalesPrice(idCountrylanguage: any, idSalesCampaignWizard: any, idSalesCampaignArticle: any): Observable<any> {
    ...
    public getPaymentTypeSalesPrice(idSalesCampaignWizardItems: number): Observable<any> {
        return this.get<any>(this.serUrl.getPaymentTypeSalesPrice, {
            idSalesCampaignWizardItems: idSalesCampaignWizardItems
        });
    }
    ...
    public savePaymentTypeSalesPrice(data: any): Observable<any> {
        return this.post<any>(this.serUrl.savePaymentTypeSalesPrice, JSON.stringify(data));
    }

    public saveSalesCampaignAddOn(data: any, deleteFiles?: any, externalParam? : any): Observable<any> {
        return this.post<any>(this.serUrl.saveSalesCampaignAddOn, JSON.stringify({ JSONText: '{"DocumentTemplate":' + JSON.stringify(data) + '}', 'DeleteFiles': deleteFiles, 'ExternalParam': externalParam  }));
    }

    public saveDocumentTemplateSampleDataFile(data: any): Observable<any> {
        return this.post<any>(this.serUrl.saveDocumentTemplateSampleDataFile, JSON.stringify({ JSONText: '{"DocumentTemplateFile":' + JSON.stringify(data) + '}' }));
    }
    ...
    public saveAppSystemColumnNameTemplate(data: any): Observable<any> {
        return this.post<any>(this.serUrl.saveAppSystemColumnNameTemplate, JSON.stringify({ JSONText: '{"SystemColumnNameTemplate":' + JSON.stringify(data) + '}' }));
    }

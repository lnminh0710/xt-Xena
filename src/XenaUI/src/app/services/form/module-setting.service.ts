    ...
    for (const customTab of newJsonSettings.Content.CustomTabs) {
      if (customTab.TabID === selectedTab.tabSummaryInfor.tabID) {
        ...
        if (
          ...
          for (const item of customTab.TabContent[contentDisplayMode].Split
            .Items) {
  ...
  mergeUserModuleLayoutSetting(
    ...
    if (
      ...
      mergedSetting.AdditionalInfo.SimpleTabs.forEach((defaultTab) => {
        let found = userModuleLayoutSetting.AdditionalInfo.SimpleTabs.find(
    ...
    if (
      ...
      mergedSetting.Content.CustomTabs.forEach((defaultTab) => {
        ...
        if (found) {
          if (
            defaultTab.TabContent[contentDisplayMode].hasOwnProperty('Split') &&
            found.TabContent[contentDisplayMode].hasOwnProperty('Split')
          ) {
            defaultTab.TabContent.Split = found.TabContent.Split;
          }

          if (
            defaultTab.TabContent[contentDisplayMode].hasOwnProperty(
              'SimpleTabs'
            ) &&
            found.TabContent[contentDisplayMode].hasOwnProperty('SimpleTabs')
          ) {
          ...
          if (
            defaultTab.TabContent[contentDisplayMode].hasOwnProperty('Page') &&
            found.TabContent[contentDisplayMode].hasOwnProperty('Page')
          ) {

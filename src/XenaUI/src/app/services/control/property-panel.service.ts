...
export class PropertyPanelService extends BaseService {
    ...
    public updateWidgetFormStyle(properties, formStyle, styleType, ofType) {
        ...
        const valueHeightAutoHeightStyle =
            propFormHeightAutoHeightStyle &&
            propFormHeightAutoHeightStyle.value;
        newFormStyle[styleType][CssStyleForm.Height] =
            valueHeightAutoHeightStyle
                ? "auto"
        ...
        if (propFormStyleColor) {
            newFormStyle[styleType][CssStyleForm.Color] =
                propFormStyleColor.value
        ...
        if (propFormStyleBold) {
            newFormStyle[styleType][CssStyleForm.FontWeight] =
                propFormStyleBold.value ? "bold" : "normal";
        }
    ...
    public updateInlineLabelStyle(properties, inlineLabelStyle) {
        ...
        if (propFormStyleLineHeight) {
            if (
                ...
                propFormStyleLineHeight.options =
                    this.defaultLineHeightOptions();
            }

            if (propFormStyleLineHeight.value) {
                newInlineLabelStyle["line-height"] =
                    propFormStyleLineHeight.value;
            }
        }
    ...
    public getValueDropdownApplyOnWidgetFromProperties(

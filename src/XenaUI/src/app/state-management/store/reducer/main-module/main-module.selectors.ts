...
export const getActiveModule = createSelector(
  getMainModule,
  (moduleState: ModuleState) => moduleState.activeModule
);
export const getMainModules = createSelector(
  getMainModule,
  (moduleState: ModuleState) => moduleState.mainModules
);
export const getUsingModule = createSelector(
  getMainModule,
  (moduleState: ModuleState) => moduleState.usingModule
);

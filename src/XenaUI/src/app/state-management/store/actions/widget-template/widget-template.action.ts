...
export class WidgetTemplateActions {
  static LOAD_All_WIDGET_TEMPLATE_SETTING_BY_MODULE_ID =
    '[WidgetTemplateSettingModel] LOAD All WIDGET TEMPLATE SETTING BY MODULE ID';
  loadWidgetTemplateSetting(
  ...
  static LOAD_All_WIDGET_TEMPLATE_SETTING_BY_MODULE_ID_SUCCESS =
    '[WidgetTemplateSettingModel] LOAD All WIDGET TEMPLATE SETTING BY MODULE ID Successfully';
  loadWidgetTemplateSettingSuccess(
    widgetTemplateSettings: WidgetTemplateSettingModel[],
    module: Module
  ): CustomAction {
    return {
  ...
  static UPDATE_EDIT_MODE_STATUS =
    '[WidgetTemplateSettingModel] UPDATE EDIT MODE STATUS';
  ...
  static TOGGLE_WIDGET_TEMPLATE_SETTING_PANEL =
    '[WidgetTemplateSettingModel] TOGGLE WIDGET TEMPLATE SETTING PANEL';
  toggleWidgetTemplateSettingPanel(
    status: boolean,
    module: Module
  ): CustomAction {
    return {

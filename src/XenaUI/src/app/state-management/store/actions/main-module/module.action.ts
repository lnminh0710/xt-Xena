...
export class ModuleActions {
    ...
    static RESET_SELECTING_WORKING_MODULE_PARKED_ITEM =
        "[Module] Reset Selecting Working Module Parked Item";
    ...
    static MOVE_SELECTED_PARKED_ITEM_TO_TOP =
        "[Module] Move Selected Parked Item To Top";
    ...
    static REQUEST_CREATE_NEW_MODULE_ITEM =
        "[Module] Request Create New Module Item";
    ...
    static CLEAR_REQUEST_CHANGE_SUB_MODULE =
        "[Module] Clear Request Change Sub Module";
    ...
    static TOGGLE_IS_WORKING_MODULES_DRAGGING =
        "[Module] Toggle Is Working Modules Dragging";
    ...
    static REMOVE_ALL_PARKED_ITEMS_OF_WORKING_MODULE =
        "[Module] Remove All Parked Items Of Working Module";
    ...
    static REMOVE_PARKED_ITEM_OF_WORKING_MODULE =
        "[Module] Remove Parked Item Of Working Module";
    removeParkedItemOfWorkingModule(
        module: Module,
        parkedItem: ParkedItemModel
    ): CustomAction {
        return {
    ...
    static UPDATE_MODULE_STATE_FROM_LOCAL_STORAGE =
        "[Module] Update module state from local storage";

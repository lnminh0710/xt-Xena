...
export class ModuleActions {
    ...
    addWorkingModule(workingModule: Module, subModules: Module[], parkedItems: ParkedItemModel[], fieldConfig: Array<any>, loadFromSetting?: boolean): CustomAction {
        return {
    ...
    storeModuleStates(currentModule: Module, selectedParkedItem: ParkedItemModel, selectedTab: TabSummaryModel, selectedAiTab: AdditionalInfromationTabModel): CustomAction {
        return {

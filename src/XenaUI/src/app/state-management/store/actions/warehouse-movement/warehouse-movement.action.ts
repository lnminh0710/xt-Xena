...
export class WarehouseMovementActions {
  ...
  static REQUEST_CONFIRM_ALL_SUCCESS =
    '[WarehouseMovement] Request Confirm All Success';
  ...
  static REQUEST_SAVE_AND_CONFIRM =
    '[WarehouseMovement] Request Save And Confirm';
  ...
  static REQUEST_SAVE_AND_CONFIRM_SUCCESS =
    '[WarehouseMovement] Request Save And Confirm Success';

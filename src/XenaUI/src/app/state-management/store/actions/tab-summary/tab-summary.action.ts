...
export class TabSummaryActions {
    ...
    static SELECT_TAB_HEADER_TABLE_FILTER = '[TabSummary] Select Tab Header Table Filter';
    selectTabHeaderTableFilter(tabHeaderTableFilter, module: Module): CustomAction {
        return {
    ...
    static UNSELECT_TAB_HEADER_TABLE_FILTER = '[TabSummary] Unselect Tab Header Table Filter';
    ...
    static STORE_TAB_HEADER_TABLE_FILTER_LIST = '[TabSummary] Store Tab Header Table Filter List';
    storeTabHeaderTableFilterList(tabHeaderTableFilterList, module: Module): CustomAction {
        return {
    ...
    static UNCHECK_TAB_HEADER_TABLE_FILTER_LIST = '[TabSummary] Uncheck Tab Header Table Filter List';

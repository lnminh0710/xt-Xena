...
import { TabSummaryModel, SimpleTabModel, Module } from "app/models";
...
export class TabSummaryActions {
    ...
    requestSelectSimpleTab(
        simpleTabID: string | number,
        module: Module
    ): CustomAction {
        return {
    ...
    static SELECT_TAB_HEADER_TABLE_FILTER =
        "[TabSummary] Select Tab Header Table Filter";
    selectTabHeaderTableFilter(
        tabHeaderTableFilter,
        module: Module
    ): CustomAction {
        return {
            type: TabSummaryActions.SELECT_TAB_HEADER_TABLE_FILTER,
            module: module,
            payload: { tabHeaderTableFilter },
        };
    }

    static UNSELECT_TAB_HEADER_TABLE_FILTER =
        "[TabSummary] Unselect Tab Header Table Filter";
    unselectTabHeaderTableFilter(module: Module): CustomAction {
        return {
            type: TabSummaryActions.UNSELECT_TAB_HEADER_TABLE_FILTER,
            module: module,
        };
    }

    static STORE_TAB_HEADER_TABLE_FILTER_LIST =
        "[TabSummary] Store Tab Header Table Filter List";
    storeTabHeaderTableFilterList(
        tabHeaderTableFilterList,
        module: Module
    ): CustomAction {
        return {
            type: TabSummaryActions.STORE_TAB_HEADER_TABLE_FILTER_LIST,
            module: module,
            payload: { tabHeaderTableFilterList },
        };
    }

    static UNCHECK_TAB_HEADER_TABLE_FILTER_LIST =
        "[TabSummary] Uncheck Tab Header Table Filter List";
    uncheckTabHeaderTableFilterList(module: Module): CustomAction {
        return {
            type: TabSummaryActions.UNCHECK_TAB_HEADER_TABLE_FILTER_LIST,
            module: module,
        };
    }
    ...
    static SET_FORM_EDIT_DATA_ACTIVE_SUB_TAB =
        "[TabSummary] Set Form Edit Data Active Sub Tab";
    setFormEditDataActiveSubTab(
    ...
    static SET_FORM_EDIT_SUB_TAB_1_CLICK =
        "[TabSummary] Set Form Edit Sub Tab 1 Click";
    ...
    static SET_FORM_EDIT_SUB_TAB_2_CLICK =
        "[TabSummary] Set Form Edit Sub Tab 2 Click";
    ...
    static SET_FORM_EDIT_TEXT_DATA_SUB_TAB =
        "[TabSummary] Set Form Edit Text Data Sub Tab";
    ...
    static CLEAR_REQUEST_UPDATE_TAB_HEADER =
        "[TabSummary] Clear Request Update Tab Header";

...
export class ProcessDataActions {
    ...
    static SAVE_ONLY_MAIN_TAB_RESULT =
        "[ProcessData] Save Only Main Tab Result";
    ...
    static REQUEST_CHANGE_SUB_MODULE =
        "[ProcessData] Requedt Change Sub Module";
    ...
    static REQUEST_GO_TO_SECOND_STEP =
        "[ProcessData] Request Go To Second Step";

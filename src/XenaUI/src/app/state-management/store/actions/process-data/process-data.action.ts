...
export class ProcessDataActions {
    ...
    static REQUEST_OPEN_SELECTION_EXPORT_DATA_DIALOG = '[ProcessData] Request Open Selection Export Data Dialog';
    ...
    static REQUEST_EXPORT_SELECTION_DATA = '[ProcessData] Request Export Selection Data';
    requestExportSelectionData(exportType, module: Module, email?, fileType?, csvDelimiter?): CustomAction {
        return {
    ...
    static REQUEST_EXPORT_SELECTION_DATA_FROM_CONTEXT_MENU = '[ProcessData] Request Export Selection Data From Context Menu';
    requestExportSelectionDataFromContextMenu(exportType, module: Module): CustomAction {
        return {
    ...
    static EXPORT_SELECTION_DATA_RESULT = '[ProcessData] Export Selection Data Result';
    exportSelectionDataResult(exportType, module: Module, isSuccess: boolean): CustomAction {
        return {
    ...
    static SELECTION_COUNTRIES_ARE_UPDATED = '[ProcessData] Selection Countries Are Updated';
    ...
    static UPDATE_PROCESS_DATA_STATE_FROM_LOCAL_STORAGE = '[ProcessData] Update process data state from local storage';
    ...
    static SET_GRID_ITEM_DATA_TO_LOCAL_STORAGE = '[ProcessData] Set Grid Item Data To Local Storage';

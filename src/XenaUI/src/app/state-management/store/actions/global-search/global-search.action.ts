...
export class GlobalSearchActions {
    ...
    static CHANGE_MODULE_TAB_STORAGE =
        "[GlobalSearch Storage] Change Module Tab";
    ...
    static MENU_CONTEXT_ACTION_STORAGE =
        "[GlobalSearch Storage] Menu Context Action Storage";

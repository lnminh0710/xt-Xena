...
export class PropertyPanelActions {
    ...
    static UPDATE_ORIGINAL_PROPERTIES = '[PropertyPanel] Update Original Properties';
    ...
    static CLEAR_PROPERTIES_WHEN_CLICK_REFRESH_BTN = '[PropertyPanel] Clear Properties When Click Refresh Button';
    ...
    static UPDATE_PROPERTY_STATE_FROM_LOCAL_STORAGE = '[PropertyPanel] Update property state from local storage';
    ...
    static CHECK_DIRTY_PROPERTIES_OF_WIDGET = '[PropertyPanel] Check Dirty Properties Of Widget';

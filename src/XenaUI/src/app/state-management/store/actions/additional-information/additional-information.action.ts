...
import { AdditionalInfromationTabModel, Module } from "app/models";

@Injectable()
export class AdditionalInformationActions {
    static SET_CURRENT_STATE =
        "[AdditionalInformationActions] Set Current State";
    ...
    static REQUEST_TOGGLE_PANEL =
        "[AdditionalInformationActions] Request Toggle Panel";
    ...
    static BACK_TO_PREVIOUS_STATE =
        "[AdditionalInformationActions] Back To Previous State";
    ...
    static SELECT_SUMMARY_TAB =
        "[AdditionalInformationActions] Select Summary Tab";
    selectAdditionalInformationTab(
        tabz: AdditionalInfromationTabModel,
        module: Module
    ): CustomAction {
        return {
    ...
    static REQUEST_SELECT_AI_TAB =
        "[AdditionalInformationActions] Request Select Ai Tab";

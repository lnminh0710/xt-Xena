...
export class ParkedItemActions {
    ...
    static LOAD_THEN_ADD_PARKED_ITEM_SUCCESS =
        "[ParkedItem] Load Then Add Parked Item Success";
    loadThenAddParkedItemSuccess(
        parkedItem: ParkedItemModel,
        module: Module
    ): CustomAction {
        return {
    ...
    static REQUEST_SAVE_PARKED_ITEM_LIST =
        "[ParkedItem] Request Save Parked Item List";
    ...
    static SELECT_PREVIOUS_PARKED_ITEM =
        "[ParkedItem] Select Previous Parked Item";
    ...
    static UPDATE_GLOBAL_SEARCH_STATE_FROM_LOCAL_STORAGE =
        "[ParkedItem] Update global search state from local storage";

...
import { ModuleSettingModel, Module } from "app/models";
...
export class ModuleSettingActions {
    ...
    static LOAD_MODULE_SETTING_SUCCESS =
        "[ModuleSetting] Load Module Setting Success";
    loadModuleSettingSuccess(
    ...
    static LOAD_MODULE_SETTING_FOR_NEW =
        "[ModuleSetting] Load Module Setting For New";
    ...
    static STORE_ORIGIN_MODULE_SETTING =
        "[ModuleSetting] Store Origin Module Setting";
    ...
    static LOAD_ORIGIN_MODULE_SETTING =
        "[ModuleSetting] Load Origin Module Setting";
    ...
    static UPDATE_GLOBAL_SEARCH_STATE_FROM_LOCAL_STORAGE =
        "[ModuleSetting] Update global search state from local storage";

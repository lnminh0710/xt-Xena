...
export class TabButtonActions {
  ...
  static SET_COMMAND_DISABLE = '[ProcessData] Set Command Disable';
  setCommandDisable(module: Module, value: any): CustomAction {
    return {
      type: TabButtonActions.SET_COMMAND_DISABLE,
      module: module,
      payload: value,
    };
  }
  ...
  static REQUEST_ADD_AS_NEW_AND_EDIT =
    '[TabButton] Request Add As New And Edit';
  requestAddAsNewAndEdit(module: Module): CustomAction {
    return {
      type: TabButtonActions.REQUEST_NEW,
      module: module,
    };
  ...
  static REQUEST_SAVE_ONLY_WITHOUT_CONTROLLING_TAB =
    '[TabButton] Request Save Only Without Controlling Tab';

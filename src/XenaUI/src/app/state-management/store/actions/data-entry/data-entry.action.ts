...
export class DataEntryActions {
    ...
    static DATA_ENTRY_CUSTOMER_DATA_CHANGED = '[DATA_ENTRY] Customer Data Changed';
    ...
    static DATA_ENTRY_COMMUNICATION_DATA_CHANGED = '[DATA_ENTRY] Communication Data Changed';
    dataEntryCommunicationDataChanged(data: FormModel, area: string): CustomAction {
        return {
    ...
    static DATA_ENTRY_ARTICLE_GRID_EXPORT_DATA = '[DATA_ENTRY] Article Grid Export Data';
    ...
    static DATA_ENTRY_SCANNING_STATUS_CALL_RELOAD = '[DATA_ENTRY] Scanning Status Call Reload';
    ...
    static DATA_ENTRY_SCANNING_STATUS_CALL_SKIP = '[DATA_ENTRY] Scanning Status Call Skip';
    ...
    static DATA_ENTRY_SCANNING_STATUS_CALL_DELETE = '[DATA_ENTRY] Scanning Status Call Delete';
    ...
    static DATA_ENTRY_PAYMENT_TYPE_CALL_ADD = '[DATA_ENTRY] Payment Type Call Add';
    ...
    static DATA_ENTRY_PAYMENT_TYPE_CALL_SAVE = '[DATA_ENTRY] Payment Type Call Save';
    ...
    static DATA_ENTRY_SET_ORDER_DATA_MEDIA_CODE = '[DATA_ENTRY] Set Order Data Media Code';
    ...
    static DATA_ENTRY_SET_ORDER_DATA_PAYMENT_TYPE = '[DATA_ENTRY] Set Order Data Payment Type';
    ...
    static DATA_ENTRY_SET_DELIVERY_CHARGES = '[DATA_ENTRY] Set Order Data Delivery Charges';
    ...
    static DATA_ENTRY_SET_ARTICLE_TOTAL = '[DATA_ENTRY] Set Order Data Article Total';
    ...
    static DATA_ENTRY_SET_ORDER_TOTAL_SUMMARY = '[DATA_ENTRY] Set Order Total Summary';
    ...
    static DATA_ENTRY_SET_MAIN_PAYMENT_TYPE_LIST = '[DATA_ENTRY] Set Main Payment Type List';
    dataEntrySetMainPaymentTypeList(data: Array<PaymentType>, area: string): CustomAction {
        return {
    ...
    static DATA_ENTRY_SET_MAIN_CURRENCY_AND_PAYMENT_TYPE_LIST = '[DATA_ENTRY] Set Main Currency And Payment Type List';
    dataEntrySetMainCurrencyAndPaymentTypeList(mainCurrency: Currency, paymentTypeList: Array<PaymentType>, area: string): CustomAction {
        ...
        return {
            ...
            payload: {
                mainCurrency: mainCurrency,
                mainPaymentTypeList: paymentTypeList,
                mainCurrencyAndMainPaymentTypeList: mainCurrencyAndMainPaymentTypeList
            },
            area: area
        };
    }

    static DATA_ENTRY_SET_CUSTOMER_MANDATORY_FIELD = '[DATA_ENTRY] SET CUSTOMER MANDATORY FIELD';
    ...
    static DATA_ENTRY_SELECT_SUMMARY_FILTER = '[DATA_ENTRY] SELECT SUMMARY FILTER';
    dataEntrySelectSummaryFilter(mode: string, area: string, dateFrom?: string, dateTo?: string): CustomAction {
        return {
    ...
    static DATA_ENTRY_CLEAR_SUMMARY_FILTER_DATA = '[DATA_ENTRY] CLEAR SUMMARY FILTER DATA';
    ...
    static DATA_ENTRY_ORDER_SUMMARY_DATA_LOADED = '[DATA_ENTRY] ORDER SUMMARY DATA LOADED';
    ...
    static DATA_ENTRY_SELECTED_CAMPAIGN_NUMBER_DATA = '[DATA_ENTRY] SELECTED CAMPAIGN NUMBER DATA';
    dataEntrySelectedCampaignNumberData(campaignNumber: string, area: string): CustomAction {
        return {
    ...
    static DATA_ENTRY_DISABLED_SAVE_BUTTON = '[DATA_ENTRY] DISABLED SAVE BUTTON';
    dataEntryDisabledSaveButton(isValid: boolean, orderType: any, area: string): CustomAction {
        return {
    ...
    static DATA_ENTRY_CUSTOMER_MATCHED_DATA_CHANGED = '[DATA_ENTRY] CUSTOMER_MATCHED_DATA_CHANGED';
    dataEntryCustomerMatchedDataChanged(customerMatchedData: any, area: string): CustomAction {
        return {
    ...
    static DATA_ENTRY_REQUEST_DOWNLOAD_SCANNING_IMAGE = '[DATA_ENTRY] REQUEST DOWNLOAD SCANNING IMAGE';
    ...
    static DATA_ENTRY_ACTIVE_TAB_IN_LIST_PAYMENT_TAB = '[DATA_ENTRY] DATA_ENTRY_ACTIVE_TAB_IN_LIST_PAYMENT_TAB';
    activeTabInListPaymentTab(tabId: string, module: Module, area: string): CustomAction {
        return {
    ...
    static DATA_ENTRY_REQUEST_CHANGE_TAB_THEN_LOAD_DATA = '[DATA_ENTRY] REQUEST CHANGE TAB THEN LOAD DATA';
    ...
    static DATA_ENTRY_CLEAR_REQUEST_CHANGE_TAB_THEN_LOAD_DATA = '[DATA_ENTRY] CLEAR REQUEST CHANGE TAB THEN LOAD DATA';
    ...
    static DATA_ENTRY_SELECT_ORDER_SUMMARY_ITEM = '[DATA_ENTRY] SELECT ORDER SUMMARY ITEM';
    ...
    static DATA_ENTRY_CLEAR_SELECTED_ORDER_SUMMARY_ITEM = '[DATA_ENTRY] CLEAR SELECTED ORDER SUMMARY ITEM';
    ...
    static DATA_ENTRY_ORDER_FAILED_REQUEST_DATA = '[DATA_ENTRY] Order Failed Request Data';
    ...
    static DATA_ENTRY_ORDER_FAILED_RECEIVE_DATA = '[DATA_ENTRY] Order Failed Receive Data';
    ...
    static DATA_ENTRY_CACHED_FAILED_DATA = '[DATA_ENTRY] Order Cached Failed Data';
    ...
    static DATA_ENTRY_ADD_ARTICLE_DATA_FROM_ARTICLE_CAMPAIGN_GRID = '[DATA_ENTRY] Add article data from article campaign grid';
    addArticleDataFromArticleCampaignGrid(data: any, area: string): CustomAction {
        return {
    ...
    static DATA_ENTRY_ORDER_DOUBLET_CHECK_REQUEST = '[DATA_ENTRY] Order Doublet Check Request';
    ...
    static DATA_ENTRY_UPDATE_IS_CANCEL_SAV = '[DATA_ENTRY] Update Is Cancel SAV';

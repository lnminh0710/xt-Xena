...
export class LayoutInfoActions {
    ...
    static SET_RIGHT_PROPERTY_PANEL_WIDTH =
        "[LayoutInfo] Set Right Property Panel Width";
    ...
    resizeSplitter(
        module: Module,
        directionMode?: SplitterDirectionMode
    ): CustomAction {
    ...
    static TOGGLE_MAKE_SPACE_FOR_TAB_BUTTON =
        "[LayoutInfo] Toggle Make Space For Tab Button";
    toggleMakeSpaceForTabButton(
        makeSpaceForTabButton: boolean,
        module: Module
    ): CustomAction {
        return {

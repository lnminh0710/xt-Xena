...
export class BackofficeActions {
  ...
  static REQUEST_GO_TO_TRACKING_PAGE =
    '[Backoffice] Request Go To Tracking Page';
  ...
  static REQUEST_OPEN_RETURN_REFUND_MODULE =
    '[Backoffice] Request Open Return Refund Module';

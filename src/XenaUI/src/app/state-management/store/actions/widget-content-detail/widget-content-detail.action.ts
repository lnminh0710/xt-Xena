...
import {
    ...
    EditingWidget,
    RelatingWidget,
} from "../../reducer/widget-content-detail";
...
export class WidgetDetailActions {
    ...
    static CLEAR_WIDGET_TYPE_DETAIL =
        "[Widget_Detail] Clear Widget Type Detail";
    ...
    static LOAD_WIDGET_TYPE_DETAIL_FOR_CAMPAIGN_MEDIA =
        "[Widget_Detail] Clear Widget Type Detail For Campaign Media";
    loadWidgetTypeDetailForCampaignMedia(
        rowData: RowData,
        ofModule: Module,
        tabId: string
    ): CustomAction {
    ...
    static CLEAR_WIDGET_TYPE_DETAIL_FOR_CAMPAIGN_MEDIA =
        "[Widget_Detail] Clear Widget Type Detail For Campaign Media";
    clearWidgetTypeDetailForCampaignMedia(
        ofModule: Module,
        tabId: string
    ): CustomAction {
        return {
    ...
    static LOAD_WIDGET_TABLE_DATA_ROWS =
        "[Widget_Detail] Load Widget Table Data Rows";
    ...
    static CLEAR_WIDGET_TABLE_DATA_ROWS =
        "[Widget_Detail] Clear Widget Table Data Rows";
    clearWidgetTableDataRows(widgetInfo: any, ofModule: Module): CustomAction {
        return {
    ...
    syncUpdateDataWidget(
        widgetDataUpdate: WidgetDataUpdated,
        ofModule: Module
    ): CustomAction {
        return {
    ...
    static CANCEL_ALL_WIDGET_EDITING =
        "[Widget_Detail] Cancel All Widget Editing";
    ...
    static HOVER_AND_DISPLAY_RELATING_WIDGET =
        "[Widget_Detail] Hover and display relating widget on design mode";
    hoverAndDisplayRelatingWidget(
    ...
    static INITIALIZED_WIDGET_CONTAINER =
        "[Widget_Detail] Initialized widget container";
    ...
    static REQUEST_REMOVE_CONNECTION_FROM_PARENT_WIDGET =
        "[Widget_Detail] Request Remove Connection From Parent Widget";
    requestRemoveConnectionFromParentWidget(
        parentWidgetId,
        ofModule: Module
    ): CustomAction {
        return {
    ...
    static REQUEST_REMOVE_CONNECTION_FROM_CHILD_WIDGET =
        "[Widget_Detail] Request Remove Connection From Child Widget";
    requestRemoveConnectionFromChildWidget(
        parentWidgetIds: Array<string>,
        ofModule: Module
    ): CustomAction {
        return {
    ...
    static SET_CONNECT_FOR_CHILD_FROM_PARENT_WIDGET =
        "[Widget_Detail] Set connect for child from parent Widget";
    setConnectForChildFromParentWidget(
        communicationWidget: any,
        ofModule: Module
    ): CustomAction {
        return {
    ...
    static SET_CONNECT_FOR_PARENT_FROM_CHILD_WIDGET =
        "[Widget_Detail] Set connect for parent from child Widget";
    setConnectForParentFromChildWidget(
        communicationWidget: any,
        ofModule: Module
    ): CustomAction {
        return {
    ...
    static SET_CONNECT_FOR_SAME_TYPE_WIDGET =
        "[Widget_Detail] Set connect for same type Widget";
    setConnectForSameTypeWidget(
        communicationWidget: any,
        ofModule: Module
    ): CustomAction {
        return {
    ...
    static REQUEST_REFRESH_WIDGETS_IN_TAB =
        "[Widget_Detail] Request Refresh Widgets In Tab";
    ...
    static REQUEST_RELOAD_WIDGET = "[Widget_Detail] Request Reload Widget";
    requestReloadWidget(widgetId, ofModule: Module): CustomAction {
        return {
            type: WidgetDetailActions.REQUEST_RELOAD_WIDGET,
            module: ofModule,
            payload: widgetId,
        };
    }

    static TOGGLE_EDIT_ALL_WIDGET_MODE =
        "[Widget_Detail] Toggle Edit All Widget Mode";
    toggleEditAllWidgetMode(
        isEditMode: boolean,
        ofModule: Module
    ): CustomAction {
        return {
    ...
    static ACTIVE_WIDGET = "[Widget_Detail] Active Widget";
    activeWidget(widgetDetail: WidgetDetail, ofModule: Module): CustomAction {
        return {
            type: WidgetDetailActions.ACTIVE_WIDGET,
            payload: widgetDetail,
            module: ofModule,
        };
    }

    static UPDATE_WIDGET_CONTENT_STATE_FROM_LOCAL_STORAGE =
        "[Widget_Detail] Update Widget content state from local storage";
    restoreAllState(data): CustomAction {
        return {
            type: WidgetDetailActions.UPDATE_WIDGET_CONTENT_STATE_FROM_LOCAL_STORAGE,
            payload: data,
        };
    }
}

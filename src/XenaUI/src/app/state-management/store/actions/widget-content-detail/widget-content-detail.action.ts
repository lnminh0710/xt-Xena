...
export class WidgetDetailActions {
    ...
    loadWidgetTypeDetailForCampaignMedia(rowData: RowData, ofModule: Module, tabId :string): CustomAction {
        return {
    ...
    clearWidgetTypeDetailForCampaignMedia(ofModule: Module, tabId:string): CustomAction {
        return {
    ...
    static UPDATE_WIDGET_CONTENT_STATE_FROM_LOCAL_STORAGE = '[Widget_Detail] Update Widget content state from local storage';

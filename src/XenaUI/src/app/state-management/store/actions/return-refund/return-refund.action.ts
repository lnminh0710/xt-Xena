...
export class ReturnRefundActions {
    ...
    static UPDATE_INVOICE_NUMBER_DATA =
        "[ReturnRefund] Return & Refund Invoice Number Data updated";
    ...
    setKeepArticleOrders(
        data: Array<ArticleOrder>,
        module: Module
    ): CustomAction {
        return {
    ...
    static SET_KEEP_ARTICLE_ORDERS_VALID =
        "[ReturnRefund] Set Keep Article Orders Valid";
    setKeepArticleOrdersValid(data: boolean, module: Module): CustomAction {
        return {
            type: ReturnRefundActions.SET_KEEP_ARTICLE_ORDERS_VALID,
            module: module,
            payload: data,
        };
    }

    static CLEAR_KEEP_ARTICLE_ORDERS =
        "[ReturnRefund] Clear Keep Article Orders";
    ...
    static SET_ALL_EDIT_ARTICLE_ORDERS =
        "[ReturnRefund] Set All Editted Article Orders";
    setAllEditArticleOrders(
        data: Array<ArticleOrder>,
        module: Module
    ): CustomAction {
        return {
    ...
    static CLEAR_ALL_EDIT_ARTICLE_ORDERS =
        "[ReturnRefund] Clear All Editted Article Orders";
    ...
    static REQUEST_UPDATE_INVOICE_NEW_DATA =
        "[ReturnRefund] Return & Refund Invoice New Data updated";
    ...
    static SUBMIT_FORM = "[ReturnRefund] Submit Form";
    submitForm(module: Module): CustomAction {
        return {
            type: ReturnRefundActions.SUBMIT_FORM,
            module: module,
        };
    }

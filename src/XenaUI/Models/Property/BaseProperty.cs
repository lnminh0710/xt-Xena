...
namespace XenaUI.Models.Property
{
    ...
    /// </summary>
    public class IdRepContactAddressType : BaseProperty
    {
        public IdRepContactAddressType(JProperty token) : base(token)
        {
        }
    }
    ...
    {
        public CommonProperty(JProperty token) : base(token)
        {
        }
    }
    ...
    /// IdCountrylanguage
    /// </summary>
    public class IdCountrylanguage : BaseProperty
    {
        public IdCountrylanguage(JProperty token) : base(token)
        {
        }
    }
    ...
    /// TotalAmount
    /// </summary>
    public class TotalAmount : BaseProperty
    {
        public TotalAmount(JProperty token) : base(token)
        {
        }
    }
    ...
    /// TotalItems
    /// </summary>
    public class TotalItems : BaseProperty
    {
        public TotalItems(JProperty token) : base(token)
        {
        }
    }
    ...
    /// CampaignNr
    /// </summary>
    public class CampaignNr : BaseProperty
    {
        public CampaignNr(JProperty token) : base(token)
        {
        }
    }

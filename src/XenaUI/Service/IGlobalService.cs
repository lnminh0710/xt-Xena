...
namespace XenaUI.Service
{
    public interface IGlobalService
    {
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        object GetAllWidgetTemplateByModuleId(Data data);
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        Task<object> GetMultiTranslateLabelText(TranslateLabelGetData data);
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        Task<object> GetSystemTranslateText(TranslateLabelGetData data);
        #endregion
    }    
}

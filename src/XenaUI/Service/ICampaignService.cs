...
namespace XenaUI.Service
{
    public interface ICampaignService
    {
        ...
        /// <returns></returns>
        Task<object> GetCampaignMediaCodeArticleSalesPrice(CampaignData data, string customMethodName);
        ...
        /// <param name="customMethodName"></param>
        /// <returns></returns>
        Task<object> SaveCampaignMediaCodeArticleSalesPrice(CampaignMediaCodeArticleSalesPriceData data, string customMethodName);
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        Task<object> GetPaymentTypeSalesPrice(CampaignData data);
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        Task<object> SavePaymentTypeSalesPrice(CampaignMediaCodeArticleSalesPriceData data);
    }

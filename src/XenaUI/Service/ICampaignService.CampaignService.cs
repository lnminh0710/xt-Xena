...
namespace XenaUI.Service
{
    ...
    public class CampaignService : BaseUniqueServiceRequest, ICampaignService
    {
        ...
        public async Task<object> GetCampaignCountry(CampaignData data)
        {
            ...
            var response = (await Service.Post(body: bodyRquest, expectedReturn: null, mappingType: Constants.EExecuteMappingType.Country))[0];
            return response;
        }
        ...
        public async Task<object> GetCampaignWizardT1(CampaignData data)
        {
            ...
            var _response = (await Service.Post(body: bodyRquest, expectedReturn: expectedReturn, mappingType: Constants.EExecuteMappingType.DynamicCoulumnsType))[1];
        ...
        public async Task<object> GetCampaignCostsCountries(CampaignData data)
        {
            ...
            var response = (await Service.Post(body: bodyRquest, expectedReturn: null, mappingType: Constants.EExecuteMappingType.Country2))[0];
            return response;
        }
        ...
        public async Task<object> SaveCampaignMediaCodeArticleSalesPrice(CampaignMediaCodeArticleSalesPriceData data, string customMethodName)
        {
            if (customMethodName != null)
            {
                data.MethodName = customMethodName;
            }
            else
            {
                data.MethodName = "SpCallCampaign";
        ...
        /// <returns></returns>
        public async Task<object> SavePaymentTypeSalesPrice(CampaignMediaCodeArticleSalesPriceData data)
        {
            data.MethodName = "SpCallCampaign";

            data.GUID = Guid.NewGuid().ToString();
            data.Object = "PaymentTypeSalesPrice";
        ...
        public async Task<object> GetCampaignMediaCodeArticleSalesPrice(CampaignData data, string customMethodName)
        {
            if (customMethodName != null)
            {
                data.MethodName = customMethodName;
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        public async Task<object> GetPaymentTypeSalesPrice(CampaignData data)
        {
            data.MethodName = "SpAppWg001Campaign";

            data.GUID = Guid.NewGuid().ToString();
            data.Object = "GetPaymentTypeSalesPrice";

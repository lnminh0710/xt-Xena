...
namespace XenaUI.Service
{
    public interface IToolsService
    {
        ...
        Task<WSEditReturn> SaveMailingReturn(MailingReturnSaveData data);
        Task<object> ResetMailingReturn(Data data);
        Task<object> GetMailingReturnSummary(Data data);
        Task<object> ExportCustomerAndBusinessStatus(Data data, string customerStatusIds, string businessStatusIds);
        #endregion

        #region ImportInvoicePayment
        Task<object> GetImportInvoiceFiles(Data data);
        #endregion

...
namespace XenaUI.Utils
{
    ...
    public class ConfirmLettersData : Data
    {
        /// <summary>
        /// IdGenerateLetter
        /// </summary>
     ...
     public class ResetLetterStatusData : Data
     {
         /// <summary>
         /// IdGenerateLetter
         /// </summary>
    ...
    public class ReturnRefundSaveData : Data
    {
        ...
        /// NewInvoiceAmount
        /// </summary>
        public string NewInvoiceAmount { get; set; }

        /// <summary>
        /// NewInvoiceTotalAmount
        /// </summary>
        public string NewInvoiceTotalAmount { get; set; }

        /// <summary>
        /// NewInvoiceCurrency
        /// </summary>
        public string NewInvoiceCurrency { get; set; }

        /// <summary>
        /// NewInvoiceFreeShipping
        /// </summary>
        public string NewInvoiceFreeShipping { get; set; }

        /// <summary>
        /// JSONNewInvoice
        /// </summary>
        public string JSONNewInvoice { get; set; }

...
namespace XenaUI.Utils
{
    ...
    public class ContactCreateData : CustomerCreateData
    {
        ...
        /// <summary>
        /// B00PersonInterfaceContactAddressGw_IdPersonInterfaceContactAddressGW
        /// </summary>
        public string B00PersonInterfaceContactAddressGw_IdPersonInterfaceContactAddressGW { get; set; }
    }

    public class ContactUpdateData : ContactCreateData
    {
        /// <summary>
        /// B00Person_IdPerson
        /// </summary>
